...
//Create objects and modify them
layout.insertNewObject(project, "Sprite", "MyObject", 0);
layout.insertNewObject(project, "Sprite", "MonPersonnage", 0);
var obj = layout.getObject("MyObject");
obj.setName("MonObjet");
var anim = new gd.Animation();
anim.setDirectionsNumber(2);
...
var functor = {
    invoke: function(instance) {
        instance.setX(instance.getX()+10);
        instance.y += 5;
    }
};
...
console.log(layout.hasObjectNamed("MyObject"));
console.log(layout.hasObjectNamed("MonObjet"));
console.log(layout.getObject("MonObjet").getName());
