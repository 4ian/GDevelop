...
AllowNoIcons=yes
LicenseFile=..\Output\Release\License-fr.rtf
InfoBeforeFile=..\Output\Release\Informations-fr.rtf
OutputDir=.\
OutputBaseFilename=gd3371
Compression=lzma
SolidCompression=yes
SetupIconFile=..\Output\Release\res\icon.ico
...
[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"; LicenseFile: "..\Output\Release\License-en.rtf"; InfoBeforeFile: "..\Output\Release\Informations-en.rtf"
Name: "french"; MessagesFile: "compiler:Languages\French.isl"
Name: "spanish"; MessagesFile: "compiler:Languages\Spanish.isl"; LicenseFile: "..\Output\Release\License-en.rtf"; InfoBeforeFile: "..\Output\Release\Informations-en.rtf"
...
[Files]
Source: ..\Output\Release\GDIDE.exe; DestDir: {app}; Flags: ignoreversion
Source: ..\Output\Release\*; DestDir: {app}; Flags: ignoreversion
Source: ..\Output\Release\Templates\*; DestDir: {app}\Templates; Flags: ignoreversion createallsubdirs recursesubdirs; Components: main
Source: ..\Output\Release\res\*; DestDir: {app}\res; Flags: ignoreversion createallsubdirs recursesubdirs; Components: main
Source: ..\Output\Release\CppPlatform\*; DestDir: {app}\CppPlatform; Flags: ignoreversion createallsubdirs recursesubdirs; Components: main
Source: ..\Output\Release\JsPlatform\*; DestDir: {app}\JsPlatform; Flags: ignoreversion createallsubdirs recursesubdirs; Components: main
Source: ..\Output\Release\locale\*; DestDir: {app}\locale; Flags: ignoreversion createallsubdirs recursesubdirs; Components: main
Source: ..\Output\Release\Examples\*; DestDir: {app}\Examples; Flags: ignoreversion createallsubdirs recursesubdirs; Components: example
Source: ..\Output\Release\Ressources\*; DestDir: {app}\Ressources; Flags: ignoreversion createallsubdirs recursesubdirs; Components: res
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: ..\Output\Release\icon.ico; DestDir: {app}; Flags: ignoreversion
Source: ..\Output\Release\SelectLanguage-en.cfg; DestDir: {userdocs}\..\.Game Develop; Flags: ignoreversion createallsubdirs recursesubdirs; DestName: SelectLanguage.cfg; Languages: english; Components: main
Source: ..\Output\Release\SelectLanguage-fr.cfg; DestDir: {userdocs}\..\.Game Develop; Flags: ignoreversion createallsubdirs recursesubdirs; DestName: SelectLanguage.cfg; Languages: french ; Components: main
Source: ..\Output\Release\SelectLanguage-es.cfg; DestDir: {userdocs}\..\.Game Develop; Flags: ignoreversion createallsubdirs recursesubdirs; DestName: SelectLanguage.cfg; Languages: spanish ; Components: main
