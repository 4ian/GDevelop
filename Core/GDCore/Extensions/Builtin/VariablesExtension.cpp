...
void GD_CORE_API BuiltinExtensionsImplementer::ImplementsVariablesExtension(
  ...
  extension
      .AddCondition("VarScene", _("Value of a scene variable"),
                    _("Compare the value of a scene variable."),
                    _("the scene variable _PARAM0_"), _("Scene variables"),
                    "res/conditions/var24.png", "res/conditions/var.png")
      .AddParameter("scenevar", _("Variable"))
      .UseStandardRelationalOperatorParameters("number");

  extension
      .AddCondition("VarSceneTxt", _("Text of a scene variable"),
                    _("Compare the text of a scene variable."),
                    _("the text of scene variable _PARAM0_"),
                    _("Scene variables"), "res/conditions/var24.png",
  ...
  extension
      .AddCondition(
          "SceneVariableAsBoolean", _("Boolean value of a scene variable"),
  ...
  extension
      .AddCondition(
          "VariableChildExists", _("Child existence"),
  ...
  extension
      .AddCondition("GlobalVariableChildExists", _("Child existence"),
  ...
  extension
      .AddCondition("VarSceneDef", "Test if a scene variable is defined",
                    "Test if the scene variable exists.",
                    "Scene variable _PARAM0_ is defined", _("Scene variables"),
                    "res/conditions/var24.png", "res/conditions/var.png")
  ...
  extension
      .AddCondition("VarGlobal", _("Value of a global variable"),
                    _("Compare the value of a global variable."),
                    _("the global variable _PARAM0_"), _("Global variables"),
                    "res/conditions/var24.png", "res/conditions/var.png")
      .AddParameter("globalvar", _("Variable"))
      .UseStandardRelationalOperatorParameters("number")
      .MarkAsAdvanced();
  ...
  extension
      .AddCondition("VarGlobalTxt", _("Text of a global variable"),
                    _("Compare the text of a global variable."),
                    _("the text of the global variable _PARAM0_"),
                    _("Global variables"), "res/conditions/var24.png",
                    "res/conditions/var.png")
      .AddParameter("globalvar", _("Variable"))
      .UseStandardRelationalOperatorParameters("string")
      .MarkAsAdvanced();
  ...
  extension
      .AddCondition(
          "GlobalVariableAsBoolean", _("Boolean value of a global variable"),
  ...
  extension
      .AddCondition("VarGlobalDef", "Test if a global variable is defined",
  ...
  extension
      .AddAction("ModVarScene", _("Value of a scene variable"),
                 _("Change the value of a scene variable."),
                 _("the scene variable _PARAM0_"), _("Scene variables"),
                 "res/actions/var24.png", "res/actions/var.png")
      .AddParameter("scenevar", _("Variable"))
      .UseStandardOperatorParameters("number");

  extension
      .AddAction("ModVarSceneTxt", _("String of a scene variable"),
                 _("Modify the text of a scene variable."),
                 _("the text of scene variable _PARAM0_"), _("Scene variables"),
                 "res/actions/var24.png", "res/actions/var.png")
      .AddParameter("scenevar", _("Variable"))
  ...
  extension
      .AddAction(
          "SetSceneVariableAsBoolean", _("Boolean value of a scene variable"),
  ...
  extension
      .AddAction("ModVarGlobal", _("Value of a global variable"),
  ...
  extension
      .AddAction("ModVarGlobalTxt", _("String of a global variable"),
                 _("Modify the text of a global variable."),
                 _("the text of global variable _PARAM0_"),
                 _("Global variables"), "res/actions/var24.png",
                 "res/actions/var.png")
      .AddParameter("globalvar", _("Variable"))
      .UseStandardOperatorParameters("string")
      .MarkAsAdvanced();
  ...
  extension
      .AddAction(
          "SetGlobalVariableAsBoolean", _("Boolean value of a global variable"),
  ...
  extension
      .AddAction("SetBooleanVariable", _("Set boolean value of a variable"),
                 _("Modify the boolean value of a variable."),
                 _("Set the boolean value of variable _PARAM0_ to _PARAM1_"),
                 _("Variables"), "res/conditions/var24.png",
                 "res/conditions/var.png")
  ...
  extension
      .AddAction("VariableRemoveChild", _("Remove a child"),
  ...
  extension
      .AddAction("GlobalVariableRemoveChild", _("Remove a child"),
  ...
  extension
      .AddAction("VariableClearChildren", _("Clear scene variable"),
                 _("Remove all the children from the scene variable."),
                 _("Clear children from scene variable _PARAM0_"),
                 _("Scene variables/Collections"), "res/actions/var24.png",
                 "res/actions/var.png")
      .AddParameter("scenevar", _("Variable"))
      .MarkAsAdvanced();

  extension
      .AddAction("GlobalVariableClearChildren", _("Clear global variable"),
                 _("Remove all the children from the global variable."),
                 _("Clear children from global variable _PARAM0_"),
                 _("Global variables/Collections"), "res/actions/var24.png",
                 "res/actions/var.png")
      .AddParameter("globalvar", _("Variable"))
      .MarkAsAdvanced();

  extension
      .AddAction("SceneVariablePush", _("Append variable to a scene array"),
  ...
  extension
      .AddAction("GlobalVariablePush", _("Append variable to a global array"),
  ...
  extension
      .AddExpression("GlobalVariableChildCount",
                     ...
                     _("Number of children of a global variable"),
                     _("Global variables"), "res/actions/var.png")
      .AddParameter("globalvar", _("Variable"));
  ...
  extension
      .AddExpression("VariableChildCount",
                     ...
                     _("Number of children of a scene variable"),
                     _("Scene variables"), "res/actions/var.png")
      .AddParameter("scenevar", _("Variable"));

  extension
      .AddExpression("Variable", _("Value of a scene variable"),
                     _("Value of a scene variable"), _("Scene variables"),
                     "res/actions/var.png")
      .AddParameter("scenevar", _("Variable"));

  extension
      .AddStrExpression("VariableString", _("Text of a scene variable"),
                        _("Text of a scene variable"), _("Scene variables"),
                        "res/actions/var.png")
      .AddParameter("scenevar", _("Variable"));

  extension
      .AddExpression("GlobalVariable", _("Value of a global variable"),
                     _("Value of a global variable"), _("Global variables"),
                     "res/actions/var.png")
      .AddParameter("globalvar", _("Name of the global variable"));

  extension
      .AddStrExpression("GlobalVariableString", _("Text of a global variable"),
                        _("Text of a global variable"), _("Global variables"),
                        "res/actions/var.png")
      .AddParameter("globalvar", _("Variable"));

  extension
      .AddVariableExpression("SceneVar", _("Scene variable"),
                             _("Get a scene variable."), _("Variables"),
                             "res/actions/var.png")
      .AddParameter("scenevar", _("Name of the scene variable"));

  extension
      .AddVariableExpression("GlobalVar", _("Global variable"),
                             _("Get a global variable."), _("Variables"),
                             "res/actions/var.png")
      .AddParameter("globalvar", _("Name of the global variable"));
}
