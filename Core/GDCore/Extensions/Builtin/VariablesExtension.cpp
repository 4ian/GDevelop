...
void GD_CORE_API BuiltinExtensionsImplementer::ImplementsVariablesExtension(
  ...
  extension
      .AddCondition("GlobalConfigExists",
                    ...
                    _("Check if a global config placeholder value exists."),
  ...
  extension
      .AddCondition("GlobalConfigNumber",
                    _("Config number"),
                    _("Compare the number value of a global config placeholder."),
  ...
  extension
      .AddCondition("GlobalConfigString",
                    _("Config text"),
                    _("Compare the text value of a global config placeholder."),
  ...
  extension
      .AddCondition("GlobalConfigBoolean",
                    _("Config boolean"),
                    _("Compare the boolean value of a global config placeholder."),
  ...
  extension
      .AddExpression("ConfigBool",
                     _("Config boolean"),
                     _("Get a global config placeholder value as a boolean, "
                       "returning 1 "
  ...
  extension
      .AddExpression("ConfigChildCount",
                     ...
                     _("Get the number of children in a global config "
                       "placeholder value."),
                     _("Global configuration"),
                     "res/actions/var.png")
      .AddParameter("string", _("Config placeholder"))
