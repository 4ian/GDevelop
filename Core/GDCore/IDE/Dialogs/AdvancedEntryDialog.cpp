...
AdvancedTextEntryDialog::AdvancedTextEntryDialog(wxWindow* parent,
                                                 gd::String caption,
                                                 gd::String description,
                                                 gd::String defaultText,
                                                 MoreButtonType moreButtonType_,
                                                 gd::Project* project_,
                                                 gd::Layout* layout_)
    : moreButtonType(moreButtonType_), project(project_), layout(layout_) {
  ...
  descriptionTxt = new wxStaticText(this,
                                    ID_STATICTEXT1,
                                    _("Label"),
                                    wxDefaultPosition,
                                    wxDefaultSize,
                                    ...
                                    _T("ID_STATICTEXT1"));
  FlexGridSizer1->Add(
      descriptionTxt, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  textEdit = new wxTextCtrl(this,
                            ID_TEXTCTRL1,
                            wxEmptyString,
                            wxDefaultPosition,
                            wxDefaultSize,
  ...
  Connect(ID_BUTTON1,
          ...
          (wxObjectEventFunction)&AdvancedTextEntryDialog::OnmoreBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&AdvancedTextEntryDialog::OncancelBtClick);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&AdvancedTextEntryDialog::OnokBtClick);
  //*)
...
void AdvancedTextEntryDialog::OnmoreBtClick(wxCommandEvent& event) {
  if (moreButtonType == MathExpression && project && layout) {
    ...
    EditStrExpressionDialog dialog(
        this, textEdit->GetValue(), *project, *layout);
    if (dialog.ShowModal() == 1) textEdit->ChangeValue(dialog.GetExpression());
  }
}
