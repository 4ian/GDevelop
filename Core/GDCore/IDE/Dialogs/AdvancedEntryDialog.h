...
/**
 * \brief Dialog used to enter a math or gd::String expression, with a button to
 * open a full editor.
 *
 * \ingroup IDEDialogs
 */
class AdvancedTextEntryDialog : public wxDialog {
 public:
  ...
  AdvancedTextEntryDialog(wxWindow* parent,
                          gd::String caption,
                          gd::String description,
                          gd::String defaultText,
                          MoreButtonType moreButtonType = None,
                          gd::Project* project_ = NULL,
                          gd::Layout* layout_ = NULL);
