...
class GD_CORE_API ChooseBehaviorDialog : public wxDialog {
 public:
   ...
   * \param behaviorTypeAllowed If not empty, only behaviors of this type will
   * be shown
   */
  ChooseBehaviorDialog(wxWindow* parent,
                       Project& project,
                       gd::Layout& layout,
   ...
   * \return true if a behavior (or none) was chosen. false if there are two
   * behaviors or more.
   */
  bool DeduceBehavior();
