...
ChooseLayerDialog::ChooseLayerDialog(wxWindow* parent,
  ...
  Connect(ID_LISTBOX1,
          ...
          (wxObjectEventFunction)&ChooseLayerDialog::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ChooseLayerDialog::OnokBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ChooseLayerDialog::OncancelBtClick);
  //*)
...
void ChooseLayerDialog::OncancelBtClick(wxCommandEvent& event) { EndModal(0); }
