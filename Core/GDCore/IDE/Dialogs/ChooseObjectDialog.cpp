...
ChooseObjectDialog::ChooseObjectDialog(wxWindow* parent,
                                       Project& project_,
                                       gd::Layout& layout_,
                                       bool canSelectGroup_,
  ...
  objectsList = new wxTreeCtrl(
      this,
      ID_TREECTRL1,
      wxDefaultPosition,
      wxDefaultSize,
      wxTR_HIDE_ROOT | wxTR_MULTIPLE | wxTR_DEFAULT_STYLE | wxNO_BORDER,
      wxDefaultValidator,
      _T("ID_TREECTRL1"));
  ...
  editMenuItem = new wxMenuItem((&Menu1),
                                ID_MENUITEM2,
                                _("Choose this object"),
                                wxEmptyString,
                                wxITEM_NORMAL);
  Menu1.Append(editMenuItem);
#ifdef __WXMSW__
  Menu1.Remove(editMenuItem);
  wxFont boldFont(wxDEFAULT,
                  wxDEFAULT,
                  wxFONTSTYLE_NORMAL,
                  wxBOLD,
                  false,
  ...
  MenuItem1 = new wxMenuItem((&Menu1),
                             ID_MENUITEM1,
                             _("To add some objects, use the objects editor"),
                             wxEmptyString,
                             wxITEM_NORMAL);
  Menu1.Append(MenuItem1);
  editGroupMenuItem = new wxMenuItem((&Menu2),
                                     ID_MENUITEM3,
                                     _("Choose this group"),
                                     wxEmptyString,
                                     wxITEM_NORMAL);
  ...
  MenuItem4 =
      new wxMenuItem((&Menu2),
                     ID_MENUITEM4,
                     _("To add some groups, use the objects groups editor"),
                     wxEmptyString,
                     wxITEM_NORMAL);
  ...
  Connect(
      ...
      (wxObjectEventFunction)&ChooseObjectDialog::OnObjetsListItemActivated);
  Connect(
      ID_TREECTRL1,
      wxEVT_COMMAND_TREE_ITEM_RIGHT_CLICK,
      (wxObjectEventFunction)&ChooseObjectDialog::OnObjetsListItemRightClick);
  Connect(
      ID_TREECTRL1,
      wxEVT_COMMAND_TREE_SEL_CHANGED,
      (wxObjectEventFunction)&ChooseObjectDialog::OnObjetsListSelectionChanged);
  Connect(ID_TEXTCTRL1,
          wxEVT_COMMAND_TEXT_UPDATED,
          (wxObjectEventFunction)&ChooseObjectDialog::OnsearchCtrlText);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ChooseObjectDialog::OnChoisirBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ChooseObjectDialog::OnAnnulerBtClick);
  ...
  if (!allowMultipleSelection) {
    objectsList->SetWindowStyleFlag(objectsList->GetWindowStyleFlag() &
                                    ~wxTR_MULTIPLE);
  }
...
void ChooseObjectDialog::OnObjetsListSelectionChanged(wxTreeEvent& event) {
  ...
  gd::TreeItemStringData* data =
      dynamic_cast<gd::TreeItemStringData*>(objectsList->GetItemData(item));
  if (!data)
    ChoisirBt->Disable();
  else
    ChoisirBt->Enable();
...
void ChooseObjectDialog::OnsearchCtrlText(wxCommandEvent& event) { Refresh(); }
