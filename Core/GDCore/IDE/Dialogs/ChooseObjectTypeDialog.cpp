...
project(project_)
{
	...
	infoEdit = new wxTextCtrl(this, ID_TEXTCTRL1, _("No information about the object."), wxDefaultPosition, wxSize(227,37), wxTE_MULTILINE|wxTE_READONLY, wxDefaultValidator, _T("ID_TEXTCTRL1"));
