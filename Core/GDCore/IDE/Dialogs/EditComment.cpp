...
EditComment::EditComment(wxWindow* parent, CommentEvent& event_)
  ...
  FlexGridSizer5->Add(
      CheckBox1, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  ColorBt = new wxButton(this,
                         ID_BUTTON1,
                         _("Background color"),
                         wxDefaultPosition,
                         wxDefaultSize,
  ...
  StaticBitmap1 = new wxStaticBitmap(this,
                                     ID_STATICBITMAP2,
                                     ...
                                     wxNO_BORDER,
                                     _T("ID_STATICBITMAP2"));
  FlexGridSizer3->Add(StaticBitmap1,
                      1,
  ...
  FlexGridSizer3->Add(
      ...
      5);
  FlexGridSizer2->Add(
      FlexGridSizer3, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);
  ...
  AnnulerBt = new wxButton(this,
                           ...
                           _T("ID_BUTTON3"));
  FlexGridSizer2->Add(
      AnnulerBt, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer1->Add(
      FlexGridSizer2,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  Connect(ID_CHECKBOX1,
          ...
          (wxObjectEventFunction)&EditComment::OnCheckBox1Click);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&EditComment::OnColorBtClick);
  Connect(ID_BUTTON5,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&EditComment::OntxtColorBtClick);
  Connect(ID_HYPERLINKCTRL1,
          wxEVT_COMMAND_HYPERLINK,
          (wxObjectEventFunction)&EditComment::OnAideBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&EditComment::OnOkBtClick);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&EditComment::OnAnnulerBtClick);
  //*)
  ...
  ColorBt->SetBackgroundColour(
      wxColour(commentEvent.r, commentEvent.v, commentEvent.b));
  txtColorBt->SetBackgroundColour(
      wxColour(commentEvent.textR, commentEvent.textG, commentEvent.textB));
  txtColorBt->SetForegroundColour(wxColour(255 - commentEvent.textR,
                                           255 - commentEvent.textG,
                                           255 - commentEvent.textB));
}
...
void EditComment::OnAnnulerBtClick(wxCommandEvent& event) { EndModal(0); }

void EditComment::OnAideBtClick(wxCommandEvent& event) {
  gd::HelpFileAccess::Get()->OpenPage(
      "game_develop/documentation/manual/comment_events");
}
void EditComment::OntxtColorBtClick(wxCommandEvent& event) {
  ...
  if (Dialog.ShowModal() == wxID_OK) {
    ...
    txtColorBt->SetForegroundColour(
        wxColour(255 - txtColorBt->GetBackgroundColour().Red(),
                 255 - txtColorBt->GetBackgroundColour().Green(),
                 255 - txtColorBt->GetBackgroundColour().Blue()));
    txtColorBt->Refresh();
  }
}
