...
EditForEachEvent::EditForEachEvent(wxWindow* parent,
                                   ForEachEvent& event_,
                                   gd::Project& game_,
                                   gd::Layout& scene_)
  ...
  Create(parent,
         wxID_ANY,
         _("Edit the \"For each object\" event"),
         wxDefaultPosition,
         wxDefaultSize,
  ...
  StaticText1 = new wxStaticText(this,
                                 ID_STATICTEXT1,
                                 _("Repeat event for each object:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT1"));
  ...
  StaticBitmap1 = new wxStaticBitmap(this,
                                     ...
                                     wxNO_BORDER,
                                     _T("ID_STATICBITMAP2"));
  FlexGridSizer5->Add(StaticBitmap1,
                      1,
  ...
  Connect(ID_BITMAPBUTTON1,
          ...
          (wxObjectEventFunction)&EditForEachEvent::OnobjectBtClick);
  Connect(ID_HYPERLINKCTRL1,
          wxEVT_COMMAND_HYPERLINK,
          (wxObjectEventFunction)&EditForEachEvent::OnhelpBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&EditForEachEvent::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&EditForEachEvent::OncancelBtClick);
  //*)
...
void EditForEachEvent::OnhelpBtClick(wxCommandEvent& event) {
  gd::HelpFileAccess::Get()->OpenPage(
      "en/game_develop/documentation/manual/foreach_events");
}
