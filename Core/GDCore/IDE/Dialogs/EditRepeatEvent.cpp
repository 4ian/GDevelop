...
EditRepeatEvent::EditRepeatEvent(wxWindow* parent,
                                 RepeatEvent& event_,
                                 gd::Project& game_,
                                 gd::Layout& scene_)
    : event(event_), game(game_), scene(scene_) {
  ...
  StaticText1 = new wxStaticText(this,
                                 ID_STATICTEXT1,
                                 _("Number of repetitions of the event :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT1"));
  ...
  expressionEdit = new wxTextCtrl(this,
                                  ID_TEXTCTRL1,
                                  wxEmptyString,
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer4->Add(
      ...
      5);
  expressionBt =
      new wxBitmapButton(this,
                         ID_BITMAPBUTTON1,
                         wxBitmap(wxImage(_T("res/expressionicon.png"))),
                         wxDefaultPosition,
                         wxDefaultSize,
                         wxBU_AUTODRAW,
                         wxDefaultValidator,
  ...
  Connect(ID_BITMAPBUTTON1,
          ...
          (wxObjectEventFunction)&EditRepeatEvent::OnexpressionBtClick);
  Connect(ID_HYPERLINKCTRL1,
          wxEVT_COMMAND_HYPERLINK,
          (wxObjectEventFunction)&EditRepeatEvent::OnhelpBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&EditRepeatEvent::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&EditRepeatEvent::OncancelBtClick);
  //*)
...
void EditRepeatEvent::OnexpressionBtClick(wxCommandEvent&) {
  gd::EditExpressionDialog dialog(
      this, expressionEdit->GetValue(), game, scene);
...
void EditRepeatEvent::OncancelBtClick(wxCommandEvent& event) { EndModal(0); }

void EditRepeatEvent::OnhelpBtClick(wxCommandEvent& event) {
  gd::HelpFileAccess::Get()->OpenPage(
      "en/game_develop/documentation/manual/repeat_events");
}
