...
const long EditStrExpressionDialog::ID_BUTTON4 = wxNewId();
    ...
    lastErrorPos(std::string::npos)
{
	...
	Connect(ID_BUTTON4,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&EditStrExpressionDialog::OnhelpBtClick);
