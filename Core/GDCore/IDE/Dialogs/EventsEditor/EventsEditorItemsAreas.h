 ...
 *
 * Used by events editor to indicate to EventsEditorItemsAreas that an event is
 * displayed somewhere. \ingroup IDEDialogsEventsEditor
 */
class GD_CORE_API EventItem {
 public:
  EventItem(std::shared_ptr<gd::BaseEvent> event_,
...
/**
 * \brief Used to indicate to EventsEditorItemsAreas that an instruction is
 * displayed somewhere \ingroup IDEDialogsEventsEditor
 */
class GD_CORE_API InstructionItem {
 public:
  /**
   * Use this constructor to declare the instruction, the list it belongs to and
   * its position in this list.
   */
  InstructionItem(gd::Instruction* instruction_,
                  bool isCondition,
                  gd::InstructionsList* instructionList_,
                  std::size_t positionInList_,
                  gd::BaseEvent* event);
  InstructionItem();
  ~InstructionItem(){};
...
/**
 * \brief Used to indicate to EventsEditorItemsAreas that an instruction list is
 * displayed somewhere \ingroup IDEDialogsEventsEditor
 */
class GD_CORE_API InstructionListItem {
 public:
   ...
   * its position in this list.
   */
  InstructionListItem(bool isConditionList,
                      gd::InstructionsList* instructionList_,
                      gd::BaseEvent* event);
  InstructionListItem();
  ~InstructionListItem(){};
...
/**
 * \brief Used to indicate to EventsEditorItemsAreas that a parameter is
 * displayed somewhere \ingroup IDEDialogsEventsEditor
 */
...
/**
 * \brief Used to indicate to EventsEditorItemsAreas that a fold/unfold button
 * is displayed somewhere \ingroup IDEDialogsEventsEditor
 */
...
/**
 * \brief Allow events to indicate where is displayed an instruction or
 * parameter.
 *
 * Events editor also uses this internally to indicate where events are
 * displayed. \ingroup IDEDialogsEventsEditor
 */
class GD_CORE_API EventsEditorItemsAreas {
 public:
  ...
  /**
   * \brief Return event at point (x,y). Be sure there is an event here using
   * IsOnEvent(x,y);
   */
...
// Hash for EventItem, ParameterItem, InstructionItem, InstructionListItem and
// FoldingItem
namespace std {
template <>
