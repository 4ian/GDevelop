...
GridSetupDialog::GridSetupDialog(wxWindow* parent,
                                 int& width,
                                 int& height,
                                 int& x,
                                 int& y,
  ...
  offsetXEdit = new wxTextCtrl(this,
                               ID_TEXTCTRL1,
                               wxEmptyString,
                               wxDefaultPosition,
                               wxDefaultSize,
  ...
  StaticText8 = new wxStaticText(this,
                                 ...
                                 _T("ID_STATICTEXT8"));
  FlexGridSizer2->Add(
      StaticText8, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  offsetYEdit = new wxTextCtrl(this,
                               ID_TEXTCTRL4,
                               wxEmptyString,
                               wxDefaultPosition,
                               wxDefaultSize,
  ...
  FlexGridSizer2->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText9 = new wxStaticText(this,
                                 ID_STATICTEXT9,
                                 _("pixels"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  heightEdit = new wxTextCtrl(this,
                              ID_TEXTCTRL3,
                              wxEmptyString,
                              wxDefaultPosition,
                              wxSize(55, -1),
  ...
  FlexGridSizer2->Add(
      ...
      5);
  FlexGridSizer2->Add(
      5, 10, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  snapCheck = new wxCheckBox(this,
                             ID_CHECKBOX1,
                             _("Snap to grid"),
                             wxDefaultPosition,
                             wxDefaultSize,
  ...
  FlexGridSizer2->Add(
      snapCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer2->Add(
      5, 10, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  ...
  colorPanel = new wxPanel(this,
                           ...
                           _T("ID_PANEL1"));
  FlexGridSizer2->Add(
      colorPanel, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer1->Add(
      FlexGridSizer2,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  FlexGridSizer1->Add(
      FlexGridSizer4,
      1,
      wxALL | wxEXPAND | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL,
      0);
  ...
  colorPanel->Connect(
      wxEVT_LEFT_UP,
      (wxObjectEventFunction)&GridSetupDialog::OncolorPanelLeftUp,
      0,
      this);
  Connect(ID_HYPERLINKCTRL1,
          wxEVT_COMMAND_HYPERLINK,
          (wxObjectEventFunction)&GridSetupDialog::OnhelpBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&GridSetupDialog::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&GridSetupDialog::OncancelBtClick);
  //*)
...
void GridSetupDialog::OncancelBtClick(wxCommandEvent& event) { EndModal(0); }
...
void GridSetupDialog::OnhelpBtClick(wxCommandEvent& event) {
  gd::HelpFileAccess::Get()->OpenPage(
      "en/game_develop/documentation/manual/editors/scene_editor/"
      "edit_scene_edit");
}
