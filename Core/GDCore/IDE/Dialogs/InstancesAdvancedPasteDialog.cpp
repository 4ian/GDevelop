...
InstancesAdvancedPasteDialog::InstancesAdvancedPasteDialog(wxWindow* parent,
                                                           wxWindowID id,
                                                           const wxPoint& pos,
                                                           const wxSize& size) {
  ...
  xStartEdit = new wxTextCtrl(this,
                              ID_TEXTCTRL2,
                              wxEmptyString,
                              wxDefaultPosition,
                              wxSize(52, -1),
  ...
  FlexGridSizer9->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  yStartEdit = new wxTextCtrl(this,
                              ID_TEXTCTRL3,
                              wxEmptyString,
                              wxDefaultPosition,
                              wxSize(52, -1),
  ...
  xCountEdit = new wxSpinCtrl(this,
                              ID_SPINCTRL1,
                              _T("1"),
                              wxDefaultPosition,
                              wxSize(56, -1),
  ...
  yCountEdit = new wxSpinCtrl(this,
                              ID_SPINCTRL2,
                              _T("1"),
                              wxDefaultPosition,
                              wxSize(56, -1),
  ...
  StaticText6 = new wxStaticText(this,
                                 ID_STATICTEXT6,
                                 _("Spaces between each obejects"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT6"));
  ...
  StaticText4 =
      new wxStaticText(this,
                       ID_STATICTEXT4,
                       _("Apply progressively to each created object :"),
                       wxDefaultPosition,
                       wxDefaultSize,
                       0,
                       _T("ID_STATICTEXT4"));
  ...
  rotationEdit = new wxTextCtrl(this,
                                ID_TEXTCTRL1,
                                _("0"),
                                wxDefaultPosition,
                                wxSize(44, -1),
  ...
  Connect(ID_HYPERLINKCTRL1,
          ...
          (wxObjectEventFunction)&InstancesAdvancedPasteDialog::OnhelpBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&InstancesAdvancedPasteDialog::OnokBtClick);
  Connect(
      ID_BUTTON2,
      wxEVT_COMMAND_BUTTON_CLICKED,
      (wxObjectEventFunction)&InstancesAdvancedPasteDialog::OncancelBtClick);
  //*)
}
