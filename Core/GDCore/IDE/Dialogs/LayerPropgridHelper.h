...
/**
 * \brief Helper class used to easily use a wxPropertyGrid so as to view and
 * edit the properties of a gd::Layer
 *
 * \ingroup IDEdialogs
 */
class GD_CORE_API LayerPropgridHelper {
 ...
 private:
  wxPropertyGrid*
      grid;  ///< The grid used for diplaying and editing properties.
  gd::Project& project;
  gd::Layout& layout;
