...
LayoutEditorCanvas::LayoutEditorCanvas(
    ...
    gd::Project &project_,
    gd::Layout &layout_,
    gd::InitialInstancesContainer &instances_,
    LayoutEditorCanvasOptions &options_,
    gd::MainFrameWrapper &mainFrameWrapper_,
    gd::ExternalLayout *externalLayout_)
    : project(project_),
      layout(layout_),
      ...
      gapBetweenButtonsAndRectangle(gd::GUIContentScaleFactor::Get() > 1 ? 12
                                                                         : 5),
...
//...and pass it to the sf::RenderWindow.
  ...
  Connect(wxEVT_ERASE_BACKGROUND,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnEraseBackground);
  Connect(wxEVT_IDLE, (wxObjectEventFunction)&LayoutEditorCanvas::OnIdle);
  Connect(wxEVT_LEFT_DOWN,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnLeftDown);
  Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&LayoutEditorCanvas::OnLeftUp);
  Connect(wxEVT_LEFT_DCLICK,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnLeftDClick);
  Connect(wxEVT_RIGHT_UP,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnRightUp);
  Connect(wxEVT_MIDDLE_DOWN,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnMiddleDown);
  Connect(wxEVT_MIDDLE_UP,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnMiddleUp);
  ...
  Connect(wxEVT_MOUSEWHEEL,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnMouseWheel);
  Connect(ID_DELOBJMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnDeleteObjectSelected);
  Connect(ID_PROPMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnPropObjSelected);
  Connect(ID_AUTOMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnAddAutoObjSelected);
  Connect(ID_LAYERUPMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnLayerUpSelected);
  Connect(ID_LAYERDOWNMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnLayerDownSelected);
  Connect(ID_COPYMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnCopySelected);
  Connect(ID_CUTMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnCutSelected);
  Connect(ID_PASTEMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnPasteSelected);
  Connect(ID_PASTESPECIALMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnPasteSpecialSelected);
  Connect(ID_CREATEOBJECTMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnCreateObjectSelected);
  Connect(ID_LOCKMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnLockSelected);
  Connect(ID_UNLOCKMENU,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::OnUnLockSelected);
  SetDropTarget(new LayoutEditorCanvasTextDnd(*this));

  // Generate undo menu
  {
    wxMenuItem *undo10item = new wxMenuItem(&undoMenu,
                                            idUndo10,
                                            _("Cancel 10 changes"),
                                            wxEmptyString,
                                            wxITEM_NORMAL);
    undoMenu.Append(undo10item);
    wxMenuItem *undo20item = new wxMenuItem(&undoMenu,
                                            idUndo20,
                                            _("Cancel 20 changes"),
                                            wxEmptyString,
                                            wxITEM_NORMAL);
    ...
    wxMenuItem *clearHistoryItem = new wxMenuItem(&undoMenu,
                                                  idClearHistory,
                                                  _("Delete the history"),
                                                  wxEmptyString,
                                                  wxITEM_NORMAL);
  ...
  latestState =
      std::shared_ptr<gd::InitialInstancesContainer>(instances.Clone());

  // Generate zoom menu
  wxMenuItem *zoom5 = new wxMenuItem((&zoomMenu),
                                     ID_CUSTOMZOOMMENUITEM5,
                                     _("5%"),
                                     wxEmptyString,
                                     wxITEM_NORMAL);
  zoomMenu.Append(zoom5);
  wxMenuItem *zoom10 = new wxMenuItem((&zoomMenu),
                                      ID_CUSTOMZOOMMENUITEM10,
                                      _("10%"),
                                      wxEmptyString,
                                      wxITEM_NORMAL);
  zoomMenu.Append(zoom10);
  wxMenuItem *zoom25 = new wxMenuItem((&zoomMenu),
                                      ID_CUSTOMZOOMMENUITEM25,
                                      _("25%"),
                                      wxEmptyString,
                                      wxITEM_NORMAL);
  zoomMenu.Append(zoom25);
  wxMenuItem *zoom50 = new wxMenuItem((&zoomMenu),
                                      ID_CUSTOMZOOMMENUITEM50,
                                      _("50%"),
                                      wxEmptyString,
                                      wxITEM_NORMAL);
  zoomMenu.Append(zoom50);
  wxMenuItem *zoom100 = new wxMenuItem((&zoomMenu),
                                       ID_CUSTOMZOOMMENUITEM100,
                                       _("100%"),
                                       wxEmptyString,
                                       wxITEM_NORMAL);
  zoomMenu.Append(zoom100);
  wxMenuItem *zoom150 = new wxMenuItem((&zoomMenu),
                                       ID_CUSTOMZOOMMENUITEM150,
                                       _("150%"),
                                       wxEmptyString,
                                       wxITEM_NORMAL);
  zoomMenu.Append(zoom150);
  wxMenuItem *zoom200 = new wxMenuItem((&zoomMenu),
                                       ID_CUSTOMZOOMMENUITEM200,
                                       _("200%"),
                                       wxEmptyString,
                                       wxITEM_NORMAL);
  zoomMenu.Append(zoom200);
  wxMenuItem *zoom500 = new wxMenuItem((&zoomMenu),
                                       ID_CUSTOMZOOMMENUITEM500,
                                       _("500%"),
                                       wxEmptyString,
                                       wxITEM_NORMAL);
  ...
  {
    wxMenuItem *layerUpItem =
        new wxMenuItem((&contextMenu),
                       ID_LAYERUPMENU,
                       _("Put the object(s) on the higher layer"),
                       wxEmptyString,
                       wxITEM_NORMAL);
    layerUpItem->SetBitmap(gd::SkinHelper::GetIcon("up", 16));
    wxMenuItem *layerDownItem =
        new wxMenuItem((&contextMenu),
                       ID_LAYERDOWNMENU,
                       _("Put the object(s) on the lower layer"),
                       wxEmptyString,
                       wxITEM_NORMAL);
    layerDownItem->SetBitmap(gd::SkinHelper::GetIcon("down", 16));
    wxMenuItem *deleteItem = new wxMenuItem((&contextMenu),
                                            ID_DELOBJMENU,
                                            _("Delete the selection\tDEL"),
                                            wxEmptyString,
                                            wxITEM_NORMAL);
    ...
    wxMenuItem *copyItem = new wxMenuItem(
        (&contextMenu), ID_COPYMENU, _("Copy"), wxEmptyString, wxITEM_NORMAL);
    copyItem->SetBitmap(gd::SkinHelper::GetIcon("copy", 16));
    contextMenu.Append(copyItem);
    wxMenuItem *cutItem = new wxMenuItem(
        (&contextMenu), ID_CUTMENU, _("Cut"), wxEmptyString, wxITEM_NORMAL);
    cutItem->SetBitmap(gd::SkinHelper::GetIcon("cut", 16));
    contextMenu.Append(cutItem);
    wxMenuItem *pasteItem = new wxMenuItem(
        (&contextMenu), ID_PASTEMENU, _("Paste"), wxEmptyString, wxITEM_NORMAL);
    pasteItem->SetBitmap(gd::SkinHelper::GetIcon("paste", 16));
    contextMenu.Append(pasteItem);
    wxMenuItem *pasteSpecialItem = new wxMenuItem((&contextMenu),
                                                  ID_PASTESPECIALMENU,
                                                  _("Special paste"),
                                                  wxEmptyString,
                                                  wxITEM_NORMAL);
    ...
    contextMenu.AppendSeparator();
    wxMenuItem *lockItem = new wxMenuItem((&contextMenu),
                                          ID_LOCKMENU,
                                          _("Lock the object(s)"),
                                          wxEmptyString,
                                          wxITEM_NORMAL);
  ...
  // Generate "no object" context menu
  {
    ...
    wxMenuItem *pasteItem = new wxMenuItem((&noObjectContextMenu),
                                           ID_PASTEMENU,
                                           _("Paste"),
                                           wxEmptyString,
                                           wxITEM_NORMAL);
    ...
    wxMenuItem *pasteSpecialItem = new wxMenuItem((&noObjectContextMenu),
                                                  ID_PASTESPECIALMENU,
                                                  _("Special paste"),
                                                  wxEmptyString,
                                                  wxITEM_NORMAL);
    ...
    noObjectContextMenu.AppendSeparator();
    wxMenuItem *unlockItem =
        new wxMenuItem((&noObjectContextMenu),
                       ID_UNLOCKMENU,
                       _("Unlock the object under the cursor"),
                       wxEmptyString,
                       wxITEM_NORMAL);
  ...
  for (std::size_t i = 0; i < project.GetUsedPlatforms().size(); ++i) {
    std::shared_ptr<gd::LayoutEditorPreviewer> previewer =
        project.GetUsedPlatforms()[i]->GetLayoutPreviewer(*this);
    previewers[project.GetUsedPlatforms()[i]->GetName()] = previewer;

    long id = wxNewId();
    if (previewer) {
      idForPlatformsMenu[id] = project.GetUsedPlatforms()[i]->GetName();
      platformsMenu.Append(
          id,
          _("Preview for ") + project.GetUsedPlatforms()[i]->GetFullName(),
          _("Launch a preview for this platform"),
          wxITEM_RADIO);
      mainFrameWrapper.GetMainEditor()->Connect(
          id,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&LayoutEditorCanvas::
              OnPreviewForPlatformSelected,
          NULL,
          this);
    } else {
      platformsMenu.Append(id,
                           _("No preview available for ") +
                               project.GetUsedPlatforms()[i]->GetFullName(),
                           _("No preview can be done for this platform"),
                           wxITEM_RADIO);
  ...
  editionView.setCenter((project.GetMainWindowDefaultWidth() / 2),
                        (project.GetMainWindowDefaultHeight() / 2));
...
void LayoutEditorCanvas::OnIdle(wxIdleEvent &event) {
  if (enableIdleEvents) {
    // Send a paint message when the control is idle, to ensure maximum
    // framerate
    Refresh();
...
void LayoutEditorCanvas::AddAssociatedEditor(
    gd::LayoutEditorCanvasAssociatedEditor *editor) {
  if (!editor) return;
...
void LayoutEditorCanvas::ConnectEvents() {
  if (!editing && currentPreviewer)
    currentPreviewer->ConnectPreviewRibbonToolsEvents();

  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonEditMode,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnEditionBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonPreviewMode,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnPreviewBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonPreviewMode,
      wxEVT_COMMAND_RIBBONBUTTON_DROPDOWN_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnPreviewDropDownBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonHelp,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnHelpBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonObjectsEditor,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnObjectsEditor,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonLayersEditor,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnLayersEditor,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonGrid,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnGridBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonGridSetup,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnGridSetupBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonWindowMask,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnWindowMaskBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonUndo,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnUndoBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonUndo,
      wxEVT_COMMAND_RIBBONBUTTON_DROPDOWN_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnUndoMoreBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonRedo,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnRedoBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonObjectsPositionList,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnObjectsPositionList,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idUndo10,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnUndo10Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idUndo20,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnUndo20Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idClearHistory,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnClearHistorySelected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonFullScreen,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnFullScreenBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonOrigine,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnOrigineBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonOriginalZoom,
      wxEVT_COMMAND_RIBBONBUTTON_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnZoomInitBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      idRibbonOriginalZoom,
      wxEVT_COMMAND_RIBBONBUTTON_DROPDOWN_CLICKED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnZoomMoreBtClick,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      ID_CUSTOMZOOMMENUITEM5,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnCustomZoom5Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      ID_CUSTOMZOOMMENUITEM10,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnCustomZoom10Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      ID_CUSTOMZOOMMENUITEM25,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnCustomZoom25Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      ID_CUSTOMZOOMMENUITEM50,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnCustomZoom50Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      ID_CUSTOMZOOMMENUITEM100,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnCustomZoom100Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      ID_CUSTOMZOOMMENUITEM150,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnCustomZoom150Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      ID_CUSTOMZOOMMENUITEM200,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnCustomZoom200Selected,
      NULL,
      this);
  mainFrameWrapper.GetMainEditor()->Connect(
      ID_CUSTOMZOOMMENUITEM500,
      wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&LayoutEditorCanvas::OnCustomZoom500Selected,
      NULL,
      this);
}

void LayoutEditorCanvas::OnGuiElementHovered(
    const gd::LayoutEditorCanvasGuiElement &guiElement) {
  UpdateMouseResizeCursor(guiElement.name);
}

void LayoutEditorCanvas::OnGuiElementPressed(
    const gd::LayoutEditorCanvasGuiElement &guiElement) {
  if (currentDraggableBt.empty() && guiElement.name.substr(0, 6) == "resize") {
    ...
    for (auto &it : selectedInstances) {
      ...
      if (it.first->HasCustomSize()) {
        ...
        gd::Object *associatedObject =
            GetObjectLinkedToInitialInstance(*(it.first));
        if (associatedObject) {
          sf::Vector2f size = associatedObject->GetInitialInstanceDefaultSize(
              *(it.first), project, layout);
          resizeOriginalWidths[it.first] = size.x;
          resizeOriginalHeights[it.first] = size.y;
        }
      }
    }
    resizeMouseStartPosition =
        sf::Vector2f(GetMouseXOnLayout(), GetMouseYOnLayout());
  } else if (currentDraggableBt.empty() && guiElement.name == "angle") {
    currentDraggableBt = "angle";
  }
}

void LayoutEditorCanvas::OnGuiElementReleased(
    const gd::LayoutEditorCanvasGuiElement &guiElement) {}
...
void LayoutEditorCanvas::LaunchPreview() {
  ...
  for (auto &it : associatedEditors) it->Enable(false);
...
void LayoutEditorCanvas::OnEditionBtClick(wxCommandEvent &event) {
  ...
  for (auto &it : associatedEditors) it->Enable();
...
wxRibbonButtonBar *LayoutEditorCanvas::CreateRibbonPage(wxRibbonPage *page) {
  ...
  {
    wxRibbonPanel *ribbonPanel =
        new wxRibbonPanel(page,
                          wxID_ANY,
                          _("Mode"),
                          SkinHelper::GetRibbonIcon("preview"),
                          wxDefaultPosition,
                          wxDefaultSize,
                          wxRIBBON_PANEL_DEFAULT_STYLE);
    modeRibbonBar = new wxRibbonButtonBar(ribbonPanel, wxID_ANY);
    modeRibbonBar->AddButton(idRibbonEditMode,
                             !hideLabels ? _("Stop the preview") : gd::String(),
                             SkinHelper::GetRibbonIcon("edit"),
                             _("Stop the preview and go back to editing"));
    modeRibbonBar->AddButton(idRibbonPreviewMode,
                             !hideLabels ? _("Preview") : gd::String(),
                             SkinHelper::GetRibbonIcon("preview"),
                             _("Launch a preview"),
  ...
  }
  {
    ...
    ribbonBar->AddButton(idRibbonObjectsEditor,
                         !hideLabels ? _("Objects editor") : gd::String(),
                         gd::SkinHelper::GetRibbonIcon("objects"),
                         _("Show the list of objects of the scene"));
    ribbonBar->AddButton(idRibbonLayersEditor,
                         !hideLabels ? _("Layers editor") : gd::String(),
                         gd::SkinHelper::GetRibbonIcon("layers"),
                         _("Show the layers editor"));
  }
  ...
  wxRibbonPanel *toolsPanel =
      new wxRibbonPanel(page,
                        wxID_ANY,
                        _("Tools"),
                        SkinHelper::GetRibbonIcon("tools"),
                        wxDefaultPosition,
                        wxDefaultSize,
                        wxRIBBON_PANEL_DEFAULT_STYLE);
  wxRibbonButtonBar *ribbonToolbar =
      new wxRibbonButtonBar(toolsPanel, wxID_ANY);

  {
    wxRibbonPanel *ribbonPanel =
        new wxRibbonPanel(page,
                          wxID_ANY,
                          _("Help"),
                          SkinHelper::GetRibbonIcon("help"),
                          wxDefaultPosition,
                          wxDefaultSize,
                          wxRIBBON_PANEL_DEFAULT_STYLE);
    wxRibbonButtonBar *ribbonBar = new wxRibbonButtonBar(ribbonPanel, wxID_ANY);
    ribbonBar->AddButton(idRibbonHelp,
                         !hideLabels ? _("Help") : gd::String(),
                         SkinHelper::GetRibbonIcon("help"));
  }
...
void LayoutEditorCanvas::RecreateRibbonToolbar() {
  wxRibbonButtonBar *toolsBar =
      mainFrameWrapper.GetRibbonSceneEditorButtonBar();
...
void LayoutEditorCanvas::CreateEditionRibbonTools() {
  ...
  wxRibbonButtonBar *ribbonToolbar =
      mainFrameWrapper.GetRibbonSceneEditorButtonBar();
  ribbonToolbar->AddButton(
      idRibbonObjectsPositionList,
      !hideLabels ? _("Instances") : gd::String(),
      gd::SkinHelper::GetRibbonIcon("ObjectsPositionsList"),
      _("Open a list of all instances of objects put on the scene"));
  ribbonToolbar->AddHybridButton(idRibbonUndo,
                                 !hideLabels ? _("Undo") : gd::String(),
                                 gd::SkinHelper::GetRibbonIcon("undo"),
                                 _("Undo the last change"));
  ribbonToolbar->AddButton(idRibbonRedo,
                           !hideLabels ? _("Redo") : gd::String(),
                           gd::SkinHelper::GetRibbonIcon("redo"));
  ribbonToolbar->AddButton(idRibbonGrid,
                           !hideLabels ? _("Grid") : gd::String(),
                           gd::SkinHelper::GetRibbonIcon("grid"));
  ribbonToolbar->AddButton(idRibbonGridSetup,
                           !hideLabels ? _("Edit the grid") : gd::String(),
                           gd::SkinHelper::GetRibbonIcon("gridedit"),
                           _("Edit the size of the grid"));
  ribbonToolbar->AddButton(
      idRibbonWindowMask,
      !hideLabels ? _("Mask") : gd::String(),
      gd::SkinHelper::GetRibbonIcon("windowMask"),
      _("Show a mask corresponding to the size of the game window"));
  ribbonToolbar->AddButton(
      idRibbonOrigine,
      !hideLabels ? _("Return to the initial position ( 0;0 )") : gd::String(),
      gd::SkinHelper::GetRibbonIcon("center"),
      _("Go back to the origin of the scene"));
  ribbonToolbar->AddHybridButton(idRibbonOriginalZoom,
                                 !hideLabels ? _("Initial zoom") : gd::String(),
                                 gd::SkinHelper::GetRibbonIcon("zoom"),
                                 _("Go back to the initial zoom level"));
}
...
void LayoutEditorCanvas::UpdateContextMenu() {
  ...
  for (auto &it : selectedInstances) {
    ...
    highestLayer =
        std::max(highestLayer, layout.GetLayerPosition(it.first->GetLayer()));
  }
  ...
  for (auto &it : selectedInstances) {
    if (it.first == NULL) continue;
    lowestLayer =
        std::min(lowestLayer, layout.GetLayerPosition(it.first->GetLayer()));
  }
  ...
  if (wxMenuItem *layerDownItem = contextMenu.FindItem(ID_LAYERDOWNMENU)) {
    ...
    if (lowestLayer >= 1) {
      ...
      layerDownItem->SetItemLabel(_("Put the object(s) on the layer \"") +
                                  name + "\"");
    }
  }
}
...
void LayoutEditorCanvas::OnLayerUpSelected(wxCommandEvent &event) {
  ...
  if (lowestLayer + 1 < layout.GetLayersCount())
    SendSelectionToLayer(layout.GetLayer(lowestLayer + 1).GetName());
}
...
void LayoutEditorCanvas::OnLayerDownSelected(wxCommandEvent &event) {
  ...
  if (highestLayer >= 1)
    SendSelectionToLayer(layout.GetLayer(highestLayer - 1).GetName());
}
...
void LayoutEditorCanvas::SendSelectionToLayer(const gd::String &newLayerName) {
  ...
  ChangesMade();
  for (auto &it : associatedEditors) it->InitialInstancesUpdated();
}
...
void LayoutEditorCanvas::OnAddAutoObjSelected(wxCommandEvent &event) {
  ...
  gd::ChooseBehaviorTypeDialog::ChooseAndAddBehaviorToObject(
      this, project, object, &layout, globalObject);
...
void LayoutEditorCanvas::AddObject(const gd::String &objectName,
  ...
  if (options.grid && options.snap) {
    newInstance.SetX(static_cast<int>(x / options.gridWidth + 0.5) *
                     options.gridWidth);
    newInstance.SetY(static_cast<int>(y / options.gridHeight + 0.5) *
                     options.gridHeight);
  } else {
    newInstance.SetX(x);
    newInstance.SetY(y);
  ...
  // Notify sub editors
  for (std::set<LayoutEditorCanvasAssociatedEditor *>::iterator it =
           associatedEditors.begin();
       it != associatedEditors.end();
       ++it)
...
void LayoutEditorCanvas::OnLeftDown(wxMouseEvent &event) {
  ...
  for (std::size_t i = 0; i < guiElements.size(); ++i) {
    if (guiElements[i].area.Contains(
            wxPoint(sf::Mouse::getPosition(*this).x,
                    sf::Mouse::getPosition(*this).y))) {
  ...
  // Check if an instance is selected
  {
    ...
    if (!shiftPressed &&      // Check that shift is not pressed
        (instance == NULL ||  // If no object is clicked
         selectedInstances.find(instance) ==
             selectedInstances
                 .end()))  // Or an object which is not currently selected.
    {
      ClearSelection();
    }

    if (instance ==
        NULL)  // If no object is clicked, create a selection rectangle
    {
      isSelecting = true;
      selectionRectangle =
          wxRect(wxPoint(mouseX, mouseY), wxPoint(mouseX, mouseY));
      return;
...
void LayoutEditorCanvas::OnRightUp(wxMouseEvent &event) {
  ...
  // Check if an instance is selected
  {
    ...
    if (instance != NULL) {
      SelectInstance(instance);
      OnUpdate();  // So as to display selection rectangle for the newly
                   // selected object
      UpdateContextMenu();
      ...
      gd::InitialInstance *instance =
          GetInitialInstanceUnderCursor(/*pickOnlyLockedInstances=*/true);
...
void LayoutEditorCanvas::ClearSelection() {
  ...
  for (auto &it : associatedEditors) it->DeselectedAllInitialInstance();
}
...
void LayoutEditorCanvas::SelectInstance(InitialInstance *instance) {
  ...
  for (auto &it : associatedEditors) it->SelectedInitialInstance(*instance);
}
...
void LayoutEditorCanvas::UnselectInstance(InitialInstance *instance) {
  ...
  for (auto &it : associatedEditors) it->DeselectedInitialInstance(*instance);
}

void LayoutEditorCanvas::DeleteInstances(
  ...
  for (std::size_t i = 0; i < instancesToDelete.size(); ++i) {
    ...
    if (selectedInstances.find(instancesToDelete[i]) != selectedInstances.end())
      selectedInstances.erase(instancesToDelete[i]);
  }
...
/** \brief Tool class collecting in a list all the instances that are inside the
 * selectionRectangle of the layout editor canvas.
 */
class InstancesInAreaPicker : public gd::InitialInstanceFunctor {
 public:
  InstancesInAreaPicker(const LayoutEditorCanvas &editor_)
      : editor(editor_), ignoreLockedInstances(false){};
  ...
  virtual void operator()(gd::InitialInstance &instance) {
    ...
    if (excludedLayers.find(instance.GetLayer()) != excludedLayers.end())
      return;

    sf::Vector2f size = editor.GetInitialInstanceSize(instance);
    sf::Vector2f origin = editor.GetInitialInstanceOrigin(instance);

    if (editor.selectionRectangle.Contains(instance.GetX() - origin.x,
                                           instance.GetY() - origin.y) &&
        editor.selectionRectangle.Contains(
            instance.GetX() - origin.x + size.x,
  ...
  InstancesInAreaPicker &IgnoreLockedInstances() {
    ignoreLockedInstances = true;
    return *this;
  }
 ...
 private:
  ...
  std::vector<InitialInstance *>
      selectedList;  ///< This list will be filled with the instances that are
                     ///< into the selectionRectangle
...
void LayoutEditorCanvas::OnLeftUp(wxMouseEvent &) {
  ...
  if (!currentDraggableBt.empty())  // First check if we were dragging a button.
  {
    ...
    if (currentDraggableBt.substr(0, 6) ==
        "resize")  // Handle the release of resize buttons here ( as the mouse
                   // if not necessarily on the button so OnGuiButtonReleased is
                   // not called )
    {
      for (auto &it : selectedInstances) {
        it.second.x = it.first->GetX();
...
void LayoutEditorCanvas::OnMotion(wxMouseEvent &) {
  ...
  auto preserveWidthRatio = [this](gd::InitialInstance *instance) {
    auto ratio =
        resizeOriginalHeights[instance] / resizeOriginalWidths[instance];
  ...
  auto snapCoordinates = [this](double &x, double &y) {
    ...
    x = gd::Round((x - options.gridOffsetX) / options.gridWidth) *
            options.gridWidth +
        options.gridOffsetX;
    y = gd::Round((y - options.gridOffsetY) / options.gridHeight) *
            options.gridHeight +
        options.gridOffsetY;
  };
  ...
  if (currentDraggableBt.substr(0, 6) == "resize") {
    ...
    if (currentDraggableBt == "resizeRight" ||
        currentDraggableBt == "resizeRightUp" ||
        currentDraggableBt == "resizeRightDown") {
      for (auto &it : selectedInstances) {
        auto newWidth = snapWidth(resizeOriginalWidths[it.first] + mouseX -
                                  resizeMouseStartPosition.x);
    ...
    if (currentDraggableBt == "resizeDown" ||
        currentDraggableBt == "resizeRightDown" ||
        currentDraggableBt == "resizeLeftDown") {
      for (auto &it : selectedInstances) {
        auto newHeight = snapHeight(resizeOriginalHeights[it.first] + mouseY -
                                    resizeMouseStartPosition.y);
    ...
    if (currentDraggableBt == "resizeLeft" ||
        currentDraggableBt == "resizeLeftUp" ||
        currentDraggableBt == "resizeLeftDown") {
      for (auto &it : selectedInstances) {
        auto newWidth = snapWidth(resizeOriginalWidths[it.first] - mouseX +
                                  resizeMouseStartPosition.x);
    ...
    if (currentDraggableBt == "resizeUp" ||
        currentDraggableBt == "resizeLeftUp" ||
        currentDraggableBt == "resizeRightUp") {
      for (auto &it : selectedInstances) {
        auto newHeight = snapHeight(resizeOriginalHeights[it.first] - mouseY +
  ...
  } else if (currentDraggableBt ==
             "angle")  // Check if we are dragging a angle button
  {
    for (auto &it : selectedInstances) {
      float newAngle =
          atan2(sf::Mouse::getPosition(*this).y - angleButtonCenter.y,
                sf::Mouse::getPosition(*this).x - angleButtonCenter.x) *
          180 / 3.14159;
  ...
  } else  // No buttons being used
  {
    ...
    if (isMovingView) {
      float zoomFactor =
          static_cast<float>(getSize().x) / editionView.getSize().x;

      editionView.setCenter(movingViewStartPosition +
                            (movingViewMouseStartPosition -
    ...
    gd::LogStatus(wxString::Format(
        wxString(_("Position %f;%f. Hold SHIFT to select multiple items, and "
    ...
    if (!hoveringSomething && !isMovingView) SetCursor(wxNullCursor);
...
void LayoutEditorCanvas::OnKey(wxKeyEvent &evt) {
  ...
  if (evt.GetKeyCode() == WXK_CONTROL) ctrlPressed = true;
  if (evt.GetKeyCode() == WXK_SHIFT) shiftPressed = true;
  if (evt.GetKeyCode() == WXK_ALT) altPressed = true;

  if (evt.GetKeyCode() == WXK_DELETE || evt.GetKeyCode() == WXK_BACK) {
    std::vector<InitialInstance *> instancesToDelete;
    for (auto &it : selectedInstances) instancesToDelete.push_back(it.first);
    ...
    for (auto &it : selectedInstances) it.first->SetY(it.first->GetY() + 1);
    ...
    for (auto &it : selectedInstances) it.first->SetX(it.first->GetX() + 1);
  ...
  if (eventIsOnlyForMe)
    ...
    evt.Skip();  // Not a shortcut managed here, let the event propagates to the
                 // parent.
}
...
void LayoutEditorCanvas::OnKeyUp(wxKeyEvent &evt) {
  ...
  if (evt.GetKeyCode() == WXK_CONTROL) ctrlPressed = false;
  if (evt.GetKeyCode() == WXK_SHIFT) shiftPressed = false;
  if (evt.GetKeyCode() == WXK_ALT) altPressed = false;
}

void LayoutEditorCanvas::ChangesMade() {
  history.push_back(
      std::shared_ptr<gd::InitialInstancesContainer>(latestState->Clone()));
  redoHistory.clear();
 ...
 public:
  ...
  virtual void operator()(gd::InitialInstance &instance) {
    ...
    wxRect2DDouble boundingBox(
        instance.GetX() - origin.x, instance.GetY() - origin.y, size.x, size.y);

    if (boundingBox.Contains(wxPoint2DDouble(xPosition, yPosition))) {
      if (smallestInstance == NULL ||
          boundingBox.GetSize().GetWidth() * boundingBox.GetSize().GetHeight() <
              smallestInstanceArea) {
        smallestInstance = &instance;
        smallestInstanceArea = boundingBox.GetSize().GetWidth() *
                               boundingBox.GetSize().GetHeight();
      }
    }
  }

  InitialInstance *GetSmallestInstanceUnderCursor() {
    return smallestInstance;
  };

  void PickLockedInstancesAndOnlyThem() { pickLockedOnly = true; }
  void ExcludeLayer(const gd::String &layerName) {
    excludedLayers.insert(layerName);
  }
...
InitialInstance *LayoutEditorCanvas::GetInitialInstanceAtPosition(
    double xPosition, double yPosition, bool pickOnlyLockedInstances) {
...
std::vector<gd::InitialInstance *> LayoutEditorCanvas::GetSelection() {
  ...
  for (std::map<InitialInstance *, wxRealPoint>::iterator it =
...
void LayoutEditorCanvas::OnUndoBtClick(wxCommandEvent &event) { Undo(); }

void LayoutEditorCanvas::Undo(std::size_t times) {
  for (std::size_t i = 0; i < times; ++i) {
    if (history.empty()) return;

    redoHistory.push_back(
        std::shared_ptr<gd::InitialInstancesContainer>(instances.Clone()));
...
void LayoutEditorCanvas::OnClearHistorySelected(wxCommandEvent &event) {
  if (wxMessageBox(_("Are you sure you want to clear the Undo History?"),
                   "Clear the history",
                   wxYES_NO) != wxYES)
    return;
...
void LayoutEditorCanvas::OnRedoBtClick(wxCommandEvent &event) { Redo(); }
...
void LayoutEditorCanvas::OnFullScreenBtClick(wxCommandEvent &event) {
  if (!mainFrameWrapper.GetMainEditor()->IsFullScreen())
    mainFrameWrapper.GetMainEditor()->ShowFullScreen(
...
sf::Vector2f LayoutEditorCanvas::GetInitialInstanceSize(
    gd::InitialInstance &instance) const {
  if (instance.HasCustomSize())
    return sf::Vector2f(instance.GetCustomWidth(), instance.GetCustomHeight());

  gd::Object *object = GetObjectLinkedToInitialInstance(instance);
  if (object)
    return object->GetInitialInstanceDefaultSize(instance, project, layout);

  return sf::Vector2f(32, 32);
}

sf::Vector2f LayoutEditorCanvas::GetInitialInstanceOrigin(
    gd::InitialInstance &instance) const {
  gd::Object *object = GetObjectLinkedToInitialInstance(instance);
  if (object)
    return object->GetInitialInstanceOrigin(instance, project, layout);

  return sf::Vector2f(0, 0);
}

gd::Object *LayoutEditorCanvas::GetObjectLinkedToInitialInstance(
    gd::InitialInstance &instance) const {
...
void LayoutEditorCanvas::UpdateMouseResizeCursor(
    const gd::String &currentDraggableBt) {
  if (currentDraggableBt == "resizeUp" || currentDraggableBt == "resizeDown")
    SetCursor(wxCursor(wxCURSOR_SIZENS));
  else if (currentDraggableBt == "resizeLeft" ||
           currentDraggableBt == "resizeRight")
    SetCursor(wxCursor(wxCURSOR_SIZEWE));
  else if (currentDraggableBt == "resizeLeftUp" ||
           currentDraggableBt == "resizeRightDown")
    SetCursor(wxCursor(wxCURSOR_SIZENWSE));
  else if (currentDraggableBt == "resizeRightUp" ||
           currentDraggableBt == "resizeLeftDown")
...
void LayoutEditorCanvas::SetParentAuiManager(wxAuiManager *parentAuiManager_) {
  ...
  for (std::map<gd::String,
                std::shared_ptr<gd::LayoutEditorPreviewer> >::iterator it =
           previewers.begin();
       it != previewers.end();
       ++it) {
    if (it->second != std::shared_ptr<gd::LayoutEditorPreviewer>()) {
      it->second->SetParentAuiManager(parentAuiManager_);
    }
  }
}
