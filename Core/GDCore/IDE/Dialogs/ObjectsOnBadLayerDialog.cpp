...
ObjectsOnBadLayerDialog::ObjectsOnBadLayerDialog(
    wxWindow* parent, const std::vector<gd::String>& availableLayers) {
  ...
  Create(parent,
         wxID_ANY,
         _("Objects on the layer to delete"),
         wxDefaultPosition,
         wxDefaultSize,
  ...
  StaticBitmap1 = new wxStaticBitmap(
      ...
      wxArtProvider::GetBitmap(
          ...
          wxART_MAKE_CLIENT_ID_FROM_STR(wxString(_T("wxART_MESSAGE_BOX")))),
      wxDefaultPosition,
      wxDefaultSize,
      0,
      _T("ID_STATICBITMAP1"));
  ...
  StaticText1 =
      new wxStaticText(Panel1,
                       ID_STATICTEXT1,
                       _("What to make of objects on the layer to delete \?"),
                       wxDefaultPosition,
                       wxDefaultSize,
                       0,
                       _T("ID_STATICTEXT1"));
  ...
  StaticText2 = new wxStaticText(this,
                                 ...
                                 _T("ID_STATICTEXT2"));
  FlexGridSizer3->Add(
      StaticText2, 0, wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  Choice1 = new wxChoice(this,
                         ID_CHOICE1,
                         wxPoint(13, 16),
                         wxSize(93, 21),
                         0,
  ...
  Connect(ID_BUTTON1,
          ...
          (wxObjectEventFunction)&ObjectsOnBadLayerDialog::OnDelClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ObjectsOnBadLayerDialog::OnMoveClick);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ObjectsOnBadLayerDialog::OnCancelClick);
  //*)
...
void ObjectsOnBadLayerDialog::OnDelClick(wxCommandEvent& event) { EndModal(1); }
