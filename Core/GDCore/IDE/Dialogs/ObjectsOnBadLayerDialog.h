...
/**
 * \brief Tool dialog used by LayersEditorPanel to ask the user what to do of
 * instances which are on a layer being deleted.
 *
...
class GD_CORE_API ObjectsOnBadLayerDialog : public wxDialog {
 public:
  ObjectsOnBadLayerDialog(wxWindow* parent,
                          const std::vector<gd::String>& availableLayers);
