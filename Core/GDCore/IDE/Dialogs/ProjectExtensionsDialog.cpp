...
ProjectExtensionsDialog::ProjectExtensionsDialog(wxWindow* parent,
                                                 gd::Project& project_)
    : project(project_), currentPlatform(&project.GetCurrentPlatform()) {
  ...
  Create(parent,
         wxID_ANY,
         _("Use extension modules for GDevelop"),
         wxDefaultPosition,
         wxDefaultSize,
  ...
  platformList = new wxListCtrl(this,
                                ID_LISTCTRL1,
                                wxDefaultPosition,
                                wxSize(713, 106),
  ...
  StaticText1 =
      new wxStaticText(this,
                       ID_STATICTEXT1,
                       _("Right-click to add or remove a platform.\nPlatforms "
                         "that are not used by the project are grayed."),
                       wxDefaultPosition,
                       wxDefaultSize,
                       wxALIGN_RIGHT,
                       _T("ID_STATICTEXT1"));
  ...
  StaticBoxSizer1 =
      new wxStaticBoxSizer(wxHORIZONTAL, this, _("Extensions available :"));
  FlexGridSizer2 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer2->AddGrowableCol(0);
  FlexGridSizer2->AddGrowableRow(0);
  ExtensionsList = new wxCheckListBox(this,
                                      ID_CHECKLISTBOX1,
                                      wxDefaultPosition,
                                      wxSize(294, 281),
                                      0,
  ...
  StaticText7 = new wxStaticText(this,
                                 ID_STATICTEXT9,
                                 _("Built-in extensions are automatically used "
  ...
  StaticBoxSizer2 = new wxStaticBoxSizer(
      wxHORIZONTAL, this, _("Information about the extension"));
  FlexGridSizer5 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer5->AddGrowableCol(0);
  FlexGridSizer7 = new wxFlexGridSizer(0, 2, 0, 0);
  FlexGridSizer7->AddGrowableCol(0);
  FlexGridSizer7->AddGrowableRow(0);
  infoEdit = new wxTextCtrl(this,
                            ID_TEXTCTRL2,
                            _("No information about the extension."),
                            wxDefaultPosition,
                            wxSize(331, 43),
  ...
  FlexGridSizer8->Add(
      ...
      5);
  authorTxt = new wxStaticText(this,
                               ID_STATICTEXT3,
                               wxEmptyString,
                               wxDefaultPosition,
                               wxDefaultSize,
  ...
  if (!authorTxtFont.Ok())
    authorTxtFont = wxSystemSettings::GetFont(wxSYS_DEFAULT_GUI_FONT);
  authorTxtFont.SetWeight(wxFONTWEIGHT_BOLD);
  authorTxt->SetFont(authorTxtFont);
  FlexGridSizer8->Add(
      authorTxt,
      1,
      wxTOP | wxLEFT | wxRIGHT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
      0);
  FlexGridSizer5->Add(
      FlexGridSizer8,
      1,
  ...
  FlexGridSizer9->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  licenseTxt = new wxStaticText(this,
                                ID_STATICTEXT4,
                                wxEmptyString,
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  if (!licenseTxtFont.Ok())
    licenseTxtFont = wxSystemSettings::GetFont(wxSYS_DEFAULT_GUI_FONT);
  licenseTxtFont.SetWeight(wxFONTWEIGHT_BOLD);
  licenseTxt->SetFont(licenseTxtFont);
  FlexGridSizer9->Add(
      licenseTxt, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer5->Add(
      FlexGridSizer9,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  wincompatibleBmp =
      new wxStaticBitmap(this,
                         ID_STATICBITMAP2,
                         wxBitmap(wxImage(_T("res/win-compatible.png"))),
                         wxDefaultPosition,
                         wxDefaultSize,
                         wxNO_BORDER,
                         _T("ID_STATICBITMAP2"));
  ...
  linuxcompatibleBmp =
      new wxStaticBitmap(this,
                         ID_STATICBITMAP4,
                         wxBitmap(wxImage(_T("res/linux-compatible.png"))),
                         wxDefaultPosition,
                         wxDefaultSize,
                         wxNO_BORDER,
                         _T("ID_STATICBITMAP4"));
  ...
  maccompatibleBmp =
      new wxStaticBitmap(this,
                         ID_STATICBITMAP1,
                         wxBitmap(wxImage(_T("res/mac-compatible.png"))),
                         wxDefaultPosition,
                         wxDefaultSize,
                         wxNO_BORDER,
                         _T("ID_STATICBITMAP1"));
  ...
  FlexGridSizer3->Add(
      ...
      0);
  StaticBoxSizer3 =
      new wxStaticBoxSizer(wxHORIZONTAL, this, _("More extensions"));
  FlexGridSizer11 = new wxFlexGridSizer(0, 1, 0, 0);
  StaticText6 = new wxStaticText(
      this,
      ID_STATICTEXT8,
      _("If you create new extensions for GDevelop, please share them here :"),
      wxDefaultPosition,
      wxDefaultSize,
      0,
      _T("ID_STATICTEXT8"));
  ...
  HyperlinkCtrl1 = new wxHyperlinkCtrl(
      this,
      ID_HYPERLINKCTRL1,
      _("Go to the Wiki page for unofficial extensions"),
      _("http://wiki.compilgames.net/doku.php/gdevelop/extensions"),
      wxDefaultPosition,
      wxDefaultSize,
      wxHL_CONTEXTMENU | wxHL_ALIGN_CENTRE | wxNO_BORDER,
      _T("ID_HYPERLINKCTRL1"));
  FlexGridSizer11->Add(
      HyperlinkCtrl1, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  StaticBoxSizer3->Add(
      FlexGridSizer11,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  StaticText2 =
      new wxStaticText(this,
                       ID_STATICTEXT2,
                       _("You must close and reopen scene editors for "
                         "newly-added extensions to become active."),
                       wxDefaultPosition,
                       wxDefaultSize,
                       0,
                       _T("ID_STATICTEXT2"));
  ...
  usePlatformMenuItem = new wxMenuItem((&notUsedPlatformMenu),
                                       ID_MENUITEM1,
                                       _("Use this platform"),
                                       wxEmptyString,
                                       wxITEM_NORMAL);
  notUsedPlatformMenu.Append(usePlatformMenuItem);
  removePlatformMenuItem = new wxMenuItem((&usedPlatformMenu),
                                          ID_MENUITEM2,
                                          _("Do not use this platform anymore"),
                                          wxEmptyString,
                                          wxITEM_NORMAL);
  ...
  Connect(ID_LISTCTRL1,
          ...
          (wxObjectEventFunction)&ProjectExtensionsDialog::
              OnplatformListItemSelect);
  Connect(ID_LISTCTRL1,
          wxEVT_COMMAND_LIST_ITEM_RIGHT_CLICK,
          (wxObjectEventFunction)&ProjectExtensionsDialog::
              OnplatformListItemRClick);
  Connect(
      ID_CHECKLISTBOX1,
      wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
      (wxObjectEventFunction)&ProjectExtensionsDialog::OnExtensionsListToggled);
  Connect(
      ID_CHECKLISTBOX1,
      wxEVT_COMMAND_LISTBOX_SELECTED,
      (wxObjectEventFunction)&ProjectExtensionsDialog::OnExtensionsListSelect);
  Connect(ID_HYPERLINKCTRL2,
          wxEVT_COMMAND_HYPERLINK,
          (wxObjectEventFunction)&ProjectExtensionsDialog::OnhelpBtClick);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ProjectExtensionsDialog::OnFermerBtClick);
  Connect(ID_MENUITEM1,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&ProjectExtensionsDialog::
              OnusePlatformMenuItemSelected);
  Connect(ID_MENUITEM2,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&ProjectExtensionsDialog::
              OnremovePlatformMenuItemSelected);
  Connect(wxEVT_SIZE,
          (wxObjectEventFunction)&ProjectExtensionsDialog::OnResize);
  //*)
...
#if defined(__WXMSW__)  // Offer nice look to list
  {
    ...
    if (theme)
      theme->SetWindowTheme((HWND)platformList->GetHWND(), L"EXPLORER", NULL);
  }
#endif

  FlexGridSizer10->Show(false);  // Cross compilation is not available and so
                                 // the bitmaps are not relevant.
...
void ProjectExtensionsDialog::RefreshPlatformList() {
  ...
  for (std::size_t i = 0; i < platforms.size(); ++i) {
    ...
    gd::TreeItemStringData* associatedData = new gd::TreeItemStringData(
        platforms[i]->GetName(), used ? "true" : "false");
    ...
    if (!used) platformList->SetItemTextColour(index, wxColor(128, 128, 128));

    if (platforms[i].get() == currentPlatform)
      platformList->SetItemState(
          index, wxLIST_STATE_SELECTED, wxLIST_MASK_STATE);
  }
}
...
void ProjectExtensionsDialog::RefreshExtensionList() {
  ...
  const vector<std::shared_ptr<PlatformExtension> >& extensionsInstalled =
      currentPlatform->GetAllPlatformExtensions();

  // Create the list of available extensions
  for (std::size_t i = 0; i < extensionsInstalled.size(); ++i) {
    wxStringClientData* associatedData =
        new wxStringClientData(extensionsInstalled[i]->GetName());

    if (!extensionsInstalled[i]->IsBuiltin())
      ExtensionsList->Insert(
          extensionsInstalled[i]->GetFullName() +
              (extensionsInstalled[i]->IsDeprecated() ? _(" (deprecated)")
                                                      : ""),
          extensionsInstalled[i]->IsDeprecated() ? ExtensionsList->GetCount()
                                                 : 0,
          associatedData);
  }
  ...
  for (std::size_t i = 0; i < ExtensionsList->GetCount(); ++i) {
    wxStringClientData* associatedData =
        dynamic_cast<wxStringClientData*>(ExtensionsList->GetClientObject(i));
    if (associatedData) {
      if (find(project.GetUsedExtensions().begin(),
               project.GetUsedExtensions().end(),
               gd::String(associatedData->GetData())) !=
          project.GetUsedExtensions().end()) {
...
void ProjectExtensionsDialog::RefreshExtensionListColumnsWidth() {
  platformList->SetColumnWidth(
      0, platformList->GetSize().GetWidth() * 2.0 / 5.0 - 5);
  platformList->SetColumnWidth(
      1, platformList->GetSize().GetWidth() * 3.0 / 5.0 - 5);
}
...
void ProjectExtensionsDialog::OnExtensionsListSelect(wxCommandEvent& event) {
  ...
  wxStringClientData* associatedData =
      dynamic_cast<wxStringClientData*>(ExtensionsList->GetClientObject(id));
  ...
  for (std::size_t i = 0; i < extensionsInstalled.size(); ++i) {
    if (extensionsInstalled[i]->GetName() ==
        gd::String(associatedData->GetData())) {
...
void ProjectExtensionsDialog::OnExtensionsListToggled(wxCommandEvent& event) {
  ...
  std::vector<gd::String>::iterator it =
      std::find(project.GetUsedExtensions().begin(),
                project.GetUsedExtensions().end(),
                gd::String(associatedData->GetData()));
  ...
  else if (!ExtensionsList->IsChecked(id) &&
           it != project.GetUsedExtensions().end())
...
void ProjectExtensionsDialog::OnFermerBtClick(wxCommandEvent& event) {
  ...
  std::vector<gd::String> builtinExtensions =
      gd::PlatformExtension::GetBuiltinExtensionsNames();
  for (std::size_t i = 0; i < builtinExtensions.size(); ++i) {
    if (std::find(project.GetUsedExtensions().begin(),
                  project.GetUsedExtensions().end(),
                  builtinExtensions[i]) == project.GetUsedExtensions().end()) {
...
void ProjectExtensionsDialog::OnhelpBtClick(wxCommandEvent& event) {
  gd::HelpFileAccess::Get()->OpenPage(
      "en/game_develop/documentation/manual/extensions");
}
...
void ProjectExtensionsDialog::OnusePlatformMenuItemSelected(
...
void ProjectExtensionsDialog::OnremovePlatformMenuItemSelected(
    wxCommandEvent& event) {
  if (!project.RemovePlatform(currentPlatform->GetName())) {
    gd::LogWarning(
        _("Unable to remove this platform: The project must use at least one "
          "plaform."));
  }
  RefreshPlatformList();
  RefreshExtensionList();
