 ...
 *
 * A resource library is a folder containing the resources ( i.e. images ) and a
 * Readme.txt file The dialog allows the user to browse the libraries located in
 * a root folder and choose some resources ( The caller of the dialog must take
 * care of adding selected resources to the project )
 *
 * \ingroup IDEDialogs
 */
class GD_CORE_API ResourceLibraryDialog : public wxDialog {
 public:
  ResourceLibraryDialog(wxWindow* parent,
