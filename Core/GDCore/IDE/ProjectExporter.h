...
class ProjectExporter {
 public:
  ...
  /**
   * \brief Must return the label that will be displayed on the button or menu
   * item allowing the user to export the project for a platform.
   *
   * \note If nothing is returned ( Default implementation ), no button will be
   * shown.
   */
