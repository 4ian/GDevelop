...
public:
    ...
    * \param objectGroup The group that must be copied and inserted into the container
    * \param position Insertion position. If the position is invalid, the group is inserted at the end of the group list.
