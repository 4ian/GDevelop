...
XMLError XMLDocument::SaveFile( const char* filename, bool compact ) const
{
...
XMLError XMLDocument::SaveFile( FILE* fp, bool compact ) const
{
...
void XMLDocument::SetError( XMLError error, const char* str1, const char* str2 ) const
{
