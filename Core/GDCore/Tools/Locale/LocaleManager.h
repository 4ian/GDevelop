...
/**
 * \brief Class allowing to use a common wxLocale object for the IDE as well as
 * for extensions.
 *
 * You may want to use this class if you have a custom translation catalog to
 * add. See LocaleManager::AddCatalog
 *
 * \ingroup Tools
 */
class GD_CORE_API LocaleManager {
 public:
   ...
   * in a search path. ( locale directory for example or
   * xxxPlatform/Extensions/locale ). \param catalogName The name of the
   * translation catalog.
   */
