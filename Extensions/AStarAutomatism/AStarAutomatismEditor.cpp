...
scene(scene_)
{
	...
	Create(parent, wxID_ANY, _("Automatism setup"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	FlexGridSizer1 = new wxFlexGridSizer(0, 1, 0, 0);
	StaticBoxSizer1 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Setup"));
	FlexGridSizer2 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer3 = new wxFlexGridSizer(0, 3, 0, 0);
	FlexGridSizer3->AddGrowableCol(1);
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _("Cost of the object :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	StaticText2 = new wxStaticText(this, ID_STATICTEXT2, _("Path will avoid the object as much as possible when the cost is high.\nA cost of 9 prevents paths from going through the object."), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	...
	StaticBoxSizer3 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Borders"));
	FlexGridSizer7 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer7->AddGrowableCol(0);
	StaticText4 = new wxStaticText(this, ID_STATICTEXT4, _("Virtual cells can be added around the object so as to\navoid it better. Enter here the number of cases to add\non the top/bottom/left/right of the object."), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	...
	StaticBoxSizer2 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Automatism global parameters"));
	FlexGridSizer4 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer5 = new wxFlexGridSizer(0, 4, 0, 0);
	StaticText3 = new wxStaticText(this, ID_STATICTEXT3, _("Size of the virtual grid used by paths ( pixels ):"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	...
	diagonalMoveCheck = new wxCheckBox(this, ID_CHECKBOX1, _("Allow diagonal paths"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
