...
Box3DObjectEditor::Box3DObjectEditor(wxWindow* parent,
                                     gd::Project& game_,
                                     Box3DObject& object_,
                                     gd::MainFrameWrapper& mainFrameWrapper_)
    : game(game_), mainFrameWrapper(mainFrameWrapper_), object(object_) {
  ...
  Create(parent,
         wxID_ANY,
         _("Settings of the 3D Box object"),
         wxDefaultPosition,
         wxDefaultSize,
  ...
  StaticText7 = new wxStaticText(Core,
                                 ID_STATICTEXT7,
                                 _("Width :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  FlexGridSizer6->Add(
      ...
      5);
  StaticText8 = new wxStaticText(Core,
                                 ID_STATICTEXT8,
                                 _("Height :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  heightEdit = new wxTextCtrl(Core,
                              ID_TEXTCTRL8,
                              _("32"),
                              wxDefaultPosition,
                              wxDefaultSize,
  ...
  FlexGridSizer6->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText9 = new wxStaticText(Core,
                                 ID_STATICTEXT9,
                                 _("Depth :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 ...
                                 _T("ID_STATICTEXT9"));
  FlexGridSizer6->Add(
      StaticText9, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  depthEdit = new wxTextCtrl(Core,
                             ID_TEXTCTRL9,
                             _("32"),
                             wxDefaultPosition,
                             wxDefaultSize,
  ...
  StaticText1 = new wxStaticText(Core,
                                 ID_STATICTEXT1,
                                 _("Front :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  frontTextureEdit = new wxTextCtrl(Core,
                                    ID_TEXTCTRL1,
                                    wxEmptyString,
                                    wxDefaultPosition,
                                    wxDefaultSize,
  ...
  FlexGridSizer3->Add(
      ...
      5);
  frontAddFromBt =
      new wxBitmapButton(Core,
                         ID_BITMAPBUTTON1,
                         wxBitmap(wxImage(_T("res/addfromimagebanque.png"))),
                         wxDefaultPosition,
                         wxDefaultSize,
                         wxBU_AUTODRAW,
                         wxDefaultValidator,
  ...
  FlexGridSizer3->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText2 = new wxStaticText(Core,
                                 ID_STATICTEXT2,
                                 _("Top :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  topTextureEdit = new wxTextCtrl(Core,
                                  ID_TEXTCTRL2,
                                  wxEmptyString,
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer3->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText3 = new wxStaticText(Core,
                                 ID_STATICTEXT3,
                                 _("Bottom :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  bottomTextureEdit = new wxTextCtrl(Core,
                                     ID_TEXTCTRL3,
                                     wxEmptyString,
                                     wxDefaultPosition,
                                     wxDefaultSize,
  ...
  FlexGridSizer3->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText4 = new wxStaticText(Core,
                                 ID_STATICTEXT4,
                                 _("Left :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  leftTextureEdit = new wxTextCtrl(Core,
                                   ID_TEXTCTRL4,
                                   wxEmptyString,
                                   wxDefaultPosition,
                                   wxDefaultSize,
  ...
  FlexGridSizer3->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText5 = new wxStaticText(Core,
                                 ID_STATICTEXT5,
                                 _("Right :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  rightTextureEdit = new wxTextCtrl(Core,
                                    ID_TEXTCTRL5,
                                    wxEmptyString,
                                    wxDefaultPosition,
                                    wxDefaultSize,
  ...
  FlexGridSizer3->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText6 = new wxStaticText(Core,
                                 ID_STATICTEXT6,
                                 _("Back :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  backTextureEdit = new wxTextCtrl(Core,
                                   ID_TEXTCTRL6,
                                   wxEmptyString,
                                   wxDefaultPosition,
                                   wxDefaultSize,
  ...
  FlexGridSizer2->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  StaticLine1 = new wxStaticLine(Core,
                                 ID_STATICLINE1,
                                 wxDefaultPosition,
                                 wxSize(10, -1),
                                 wxLI_HORIZONTAL,
  ...
  imageBankBt = new wxButton(Core,
                             ID_BUTTON3,
                             _("Show image bank\'s editor"),
                             wxDefaultPosition,
                             wxDefaultSize,
                             0,
                             wxDefaultValidator,
  ...
  FlexGridSizer7->Add(
      ...
      5);
  FlexGridSizer2->Add(
      FlexGridSizer7, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 0);
  ...
  Connect(ID_BITMAPBUTTON1,
          ...
          (wxObjectEventFunction)&Box3DObjectEditor::OnfrontAddFromBtClick);
  Connect(ID_BITMAPBUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&Box3DObjectEditor::OntopAddFromBtClick);
  Connect(ID_BITMAPBUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&Box3DObjectEditor::OnbottomAddFromBtClick);
  Connect(ID_BITMAPBUTTON4,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&Box3DObjectEditor::OnleftAddFromBtClick);
  Connect(ID_BITMAPBUTTON5,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&Box3DObjectEditor::OnrightAddFromBtClick);
  Connect(ID_BITMAPBUTTON6,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&Box3DObjectEditor::OnbackAddFromBtClick);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&Box3DObjectEditor::OnimageBankBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&Box3DObjectEditor::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&Box3DObjectEditor::OncancelBtClick);
  //*)
  ...
  m_mgr.AddPane(
      Core, wxAuiPaneInfo().Name(wxT("Core")).Center().CaptionVisible(false));
  m_mgr.AddPane(resourcesEditor,
                wxAuiPaneInfo()
                    .Name(wxT("EI"))
                    .Left()
                    .Caption(_("Images Bank Editor"))
                    .MaximizeButton(true)
                    .MinimizeButton(false)
                    .Show(false)
                    .MinSize(150, 100));
  m_mgr.SetFlags(wxAUI_MGR_ALLOW_FLOATING | wxAUI_MGR_ALLOW_ACTIVE_PANE |
                 wxAUI_MGR_TRANSPARENT_HINT | wxAUI_MGR_TRANSPARENT_DRAG |
 ...
 */
void Box3DObjectEditor::OncancelBtClick(wxCommandEvent& event) { EndModal(0); }
...
void Box3DObjectEditor::OnfrontAddFromBtClick(wxCommandEvent& event) {
  if (!m_mgr.GetPane(resourcesEditor).IsShown()) {
    gd::LogMessage(
        _("Please display the image bank's editor and select an image before "
          "clicking on this button."));
    return;
  }

  frontTextureEdit->ChangeValue(resourcesEditor->resourcesTree->GetItemText(
      resourcesEditor->m_itemSelected));
}
...
void Box3DObjectEditor::OntopAddFromBtClick(wxCommandEvent& event) {
  ...
  topTextureEdit->ChangeValue(resourcesEditor->resourcesTree->GetItemText(
      resourcesEditor->m_itemSelected));
}
...
void Box3DObjectEditor::OnbottomAddFromBtClick(wxCommandEvent& event) {
  ...
  bottomTextureEdit->ChangeValue(resourcesEditor->resourcesTree->GetItemText(
      resourcesEditor->m_itemSelected));
}
...
void Box3DObjectEditor::OnleftAddFromBtClick(wxCommandEvent& event) {
  ...
  leftTextureEdit->ChangeValue(resourcesEditor->resourcesTree->GetItemText(
      resourcesEditor->m_itemSelected));
}
...
void Box3DObjectEditor::OnrightAddFromBtClick(wxCommandEvent& event) {
  ...
  rightTextureEdit->ChangeValue(resourcesEditor->resourcesTree->GetItemText(
      resourcesEditor->m_itemSelected));
}
...
void Box3DObjectEditor::OnbackAddFromBtClick(wxCommandEvent& event) {
  ...
  backTextureEdit->ChangeValue(resourcesEditor->resourcesTree->GetItemText(
      resourcesEditor->m_itemSelected));
}
