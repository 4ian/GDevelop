...
object(object_)
{
    ...
    m_mgr.AddPane( resourcesEditor, wxAuiPaneInfo().Name( wxT( "EI" ) ).Left().Caption( _T( "Image Bank Editor" ) ).MaximizeButton( true ).MinimizeButton( false ).Show(false).MinSize(150, 100) );
