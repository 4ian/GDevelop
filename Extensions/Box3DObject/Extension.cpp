  ...
  Extension() {
...

    {
      gd::ObjectMetadata& obj =
          AddObject<Box3DObject>("Box3D",
                                 _("3D Box"),
                                 _("Displays a 3D Box"),
                                 "CppPlatform/Extensions/Box3Dicon.png");

      AddRuntimeObject<Box3DObject, RuntimeBox3DObject>(obj,
                                                        "RuntimeBox3DObject");
      ...
      obj.AddAction("Width",
          ...
          .SetGetter("GetWidth")
          .SetIncludeFile("Box3DObject/Box3DObject.h");
      ...
      obj.AddAction("ZPosition",
          ...
          .SetFunctionName("SetZPosition")
          .SetManipulatedType("number")
          .SetGetter("GetZPosition")
          .SetIncludeFile("Box3DObject/Box3DObject.h");
      ...
      obj.AddCondition("Roll",
          ...
          .AddParameter("relationalOperator", _("Sign of the test"))
          .AddParameter("expression", _("Value to test"))
          .SetFunctionName("GetRoll")
          .SetManipulatedType("number")
          .SetIncludeFile("Box3DObject/Box3DObject.h");

      obj.AddExpression("Depth",
                        _("Depth of the 3D Box"),
                        _("Depth of the 3D Box"),
                        _("Size"),
                        "res/actions/scaleHeight.png")
          .AddParameter("object", _("Object"), "Box3D")
          .codeExtraInformation.SetFunctionName("GetDepth")
          .SetIncludeFile("Box3DObject/Box3DObject.h");
