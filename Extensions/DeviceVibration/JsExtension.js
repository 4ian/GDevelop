  ...
  createExtension: function(t, gd) {
    ...
    extension
      .setExtensionInformation(
        "DeviceVibration",
        t("Device vibration"),
        t("Use the vibration of mobile devices."),
        "Matthias Meike",
    ...
    extension
      .addAction(
        ...
        t(
          "Vibrate (Duration in ms). You can add multiple comma separated values where every second value determins the silense inbetween two vibrations. This is a string value so use quotes."
        ),
        t("Start vibration for _PARAM0_ ms"),
        t("Vibration"),
      ...
      .addParameter(
        "string",
        t('Intervals (for example "500,100,200"'),
        "",
        false
      )
      .getCodeExtraInformation()
