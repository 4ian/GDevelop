...
gdjs.DraggableRuntimeBehavior.prototype = Object.create(
  gdjs.RuntimeBehavior.prototype
);
gdjs.DraggableRuntimeBehavior.thisIsARuntimeBehaviorConstructor =
...
gdjs.DraggableRuntimeBehavior.prototype._endDrag = function() {
  ...
  if (this._dragged && this._touchId !== null)
    gdjs.DraggableRuntimeBehavior.touchDraggingSomething[this._touchId] = false;
...
gdjs.DraggableRuntimeBehavior.prototype._shouldEndDrag = function(
  runtimeScene
) {
  if (!this._dragged) return false;
  var inputManager = runtimeScene.getGame().getInputManager();

  if (this._mouse) return !inputManager.isMouseButtonPressed(0);
...
gdjs.DraggableRuntimeBehavior.prototype._updateObjectPosition = function(
  runtimeScene
) {
  if (!this._dragged) return false;
  var inputManager = runtimeScene.getGame().getInputManager();
...
gdjs.DraggableRuntimeBehavior.prototype.doStepPreEvents = function(
  runtimeScene
) {
...
gdjs.DraggableRuntimeBehavior.prototype.doStepPostEvents = function(
  runtimeScene
) {
  gdjs.DraggableRuntimeBehavior.leftPressedLastFrame = runtimeScene
    .getGame()
    .getInputManager()
