...
module.exports = {
  createExtension: function(_, gd) {
    ...
    const dotEffect = extension
      .addEffect('Dot')
      .setFullName(_('Dot'))
      .setDescription(_('applies a dotscreen effect making display objects '
        + 'appear to be made out of black and white halftone dots like an '
        + 'old printer.'))
    ...
    colorReplaceProperties.set(
      'originalColor',
      new gd.PropertyDescriptor(/* defaultValue= */ 255)
    ...
    colorReplaceProperties.set(
      ...
      new gd.PropertyDescriptor(/* defaultValue= */ '0.4')
        ...
        .setType('number')
        .setDescription('Tolerance/sensitivity of the floating-point comparison '
          + 'between colors (lower = more exact, higher = more inclusive)')
    );
