 ...
 * @constructor
 */
gdjs.DummyWithSharedDataRuntimeBehavior = function(
  runtimeScene,
  behaviorData,
  owner
) {
  ...
  var sharedData = runtimeScene.getInitialSharedDataForBehavior(
    behaviorData.name
  );
...
gdjs.DummyWithSharedDataRuntimeBehavior.prototype = Object.create(
  gdjs.RuntimeBehavior.prototype
);
gdjs.DummyWithSharedDataRuntimeBehavior.thisIsARuntimeBehaviorConstructor =
  "MyDummyExtension::DummyBehaviorWithSharedData";

gdjs.DummyWithSharedDataRuntimeBehavior.prototype.onDeActivate = function() {};

gdjs.DummyWithSharedDataRuntimeBehavior.prototype.doStepPreEvents = function(
  runtimeScene
) {
...
gdjs.DummyWithSharedDataRuntimeBehavior.prototype.doStepPostEvents = function(
  runtimeScene
) {
