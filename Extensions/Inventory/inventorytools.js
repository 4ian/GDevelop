...
gdjs.evtTools.inventory.setMaximum = function(
  ...
  return gdjs.InventoryManager.get(runtimeScene, inventoryName).setMaximum(
    name,
    maxCount
  );
};
...
gdjs.evtTools.inventory.setUnlimited = function(
  ...
  return gdjs.InventoryManager.get(runtimeScene, inventoryName).setUnlimited(
    name,
    enable
  );
};
...
gdjs.evtTools.inventory.equip = function(
  ...
  return gdjs.InventoryManager.get(runtimeScene, inventoryName).equip(
    name,
    equip
  );
};
...
gdjs.evtTools.inventory.isEquipped = function(
  ...
  return gdjs.InventoryManager.get(runtimeScene, inventoryName).isEquipped(
    name
  );
};
...
gdjs.evtTools.inventory.serializeToVariable = function(
  ...
  var allItems = gdjs.InventoryManager.get(
    runtimeScene,
    inventoryName
  ).getAllItems();
