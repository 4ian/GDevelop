...
class GD_EXTENSION_API Light {
 public:
  ...
  // Ajouter un triangle à la lumière, en effet, les lumières sont composée de
  // triangles
  void AddTriangle(sf::Vector2f pt1,
                   sf::Vector2f pt2,
                   int minimum_wall,
 ...
 protected:
  ...
  // Tableau dynamique de Shape, ce sont ces shapes de type triangle qui compose
  // la lumière
 ...
 private:
  ...
  // Qualité de la lumière, c'est à dire le nombre de triangles par défaut qui
  // la compose.
  int m_quality;
};
