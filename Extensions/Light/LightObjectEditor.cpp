...
LightObjectEditor::LightObjectEditor(wxWindow* parent,
                                     gd::Project& game_,
                                     LightObject& object_)
  ...
  FlexGridSizer2->Add(
      ...
      5);
  colorPicker = new wxColourPickerCtrl(this,
                                       ...
                                       0,
                                       wxDefaultValidator,
                                       _T("ID_COLOURPICKERCTRL1"));
  FlexGridSizer2->Add(
      colorPicker, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  radiusEdit = new wxTextCtrl(this,
                              ID_TEXTCTRL1,
                              wxEmptyString,
                              wxDefaultPosition,
                              wxSize(45, 21),
  ...
  intensityEdit = new wxSpinCtrl(this,
                                 ID_SPINCTRL1,
                                 _T("255"),
                                 wxDefaultPosition,
                                 wxSize(56, 21),
  ...
  qualityEdit = new wxTextCtrl(this,
                               ID_TEXTCTRL2,
                               wxEmptyString,
                               wxDefaultPosition,
                               wxSize(45, 21),
  ...
  globalCheck = new wxCheckBox(this,
                               ID_CHECKBOX1,
                               _("Set the light as the global light"),
                               wxDefaultPosition,
                               wxDefaultSize,
                               0,
                               wxDefaultValidator,
  ...
  FlexGridSizer4->Add(
      globalCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer6 = new wxFlexGridSizer(0, 2, 0, 0);
  FlexGridSizer6->AddGrowableCol(1);
  StaticText6 = new wxStaticText(this,
                                 ID_STATICTEXT6,
                                 _("Color of the scene:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT6"));
  ...
  globalColorPicker = new wxColourPickerCtrl(this,
                                             ...
                                             0,
                                             wxDefaultValidator,
                                             _T("ID_COLOURPICKERCTRL2"));
  FlexGridSizer6->Add(
      globalColorPicker, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer4->Add(
      FlexGridSizer6,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  Connect(ID_BUTTON1,
          ...
          (wxObjectEventFunction)&LightObjectEditor::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&LightObjectEditor::OncancelBtClick);
  //*)
  ...
  colorPicker->SetColour(
      wxColour(object.GetColor().r, object.GetColor().g, object.GetColor().b));

  globalCheck->SetValue(object.IsGlobalLight());
  globalColorPicker->SetColour(wxColour(object.GetGlobalColor().r,
                                        object.GetGlobalColor().g,
                                        object.GetGlobalColor().b));
...
void LightObjectEditor::OnokBtClick(wxCommandEvent& event) {
  ...
  object.SetColor(sf::Color(colorPicker->GetColour().Red(),
                            colorPicker->GetColour().Green(),
                            colorPicker->GetColour().Blue()));

  object.SetGlobalLight(globalCheck->GetValue());
  object.SetGlobalColor(
      sf::Color(globalColorPicker->GetColour().Red(),
                globalColorPicker->GetColour().Green(),
                globalColorPicker->GetColour()
                    .Blue() /*, globalIntensityEdit->GetValue()*/));

  EndModal(1);
}

void LightObjectEditor::OncancelBtClick(wxCommandEvent& event) { EndModal(0); }
