...
const long LightObstacleAutomatismEditor::ID_STATICTEXT1 = wxNewId();
const long LightObstacleAutomatismEditor::ID_TEXTCTRL1 = wxNewId();
const long LightObstacleAutomatismEditor::ID_STATICTEXT2 = wxNewId();
const long LightObstacleAutomatismEditor::ID_STATICTEXT4 = wxNewId();
const long LightObstacleAutomatismEditor::ID_TEXTCTRL4 = wxNewId();
const long LightObstacleAutomatismEditor::ID_TEXTCTRL5 = wxNewId();
const long LightObstacleAutomatismEditor::ID_TEXTCTRL6 = wxNewId();
const long LightObstacleAutomatismEditor::ID_TEXTCTRL7 = wxNewId();
const long LightObstacleAutomatismEditor::ID_STATICTEXT3 = wxNewId();
const long LightObstacleAutomatismEditor::ID_TEXTCTRL2 = wxNewId();
const long LightObstacleAutomatismEditor::ID_STATICTEXT5 = wxNewId();
const long LightObstacleAutomatismEditor::ID_TEXTCTRL3 = wxNewId();
const long LightObstacleAutomatismEditor::ID_CHECKBOX1 = wxNewId();
const long LightObstacleAutomatismEditor::ID_STATICLINE1 = wxNewId();
const long LightObstacleAutomatismEditor::ID_BUTTON1 = wxNewId();
const long LightObstacleAutomatismEditor::ID_BUTTON2 = wxNewId();
//*)
...
mainEditorCommand(mainEditorCommand_)
{
	...
	Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&LightObstacleAutomatismEditor::OncancelBtClick);
	Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&LightObstacleAutomatismEditor::OnokBtClick);
	//*)
