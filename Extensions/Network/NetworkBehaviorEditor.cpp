...
NetworkBehaviorEditor::NetworkBehaviorEditor(wxWindow* parent,
                                             gd::Project& game_,
                                             gd::Layout* scene_,
                                             NetworkBehavior& behavior_)
  ...
  wxString __wxRadioBoxChoices_1[2] = {_("Send data"), _("Receive data")};
  initialBehaviourList = new wxRadioBox(this,
                                        ID_RADIOBOX1,
                                        _("Initial behaviour"),
                                        wxDefaultPosition,
                                        wxDefaultSize,
  ...
  StaticText1 = new wxStaticText(
      this,
      ID_STATICTEXT1,
      _("Depending on whether the game is \"hosting\" or joining, you wish "
        "change this behaviour\nof the behavior. You can use actions in the "
        "sub category \"Network > Behavior Automatic Network Updater\""),
      wxDefaultPosition,
      wxDefaultSize,
      0,
      _T("ID_STATICTEXT1"));
  ...
  StaticBoxSizer1 =
      new wxStaticBoxSizer(wxHORIZONTAL, this, _("Sent / Received data"));
  FlexGridSizer6 = new wxFlexGridSizer(0, 2, 0, 0);
  xPosCheck = new wxCheckBox(this,
                             ID_CHECKBOX1,
                             _("X position"),
                             wxDefaultPosition,
                             wxDefaultSize,
  ...
  FlexGridSizer6->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  angleCheck = new wxCheckBox(this,
                              ID_CHECKBOX3,
                              _("Angle"),
                              wxDefaultPosition,
                              wxDefaultSize,
  ...
  FlexGridSizer6->Add(
      angleCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  widthCheck = new wxCheckBox(this,
                              ID_CHECKBOX4,
                              _("Width"),
                              wxDefaultPosition,
                              wxDefaultSize,
  ...
  FlexGridSizer6->Add(
      widthCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  heightCheck = new wxCheckBox(this,
                               ID_CHECKBOX5,
                               _("Height"),
                               wxDefaultPosition,
                               wxDefaultSize,
  ...
  FlexGridSizer6->Add(
      heightCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  StaticBoxSizer1->Add(
      FlexGridSizer6,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  dataPrefixEdit = new wxTextCtrl(this,
                                  ID_TEXTCTRL1,
                                  wxEmptyString,
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  StaticText2 = new wxStaticText(this,
                                 ...
                                 0,
                                 _T("ID_STATICTEXT2"));
  FlexGridSizer8->Add(StaticText2,
                      1,
  ...
  StaticText3 = new wxStaticText(
      this,
      ID_STATICTEXT3,
      _("X represent identifier number and Data the data title."),
      wxDefaultPosition,
      wxDefaultSize,
      0,
      _T("ID_STATICTEXT3"));
  ...
  Connect(ID_BUTTON1,
          ...
          (wxObjectEventFunction)&NetworkBehaviorEditor::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&NetworkBehaviorEditor::OncancelBtClick);
  //*)
