...
PanelSpriteObjectEditor::PanelSpriteObjectEditor(
  ...
  Create(parent,
         wxID_ANY,
         _("Settings of the Panel Sprite Object"),
         wxDefaultPosition,
         wxDefaultSize,
  ...
  StaticBoxSizer3 = new wxStaticBoxSizer(
      wxHORIZONTAL, Core, _("Texture configuration (for HTML5 games only)"));
  tileCheck = new wxCheckBox(
      Core,
      ID_CHECKBOX1,
      _("Repeat borders and center textures (instead of stretching them)"),
      wxDefaultPosition,
      wxDefaultSize,
      0,
      wxDefaultValidator,
  ...
  FlexGridSizer10->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  topMarginTextCtrl = new wxTextCtrl(Core,
                                     ID_TEXTCTRL3,
                                     _("0"),
                                     wxDefaultPosition,
                                     wxDefaultSize,
  ...
  FlexGridSizer11->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  leftMarginTextCtrl = new wxTextCtrl(Core,
                                      ID_TEXTCTRL2,
                                      _("0"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
  ...
  StaticText5 = new wxStaticText(Core,
                                 ...
                                 0,
                                 _T("ID_STATICTEXT5"));
  wxFont StaticText5Font(wxDEFAULT,
  ...
  FlexGridSizer12->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  rightMarginTextCtrl = new wxTextCtrl(Core,
                                       ID_TEXTCTRL4,
                                       _("0"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
  ...
  FlexGridSizer9->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  bottomMarginTextCtrl = new wxTextCtrl(Core,
                                        ID_TEXTCTRL5,
                                        _("0"),
                                        wxDefaultPosition,
                                        wxDefaultSize,
  ...
  Connect(
      ...
      (wxObjectEventFunction)&PanelSpriteObjectEditor::OnfrontAddFromBtClick);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PanelSpriteObjectEditor::OnimageBankBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PanelSpriteObjectEditor::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PanelSpriteObjectEditor::OncancelBtClick);
  //*)
  ...
  SetSize(800, 640);
  resourcesEditor->toolbar
      ->Realize();  // Mandatory on linux to display the toolbar.
}
...
void PanelSpriteObjectEditor::OnokBtClick(wxCommandEvent& event) {
  ...
  object.SetRightMargin(
      gd::String(rightMarginTextCtrl->GetValue()).To<float>());
  object.SetBottomMargin(
      gd::String(bottomMarginTextCtrl->GetValue()).To<float>());
