gdjs.PanelSpriteRuntimeObjectCocosRenderer = function(
  runtimeObject,
  runtimeScene,
  textureName,
  tiled
...
gdjs.PanelSpriteRuntimeObjectRenderer =
  gdjs.PanelSpriteRuntimeObjectCocosRenderer; //Register the class to let the engine use it.
...
gdjs.PanelSpriteRuntimeObjectCocosRenderer.prototype._updateScaleAndShader = function(
  sprite,
  shader,
  scaleX,
  scaleY
...
gdjs.PanelSpriteRuntimeObjectCocosRenderer.prototype.setTexture = function(
  textureName,
  runtimeScene
) {
  var obj = this._object;
  ...
  this._borderSprites[1].setTextureRect(
    makeInsideTexture(
      cc.rect(texture.pixelsWidth - obj._rBorder, 0, obj._rBorder, obj._tBorder)
    )
  );
