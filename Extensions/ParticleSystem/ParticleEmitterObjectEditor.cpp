...
object(object_)
{
	...
	Create(parent, wxID_ANY, _("Editer l\'objet texte"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER, _T("wxID_ANY"));
	...
	StaticBoxSizer10 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Taille"));
	FlexGridSizer27 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer27->AddGrowableCol(0);
	FlexGridSizer28 = new wxFlexGridSizer(0, 3, 0, 0);
	sizeNothingCheck = new wxRadioButton(this, ID_RADIOBUTTON19, _("Pas de changement"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON19"));
	...
	sizeRandomCheck = new wxRadioButton(this, ID_RADIOBUTTON20, _("Aléatoire"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON20"));
	...
	sizeMutableCheck = new wxRadioButton(this, ID_RADIOBUTTON21, _("Changeant au cours du temps"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON21"));
	...
	size1Edit = new wxSpinCtrlDouble(this,ID_CUSTOM10,"",wxDefaultPosition,wxSize(55,21),0,0,1,0,0.1,_T("ID_CUSTOM10"));
	...
	size2Edit = new wxSpinCtrlDouble(this,ID_CUSTOM11,"",wxDefaultPosition,wxSize(55,21),0,0,1,0,0.1,_T("ID_CUSTOM11"));
	...
	StaticBoxSizer9 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Angle"));
	FlexGridSizer24 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer24->AddGrowableCol(0);
	FlexGridSizer25 = new wxFlexGridSizer(0, 3, 0, 0);
	angleNothingCheck = new wxRadioButton(this, ID_RADIOBUTTON16, _("Pas de changement"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON16"));
	...
	angleRandomCheck = new wxRadioButton(this, ID_RADIOBUTTON17, _("Aléatoire"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON17"));
	...
	angleMutableCheck = new wxRadioButton(this, ID_RADIOBUTTON18, _("Changeant au cours du temps"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON18"));
	...
	angle1Edit = new wxSpinCtrlDouble(this,ID_CUSTOM8,"",wxDefaultPosition,wxSize(55,21),0,0,1,0,0.1,_T("ID_CUSTOM8"));
	...
	angle2Edit = new wxSpinCtrlDouble(this,ID_CUSTOM9,"",wxDefaultPosition,wxSize(55,21),0,0,1,0,0.1,_T("ID_CUSTOM9"));
	...
	FlexGridSizer30->Add(GridSizer1, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
	...
	StaticBoxSizer11 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Zone et direction d\'émission"));
	FlexGridSizer34 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer34->AddGrowableCol(0);
	FlexGridSizer11 = new wxFlexGridSizer(0, 3, 0, 0);
	FlexGridSizer11->AddGrowableCol(1);
	StaticText30 = new wxStaticText(this, ID_STATICTEXT33, _("Rayon de la sphère d\'apparition :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT33"));
	FlexGridSizer11->Add(StaticText30, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	zoneRadiusEdit = new wxTextCtrl(this, ID_TEXTCTRL14, wxEmptyString, wxDefaultPosition, wxSize(66,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL14"));
	...
	StaticText31 = new wxStaticText(this, ID_STATICTEXT34, _("Direction :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT34"));
	FlexGridSizer35->Add(StaticText31, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer1 = new wxBoxSizer(wxHORIZONTAL);
	emitterDirXEdit = new wxTextCtrl(this, ID_TEXTCTRL18, wxEmptyString, wxDefaultPosition, wxSize(62,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL18"));
	BoxSizer1->Add(emitterDirXEdit, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	emitterDirYEdit = new wxTextCtrl(this, ID_TEXTCTRL19, wxEmptyString, wxDefaultPosition, wxSize(62,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL19"));
	BoxSizer1->Add(emitterDirYEdit, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	emitterDirZEdit = new wxTextCtrl(this, ID_TEXTCTRL20, wxEmptyString, wxDefaultPosition, wxSize(62,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL20"));
	...
	StaticText33 = new wxStaticText(this, ID_STATICTEXT36, _("Angle de la zone d\'émission :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT36"));
	FlexGridSizer41->Add(StaticText33, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText35 = new wxStaticText(this, ID_STATICTEXT38, _("1er angle :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT38"));
	FlexGridSizer41->Add(StaticText35, 1, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
	emitterAngleAEdit = new wxTextCtrl(this, ID_TEXTCTRL15, wxEmptyString, wxDefaultPosition, wxSize(62,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL15"));
	FlexGridSizer41->Add(emitterAngleAEdit, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText32 = new wxStaticText(this, ID_STATICTEXT35, _("rad"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT35"));
	...
	StaticText36 = new wxStaticText(this, ID_STATICTEXT39, _("2eme angle :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT39"));
	FlexGridSizer41->Add(StaticText36, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	emitterAngleBEdit = new wxTextCtrl(this, ID_TEXTCTRL16, wxEmptyString, wxDefaultPosition, wxSize(62,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL16"));
	FlexGridSizer41->Add(emitterAngleBEdit, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText34 = new wxStaticText(this, ID_STATICTEXT37, _("rad"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT37"));
	...
	FlexGridSizer34->Add(FlexGridSizer38, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
	StaticBoxSizer11->Add(FlexGridSizer34, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
	...
	StaticBoxSizer1 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Quantité"));
	...
	FlexGridSizer1->Add(FlexGridSizer33, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
...
void ParticleEmitterObjectEditor::OnokBtClick(wxCommandEvent& event)
{
    ...
    object.SetEmitterXDirection(ToFloat(emitterDirXEdit->GetValue().mb_str()));
    object.SetEmitterYDirection(ToFloat(emitterDirYEdit->GetValue().mb_str()));
    object.SetEmitterZDirection(ToFloat(emitterDirZEdit->GetValue().mb_str()));
    object.SetEmitterAngleA(ToFloat(emitterAngleAEdit->GetValue().mb_str()));
    object.SetEmitterAngleB(ToFloat(emitterAngleBEdit->GetValue().mb_str()));
    ...
    object.SetZoneRadius(ToFloat(zoneRadiusEdit->GetValue().mb_str()));
