...
object(object_)
{
	...
	Create(parent, wxID_ANY, _T("Editer l\'émetteur de particules"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER, _T("wxID_ANY"));
	...
	StaticBoxSizer3 = new wxStaticBoxSizer(wxHORIZONTAL, Core, _T("Rendu"));
	FlexGridSizer7 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer7->AddGrowableCol(0);
	FlexGridSizer10 = new wxFlexGridSizer(0, 4, 0, 0);
	StaticText7 = new wxStaticText(Core, ID_STATICTEXT7, _T("Mode de rendu :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	FlexGridSizer10->Add(StaticText7, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	pointCheck = new wxRadioButton(Core, ID_RADIOBUTTON2, _T("Points"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON2"));
	FlexGridSizer10->Add(pointCheck, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	lineCheck = new wxRadioButton(Core, ID_RADIOBUTTON1, _T("Lignes"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
	FlexGridSizer10->Add(lineCheck, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	quadCheck = new wxRadioButton(Core, ID_RADIOBUTTON3, _T("Quadrilatère"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON3"));
	...
	rendererParam1Txt = new wxStaticText(Core, ID_STATICTEXT9, _T("rendererParam1 :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
	...
	rendererParam2Txt = new wxStaticText(Core, ID_STATICTEXT10, _T("rendererParam2 :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT10"));
	...
	textureTxt = new wxStaticText(Core, ID_STATICTEXT32, _T("Image :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT32"));
	...
	alphaRenderingCheck = new wxRadioButton(Core, ID_RADIOBUTTON22, _T("Rendu normal"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON22"));
	FlexGridSizer22->Add(alphaRenderingCheck, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	additiveRenderingCheck = new wxRadioButton(Core, ID_RADIOBUTTON23, _T("Rendu additif"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON23"));
	...
	StaticBoxSizer4 = new wxStaticBoxSizer(wxHORIZONTAL, Core, _T("Particules"));
	...
	StaticText27 = new wxStaticText(Core, ID_STATICTEXT29, _T("Temps de vie : Entre"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT29"));
	...
	lifeTimeMinEdit->SetToolTip(_T("Temps de vie minimum"));
	FlexGridSizer60->Add(lifeTimeMinEdit, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText28 = new wxStaticText(Core, ID_STATICTEXT30, _T("et"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT30"));
	...
	lifeTimeMaxEdit->SetToolTip(_T("Temps de vie maximum"));
	FlexGridSizer60->Add(lifeTimeMaxEdit, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText29 = new wxStaticText(Core, ID_STATICTEXT31, _T("secondes"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT31"));
	...
	infiniteTankCheck = new wxCheckBox(Core, ID_CHECKBOX1, _T("Capacité infinie"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
	infiniteTankCheck->SetValue(false);
	infiniteTankCheck->SetToolTip(_T("En cochant ceci, l\'émetteur ne s\'arrêtera jamais d\'émettre des particules."));
	FlexGridSizer39->Add(infiniteTankCheck, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText3 = new wxStaticText(Core, ID_STATICTEXT3, _T("Capacité :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	...
	tankEdit->SetToolTip(_T("Le nombre de particules disponibles."));
	...
	StaticText1 = new wxStaticText(Core, ID_STATICTEXT1, _T("Flux :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	flowEdit->SetToolTip(_T("Le nombre de particules émises à la seconde. -1 pour tout émettre d\'un coup."));
	...
	StaticText59 = new wxStaticText(Core, ID_STATICTEXT62, _T("Nombre maximum de particules affichables :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT62"));
	FlexGridSizer59->Add(StaticText59, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	maxParticleNbEdit = new wxTextCtrl(Core, ID_TEXTCTRL24, _T("5000"), wxDefaultPosition, wxSize(37,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL24"));
	...
	StaticBoxSizer12 = new wxStaticBoxSizer(wxHORIZONTAL, Panel2, _T("Couleur"));
	FlexGridSizer43 = new wxFlexGridSizer(0, 4, 0, 0);
	StaticText37 = new wxStaticText(Panel2, ID_STATICTEXT40, _T("Couleur des particules à leur apparition :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT40"));
	...
	StaticText38 = new wxStaticText(Panel2, ID_STATICTEXT41, _T("Couleur des particules à leur disparition :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT41"));
	...
	StaticBoxSizer5 = new wxStaticBoxSizer(wxHORIZONTAL, Panel1, _T("Rouge"));
	FlexGridSizer13 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer13->AddGrowableCol(0);
	FlexGridSizer14 = new wxFlexGridSizer(0, 3, 0, 0);
	redFixedCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON6, _T("Fixé"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON6"));
	redFixedCheck->SetValue(true);
	FlexGridSizer14->Add(redFixedCheck, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	redRandomCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON5, _T("Aléatoire"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON5"));
	...
	redMutableCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON4, _T("Changeant au cours du temps"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON4"));
	...
	StaticText11 = new wxStaticText(Panel1, ID_STATICTEXT13, _T("De"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT13"));
	...
	StaticText10 = new wxStaticText(Panel1, ID_STATICTEXT12, _T("à"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT12"));
	...
	StaticBoxSizer7 = new wxStaticBoxSizer(wxHORIZONTAL, Panel1, _T("Vert"));
	FlexGridSizer18 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer18->AddGrowableCol(0);
	FlexGridSizer19 = new wxFlexGridSizer(0, 3, 0, 0);
	greenFixedCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON10, _T("Fixé"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON10"));
	...
	greenRandomCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON11, _T("Aléatoire"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON11"));
	...
	greenMutableCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON12, _T("Changeant au cours du temps"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON12"));
	...
	StaticText16 = new wxStaticText(Panel1, ID_STATICTEXT18, _T("De"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT18"));
	...
	StaticText17 = new wxStaticText(Panel1, ID_STATICTEXT19, _T("à"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT19"));
	...
	StaticBoxSizer6 = new wxStaticBoxSizer(wxHORIZONTAL, Panel1, _T("Bleu"));
	FlexGridSizer16 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer16->AddGrowableCol(0);
	FlexGridSizer17 = new wxFlexGridSizer(0, 3, 0, 0);
	blueFixedCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON7, _T("Fixé"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON7"));
	...
	blueRandomCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON8, _T("Aléatoire"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON8"));
	...
	blueMutableCheck = new wxRadioButton(Panel1, ID_RADIOBUTTON9, _T("Changeant au cours du temps"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON9"));
	...
	StaticText13 = new wxStaticText(Panel1, ID_STATICTEXT15, _T("De"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT15"));
	...
	StaticText14 = new wxStaticText(Panel1, ID_STATICTEXT16, _T("à"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT16"));
	...
	particleNotebook->AddPage(Panel2, _T("Couleurs"), false);
	particleNotebook->AddPage(Panel1, _T("Couleurs ( avancées )"), false);
	...
	StaticBoxSizer13 = new wxStaticBoxSizer(wxHORIZONTAL, Core, _T("Transparence"));
	FlexGridSizer55 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer27 = new wxFlexGridSizer(0, 3, 0, 0);
	alphaRandomCheck = new wxRadioButton(Core, ID_RADIOBUTTON13, _T("Valeur aléatoire"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON13"));
	FlexGridSizer27->Add(alphaRandomCheck, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	alphaMutableCheck = new wxRadioButton(Core, ID_RADIOBUTTON14, _T("Evolution au cours du temps"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON14"));
	...
	StaticText39 = new wxStaticText(Core, ID_STATICTEXT42, _T("Entre"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT42"));
	...
	StaticText58 = new wxStaticText(Core, ID_STATICTEXT61, _T("et"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT61"));
	...
	StaticText15 = new wxStaticText(Core, ID_STATICTEXT17, _T("Variation aléatoire\nde ces deux valeurs :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT17"));
	StaticText15->SetToolTip(_T("Amplitude de la variation aléatoire de la valeur initiale de la transparence"));
	...
	StaticBoxSizer15 = new wxStaticBoxSizer(wxHORIZONTAL, Core, _T("Angle d\'affichage"));
	FlexGridSizer56 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer28 = new wxFlexGridSizer(0, 3, 0, 0);
	angleRandomCheck = new wxRadioButton(Core, ID_RADIOBUTTON26, _T("Valeur aléatoire"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON26"));
	FlexGridSizer28->Add(angleRandomCheck, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	angleMutableCheck = new wxRadioButton(Core, ID_RADIOBUTTON27, _T("Evolution au cours du temps"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON27"));
	...
	StaticText41 = new wxStaticText(Core, ID_STATICTEXT44, _T("Entre"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT44"));
	...
	StaticText55 = new wxStaticText(Core, ID_STATICTEXT58, _T("°"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT58"));
	FlexGridSizer57->Add(StaticText55, 1, wxTOP|wxBOTTOM|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText56 = new wxStaticText(Core, ID_STATICTEXT59, _T("et"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT59"));
	...
	StaticText57 = new wxStaticText(Core, ID_STATICTEXT60, _T("°"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT60"));
	FlexGridSizer57->Add(StaticText57, 1, wxTOP|wxBOTTOM|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText18 = new wxStaticText(Core, ID_STATICTEXT20, _T("Variation aléatoire\nde ces deux valeurs :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT20"));
	StaticText18->SetToolTip(_T("Amplitude de la variation aléatoire de la valeur initiale de la transparence"));
	FlexGridSizer57->Add(StaticText18, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	angle1RandomnessEdit = new wxTextCtrl(Core, ID_TEXTCTRL17, _T("0"), wxDefaultPosition, wxSize(55,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL17"));
	angle1RandomnessEdit->SetToolTip(_T("Amplitude de la variation aléatoire de la valeur."));
	...
	FlexGridSizer57->Add(5,5,1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
	angle2RandomnessEdit = new wxTextCtrl(Core, ID_TEXTCTRL29, _T("0"), wxDefaultPosition, wxSize(55,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL29"));
	angle2RandomnessEdit->SetToolTip(_T("Amplitude de la variation aléatoire de la valeur."));
	...
	StaticBoxSizer14 = new wxStaticBoxSizer(wxHORIZONTAL, Core, _T("Taille"));
	FlexGridSizer54 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer29 = new wxFlexGridSizer(0, 3, 0, 0);
	sizeRandomCheck = new wxRadioButton(Core, ID_RADIOBUTTON25, _T("Valeur aléatoire"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON25"));
	FlexGridSizer29->Add(sizeRandomCheck, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	sizeMutableCheck = new wxRadioButton(Core, ID_RADIOBUTTON24, _T("Evolution au cours du temps"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON24"));
	...
	StaticText40 = new wxStaticText(Core, ID_STATICTEXT43, _T("Entre"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT43"));
	...
	StaticText53 = new wxStaticText(Core, ID_STATICTEXT56, _T("%"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT56"));
	FlexGridSizer44->Add(StaticText53, 1, wxTOP|wxBOTTOM|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText52 = new wxStaticText(Core, ID_STATICTEXT55, _T("et"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT55"));
	...
	StaticText51 = new wxStaticText(Core, ID_STATICTEXT54, _T("%"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT54"));
	FlexGridSizer44->Add(StaticText51, 1, wxTOP|wxBOTTOM|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText54 = new wxStaticText(Core, ID_STATICTEXT57, _T("de la taille initiale"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT57"));
	FlexGridSizer44->Add(StaticText54, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText19 = new wxStaticText(Core, ID_STATICTEXT21, _T("Variation aléatoire\nde ces deux valeurs :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT21"));
	StaticText19->SetToolTip(_T("Amplitude de la variation aléatoire de la valeur initiale de la transparence"));
	...
	StaticBoxSizer11 = new wxStaticBoxSizer(wxHORIZONTAL, Core, _T("Zone et direction d\'émission"));
	...
	StaticText4 = new wxStaticText(Core, ID_STATICTEXT4, _T("Force d\'émission :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	FlexGridSizer38->Add(StaticText4, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer2 = new wxBoxSizer(wxHORIZONTAL);
	StaticText5 = new wxStaticText(Core, ID_STATICTEXT5, _T("Entre"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	...
	StaticText6 = new wxStaticText(Core, ID_STATICTEXT6, _T("et"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
	...
	StaticText30 = new wxStaticText(Core, ID_STATICTEXT33, _T("Rayon de la sphère d\'apparition :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT33"));
	...
	StaticText43 = new wxStaticText(Panel4, ID_STATICTEXT46, _T("Angle d\'émission :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT46"));
	...
	StaticText44 = new wxStaticText(Panel4, ID_STATICTEXT47, _T("°"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT47"));
	...
	StaticText45 = new wxStaticText(Panel4, ID_STATICTEXT48, _T("Angle d\'ouverture du cone d\'émission :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT48"));
	...
	StaticText46 = new wxStaticText(Panel4, ID_STATICTEXT49, _T("°"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT49"));
	...
	StaticText31 = new wxStaticText(Panel3, ID_STATICTEXT34, _T("Direction d\'émission :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT34"));
	...
	emitterDirXEdit->SetToolTip(_T("Direction de l\'émission, sur l\'axe X"));
	...
	emitterDirYEdit->SetToolTip(_T("Direction de l\'émission, sur l\'axe Y"));
	...
	emitterDirZEdit->SetToolTip(_T("Direction de l\'émission, sur l\'axe Z ( profondeur )"));
	...
	StaticText33 = new wxStaticText(Panel3, ID_STATICTEXT36, _T("Angle de la zone d\'émission :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT36"));
	FlexGridSizer41->Add(StaticText33, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText35 = new wxStaticText(Panel3, ID_STATICTEXT38, _T("1er angle :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT38"));
	...
	StaticText9 = new wxStaticText(Panel3, ID_STATICTEXT11, _T("°"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT11"));
	...
	StaticText36 = new wxStaticText(Panel3, ID_STATICTEXT39, _T("2eme angle :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT39"));
	...
	StaticText12 = new wxStaticText(Panel3, ID_STATICTEXT14, _T("°"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT14"));
	...
	emissionNotebook->AddPage(Panel4, _T("Configuration simple"), false);
	emissionNotebook->AddPage(Panel3, _T("Configuration avancée"), false);
	...
	StaticBoxSizer2 = new wxStaticBoxSizer(wxHORIZONTAL, Core, _T("Gravité"));
	...
	StaticText47 = new wxStaticText(Panel6, ID_STATICTEXT50, _T("Gravité :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT50"));
	...
	simpleGravityLengthEdit->SetToolTip(_T("Gravité sur l\'axe X"));
	...
	StaticText49 = new wxStaticText(Panel6, ID_STATICTEXT52, _T("Angle de la gravité :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT52"));
	...
	simpleGravityAngleEdit->SetToolTip(_T("Gravité sur l\'axe Z ( profondeur )"));
	FlexGridSizer51->Add(simpleGravityAngleEdit, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText50 = new wxStaticText(Panel6, ID_STATICTEXT53, _T("°"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT53"));
	...
	StaticText48 = new wxStaticText(Panel6, ID_STATICTEXT51, _T("Friction :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT51"));
	...
	StaticText2 = new wxStaticText(Panel5, ID_STATICTEXT2, _T("Gravité appliquée aux particules :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	...
	gravityXEdit->SetToolTip(_T("Gravité sur l\'axe X"));
	...
	gravityYEdit->SetToolTip(_T("Gravité sur l\'axe Y"));
	...
	gravityZEdit->SetToolTip(_T("Gravité sur l\'axe Z ( profondeur )"));
	...
	StaticText8 = new wxStaticText(Panel5, ID_STATICTEXT8, _T("Friction :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	...
	gravityNotebook->AddPage(Panel6, _T("Configuration simple"), false);
	gravityNotebook->AddPage(Panel5, _T("Configuration avancée"), false);
	...
	imageBankBt = new wxButton(Core, ID_BUTTON3, _T("Afficher la banque d\'images"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
