...
ParticleEmitterObjectEditor::ParticleEmitterObjectEditor(
  ...
  FlexGridSizer10->Add(
      ...
      5);
  pointCheck = new wxRadioButton(Core,
                                 ID_RADIOBUTTON2,
                                 _("Points"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  FlexGridSizer10->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  lineCheck = new wxRadioButton(Core,
                                ID_RADIOBUTTON1,
                                _("Line"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  FlexGridSizer10->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  quadCheck = new wxRadioButton(Core,
                                ID_RADIOBUTTON3,
                                _("Quad"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  rendererParam1Txt = new wxStaticText(Core,
                                       ID_STATICTEXT9,
                                       _("rendererParam1 :"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
  ...
  FlexGridSizer9->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  rendererParam1Edit = new wxTextCtrl(Core,
                                      ID_TEXTCTRL9,
                                      wxEmptyString,
                                      wxDefaultPosition,
                                      wxDefaultSize,
  ...
  FlexGridSizer9->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  rendererParam2Txt = new wxStaticText(Core,
                                       ID_STATICTEXT10,
                                       _("rendererParam2 :"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
  ...
  FlexGridSizer9->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  rendererParam2Edit = new wxTextCtrl(Core,
                                      ID_TEXTCTRL10,
                                      wxEmptyString,
                                      wxDefaultPosition,
                                      wxSize(-1, -1),
  ...
  FlexGridSizer9->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  textureTxt = new wxStaticText(Core,
                                ID_STATICTEXT32,
                                _("Image :"),
                                wxDefaultPosition,
                                wxDefaultSize,
                                ...
                                _T("ID_STATICTEXT32"));
  FlexGridSizer9->Add(
      textureTxt, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  textureEdit = new wxTextCtrl(Core,
                               ID_TEXTCTRL13,
                               wxEmptyString,
                               wxDefaultPosition,
                               wxSize(179, 21),
  ...
  alphaRenderingCheck = new wxRadioButton(Core,
                                          ID_RADIOBUTTON22,
  ...
  FlexGridSizer22->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  additiveRenderingCheck = new wxRadioButton(Core,
                                             ID_RADIOBUTTON23,
                                             _("Additive rendering"),
                                             wxDefaultPosition,
                                             wxDefaultSize,
                                             0,
                                             wxDefaultValidator,
  ...
  StaticText27 = new wxStaticText(Core,
                                  ID_STATICTEXT29,
                                  _("Lifetime : Between"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer60->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  lifeTimeMinEdit = new wxTextCtrl(Core,
                                   ID_TEXTCTRL11,
                                   wxEmptyString,
                                   wxDefaultPosition,
                                   wxSize(55, 21),
  ...
  FlexGridSizer60->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText28 = new wxStaticText(Core,
                                  ID_STATICTEXT30,
                                  _("and"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer60->Add(
      ...
      5);
  lifeTimeMaxEdit = new wxTextCtrl(Core,
                                   ID_TEXTCTRL12,
                                   wxEmptyString,
                                   wxDefaultPosition,
                                   wxSize(55, 21),
  ...
  FlexGridSizer60->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText29 = new wxStaticText(Core,
                                  ID_STATICTEXT31,
                                  _("seconds"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT31"));
  FlexGridSizer60->Add(StaticText29,
                       1,
  ...
  infiniteTankCheck = new wxCheckBox(Core,
                                     ID_CHECKBOX1,
                                     _("Unlimited capacity"),
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     0,
                                     wxDefaultValidator,
  ...
  infiniteTankCheck->SetToolTip(
      _("If this box is checked, the emitter will keep emit particles."));
  FlexGridSizer39->Add(
      infiniteTankCheck,
      1,
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  flowEdit = new wxTextCtrl(Core,
                            ...
                            _T("ID_TEXTCTRL2"));
  flowEdit->SetToolTip(
      _("Number of particles emitted ( by seconds ). -1 to emit everything in "
        "a single shot."));
  FlexGridSizer37->Add(
      flowEdit,
      1,
  ...
  StaticText59 = new wxStaticText(Core,
                                  ID_STATICTEXT62,
                                  _("Maximum particles number:"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT62"));
  FlexGridSizer59->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  maxParticleNbEdit = new wxTextCtrl(Core,
                                     ID_TEXTCTRL24,
                                     _("5000"),
                                     wxDefaultPosition,
                                     wxSize(37, 21),
  ...
  particleNotebook = new wxNotebook(Core,
                                    ID_NOTEBOOK1,
                                    wxDefaultPosition,
                                    wxDefaultSize,
                                    0,
                                    _T("ID_NOTEBOOK1"));
  Panel2 = new wxPanel(particleNotebook,
                       ID_PANEL3,
                       wxDefaultPosition,
                       wxDefaultSize,
                       wxTAB_TRAVERSAL,
  ...
  StaticText37 = new wxStaticText(Panel2,
                                  ID_STATICTEXT40,
                                  _("Initial particles color :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT40"));
  FlexGridSizer43->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  simpleColor1Bt = new wxColourPickerCtrl(Panel2,
  ...
  FlexGridSizer43->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText38 = new wxStaticText(Panel2,
                                  ID_STATICTEXT41,
                                  _("Final particles color :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT41"));
  FlexGridSizer43->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  simpleColor2Bt = new wxColourPickerCtrl(Panel2,
  ...
  Panel1 = new wxPanel(particleNotebook,
                       ID_PANEL2,
                       wxDefaultPosition,
                       wxDefaultSize,
                       wxTAB_TRAVERSAL,
  ...
  redFixedCheck = new wxRadioButton(Panel1,
                                    ID_RADIOBUTTON6,
                                    _("Fixed"),
                                    wxDefaultPosition,
                                    wxDefaultSize,
  ...
  FlexGridSizer14->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  redRandomCheck = new wxRadioButton(Panel1,
                                     ID_RADIOBUTTON5,
                                     _("Random"),
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     ...
                                     _T("ID_RADIOBUTTON5"));
  FlexGridSizer14->Add(
      redRandomCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer13->Add(
      FlexGridSizer14,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  redMutableCheck = new wxRadioButton(Panel1,
                                      ID_RADIOBUTTON4,
                                      _("Changing over time"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
                                      0,
                                      wxDefaultValidator,
                                      _T("ID_RADIOBUTTON4"));
  FlexGridSizer13->Add(
      redMutableCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer15 = new wxFlexGridSizer(0, 5, 0, 0);
  StaticText11 = new wxStaticText(Panel1,
                                  ID_STATICTEXT13,
                                  _("From"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer15->Add(
      ...
      wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  red1Edit = new wxSpinCtrlDouble(Panel1,
                                  ID_SPINCTRL1,
                                  "",
                                  wxDefaultPosition,
                                  wxSize(55, 21),
  ...
  FlexGridSizer15->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText10 = new wxStaticText(Panel1,
                                  ID_STATICTEXT12,
                                  _("to"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer15->Add(
      ...
      wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  red2Edit = new wxSpinCtrlDouble(Panel1,
                                  ID_CUSTOM1,
                                  "",
                                  wxDefaultPosition,
                                  wxSize(55, 21),
  ...
  greenFixedCheck = new wxRadioButton(Panel1,
                                      ID_RADIOBUTTON10,
                                      _("Fixed"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
  ...
  FlexGridSizer19->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  greenRandomCheck = new wxRadioButton(Panel1,
                                       ID_RADIOBUTTON11,
                                       _("Random"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
                                       ...
                                       _T("ID_RADIOBUTTON11"));
  FlexGridSizer19->Add(
      greenRandomCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer18->Add(
      FlexGridSizer19,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  greenMutableCheck = new wxRadioButton(Panel1,
                                        ID_RADIOBUTTON12,
                                        _("Changing over time"),
                                        wxDefaultPosition,
                                        wxDefaultSize,
                                        ...
                                        _T("ID_RADIOBUTTON12"));
  FlexGridSizer18->Add(
      greenMutableCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer20 = new wxFlexGridSizer(0, 5, 0, 0);
  StaticText16 = new wxStaticText(Panel1,
                                  ID_STATICTEXT18,
                                  _("From"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer20->Add(
      ...
      wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  green1Edit = new wxSpinCtrlDouble(Panel1,
                                    ID_CUSTOM2,
                                    "",
                                    wxDefaultPosition,
                                    wxSize(55, 21),
  ...
  FlexGridSizer20->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText17 = new wxStaticText(Panel1,
                                  ID_STATICTEXT19,
                                  _("to"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer20->Add(
      ...
      wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  green2Edit = new wxSpinCtrlDouble(Panel1,
                                    ID_CUSTOM3,
                                    "",
                                    wxDefaultPosition,
                                    wxSize(55, 21),
  ...
  blueFixedCheck = new wxRadioButton(Panel1,
                                     ID_RADIOBUTTON7,
                                     _("Fixed"),
                                     wxDefaultPosition,
                                     wxDefaultSize,
  ...
  FlexGridSizer17->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  blueRandomCheck = new wxRadioButton(Panel1,
                                      ID_RADIOBUTTON8,
                                      _("Random"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
                                      ...
                                      _T("ID_RADIOBUTTON8"));
  FlexGridSizer17->Add(
      blueRandomCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer16->Add(
      FlexGridSizer17,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  blueMutableCheck = new wxRadioButton(Panel1,
                                       ID_RADIOBUTTON9,
                                       _("Changing over time"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
                                       ...
                                       _T("ID_RADIOBUTTON9"));
  FlexGridSizer16->Add(
      blueMutableCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer21 = new wxFlexGridSizer(0, 5, 0, 0);
  StaticText13 = new wxStaticText(Panel1,
                                  ID_STATICTEXT15,
                                  _("From"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer21->Add(
      ...
      wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  blue1Edit = new wxSpinCtrlDouble(Panel1,
                                   ID_CUSTOM4,
                                   "",
                                   wxDefaultPosition,
                                   wxSize(55, 21),
  ...
  FlexGridSizer21->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText14 = new wxStaticText(Panel1,
                                  ID_STATICTEXT16,
                                  _("to"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer21->Add(
      ...
      wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  blue2Edit = new wxSpinCtrlDouble(Panel1,
                                   ID_CUSTOM5,
                                   "",
                                   wxDefaultPosition,
                                   wxSize(55, 21),
  ...
  FlexGridSizer31->Add(
      ...
      0);
  StaticBoxSizer13 =
      new wxStaticBoxSizer(wxHORIZONTAL, Core, _("Transparency"));
  FlexGridSizer55 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer27 = new wxFlexGridSizer(0, 3, 0, 0);
  alphaRandomCheck = new wxRadioButton(Core,
                                       ID_RADIOBUTTON13,
                                       _("Random value"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
                                       ...
                                       _T("ID_RADIOBUTTON13"));
  FlexGridSizer27->Add(
      alphaRandomCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  alphaMutableCheck = new wxRadioButton(Core,
                                        ID_RADIOBUTTON14,
                                        _("Changing over time"),
                                        wxDefaultPosition,
                                        wxDefaultSize,
                                        ...
                                        _T("ID_RADIOBUTTON14"));
  FlexGridSizer27->Add(
      alphaMutableCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer55->Add(
      FlexGridSizer27,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  StaticText39 = new wxStaticText(Core,
                                  ID_STATICTEXT42,
                                  _("Between"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  ...
                                  _T("ID_STATICTEXT42"));
  FlexGridSizer23->Add(
      StaticText39, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  alpha1Edit = new wxSpinCtrlDouble(Core,
                                    ID_CUSTOM12,
                                    "",
                                    wxDefaultPosition,
                                    wxSize(55, 21),
  ...
  FlexGridSizer23->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText58 = new wxStaticText(Core,
                                  ID_STATICTEXT61,
                                  _("and"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer23->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  alpha2Edit = new wxSpinCtrlDouble(Core,
                                    ID_CUSTOM17,
                                    "",
                                    wxDefaultPosition,
                                    wxSize(55, 21),
  ...
  FlexGridSizer23->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText15 = new wxStaticText(Core,
                                  ID_STATICTEXT17,
                                  _("Random variation\nbetween:"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT17"));
  StaticText15->SetToolTip(
      _("Ampltiude of the random variation of the initial transparency"));
  FlexGridSizer23->Add(
      StaticText15,
      1,
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  alpha1RandomnessEdit = new wxSpinCtrlDouble(Core,
                                              ID_CUSTOM6,
                                              "",
                                              wxDefaultPosition,
                                              wxSize(55, 21),
                                              ...
                                              _T("ID_CUSTOM6"));
  FlexGridSizer23->Add(
      alpha1RandomnessEdit,
      1,
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  FlexGridSizer23->Add(
      5, 5, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  alpha2RandomnessEdit = new wxSpinCtrlDouble(Core,
                                              ID_CUSTOM7,
                                              "",
                                              wxDefaultPosition,
                                              wxSize(55, 21),
  ...
  StaticBoxSizer15 =
      new wxStaticBoxSizer(wxHORIZONTAL, Core, _("Display angle"));
  FlexGridSizer56 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer28 = new wxFlexGridSizer(0, 3, 0, 0);
  angleRandomCheck = new wxRadioButton(Core,
                                       ID_RADIOBUTTON26,
                                       _("Random value"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
                                       ...
                                       _T("ID_RADIOBUTTON26"));
  FlexGridSizer28->Add(
      angleRandomCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  angleMutableCheck = new wxRadioButton(Core,
                                        ID_RADIOBUTTON27,
                                        _("Changing over time"),
                                        wxDefaultPosition,
                                        wxDefaultSize,
                                        ...
                                        _T("ID_RADIOBUTTON27"));
  FlexGridSizer28->Add(
      angleMutableCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer56->Add(
      FlexGridSizer28,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  StaticText41 = new wxStaticText(Core,
                                  ID_STATICTEXT44,
                                  _("Between"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  ...
                                  _T("ID_STATICTEXT44"));
  FlexGridSizer57->Add(
      StaticText41, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  angle1Edit = new wxTextCtrl(Core,
                              ID_TEXTCTRL28,
                              wxEmptyString,
                              wxDefaultPosition,
                              wxSize(55, 21),
  ...
  FlexGridSizer57->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText55 = new wxStaticText(Core,
                                  ID_STATICTEXT58,
                                  _("\302\260"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT58"));
  FlexGridSizer57->Add(StaticText55,
                       1,
                       wxTOP | wxBOTTOM | wxRIGHT | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText56 = new wxStaticText(Core,
                                  ID_STATICTEXT59,
                                  _("and"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer57->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  angle2Edit = new wxTextCtrl(Core,
                              ID_TEXTCTRL27,
                              wxEmptyString,
                              wxDefaultPosition,
                              wxSize(55, 21),
  ...
  FlexGridSizer57->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText57 = new wxStaticText(Core,
                                  ID_STATICTEXT60,
                                  _("\302\260"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT60"));
  FlexGridSizer57->Add(StaticText57,
                       1,
                       wxTOP | wxBOTTOM | wxRIGHT | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText18 = new wxStaticText(Core,
                                  ID_STATICTEXT20,
                                  _("Random variation\nbetween:"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer57->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  angle1RandomnessEdit = new wxTextCtrl(Core,
                                        ID_TEXTCTRL17,
                                        _("0"),
                                        wxDefaultPosition,
                                        wxSize(55, 21),
                                        ...
                                        wxDefaultValidator,
                                        _T("ID_TEXTCTRL17"));
  angle1RandomnessEdit->SetToolTip(
      _("Ampltiude of the random variation of the value."));
  FlexGridSizer57->Add(
      angle1RandomnessEdit,
      1,
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  FlexGridSizer57->Add(
      5, 5, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  FlexGridSizer57->Add(
      5, 5, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  angle2RandomnessEdit = new wxTextCtrl(Core,
                                        ID_TEXTCTRL29,
                                        _("0"),
                                        wxDefaultPosition,
                                        wxSize(55, 21),
                                        ...
                                        wxDefaultValidator,
                                        _T("ID_TEXTCTRL29"));
  angle2RandomnessEdit->SetToolTip(
      _("Ampltiude of the random variation of the value."));
  FlexGridSizer57->Add(
      angle2RandomnessEdit,
      1,
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  FlexGridSizer57->Add(
  ...
  sizeRandomCheck = new wxRadioButton(Core,
                                      ID_RADIOBUTTON25,
                                      _("Random value"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
                                      ...
                                      _T("ID_RADIOBUTTON25"));
  FlexGridSizer29->Add(
      sizeRandomCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  sizeMutableCheck = new wxRadioButton(Core,
                                       ID_RADIOBUTTON24,
                                       _("Changing over time"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
                                       ...
                                       _T("ID_RADIOBUTTON24"));
  FlexGridSizer29->Add(
      sizeMutableCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer54->Add(
      FlexGridSizer29,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  StaticText40 = new wxStaticText(Core,
                                  ID_STATICTEXT43,
                                  _("Between"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  ...
                                  _T("ID_STATICTEXT43"));
  FlexGridSizer44->Add(
      StaticText40, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  size1Edit = new wxSpinCtrlDouble(Core,
                                   ID_CUSTOM13,
                                   "",
                                   wxDefaultPosition,
                                   wxSize(55, 21),
  ...
  FlexGridSizer44->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText53 = new wxStaticText(Core,
                                  ID_STATICTEXT56,
                                  _("%"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT56"));
  FlexGridSizer44->Add(StaticText53,
                       1,
                       wxTOP | wxBOTTOM | wxRIGHT | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText52 = new wxStaticText(Core,
                                  ID_STATICTEXT55,
                                  _("and"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer44->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  size2Edit = new wxSpinCtrlDouble(Core,
                                   ID_CUSTOM14,
                                   "",
                                   wxDefaultPosition,
                                   wxSize(55, 21),
  ...
  FlexGridSizer44->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText51 = new wxStaticText(Core,
                                  ID_STATICTEXT54,
                                  _("%"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT54"));
  FlexGridSizer44->Add(StaticText51,
                       1,
                       wxTOP | wxBOTTOM | wxRIGHT | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText54 = new wxStaticText(Core,
                                  ID_STATICTEXT57,
                                  _("of the initial size"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT57"));
  FlexGridSizer44->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText19 = new wxStaticText(Core,
                                  ID_STATICTEXT21,
                                  _("Random variation\nbetween:"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer44->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  size1RandomnessEdit = new wxSpinCtrlDouble(Core,
                                             ID_CUSTOM8,
                                             "",
                                             wxDefaultPosition,
                                             wxSize(55, 21),
  ...
  FlexGridSizer44->Add(
      5, 5, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  size2RandomnessEdit = new wxSpinCtrlDouble(Core,
                                             ID_CUSTOM9,
                                             "",
                                             wxDefaultPosition,
                                             wxSize(55, 21),
  ...
  StaticBoxSizer11 = new wxStaticBoxSizer(
      wxHORIZONTAL, Core, _("Zone and direction of emission"));
  ...
  StaticText5 = new wxStaticText(Core,
                                 ...
                                 0,
                                 _T("ID_STATICTEXT5"));
  BoxSizer2->Add(StaticText5,
                 0,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 5);
  emitterForceMinEdit = new wxTextCtrl(Core,
                                       ID_TEXTCTRL6,
                                       wxEmptyString,
                                       wxDefaultPosition,
                                       wxSize(66, 21),
                                       ...
                                       wxDefaultValidator,
                                       _T("ID_TEXTCTRL6"));
  BoxSizer2->Add(emitterForceMinEdit,
                 1,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 5);
  StaticText6 = new wxStaticText(Core,
                                 ...
                                 0,
                                 _T("ID_STATICTEXT6"));
  BoxSizer2->Add(StaticText6,
                 0,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 5);
  emitterForceMaxEdit = new wxTextCtrl(Core,
                                       ID_TEXTCTRL7,
                                       wxEmptyString,
                                       wxDefaultPosition,
                                       wxSize(66, 21),
                                       ...
                                       wxDefaultValidator,
                                       _T("ID_TEXTCTRL7"));
  BoxSizer2->Add(emitterForceMaxEdit,
                 1,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 5);
  FlexGridSizer38->Add(
  ...
  StaticText30 = new wxStaticText(Core,
                                  ID_STATICTEXT33,
                                  _("Radius of the emission sphere :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT33"));
  FlexGridSizer11->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  zoneRadiusEdit = new wxTextCtrl(Core,
                                  ID_TEXTCTRL14,
                                  wxEmptyString,
                                  wxDefaultPosition,
                                  wxSize(66, 21),
  ...
  FlexGridSizer45->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  emissionNotebook = new wxNotebook(Core,
                                    ID_NOTEBOOK2,
                                    wxDefaultPosition,
                                    wxDefaultSize,
                                    0,
                                    _T("ID_NOTEBOOK2"));
  Panel4 = new wxPanel(emissionNotebook,
                       ID_PANEL5,
                       wxDefaultPosition,
                       wxDefaultSize,
                       wxTAB_TRAVERSAL,
  ...
  StaticText45 = new wxStaticText(Panel4,
                                  ID_STATICTEXT48,
  ...
  FlexGridSizer49->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  simpleConeAngleEdit = new wxTextCtrl(Panel4,
                                       ID_TEXTCTRL22,
                                       wxEmptyString,
                                       wxDefaultPosition,
                                       wxSize(66, 21),
  ...
  FlexGridSizer49->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText46 = new wxStaticText(Panel4,
                                  ID_STATICTEXT49,
                                  _("\302\260"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT49"));
  FlexGridSizer49->Add(StaticText46,
                       1,
                       wxTOP | wxBOTTOM | wxRIGHT | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  Panel3 = new wxPanel(emissionNotebook,
                       ID_PANEL4,
                       wxDefaultPosition,
                       wxDefaultSize,
                       wxTAB_TRAVERSAL,
  ...
  StaticText31 = new wxStaticText(Panel3,
                                  ID_STATICTEXT34,
  ...
  emitterDirZEdit = new wxTextCtrl(Panel3,
                                   ID_TEXTCTRL20,
                                   wxEmptyString,
                                   wxDefaultPosition,
                                   wxSize(62, 21),
  ...
  StaticText33 = new wxStaticText(Panel3,
                                  ID_STATICTEXT36,
                                  _("Angle of the emission zone :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT36"));
  FlexGridSizer41->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText35 = new wxStaticText(Panel3,
                                  ID_STATICTEXT38,
                                  _("1st angle :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  ...
                                  _T("ID_STATICTEXT38"));
  FlexGridSizer41->Add(
      StaticText35, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  emitterAngleAEdit = new wxTextCtrl(Panel3,
                                     ID_TEXTCTRL15,
                                     wxEmptyString,
                                     wxDefaultPosition,
                                     wxSize(62, 21),
  ...
  FlexGridSizer41->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText9 = new wxStaticText(Panel3,
                                 ID_STATICTEXT11,
                                 _("\302\260"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  FlexGridSizer41->Add(
      ...
      5);
  FlexGridSizer41->Add(
      8, 9, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText36 = new wxStaticText(Panel3,
                                  ID_STATICTEXT39,
                                  _("2nd angle :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer41->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  emitterAngleBEdit = new wxTextCtrl(Panel3,
                                     ID_TEXTCTRL16,
                                     wxEmptyString,
                                     wxDefaultPosition,
                                     wxSize(62, 21),
  ...
  FlexGridSizer41->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText12 = new wxStaticText(Panel3,
                                  ID_STATICTEXT14,
                                  _("\302\260"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  gravityNotebook = new wxNotebook(Core,
                                   ID_NOTEBOOK3,
                                   wxDefaultPosition,
                                   wxDefaultSize,
                                   0,
                                   _T("ID_NOTEBOOK3"));
  Panel6 = new wxPanel(gravityNotebook,
                       ID_PANEL7,
                       wxDefaultPosition,
                       wxDefaultSize,
                       wxTAB_TRAVERSAL,
  ...
  StaticText47 = new wxStaticText(Panel6,
                                  ID_STATICTEXT50,
                                  _("Gravity :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer52->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  simpleGravityLengthEdit = new wxTextCtrl(Panel6,
                                           ID_TEXTCTRL23,
                                           wxEmptyString,
                                           wxDefaultPosition,
                                           wxSize(62, 21),
  ...
  StaticText49 = new wxStaticText(Panel6,
                                  ID_STATICTEXT52,
                                  _("Gravity angle :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer51->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  simpleGravityAngleEdit = new wxTextCtrl(Panel6,
                                          ID_TEXTCTRL25,
                                          wxEmptyString,
                                          wxDefaultPosition,
                                          wxSize(62, 21),
  ...
  FlexGridSizer51->Add(
      simpleGravityAngleEdit,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText50 = new wxStaticText(Panel6,
                                  ID_STATICTEXT53,
                                  _("\302\260"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  StaticText48 = new wxStaticText(Panel6,
                                  ID_STATICTEXT51,
                                  _("Friction :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  ...
                                  _T("ID_STATICTEXT51"));
  FlexGridSizer53->Add(
      StaticText48, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  simpleFrictionEdit = new wxTextCtrl(Panel6,
                                      ID_TEXTCTRL26,
                                      wxEmptyString,
                                      wxDefaultPosition,
                                      wxSize(62, 21),
  ...
  Panel5 = new wxPanel(gravityNotebook,
                       ID_PANEL6,
                       wxDefaultPosition,
                       wxDefaultSize,
                       wxTAB_TRAVERSAL,
  ...
  StaticText2 = new wxStaticText(Panel5,
                                 ID_STATICTEXT2,
                                 _("Gravity applied to particles :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT2"));
  ...
  gravityXEdit = new wxTextCtrl(Panel5,
                                ID_TEXTCTRL3,
                                wxEmptyString,
                                wxDefaultPosition,
                                wxSize(62, 21),
  ...
  FlexGridSizer4->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  gravityYEdit = new wxTextCtrl(Panel5,
                                ID_TEXTCTRL4,
                                wxEmptyString,
                                wxDefaultPosition,
                                wxSize(62, 21),
  ...
  FlexGridSizer4->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  gravityZEdit = new wxTextCtrl(Panel5,
                                ID_TEXTCTRL5,
                                wxEmptyString,
                                wxDefaultPosition,
                                wxSize(62, 21),
  ...
  FlexGridSizer3->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  StaticText8 = new wxStaticText(Panel5,
                                 ID_STATICTEXT8,
                                 _("Friction :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  frictionEdit = new wxTextCtrl(Panel5,
                                ID_TEXTCTRL8,
                                wxEmptyString,
                                wxDefaultPosition,
                                wxSize(62, 21),
  ...
  StaticBoxSizer2->Add(
      ...
      5);
  FlexGridSizer32->Add(
      StaticBoxSizer2, 1, wxALL | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL, 5);
  StaticBoxSizer1 =
      new wxStaticBoxSizer(wxHORIZONTAL, Core, _("Miscellaneous"));
  FlexGridSizer30 = new wxFlexGridSizer(0, 3, 0, 0);
  destroyWhenNoParticlesCheck =
      new wxCheckBox(Core,
                     ID_CHECKBOX2,
                     _("Destroy the object when no more particles are sprayed"),
                     wxDefaultPosition,
                     wxDefaultSize,
                     0,
                     wxDefaultValidator,
  ...
  FlexGridSizer32->Add(
      StaticBoxSizer1,
      1,
      wxALL | wxEXPAND | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL,
      5);
  FlexGridSizer5->Add(
      FlexGridSizer32,
      1,
  ...
  Connect(
      ...
      (wxObjectEventFunction)&ParticleEmitterObjectEditor::OnpointCheckSelect);
  Connect(
      ID_RADIOBUTTON1,
      wxEVT_COMMAND_RADIOBUTTON_SELECTED,
      (wxObjectEventFunction)&ParticleEmitterObjectEditor::OnLineCheckSelect);
  Connect(
      ID_RADIOBUTTON3,
      wxEVT_COMMAND_RADIOBUTTON_SELECTED,
      (wxObjectEventFunction)&ParticleEmitterObjectEditor::OnQuadCheckSelect);
  Connect(ID_BITMAPBUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnimageChooseBtClick);
  Connect(ID_CHECKBOX1,
          wxEVT_COMMAND_CHECKBOX_CLICKED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OninfiniteTankCheckClick);
  Connect(ID_COLOURPICKERCTRL1,
          wxEVT_COMMAND_COLOURPICKER_CHANGED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnsimpleColor1BtColourChanged);
  Connect(ID_COLOURPICKERCTRL2,
          wxEVT_COMMAND_COLOURPICKER_CHANGED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnsimpleColor1BtColourChanged);
  Connect(ID_RADIOBUTTON6,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnredFixedCheckSelect);
  Connect(ID_RADIOBUTTON5,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnredRandomCheckSelect);
  Connect(ID_RADIOBUTTON4,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnredRandomCheckSelect);
  Connect(ID_RADIOBUTTON10,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OngreenFixedCheckSelect);
  Connect(ID_RADIOBUTTON11,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OngreenRandomCheckSelect);
  Connect(ID_RADIOBUTTON12,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OngreenRandomCheckSelect);
  Connect(ID_RADIOBUTTON7,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnblueFixedCheckSelect);
  Connect(ID_RADIOBUTTON8,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnblueRandomCheckSelect);
  Connect(ID_RADIOBUTTON9,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnblueRandomCheckSelect);
  Connect(ID_RADIOBUTTON13,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnalphaRandomCheckSelect1);
  Connect(ID_RADIOBUTTON14,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnalphaMutableCheckSelect);
  Connect(ID_RADIOBUTTON26,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnangleRandomCheckSelect1);
  Connect(ID_RADIOBUTTON27,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnangleMutableCheckSelect);
  Connect(ID_RADIOBUTTON25,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnsizeRandomCheckSelect1);
  Connect(ID_RADIOBUTTON24,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnsizeMutableCheckSelect);
  Connect(ID_TEXTCTRL22,
          wxEVT_COMMAND_TEXT_UPDATED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnsimpleConeAngleText);
  Connect(ID_TEXTCTRL23,
          wxEVT_COMMAND_TEXT_UPDATED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnsimpleGravityAngleText);
  Connect(ID_TEXTCTRL25,
          wxEVT_COMMAND_TEXT_UPDATED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
              OnsimpleGravityAngleText);
  Connect(ID_TEXTCTRL26,
          wxEVT_COMMAND_TEXT_UPDATED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::
  ...
  Connect(
      ID_BUTTON3,
      wxEVT_COMMAND_BUTTON_CLICKED,
      (wxObjectEventFunction)&ParticleEmitterObjectEditor::OnimageBankBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ParticleEmitterObjectEditor::OncancelBtClick);
  //*)
  ...
  alpha1RandomnessEdit->SetValue(
      gd::String::From(object.GetParticleAlphaRandomness1()));
  alpha2RandomnessEdit->SetValue(
      gd::String::From(object.GetParticleAlphaRandomness2()));
  ...
  size1RandomnessEdit->SetValue(
      gd::String::From(object.GetParticleSizeRandomness1()));
  size2RandomnessEdit->SetValue(
      gd::String::From(object.GetParticleSizeRandomness2()));
  angle1RandomnessEdit->SetValue(
      gd::String::From(object.GetParticleAngleRandomness1()));
  angle2RandomnessEdit->SetValue(
      gd::String::From(object.GetParticleAngleRandomness2()));
  ...
  simpleColor1Bt->SetColour(wxColour(object.GetParticleRed1(),
                                     object.GetParticleGreen1(),
                                     object.GetParticleBlue1()));
  simpleColor2Bt->SetColour(wxColour(object.GetParticleRed2(),
                                     object.GetParticleGreen2(),
                                     object.GetParticleBlue2()));
  ...
  simpleFrictionEdit->ChangeValue(frictionEdit->GetValue());
  {
    ...
    simpleGravityAngleEdit->ChangeValue(
        gd::String::From(atan2(y, x) * 180.0f / 3.14159f));
...
void ParticleEmitterObjectEditor::OnokBtClick(wxCommandEvent& event) {
  std::size_t particleNb =
      gd::String(maxParticleNbEdit->GetValue()).To<int>() > 0
          ? gd::String(maxParticleNbEdit->GetValue()).To<std::size_t>()
          : 0;
  if (particleNb > 30000) {
    if (wxMessageBox(
            _("The number of particles is huge. A number too important could "
  ...
  if (infiniteTankCheck->GetValue())
    object.SetTank(-1);
  else
    object.SetTank(gd::String(tankEdit->GetValue()).To<float>());

  if (lineCheck->GetValue())
    object.SetRendererType(ParticleEmitterObject::Line);
  else if (quadCheck->GetValue())
    object.SetRendererType(ParticleEmitterObject::Quad);
  else
    object.SetRendererType(ParticleEmitterObject::Point);

  if (alphaRenderingCheck->GetValue())
    object.SetRenderingAlpha();
  else
    object.SetRenderingAdditive();

  object.SetFlow(gd::String(flowEdit->GetValue()).To<float>());
  object.SetEmitterForceMin(
      gd::String(emitterForceMinEdit->GetValue()).To<float>());
  object.SetEmitterForceMax(
      gd::String(emitterForceMaxEdit->GetValue()).To<float>());
  object.SetEmitterZDirection(
      gd::String(emitterDirZEdit->GetValue()).To<float>());
  object.SetEmitterAngleA(
      gd::String(emitterAngleAEdit->GetValue()).To<float>());
  object.SetEmitterAngleB(
      gd::String(emitterAngleBEdit->GetValue()).To<float>());
  ...
  object.SetRendererParam1(
      gd::String(rendererParam1Edit->GetValue()).To<float>());
  object.SetRendererParam2(
      gd::String(rendererParam2Edit->GetValue()).To<float>());
  object.SetParticleLifeTimeMin(
      gd::String(lifeTimeMinEdit->GetValue()).To<float>());
  object.SetParticleLifeTimeMax(
      gd::String(lifeTimeMaxEdit->GetValue()).To<float>());
  ...
  object.SetParticleAngleRandomness1(
      gd::String(angle1RandomnessEdit->GetValue()).To<float>());
  object.SetParticleAngleRandomness2(
      gd::String(angle2RandomnessEdit->GetValue()).To<float>());
  if (redRandomCheck->GetValue())
    object.SetRedParameterType(ParticleEmitterObject::Random);
  else if (redMutableCheck->GetValue())
    object.SetRedParameterType(ParticleEmitterObject::Mutable);
  else
    object.SetRedParameterType(ParticleEmitterObject::Enabled);
  if (greenRandomCheck->GetValue())
    object.SetGreenParameterType(ParticleEmitterObject::Random);
  else if (greenMutableCheck->GetValue())
    object.SetGreenParameterType(ParticleEmitterObject::Mutable);
  else
    object.SetGreenParameterType(ParticleEmitterObject::Enabled);
  if (blueRandomCheck->GetValue())
    object.SetBlueParameterType(ParticleEmitterObject::Random);
  else if (blueMutableCheck->GetValue())
    object.SetBlueParameterType(ParticleEmitterObject::Mutable);
  else
    object.SetBlueParameterType(ParticleEmitterObject::Enabled);
  if (alphaRandomCheck->GetValue())
    object.SetAlphaParameterType(ParticleEmitterObject::Random);
  else if (alphaMutableCheck->GetValue())
    object.SetAlphaParameterType(ParticleEmitterObject::Mutable);
  else
    object.SetAlphaParameterType(ParticleEmitterObject::Enabled);
  if (sizeRandomCheck->GetValue())
    object.SetSizeParameterType(ParticleEmitterObject::Random);
  else if (sizeMutableCheck->GetValue())
    object.SetSizeParameterType(ParticleEmitterObject::Mutable);
  else
    object.SetSizeParameterType(ParticleEmitterObject::Nothing);
  if (angleRandomCheck->GetValue())
    object.SetAngleParameterType(ParticleEmitterObject::Random);
  else if (angleMutableCheck->GetValue())
    object.SetAngleParameterType(ParticleEmitterObject::Mutable);
  else
    object.SetAngleParameterType(ParticleEmitterObject::Nothing);
  ...
  if (emissionNotebook->GetSelection() == 0)
    object.emissionEditionSimpleMode = true;
  if (gravityNotebook->GetSelection() == 0)
    object.gravityEditionSimpleMode = true;
  if (particleNotebook->GetSelection() == 0)
    object.particleEditionSimpleMode = true;
...
void ParticleEmitterObjectEditor::OninfiniteTankCheckClick(
...
void ParticleEmitterObjectEditor::OnredRandomCheckSelect(
    wxCommandEvent& event) {
  red2Edit->Enable(true);
}

void ParticleEmitterObjectEditor::OngreenFixedCheckSelect(
    wxCommandEvent& event) {
  green2Edit->Enable(false);
}

void ParticleEmitterObjectEditor::OngreenRandomCheckSelect(
    wxCommandEvent& event) {
  green2Edit->Enable(true);
}

void ParticleEmitterObjectEditor::OnblueFixedCheckSelect(
    wxCommandEvent& event) {
  blue2Edit->Enable(false);
}

void ParticleEmitterObjectEditor::OnblueRandomCheckSelect(
    wxCommandEvent& event) {
  blue2Edit->Enable(true);
}
...
void ParticleEmitterObjectEditor::OnimageChooseBtClick(wxCommandEvent& event) {
  ...
  textureEdit->ChangeValue(editorImagesPnl->resourcesTree->GetItemText(
      editorImagesPnl->m_itemSelected));
}
...
void ParticleEmitterObjectEditor::OnsimpleColor1BtColourChanged(
...
void ParticleEmitterObjectEditor::OnsimpleGravityAngleText(
    wxCommandEvent& event) {
  float angle = gd::String(simpleGravityAngleEdit->GetValue()).To<float>() /
                180.0f * 3.14159f;
...
void ParticleEmitterObjectEditor::OnsimpleFrictionEditText(
    wxCommandEvent& event) {
  frictionEdit->SetValue(simpleFrictionEdit->GetValue());
}

void ParticleEmitterObjectEditor::OnalphaMutableCheckSelect(
    wxCommandEvent& event) {
  alpha1RandomnessEdit->Enable(true);
  alpha2RandomnessEdit->Enable(true);
}

void ParticleEmitterObjectEditor::OnalphaRandomCheckSelect1(
    wxCommandEvent& event) {
  alpha1RandomnessEdit->Enable(false);
  alpha2RandomnessEdit->Enable(false);
}

void ParticleEmitterObjectEditor::OnangleRandomCheckSelect1(
    wxCommandEvent& event) {
  angle1RandomnessEdit->Enable(false);
  angle2RandomnessEdit->Enable(false);
}

void ParticleEmitterObjectEditor::OnangleMutableCheckSelect(
    wxCommandEvent& event) {
  angle1RandomnessEdit->Enable(true);
  angle2RandomnessEdit->Enable(true);
}

void ParticleEmitterObjectEditor::OnsizeRandomCheckSelect1(
    wxCommandEvent& event) {
  size1RandomnessEdit->Enable(false);
  size2RandomnessEdit->Enable(false);
}

void ParticleEmitterObjectEditor::OnsizeMutableCheckSelect(
    wxCommandEvent& event) {
