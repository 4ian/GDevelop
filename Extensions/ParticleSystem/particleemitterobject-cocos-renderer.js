...
gdjs.ParticleEmitterObjectCocosRenderer = function(
  runtimeScene,
  runtimeObject,
  objectData
) {
  ...
  var plist = {
    ...
    speedVariance:
      Math.abs(objectData.emitterForceMax - objectData.emitterForceMin) / 2.0,
  ...
  if (objectData.greenParam === "Mutable") {
    ...
    plist.startColorGreen = plist.finishColorGreen =
      (objectData.particleGreen1 + objectData.particleGreen2) / (2.0 * 255.0);
  ...
  if (objectData.blueParam === "Mutable") {
    ...
    plist.startColorBlue = plist.finishColorBlue =
      (objectData.particleBlue1 + objectData.particleBlue2) / (2.0 * 255.0);
  ...
  if (objectData.alphaParam === "Mutable") {
    var alphaInit =
      (objectData.particleAlpha1 + objectData.particleAlphaRandomness1) / 255.0;
    var alphaEnd =
      (objectData.particleAlpha1 + objectData.particleAlphaRandomness2) / 255.0;
    plist.startColorAlpha = (alphaInit + alphaEnd) / 2.0;
    plist.startColorVarianceAlpha = alphaEnd - plist.startColorAlpha;
    alphaInit =
      (objectData.particleAlpha2 + objectData.particleAlphaRandomness1) / 255.0;
    alphaEnd =
      (objectData.particleAlpha2 + objectData.particleAlphaRandomness2) / 255.0;
...
gdjs.ParticleEmitterObjectCocosRenderer.prototype.setAngle = function(
  angle1,
  angle2
) {
...
gdjs.ParticleEmitterObjectCocosRenderer.prototype.setForce = function(
  min,
  max
) {
...
gdjs.ParticleEmitterObjectCocosRenderer.prototype.setZoneRadius = function(
  radius
) {
  this.renderer.setPosVar(cc.p(radius, radius));
};

gdjs.ParticleEmitterObjectCocosRenderer.prototype.setLifeTime = function(
  min,
  max
) {
...
gdjs.ParticleEmitterObjectCocosRenderer.prototype.setColor = function(
  r1,
  g1,
  b1,
  r2,
...
gdjs.ParticleEmitterObjectCocosRenderer.prototype.setAlpha = function(
  alpha1,
  alpha2
) {
...
gdjs.ParticleEmitterObjectCocosRenderer.prototype.setSize = function(
  size1,
  size2
) {
...
gdjs.ParticleEmitterObjectCocosRenderer.prototype.isTextureValid = function(
  texture,
  runtimeScene
) {
  return runtimeScene
    .getGame()
    .getImageManager()
    .getTexture(texture)._textureLoaded;
};

gdjs.ParticleEmitterObjectCocosRenderer.prototype.setTexture = function(
  texture,
  runtimeScene
) {
