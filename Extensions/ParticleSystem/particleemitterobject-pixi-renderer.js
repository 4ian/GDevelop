...
gdjs.ParticleEmitterObjectPixiRenderer.prototype.setAngle = function(
  angle1,
  angle2
) {
...
gdjs.ParticleEmitterObjectPixiRenderer.prototype.setZoneRadius = function(
  radius
) {
  this.emitter.spawnCircle.radius = radius;
};

gdjs.ParticleEmitterObjectPixiRenderer.prototype.setLifeTime = function(
  min,
  max
) {
...
gdjs.ParticleEmitterObjectPixiRenderer.prototype.setColor = function(
  r1,
  g1,
  b1,
  r2,
...
gdjs.ParticleEmitterObjectPixiRenderer.prototype.setSize = function(
  size1,
  size2
) {
...
gdjs.ParticleEmitterObjectPixiRenderer.prototype.setAlpha = function(
  alpha1,
  alpha2
) {
...
gdjs.ParticleEmitterObjectPixiRenderer.prototype.setFlow = function(
  flow,
  tank
) {
...
gdjs.ParticleEmitterObjectPixiRenderer.prototype.isTextureValid = function(
  texture,
  runtimeScene
) {
  return runtimeScene
    .getGame()
    .getImageManager()
    .getPIXITexture(texture).valid;
};

gdjs.ParticleEmitterObjectPixiRenderer.prototype.setTexture = function(
  texture,
  runtimeScene
) {
  var pixiTexture = runtimeScene
    .getGame()
    .getImageManager()
