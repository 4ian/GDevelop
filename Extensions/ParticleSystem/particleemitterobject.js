...
gdjs.ParticleEmitterObject = function(runtimeScene, objectData) {
  ...
  this.renderer = new gdjs.ParticleEmitterObjectRenderer(
    runtimeScene,
    this,
    objectData
  );
...
gdjs.ParticleEmitterObject.prototype = Object.create(
  gdjs.RuntimeObject.prototype
);
gdjs.ParticleEmitterObject.thisIsARuntimeObjectConstructor =
...
gdjs.ParticleEmitterObject.prototype.update = function(runtimeScene) {
  ...
  if (
    this.renderer.hasStarted() &&
    this.renderer.getParticleCount() === 0 &&
...
gdjs.ParticleEmitterObject.prototype.onDeletedFromScene = function(
  runtimeScene
) {
...
gdjs.ParticleEmitterObject.prototype.setParticleLifeTimeMin = function(
  lifeTime
) {
...
gdjs.ParticleEmitterObject.prototype.setParticleLifeTimeMax = function(
  lifeTime
) {
  if (lifeTime < 0) lifeTime = 0;
...
gdjs.ParticleEmitterObject.prototype.setParticleGravityLength = function(
  length
) {
...
gdjs.ParticleEmitterObject.prototype.setTexture = function(
  texture,
  runtimeScene
) {
