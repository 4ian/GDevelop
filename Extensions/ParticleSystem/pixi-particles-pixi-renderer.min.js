            ...
            o = (function(t) {
              ...
              return (
                ...
                (e.parseArt = function(t) {
                  for (var e, i, s, a, r, o = [], h = 0; h < t.length; ++h) {
                    (e = t[h]),
                      (o[h] = i = {}),
                      (i.textures = r = []),
                      (s = e.textures);
                    for (var l = 0; l < s.length; ++l)
                      if ("string" == typeof (a = s[l])) r.push(n.fromImage(a));
                      else if (a instanceof n) r.push(a);
                      else {
                        var p = a.count || 1;
                        for (
                          a =
                            "string" == typeof a.texture
                              ? n.fromImage(a.texture)
                              : a.texture;
                          p > 0;
                          --p
                        )
                    ...
                    "matchLife" == e.framerate
                      ? ((i.framerate = -1), (i.duration = 0), (i.loop = !1))
                      : ((i.loop = !!e.loop),
                        (i.framerate = e.framerate > 0 ? e.framerate : 60),
                        (i.duration = r.length / i.framerate));
                  }
                  return o;
                }),
                e
      ...
      2: [
        function(t, e, i) {
          ...
          var s = t("./ParticleUtils"),
            ...
            h = (function() {
              function t(t, e, i) {
                (this._particleConstructor = a.default),
              ...
              return (
                ...
                (t.prototype.init = function(t, e) {
                  if (t && e) {
                    ...
                    (this.particleImages = i.parseArt ? i.parseArt(t) : t),
                      e.alpha
                        ? (this.startAlpha = r.default.createList(e.alpha))
                        : (this.startAlpha = new r.default(1, 0)),
                      e.speed
                        ? ((this.startSpeed = r.default.createList(e.speed)),
                          (this.minimumSpeedMultiplier =
                            e.speed.minimumSpeedMultiplier || 1))
                        : ((this.minimumSpeedMultiplier = 1),
                          (this.startSpeed = new r.default(0, 0)));
                    var a,
                      n = e.acceleration;
                    switch (
                      (n && (n.x || n.y)
                        ? ((this.startSpeed.next = null),
                          (this.acceleration = new PIXI.Point(n.x, n.y)),
                          (this.maxSpeed = e.maxSpeed || NaN))
                        : (this.acceleration = new PIXI.Point()),
                      e.scale
                        ? ((this.startScale = r.default.createList(e.scale)),
                          (this.minimumScaleMultiplier =
                            e.scale.minimumScaleMultiplier || 1))
                        : ((this.startScale = new r.default(1, 0)),
                          (this.minimumScaleMultiplier = 1)),
                      e.color
                        ? (this.startColor = r.default.createList(e.color))
                        : (this.startColor = new r.default(
                            { r: 255, g: 255, b: 255 },
                            0
                          )),
                      e.startRotation
                        ? ((this.minStartRotation = e.startRotation.min),
                          (this.maxStartRotation = e.startRotation.max))
                        : (this.minStartRotation = this.maxStartRotation = 0),
                      e.noRotation &&
                      (this.minStartRotation || this.maxStartRotation)
                        ? (this.noRotation = !!e.noRotation)
                        : (this.noRotation = !1),
                      e.rotationSpeed
                        ? ((this.minRotationSpeed = e.rotationSpeed.min),
                          (this.maxRotationSpeed = e.rotationSpeed.max))
                        : (this.minRotationSpeed = this.maxRotationSpeed = 0),
                      (this.minLifetime = e.lifetime.min),
                      (this.maxLifetime = e.lifetime.max),
                      (this.particleBlendMode = s.default.getBlendMode(
                        e.blendMode
                      )),
                      e.ease
                        ? (this.customEase =
                            "function" == typeof e.ease
                              ? e.ease
                              : s.default.generateEase(e.ease))
                        : (this.customEase = null),
                      i.parseData
                        ? (this.extraData = i.parseData(e.extraData))
                        : (this.extraData = e.extraData || null),
                      (this.spawnRect = this.spawnCircle = null),
                      (this.particlesPerWave = 1),
                      e.particlesPerWave &&
                        e.particlesPerWave > 1 &&
                        (this.particlesPerWave = e.particlesPerWave),
                      (this.particleSpacing = 0),
                      (this.angleStart = 0),
                      e.spawnType)
                    ) {
                      ...
                      case "circle":
                        (this.spawnType = "circle"),
                          ...
                          (a = e.spawnCircle),
                          (this.spawnCircle = new PIXI.Circle(a.x, a.y, a.r));
                        break;
                      case "ring":
                        (this.spawnType = "ring"),
                          ...
                          (a = e.spawnCircle),
                          (this.spawnCircle = new PIXI.Circle(a.x, a.y, a.r)),
                          (this.spawnCircle.minRadius = a.minR);
                        break;
                      case "burst":
                        (this.spawnType = "burst"),
                          (this._spawnFunc = this._spawnBurst),
                          (this.particleSpacing = e.particleSpacing),
                          (this.angleStart = e.angleStart ? e.angleStart : 0);
                        break;
                      case "point":
                      default:
                    ...
                    (this.frequency = e.frequency),
                      (this.spawnChance =
                        "number" == typeof e.spawnChance && e.spawnChance > 0
                          ? e.spawnChance
                          : 1),
                      (this.emitterLifetime = e.emitterLifetime || -1),
                      (this.maxParticles =
                        e.maxParticles > 0 ? e.maxParticles : 1e3),
                      (this.totalParticleCount = 0),
                      (this.addAtBack = !!e.addAtBack),
                      (this.rotation = 0),
                      (this.ownerPos = new PIXI.Point()),
                      (this.spawnPos = new PIXI.Point(e.pos.x, e.pos.y)),
                      (this._prevEmitterPos = this.spawnPos.clone()),
                      (this._prevPosIsValid = !1),
                      (this._spawnTimer = 0),
                      (this.emit = void 0 === e.emit || !!e.emit),
                      (this.autoUpdate =
                        void 0 !== e.autoUpdate && !!e.autoUpdate);
                  }
                }),
                ...
                (t.prototype.rotate = function(t) {
                  if (this.rotation != t) {
                    ...
                    (this.rotation = t),
                      s.default.rotatePoint(e, this.spawnPos),
                      (this._posChanged = !0);
                  }
                }),
                ...
                (t.prototype.update = function(t) {
                  if (
                    (this._autoUpdate &&
                      (t = t / PIXI.settings.TARGET_FPMS / 1e3),
                    this._parent)
                  ) {
                    var e, i, s, a, r;
                    for (i = this._activeParticlesFirst; i; i = s)
                      (s = i.next), i.update(t);
                    this._prevPosIsValid &&
                      ((a = this._prevEmitterPos.x),
                      (r = this._prevEmitterPos.y));
                                ...
                                if (
                                  (this._poolFirst
                                    ? ((d = this._poolFirst),
                                      ...
                                      (d.next = null))
                                    : (d = new this.particleConstructor(this)),
                                  this.particleImages.length > 1
                                    ...
                                    : d.applyArt(this.particleImages[0]),
                                  ...
                                  this.minRotationSpeed == this.maxRotationSpeed
                                    ? (d.rotationSpeed = this.minRotationSpeed)
                                    : (d.rotationSpeed =
                                        Math.random() *
                                  ...
                                  this.addAtBack
                                    ? this._parent.addChildAt(d, 0)
                                    : this._parent.addChild(d);
                                this._activeParticlesLast
                                  ? ((this._activeParticlesLast.next = d),
                                    (d.prev = this._activeParticlesLast),
                                    (this._activeParticlesLast = d))
                                  : (this._activeParticlesLast = this._activeParticlesFirst = d),
                                  ++this.particleCount,
                ...
                (t.prototype._spawnRect = function(t, e, i) {
                  this.minStartRotation == this.maxStartRotation
                    ...
                    : (t.rotation =
                        ...
                        this.rotation),
                    (o.x =
                      Math.random() * this.spawnRect.width + this.spawnRect.x),
                    (o.y =
                      Math.random() * this.spawnRect.height + this.spawnRect.y),
                    0 !== this.rotation &&
                      s.default.rotatePoint(this.rotation, o),
                    (t.position.x = e + o.x),
                    (t.position.y = i + o.y);
                }),
                (t.prototype._spawnCircle = function(t, e, i) {
                  this.minStartRotation == this.maxStartRotation
                    ...
                    : (t.rotation =
                        ...
                        this.minStartRotation +
                        this.rotation),
                    (o.x = Math.random() * this.spawnCircle.radius),
                    (o.y = 0),
                    s.default.rotatePoint(360 * Math.random(), o),
                    (o.x += this.spawnCircle.x),
                    (o.y += this.spawnCircle.y),
                    0 !== this.rotation &&
                      s.default.rotatePoint(this.rotation, o),
                    (t.position.x = e + o.x),
                    (t.position.y = i + o.y);
                ...
                (t.prototype._spawnRing = function(t, e, i) {
                  ...
                  this.minStartRotation == this.maxStartRotation
                    ...
                    a.minRadius == a.radius
                      ? (o.x =
                          Math.random() * (a.radius - a.minRadius) +
                          a.minRadius)
                      : (o.x = a.radius),
                    (o.y = 0);
                  var r = 360 * Math.random();
                  (t.rotation += r),
                    s.default.rotatePoint(r, o),
                    (o.x += this.spawnCircle.x),
                    (o.y += this.spawnCircle.y),
                    0 !== this.rotation &&
                      s.default.rotatePoint(this.rotation, o),
                ...
                (t.prototype.destroy = function() {
                  ...
                  for (var e = this._poolFirst; e; e = t)
                    (t = e.next), e.destroy();
        ...
        { "./Particle": 3, "./ParticleUtils": 4, "./PropertyNode": 7 }
      ],
      3: [
        function(t, e, i) {
          "use strict";
            ...
            o = (function(t) {
              function e(i) {
                ...
                return (
                  ...
                  (s.velocity = new PIXI.Point()),
                  (s.maxLife = 0),
                  (s.age = 0),
                  (s.ease = null),
                  (s.extraData = null),
                  (s.alphaList = new n.default()),
                  (s.speedList = new n.default()),
                  (s.speedMultiplier = 1),
                  (s.acceleration = new PIXI.Point()),
                  (s.maxSpeed = NaN),
                  (s.scaleList = new n.default()),
                  (s.scaleMultiplier = 1),
                  (s.colorList = new n.default(!0)),
                  (s._doAlpha = !1),
                  (s._doScale = !1),
                  (s._doSpeed = !1),
                  (s._doAcceleration = !1),
                  (s._doColor = !1),
                  (s._doNormalMovement = !1),
                  (s._oneOverLife = 0),
                  (s.next = null),
                  (s.prev = null),
                  (s.init = s.init),
                  (s.Particle_init = e.prototype.init),
                  (s.update = s.update),
                  (s.Particle_update = e.prototype.update),
                  (s.Sprite_destroy = t.prototype.destroy),
                  (s.Particle_destroy = e.prototype.destroy),
                  (s.applyArt = s.applyArt),
                  (s.kill = s.kill),
                  s
                );
              }
              return (
                ...
                (e.prototype.init = function() {
                  (this.age = 0),
                    ...
                    (this.velocity.y = 0),
                    r.default.rotatePoint(this.rotation, this.velocity),
                    this.noRotation
                      ? (this.rotation = 0)
                      : (this.rotation *= r.default.DEG_TO_RADS),
                    (this.rotationSpeed *= r.default.DEG_TO_RADS),
                  ...
                  (this.tint = r.default.combineRGBComponents(t.r, t.g, t.b)),
                    (this.visible = !0);
                }),
                (e.prototype.applyArt = function(t) {
                ...
                (e.prototype.update = function(t) {
                  ...
                  if (this._doNormalMovement) {
                    if (this._doSpeed) {
                      var s =
                        this.speedList.interpolate(e) * this.speedMultiplier;
                      r.default.normalize(this.velocity),
                        r.default.scaleBy(this.velocity, s);
                    } else if (
                      this._doAcceleration &&
                      ...
                      var a = r.default.length(this.velocity);
                      a > this.maxSpeed &&
                        r.default.scaleBy(this.velocity, this.maxSpeed / a);
                    }
                ...
                (e.parseArt = function(t) {
                  ...
                  for (e = t.length; e >= 0; --e)
                    "string" == typeof t[e] &&
                      (t[e] = PIXI.Texture.fromImage(t[e]));
                  if (r.default.verbose)
        ...
        { "./ParticleUtils": 4, "./PropertyList": 6 }
      ],
      4: [
        function(t, e, i) {
          "use strict";
            ...
            r = {
              ...
              hexToRGB: function(t, e) {
                ...
                return (
                  ...
                  8 == t.length && ((i = t.substr(0, 2)), (t = t.substr(2))),
            ...
            p = (function(t) {
              function e(e) {
                ...
                return (
                  (i.path = null),
                  (i.initialRotation = 0),
                  (i.initialPosition = new PIXI.Point()),
                  (i.movement = 0),
                  i
                );
              }
              return (
                ...
                (e.prototype.update = function(t) {
                  ...
                  if (e >= 0 && this.path) {
                    ...
                    (this.movement += i * t),
                      (o.x = this.movement),
                      (o.y = this.path(this.movement)),
                      r.default.rotatePoint(this.initialRotation, o),
                      (this.position.x = this.initialPosition.x + o.x),
                      (this.position.y = this.initialPosition.y + o.y);
                  }
                  return e;
                }),
                (e.prototype.destroy = function() {
                ...
                (e.parseData = function(t) {
                  ...
                  if (t && t.path)
                    try {
                      e.path = (function(t) {
                        for (var e = t.match(l), i = e.length - 1; i >= 0; --i)
                          h.indexOf(e[i]) >= 0 && (e[i] = "Math." + e[i]);
                        return (
                          (t = e.join("")),
        ...
        function(t, e, i) {
                ...
                (t.prototype.reset = function(t) {
                  (this.current = t),
                    ...
                    this.next && this.next.time >= 1
                      ? (this.interpolate = this.isColor ? n : r)
                      : t.isStepped
                        ? (this.interpolate = this.isColor ? p : l)
                        : (this.interpolate = this.isColor ? h : o),
          ...
          function n(t) {
            ...
            var e = this.current.value,
              ...
              r = (i.g - e.g) * t + e.g,
              n = (i.b - e.b) * t + e.b;
            return s.default.combineRGBComponents(a, r, n);
          }
          function o(t) {
            ...
            return (
              (t =
                (t - this.current.time) / (this.next.time - this.current.time)),
              (this.next.value - this.current.value) * t + this.current.value
            );
          }
          function h(t) {
          ...
          function p(t) {
            for (
              ...
              (this.current = this.next), (this.next = this.next.next);
            var e = this.current.value;
            return s.default.combineRGBComponents(e.r, e.g, e.b);
          }
          i.default = a;
        },
        { "./ParticleUtils": 4 }
      ...
      7: [
        function(t, e, i) {
          ...
          var s = t("./ParticleUtils"),
            a = (function() {
              function t(t, e, i) {
                (this.value = "string" == typeof t ? s.default.hexToRGB(t) : t),
                  (this.time = e),
                  (this.next = null),
                  (this.isStepped = !1),
                  (this.ease = i
                ...
                (t.createList = function(e) {
                  if (Array.isArray(e.list)) {
                    var i = e.list,
                      ...
                      a = void 0;
                    if (
                      ((a = s = new t(i[0].value, i[0].time, e.ease)),
                      i.length > 2 ||
                        (2 === i.length && i[1].value !== i[0].value))
                    )
                      for (var r = 1; r < i.length; ++r)
                        (s.next = new t(i[r].value, i[r].time)), (s = s.next);
