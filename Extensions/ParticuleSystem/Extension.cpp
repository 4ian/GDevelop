...
class Extension : public ExtensionBase
{
    public:
        ...
        Extension()
        {
            DECLARE_THE_EXTENSION("ParticuleEmitterObject",
            ...
            DECLARE_OBJECT("ParticuleEmitter",
                           _("Emetteur de particules"),
                           _("Objet affichant un texte"),
                           "Extensions/texticon.png",
                           &CreateParticuleEmitterObject,
                           &DestroyParticuleEmitterObject);
                ...
                DECLARE_OBJECT_ACTION("String",
                               ...
                               &ParticuleEmitterObject::ActString);
                ...
                DECLARE_OBJECT_CONDITION("String",
                               ...
                               &ParticuleEmitterObject::CondString);
                ...
                DECLARE_OBJECT_ACTION("Font",
                               ...
                               &ParticuleEmitterObject::ActFont);
                ...
                DECLARE_OBJECT_ACTION("Size",
                               ...
                               &ParticuleEmitterObject::ActSize);
                ...
                DECLARE_OBJECT_CONDITION("Size",
                               ...
                               &ParticuleEmitterObject::CondSize);
                ...
                DECLARE_OBJECT_ACTION("ChangeColor",
                               ...
                               &ParticuleEmitterObject::ActChangeColor);
                ...
                DECLARE_OBJECT_ACTION("Opacity",
                               ...
                               &ParticuleEmitterObject::ActOpacity);
                ...
                DECLARE_OBJECT_CONDITION("Opacity",
                               ...
                               &ParticuleEmitterObject::CondOpacity);
                ...
                DECLARE_OBJECT_ACTION("Angle",
                               ...
                               &ParticuleEmitterObject::ActAngle);
                ...
                DECLARE_OBJECT_CONDITION("Angle",
                               ...
                               &ParticuleEmitterObject::CondAngle);
                ...
                DECLARE_OBJECT_EXPRESSION("Opacity", _("Opacité"), _("Opacité"), _("Opacité"), "res/actions/opacity.png", &ParticuleEmitterObject::ExpOpacity)
                    DECLARE_PARAMETER("object", _("Objet"), true, "Text")
                DECLARE_END_OBJECT_EXPRESSION()

                DECLARE_OBJECT_EXPRESSION("Angle", _("Angle"), _("Angle"), _("Rotation"), "res/actions/rotate.png", &ParticuleEmitterObject::ExpAngle)
                    DECLARE_PARAMETER("object", _("Objet"), true, "Text")
                DECLARE_END_OBJECT_EXPRESSION()

                DECLARE_OBJECT_STR_EXPRESSION("String", _("Texte"), _("Texte"), _("Texte"), "res/texteicon.png", &ParticuleEmitterObject::ExpString)
                    DECLARE_PARAMETER("object", _("Objet"), true, "Text")
