...
PathBehaviorEditor::PathBehaviorEditor(wxWindow* parent,
                                       gd::Project& game_,
                                       gd::Layout* scene_,
                                       PathBehavior& behavior_,
  ...
  StaticText5 = new wxStaticText(this,
                                 ID_STATICTEXT6,
                                 _("Paths:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  FlexGridSizer13->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  BitmapButton3 = new wxBitmapButton(this,
                                     ID_BITMAPBUTTON3,
  ...
  FlexGridSizer13->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  BitmapButton4 = new wxBitmapButton(this,
                                     ID_BITMAPBUTTON4,
                                     gd::SkinHelper::GetIcon("delete", 16),
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     wxBU_AUTODRAW,
                                     wxDefaultValidator,
  ...
  FlexGridSizer13->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      -2);
  BitmapButton5 = new wxBitmapButton(this,
                                     ID_BITMAPBUTTON5,
                                     gd::SkinHelper::GetIcon("rename", 16),
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     wxBU_AUTODRAW,
                                     wxDefaultValidator,
  ...
  FlexGridSizer13->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  globalCheck = new wxCheckBox(this,
                               ID_CHECKBOX4,
                               _("Global"),
                               wxDefaultPosition,
                               wxDefaultSize,
  ...
  BitmapButton1 = new wxBitmapButton(this,
                                     ID_BITMAPBUTTON1,
                                     gd::SkinHelper::GetIcon("add", 16),
                                     wxDefaultPosition,
                                     wxDefaultSize,
  ...
  BoxSizer1->Add(BitmapButton1,
                 1,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 3);
  BitmapButton6 = new wxBitmapButton(this,
                                     ID_BITMAPBUTTON6,
                                     wxBitmap(wxImage(_T("res/addmore.png"))),
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     wxBU_AUTODRAW,
                                     wxDefaultValidator,
  ...
  BoxSizer1->Add(BitmapButton6,
                 1,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 2);
  BitmapButton2 = new wxBitmapButton(this,
                                     ID_BITMAPBUTTON2,
                                     gd::SkinHelper::GetIcon("delete", 16),
                                     wxDefaultPosition,
                                     wxDefaultSize,
  ...
  BoxSizer1->Add(BitmapButton2,
                 1,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 3);
  FlexGridSizer6->Add(
      BoxSizer1, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);
  StaticText8 = new wxStaticText(this,
                                 ID_STATICTEXT9,
                                 _("0;0"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  FlexGridSizer2->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  contextMessageLabel = new wxStaticText(this,
                                         ID_STATICTEXT1,
                                         _("Label"),
                                         wxDefaultPosition,
                                         wxDefaultSize,
  ...
  ToggleButton1 = new wxToggleButton(this,
                                     ID_TOGGLEBUTTON1,
                                     _("Image"),
                                     wxDefaultPosition,
                                     wxDefaultSize,
  ...
  FlexGridSizer16->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText10 = new wxStaticText(this,
                                  ID_STATICTEXT11,
                                  _("X:"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer16->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  bgImgXSpin = new wxSpinCtrl(this,
                              ID_SPINCTRL1,
                              _T("0"),
                              wxDefaultPosition,
                              wxSize(70, 21),
  ...
  FlexGridSizer16->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText11 = new wxStaticText(this,
                                  ID_STATICTEXT12,
                                  _("Y:"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer16->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  bgImgYSpin = new wxSpinCtrl(this,
                              ID_SPINCTRL2,
                              _T("0"),
                              wxDefaultPosition,
                              wxSize(70, 21),
  ...
  xOffsetEdit = new wxTextCtrl(this,
                               ID_TEXTCTRL3,
                               _("0"),
                               wxDefaultPosition,
                               wxSize(51, 21),
  ...
  FlexGridSizer15->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText7 = new wxStaticText(this,
                                 ID_STATICTEXT8,
                                 _(";"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  FlexGridSizer15->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  yOffsetEdit = new wxTextCtrl(this,
                               ID_TEXTCTRL4,
                               _("0"),
                               wxDefaultPosition,
                               wxSize(51, 21),
  ...
  FlexGridSizer11->Add(
      ...
      5);
  StaticBoxSizer3 =
      new wxStaticBoxSizer(wxHORIZONTAL, this, _("Object orientation"));
  FlexGridSizer7 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer7->AddGrowableCol(0);
  followAngleCheck = new wxCheckBox(this,
                                    ID_CHECKBOX3,
                                    _("Automatically update object's angle"),
                                    wxDefaultPosition,
                                    wxDefaultSize,
                                    0,
                                    wxDefaultValidator,
  ...
  FlexGridSizer7->Add(
      followAngleCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer8 = new wxFlexGridSizer(0, 2, 0, 0);
  StaticText3 = new wxStaticText(this,
                                 ID_STATICTEXT4,
                                 _("Angle offset:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT4"));
  StaticText3->SetToolTip(
      _("This angle will be added to the angle the object must take when "
        "following the path"));
  FlexGridSizer8->Add(
      StaticText3,
      1,
  ...
  angleOffsetEdit = new wxTextCtrl(this,
                                   ID_TEXTCTRL2,
                                   _("0"),
                                   wxDefaultPosition,
                                   wxSize(45, 21),
                                   ...
                                   _T("ID_TEXTCTRL2"));
  FlexGridSizer9->Add(
      angleOffsetEdit, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  FlexGridSizer11->Add(
      ...
      5);
  StaticBoxSizer1 =
      new wxStaticBoxSizer(wxHORIZONTAL, this, _("Movement and speed"));
  ...
  FlexGridSizer4->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText2 = new wxStaticText(this,
                                 ID_STATICTEXT3,
                                 _("Options:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  reverseCheck = new wxCheckBox(this,
                                ID_CHECKBOX1,
                                _("Reverse movement at the end"),
                                wxDefaultPosition,
                                wxDefaultSize,
                                0,
                                wxDefaultValidator,
  ...
  StaticText9 =
      new wxStaticText(this,
                       ID_STATICTEXT10,
                       _("These parameters are independent from the path."),
                       wxDefaultPosition,
                       wxDefaultSize,
                       0,
                       _T("ID_STATICTEXT10"));
  wxFont StaticText9Font(wxDEFAULT,
  ...
  FlexGridSizer3->Add(
      ...
      5);
  FlexGridSizer1->Add(
      FlexGridSizer3, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 0);
  ...
  Connect(ID_CHOICE1,
          ...
          (wxObjectEventFunction)&PathBehaviorEditor::OnpathChoiceSelect);
  Connect(ID_BITMAPBUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnBitmapButton3Click1);
  Connect(ID_BITMAPBUTTON4,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnBitmapButton4Click);
  Connect(ID_BITMAPBUTTON5,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnBitmapButton5Click);
  Connect(ID_CHECKBOX4,
          wxEVT_COMMAND_CHECKBOX_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnglobalCheckClick);
  Connect(ID_BITMAPBUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnBitmapButton1Click);
  Connect(ID_BITMAPBUTTON6,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnBitmapButton6Click1);
  Connect(ID_BITMAPBUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnBitmapButton2Click);
  previewPnl->Connect(wxEVT_PAINT,
                      (wxObjectEventFunction)&PathBehaviorEditor::OnPanel1Paint,
                      0,
                      this);
  previewPnl->Connect(
      wxEVT_ERASE_BACKGROUND,
      (wxObjectEventFunction)&PathBehaviorEditor::OnpreviewPnlEraseBackground,
      0,
      this);
  previewPnl->Connect(
      wxEVT_LEFT_DOWN,
      (wxObjectEventFunction)&PathBehaviorEditor::OnpreviewPnlLeftDown,
      0,
      this);
  previewPnl->Connect(
      wxEVT_LEFT_UP,
      (wxObjectEventFunction)&PathBehaviorEditor::OnpreviewPnlLeftUp,
      0,
      this);
  previewPnl->Connect(
      wxEVT_RIGHT_UP,
      (wxObjectEventFunction)&PathBehaviorEditor::OnpreviewPnlRightUp,
      0,
      this);
  previewPnl->Connect(
      wxEVT_MOTION,
      (wxObjectEventFunction)&PathBehaviorEditor::OnpreviewPnlMouseMove,
      0,
      this);
  Connect(ID_TOGGLEBUTTON1,
          wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnBitmapButton6Click);
  Connect(ID_SPINCTRL1,
          wxEVT_COMMAND_SPINCTRL_UPDATED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnbgImgXSpinChange);
  Connect(ID_SPINCTRL2,
          wxEVT_COMMAND_SPINCTRL_UPDATED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnbgImgXSpinChange);
  Connect(ID_CHECKBOX3,
          wxEVT_COMMAND_CHECKBOX_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnCheckBox1Click);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PathBehaviorEditor::OncancelBtClick);
  //*)

  coordsBt = new wxMenuItem(&pointMenu, coordsBtID, _("See coordinates"));
  positionBt =
      new wxMenuItem(&pointMenu, positionBtID, _("Enter manually coordinates"));
  addPointAfterBt = new wxMenuItem(
      &pointMenu, addPointAfterBtID, _("Add a point after another"));
  removePointBt =
      new wxMenuItem(&pointMenu, removePointBtID, _("Delete this point"));

  addAfterBt = new wxMenuItem(
      &advanceAddMenu, addAfterBtID, _("Add a point after another"));
  addBeforeBt = new wxMenuItem(
      &advanceAddMenu, addBeforeBtID, _("Add a point before another"));
  ...
  sharedDatas = std::dynamic_pointer_cast<ScenePathDatas>(
      scene->GetBehaviorSharedDataSmartPtr(behavior.GetName()));
  ...
  // Load global paths
  for (std::map<gd::String, std::vector<sf::Vector2f> >::iterator it =
           sharedDatas->globalPaths.begin();
       it != sharedDatas->globalPaths.end();
       it++) {
  ...
  for (std::size_t a = 0; a < listOfPathsNames.size(); a++) {
    ...
    if (paths.count(listOfPathsNames[a]) ==
        0)  // If a global using the same name doesn't exist
    {
      newPathInfo.name = listOfPathsNames[a];
    } else {
      gd::String futureName;
      do {
        futureName = wxGetTextFromUser(
            _("A global path with the same name already exists.\nTo avoid name "
              "conflict, please rename the local path:"),
            _("Path conflict"),
            listOfPathsNames[a],
            this);
    ...
    newPathInfo.path =
        std::vector<sf::Vector2f>(behavior.GetPath(listOfPathsNames[a]));
  ...
  if (paths.count(behavior.GetCurrentPathName()) != 0) {
    ...
    wxMessageBox(_("Path \"") + behavior.GetCurrentPathName() +
                     _("\" cannot be found.\nThe preview will go back to the "
                       "\"Object main path\"."),
                 _("Path not found"),
...
void PathBehaviorEditor::OnpathChoiceSelect(wxCommandEvent& event) {
  ChangePathOfPreview(
      GetNameWithoutPrefix(pathChoice->GetString(pathChoice->GetSelection())));
}
...
void PathBehaviorEditor::ChangePathOfPreview(const gd::String& name) {
  ...
  pathChoice->Select(pathChoice->FindString(
      pathInfo->isGlobal ? "global: " + name : name, true));
...
void PathBehaviorEditor::UpdateComboBoxWithPathsName() {
  gd::String previousSelectedName =
      pathChoice->GetString(pathChoice->GetSelection());

  pathChoice->Clear();

  for (std::map<gd::String, PathInfo>::iterator it = paths.begin();
       it != paths.end();
       it++) {
...
void PathBehaviorEditor::OnBitmapButton3Click1(wxCommandEvent& event) {
  gd::String newPathName =
      wxGetTextFromUser(_("Name of the new path:"), _("New path"), "newPath");

  if (PathExists(newPathName)) {
    wxMessageBox(_("This path already exists."),
                 _("Unable to create the path"));
    return;
  }
...
void PathBehaviorEditor::OnBitmapButton4Click(wxCommandEvent& event) {
  ...
  int r = wxMessageBox(
      _("Are you sure to delete this path\?"), _("Confirm deletion"), wxYES_NO);
  if (r != wxYES) return;

  if (paths.count(pathInfo->name) != 0 && paths.size() > 1) {
    if (pathInfo->isGlobal) haveDeletedAGlobalPath = true;
...
void PathBehaviorEditor::OnBitmapButton5Click(wxCommandEvent& event) {
  ...
  gd::String newName =
      wxGetTextFromUser(_("New path name:"), _("Rename a path"), originalName);

  if (PathExists(newName) && newName != originalName) {
    wxMessageBox(_("This path already exists."),
                 _("Unable to rename the path"));
    return;
  }
...
void PathBehaviorEditor::OnokBtClick(wxCommandEvent& event) {
  ...
  if (haveDeletedAGlobalPath)
    mainFrameWrapper.GetInfoBar()->ShowMessage(
        _("You have deleted a global path. Be sure that no other object was "
          "using it."),
        wxICON_WARNING);
...
void PathBehaviorEditor::OnPanel1Paint(wxPaintEvent& event) {
  ...
  if (previewPnlState.backgroundBitmap != NULL) {
    dc.DrawBitmap(*previewPnlState.backgroundBitmap,
                  0 - previewPnlState.offset.x + bgImgXSpin->GetValue(),
  ...
  dc.DrawLine(0,
              -previewPnlState.offset.y,
              panelSize.GetWidth(),
              -previewPnlState.offset.y);
  dc.DrawLine(-previewPnlState.offset.x,
              0,
              -previewPnlState.offset.x,
              panelSize.GetHeight());
  ...
  if (previewPnlState.state != VIEWMOVING) {
    ...
    dc.DrawLine(0,
                previewPnlState.mousePosition.y,
                panelSize.GetWidth(),
                previewPnlState.mousePosition.y);
    dc.DrawLine(previewPnlState.mousePosition.x,
                0,
                previewPnlState.mousePosition.x,
                panelSize.GetHeight());
    dc.DrawText(gd::String::From(previewPnlState.mousePosition.x +
                                 previewPnlState.offset.x),
                previewPnlState.mousePosition.x + 2,
                2);
    dc.DrawText(gd::String::From(previewPnlState.mousePosition.y +
                                 previewPnlState.offset.y),
                2,
                previewPnlState.mousePosition.y + 2);
  }
...
void PathBehaviorEditor::OnpreviewPnlLeftDown(wxMouseEvent& event) {
  ...
  if ((selectedPoint = GetPointOnMouse(event)) != -1) {
    ...
    if (previewPnlState.state == DRAGGING) {
      ...
      previewPnlState.originalPoint =
          sf::Vector2f(event.GetPosition().x, event.GetPosition().y);
    }
  ...
  if (previewPnlState.state == ADDING) {
    ...
    if ((selectedPoint = GetPointOnMouse(event)) != -1) {
      ...
      if (selectedPoint < (path->size() - 1)) {
        path->insert(
            path->begin() + selectedPoint + 1,
            sf::Vector2f(
                (path->at(selectedPoint) + path->at(selectedPoint + 1)) / 2.f));
      }
    } else {
      previewPnlState.state = NOTHING;
    }
    ...
    if ((selectedPoint = GetPointOnMouse(event)) != -1) {
      ...
      if (selectedPoint > 0) {
        path->insert(
            path->begin() + selectedPoint,
            sf::Vector2f(
                (path->at(selectedPoint - 1) + path->at(selectedPoint)) / 2.f));
      }
    } else {
      previewPnlState.state = NOTHING;
    }
...
void PathBehaviorEditor::OnpreviewPnlMouseMove(wxMouseEvent& event) {
  ...
  if (previewPnlState.state == DRAGGING) {
    (*path)[previewPnlState.selectedPoint] =
        sf::Vector2f(event.GetPosition().x + previewPnlState.offset.x,
                     event.GetPosition().y + previewPnlState.offset.y);
  } else if (previewPnlState.state == VIEWMOVING) {
    previewPnlState.offset +=
        previewPnlState.originalPoint -
        sf::Vector2f(event.GetPosition().x, event.GetPosition().y);
    previewPnlState.originalPoint =
        sf::Vector2f(event.GetPosition().x, event.GetPosition().y);
  ...
  previewPnlState.mousePosition =
      sf::Vector2f(event.GetPosition().x, event.GetPosition().y);

  previewPnl->Refresh();
  previewPnl->Update();

  StaticText8->SetLabel(
      gd::String::From(event.GetPosition().x + previewPnlState.offset.x) + ";" +
      gd::String::From(event.GetPosition().y + previewPnlState.offset.y));
...
void PathBehaviorEditor::OnpreviewPnlRightUp(wxMouseEvent& event) {
  ...
  if ((selectedPoint = GetPointOnMouse(event)) != -1) {
    if (previewPnlState.state == NOTHING) {
      int menuSelection = previewPnl->GetPopupMenuSelectionFromUser(
          pointMenu, event.GetPosition());

      if (menuSelection == coordsBtID) {
        wxMessageBox(_("Point position:") +
                     gd::String::From(path->at(selectedPoint).x) + ";" +
                     gd::String::From(path->at(selectedPoint).y));
      } else if (menuSelection == positionBtID) {
        int posX = gd::String(wxGetTextFromUser(
                                  _("X position:"),
                                  _("Position precisely"),
                                  gd::String::From(path->at(selectedPoint).x),
                                  this))
                       .To<int>();
        int posY = gd::String(wxGetTextFromUser(
                                  _("Y position:"),
                                  _("Position precisely"),
                                  gd::String::From(path->at(selectedPoint).y),
                                  this))
        ...
        if (selectedPoint < (path->size() - 1)) {
          path->insert(path->begin() + selectedPoint + 1,
                       sf::Vector2f((path->at(selectedPoint) +
                                     path->at(selectedPoint + 1)) /
                                    2.f));
        }
...
void PathBehaviorEditor::OnBitmapButton6Click1(wxCommandEvent& event) {
  int menuSelection = BitmapButton6->GetPopupMenuSelectionFromUser(
      advanceAddMenu, 0, BitmapButton6->GetSize().GetHeight() - 1);
...
int PathBehaviorEditor::GetSegmentOnMouse(wxMouseEvent& event) {
  ...
  for (std::size_t a = 0; a < path->size() - 1; a++) {
    ...
    float ratioX = static_cast<float>(deltaX) /
                   static_cast<float>(posOfMouse.x - pointPosX1);
    float ratioY = static_cast<float>(deltaY) /
                   static_cast<float>(posOfMouse.y - pointPosY1);

    if (((posOfMouse.x > pointPosX1 && posOfMouse.x < pointPosX2) ||
         (posOfMouse.x < pointPosX1 && posOfMouse.x > pointPosX2)) &&
        ((posOfMouse.y > pointPosY1 && posOfMouse.y < pointPosY2) ||
         (posOfMouse.y < pointPosY1 && posOfMouse.y > pointPosY2)) &&
        (ratioY > (ratioX - 0.7)) && (ratioY < (ratioX + 0.7)))
      return a;
    else if (((posOfMouse.y > pointPosY1 && posOfMouse.y < pointPosY2) ||
              (posOfMouse.y < pointPosY1 && posOfMouse.y > pointPosY2)) &&
...
void PathBehaviorEditor::UpdateContextMessage() {
  if (previewPnlState.state == NOTHING) {
    ...
    contextMessageLabel->SetLabelText(
        _("Release the button to validate point's position."));
  } else if (previewPnlState.state == ADDING) {
    contextMessageLabel->SetLabelText(
        _("Add a point by clicking with the mouse. Clic on a segment to add a "
          "point to it."));
  } else if (previewPnlState.state == REMOVING) {
    contextMessageLabel->SetLabelText(
        _("Delete a point by clicking on it with the cursor."));
  } else if (previewPnlState.state == VIEWMOVING) {
    contextMessageLabel->SetLabelText(
        _("Drag the mouse to make the view scroll."));
  } else if (previewPnlState.state == ADDINGPOINTAFTER) {
    contextMessageLabel->SetLabelText(
        _("Click on a point to add a new point after."));
  } else if (previewPnlState.state == ADDINGPOINTBEFORE) {
    contextMessageLabel->SetLabelText(
        _("Click on a point to add a new point before."));
  }
}
...
void PathBehaviorEditor::OnBitmapButton6Click(wxCommandEvent& event) {
  if (ToggleButton1->GetValue()) {
    wxString filename = wxLoadFileSelector(_("Choose an image to be displayed"),
    ...
    if (!filename.empty()) {
      ...
      previewPnlState.backgroundBitmap =
          new wxBitmap(filename, wxBITMAP_TYPE_ANY);
