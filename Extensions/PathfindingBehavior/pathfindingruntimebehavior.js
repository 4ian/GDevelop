...
gdjs.PathfindingRuntimeBehavior.prototype = Object.create(
  gdjs.RuntimeBehavior.prototype
);
gdjs.PathfindingRuntimeBehavior.thisIsARuntimeBehaviorConstructor =
...
gdjs.PathfindingRuntimeBehavior.prototype.setAcceleration = function(
  acceleration
) {
...
gdjs.PathfindingRuntimeBehavior.prototype.setAngularMaxSpeed = function(
  angularMaxSpeed
) {
...
gdjs.PathfindingRuntimeBehavior.prototype.setAngleOffset = function(
  angleOffset
) {
...
gdjs.PathfindingRuntimeBehavior.prototype.setExtraBorder = function(
  extraBorder
) {
...
gdjs.PathfindingRuntimeBehavior.prototype.getNextNodeIndex = function() {
  ...
  else return this._path.length - 1;
};
...
gdjs.PathfindingRuntimeBehavior.prototype.getLastNodeX = function() {
  ...
  else return this._path[this._path.length - 1][0];
};
gdjs.PathfindingRuntimeBehavior.prototype.getLastNodeY = function() {
  ...
  else return this._path[this._path.length - 1][1];
};
 ...
 */
gdjs.PathfindingRuntimeBehavior.prototype.moveTo = function(
  runtimeScene,
  x,
  y
) {
  ...
  if (this._searchContext.computePathTo(x, y)) {
    ...
    while (node) {
      if (finalPathLength === this._path.length) this._path.push([0, 0]);
...
gdjs.PathfindingRuntimeBehavior.prototype._enterSegment = function(
  segmentNumber
) {
...
gdjs.PathfindingRuntimeBehavior.prototype.doStepPreEvents = function(
  runtimeScene
) {
  ...
  } else newPos = this._path[this._path.length - 1];
...
gdjs.PathfindingRuntimeBehavior.prototype.doStepPostEvents = function(
  runtimeScene
) {
...
gdjs.PathfindingRuntimeBehavior.Node = function(xPos, yPos) {
  if (this.pos === undefined) this.pos = [xPos, yPos];
  else {
    this.pos[0] = xPos;
    this.pos[1] = yPos;
  }
...
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype.setObstacles = function(
  obstacles
) {
...
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype.allowDiagonals = function(
  allowDiagonals
) {
...
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype.setStartPosition = function(
  x,
  y
) {
  this._startX = x;
...
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype.setObjectSize = function(
  leftBorder,
  topBorder,
  rightBorder,
  bottomBorder
...
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype.setCellSize = function(
  cellWidth,
  cellHeight
) {
...
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype.computePathTo = function(
  targetX,
  targetY
) {
 ...
 */
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype._insertNeighbors = function(
  currentNode
) {
 ...
 */
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype._getNode = function(
  xPos,
  yPos
) {
  ...
  } else newNode = new gdjs.PathfindingRuntimeBehavior.Node(xPos, yPos);
  ...
  for (var k = 0; k < this._closeObstacles.length; ++k) {
    ...
    var topLeftCellX = Math.floor(
      (obj.getDrawableX() - this._rightBorder) / this._cellWidth
    );
    var topLeftCellY = Math.floor(
      (obj.getDrawableY() - this._bottomBorder) / this._cellHeight
    );
    var bottomRightCellX = Math.ceil(
      (obj.getDrawableX() + obj.getWidth() + this._leftBorder) / this._cellWidth
    );
    var bottomRightCellY = Math.ceil(
    ...
    if (
      ...
      else newNode.cost += this._closeObstacles[k].getCost();
    }
  }
 ...
 */
gdjs.PathfindingRuntimeBehavior.SearchContext.prototype._addOrUpdateNode = function(
  newNodeX,
  newNodeY,
  currentNode,
  factor
