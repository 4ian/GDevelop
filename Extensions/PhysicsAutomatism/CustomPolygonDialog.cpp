    ...
    polygonHeight(polygonSize.y)
{
	...
	StaticBoxSizer3 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Redimensionnement"));
	FlexGridSizer9 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer9->AddGrowableCol(0);
	autoResizingCheckBox = new wxCheckBox(this, ID_CHECKBOX1, _("Etirer automatiquement en fonction de la taille de l\'objet"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
	...
	StaticText3 = new wxStaticText(this, ID_STATICTEXT5, _("Pour que le polygone s\'étire en fonction de la taille de l\'objet, il faut définir le rectangle correspondant à la taille initiale de l\'objet."), wxDefaultPosition, wxSize(291,47), wxST_NO_AUTORESIZE, _T("ID_STATICTEXT5"));
	StaticText3->Disable();
	...
	StaticText4 = new wxStaticText(this, ID_STATICTEXT6, _("Largeur:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
	StaticText4->Disable();
	...
	StaticText5 = new wxStaticText(this, ID_STATICTEXT7, _("Hauteur:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	StaticText5->Disable();
	...
	StaticBoxSizer4 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("Outils"));
	FlexGridSizer11 = new wxFlexGridSizer(0, 4, 0, 0);
	Button1 = new wxButton(this, ID_BUTTON2, _("Décaler..."), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
	Button1->SetToolTip(_("Décaler la forme"));
	FlexGridSizer11->Add(Button1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	Button2 = new wxButton(this, ID_BUTTON3, _("Agrandir..."), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
	Button2->SetToolTip(_("Agrandir la forme"));
	...
	Button3->SetToolTip(_("Tourner le polygone par rapport à un point"));
	FlexGridSizer11->Add(Button3, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 2);
	Button4 = new wxButton(this, ID_BUTTON5, _("Arrondir..."), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
	Button4->SetToolTip(_("Arrondir les coordonnées"));
	...
	pointLabelTxt = new wxStaticText(this, ID_STATICTEXT4, _("Le point indique l\'origine de l\'objet."), wxDefaultPosition, wxSize(277,13), 0, _T("ID_STATICTEXT4"));
...
{
    wxString xOffsetStr = wxGetTextFromUser(_("Décalage en X"), _("Décaler..."), "0", this);
    wxString yOffsetStr = wxGetTextFromUser(_("Décalage en Y"), _("Décaler..."), "0", this);
...
{
    wxString xScaleStr = wxGetTextFromUser(_("Agrandissement (échelle) en X"), _("Agrandir..."), "1", this);
    wxString yScaleStr = wxGetTextFromUser(_("Agrandissement (échelle) en Y"), _("Agrandir..."), "1", this);
...
{
    wxString angleStr = wxGetTextFromUser(_("Angle de rotation\nUn angle positif donnera une rotation dans le sens des aiguilles d'une montre."), _("Rotation..."), "0", this);
    wxString originStr = wxGetTextFromUser(_("Point par rapport auquel effectuer la rotation.\nTapez le sous forme x;y .\nLe point 0;0 correspond au point dessiné sur l'aperçu du polygone."), _("Rotation..."), "0;0", this);
    int precision = wxGetNumberFromUser(_("La précision définit le nombre de chiffre après la virgule des coordonnées après le calcul"), _("Précision du résultat"), _("Rotation..."), 2, 0, 10, this);
...
{
    int precision = wxGetNumberFromUser(_("La précision des nombres n'est pas garantie au-dela de 8 chiffres derrière la virgule."), _("Nombre de chiffres après la virgule"), _("Arrondir..."), 2, 0, 10, this);
