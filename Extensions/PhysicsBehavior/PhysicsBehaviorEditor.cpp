...
PhysicsBehaviorEditor::PhysicsBehaviorEditor(
    ...
    gd::Project& game_,
    gd::Layout* scene_,
    PhysicsBehavior& behavior_,
    gd::MainFrameWrapper& mainFrameWrapper_)
    : behavior(behavior_), game(game_), scene(scene_) {
  ...
  StaticBoxSizer1 =
      new wxStaticBoxSizer(wxHORIZONTAL, this, _("Initial parameters"));
  ...
  rectCheck = new wxRadioButton(this,
                                ID_RADIOBUTTON1,
                                _("Rectangle"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  FlexGridSizer13->Add(
      ...
      5);
  circleCheck = new wxRadioButton(this,
                                  ID_RADIOBUTTON2,
                                  _("Circle"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer13->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  polygonCheck = new wxRadioButton(this,
                                   ID_RADIOBUTTON3,
                                   _("Custom polygon"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
  ...
  staticCheck = new wxCheckBox(this,
                               ID_CHECKBOX1,
                               _("Static object"),
                               wxDefaultPosition,
                               wxDefaultSize,
  ...
  FlexGridSizer11->Add(
      staticCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  fixedRotationCheck = new wxCheckBox(this,
                                      ID_CHECKBOX3,
                                      _("Fixed rotation"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
  ...
  FlexGridSizer2->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  bulletCheck = new wxCheckBox(
      this,
      ID_CHECKBOX2,
      _("Comparable to a projectile (better collision handling, but slower)"),
      wxDefaultPosition,
      wxDefaultSize,
      0,
      wxDefaultValidator,
  ...
  FlexGridSizer2->Add(
      bulletCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  massDensityEdit = new wxTextCtrl(this,
                                   ID_TEXTCTRL1,
                                   _("1"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
  ...
  frictionEdit = new wxTextCtrl(this,
                                ID_TEXTCTRL2,
                                _("0.8"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  StaticText12 = new wxStaticText(this,
                                  ID_STATICTEXT12,
                                  _("Restitution ( Elasticity ) :"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  0,
                                  _T("ID_STATICTEXT12"));
  FlexGridSizer12->Add(
      StaticText12, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  restitutionEdit = new wxTextCtrl(this,
                                   ID_TEXTCTRL9,
                                   _("0"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
  ...
  linearDampingEdit = new wxTextCtrl(this,
                                     ID_TEXTCTRL7,
                                     _("0.1"),
                                     wxDefaultPosition,
                                     wxDefaultSize,
  ...
  StaticText10 = new wxStaticText(this,
                                  ...
                                  _T("ID_STATICTEXT10"));
  FlexGridSizer10->Add(
      StaticText10, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  angularDampingEdit = new wxTextCtrl(this,
                                      ID_TEXTCTRL8,
                                      _("0.1"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
  ...
  StaticBoxSizer2 = new wxStaticBoxSizer(
      wxHORIZONTAL, this, _("Global parameters of physics engine"));
  FlexGridSizer4 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer4->AddGrowableCol(0);
  StaticText3 = new wxStaticText(this,
                                 ID_STATICTEXT3,
                                 _("Gravity coordinates :"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT3"));
  ...
  gravityXEdit = new wxTextCtrl(this,
                                ID_TEXTCTRL3,
                                _("0"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  BoxSizer1->Add(
      ...
      5);
  gravityYEdit = new wxTextCtrl(this,
                                ID_TEXTCTRL4,
                                _("0"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  FlexGridSizer6->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  scaleXEdit = new wxTextCtrl(this,
                              ID_TEXTCTRL5,
                              _("0"),
                              wxDefaultPosition,
                              wxDefaultSize,
  ...
  FlexGridSizer6->Add(
      ...
      wxTOP | wxBOTTOM | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  scaleYEdit = new wxTextCtrl(this,
                              ID_TEXTCTRL6,
                              _("0"),
                              wxDefaultPosition,
                              wxDefaultSize,
  ...
  StaticText8 = new wxStaticText(this,
                                 ...
                                 0,
                                 _T("ID_STATICTEXT8"));
  FlexGridSizer6->Add(StaticText8,
                      1,
  ...
  Connect(ID_RADIOBUTTON1,
          ...
          (wxObjectEventFunction)&PhysicsBehaviorEditor::OnrectCheckSelect);
  Connect(ID_RADIOBUTTON2,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&PhysicsBehaviorEditor::OncircleCheckSelect);
  Connect(ID_RADIOBUTTON3,
          wxEVT_COMMAND_RADIOBUTTON_SELECTED,
          (wxObjectEventFunction)&PhysicsBehaviorEditor::OnpolygonCheckSelect);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PhysicsBehaviorEditor::OnpolygonBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PhysicsBehaviorEditor::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&PhysicsBehaviorEditor::OncancelBtClick);
  //*)
  ...
  sharedDatas = std::dynamic_pointer_cast<ScenePhysicsDatas>(
...
void PhysicsBehaviorEditor::OnokBtClick(wxCommandEvent& event) {
  ...
  behavior.averageRestitution =
      gd::String(restitutionEdit->GetValue()).To<float>();
  behavior.linearDamping =
      gd::String(linearDampingEdit->GetValue()).To<float>();
  behavior.angularDamping =
      gd::String(angularDampingEdit->GetValue()).To<float>();
  behavior.polygonPositioning =
      static_cast<PhysicsBehavior::Positioning>(positioning);
...
void PhysicsBehaviorEditor::OnpolygonBtClick(wxCommandEvent& event) {
  CustomPolygonDialog dialog(this,
                             coordsVector,
                             positioning,
                             sf::Vector2f(polygonWidth, polygonHeight),
                             automaticResizing);
  dialog.ShowModal();
