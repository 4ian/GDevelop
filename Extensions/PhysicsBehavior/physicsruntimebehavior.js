...
gdjs.PhysicsSharedData.gdjsCallbackRuntimeSceneUnloaded = function(
  runtimeScene
) {
...
gdjs.PhysicsRuntimeBehavior = function(runtimeScene, behaviorData, owner) {
  ...
  if (this.currentContacts !== undefined) this.currentContacts.length = 0;
  else this.currentContacts = [];

  this._sharedData = gdjs.PhysicsSharedData.getSharedData(
    runtimeScene,
    behaviorData.name
  );
...
gdjs.PhysicsRuntimeBehavior.prototype = Object.create(
  gdjs.RuntimeBehavior.prototype
);
gdjs.PhysicsRuntimeBehavior.thisIsARuntimeBehaviorConstructor =
...
gdjs.PhysicsRuntimeBehavior.prototype.doStepPostEvents = function(
  runtimeScene
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.applyImpulse = function(
  xCoordinate,
  yCoordinate
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.applyImpulseUsingPolarCoordinates = function(
  angle,
  length
) {
...
gdjs.PhysicsRuntimeBehavior.prototype.applyImpulseTowardPosition = function(
  xPosition,
  yPosition,
  length
) {
...
gdjs.PhysicsRuntimeBehavior.prototype.applyForce = function(
  xCoordinate,
  yCoordinate
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.applyForceUsingPolarCoordinates = function(
  angle,
  length
) {
  angle = gdjs.toRad(angle);
...
gdjs.PhysicsRuntimeBehavior.prototype.applyForceTowardPosition = function(
  xPosition,
  yPosition,
  length
) {
...
gdjs.PhysicsRuntimeBehavior.prototype.setLinearVelocity = function(
  xVelocity,
  yVelocity
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.setAngularVelocity = function(
  angularVelocity
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.setLinearDamping = function(
  linearDamping
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.setAngularDamping = function(
  angularDamping
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.addRevoluteJointBetweenObjects = function(
  object,
  scene,
...
gdjs.PhysicsRuntimeBehavior.prototype.addRevoluteJoint = function(
  xPosition,
  yPosition
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.setGravity = function(
  xGravity,
  yGravity
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.addGearJointBetweenObjects = function(
  object,
  ratio
) {
  if (this._box2DBody === null) this.createBody();
...
gdjs.PhysicsRuntimeBehavior.prototype.collisionWith = function(
  otherObjectsTable
) {
  if (this._box2DBody === null) this.createBody();
  ...
  var objects = gdjs.staticArray(
    gdjs.PhysicsRuntimeBehavior.prototype.collisionWith
  );
  objects.length = 0;

  var objectsLists = gdjs.staticArray2(
    gdjs.PhysicsRuntimeBehavior.prototype.collisionWith
  );
  ...
  for (var i = 0, len = objects.length; i < len; ++i) {
    for (var j = 0, lenj = this.currentContacts.length; j < lenj; ++j) {
      if (this.currentContacts[j].owner.id === objects[i].id) return true;
    }
  }
