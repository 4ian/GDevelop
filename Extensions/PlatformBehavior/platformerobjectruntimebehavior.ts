    ...
    private _updatePotentialCollidingObjects(maxMovementLength: float) {
      ...
      for (let i = 0; i < this._potentialCollidingObjects.length; ) {
        ...
        if (
          ...
          // Filter platform that not in the searched area anymore.
          // This can happen because the platform are not updated in the RBush before that
          // the character movement is processed.
