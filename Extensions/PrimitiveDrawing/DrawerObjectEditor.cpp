...
object(object_)
{
	...
	StaticText5 = new wxStaticText(this, ID_STATICTEXT5, _("Opacité :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	...
	StaticText2 = new wxStaticText(this, ID_STATICTEXT2, _("Opacité :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	...
	coordinatesRadio = new wxRadioBox(this, ID_RADIOBOX1, _("Coordonnées de dessin"), wxDefaultPosition, wxDefaultSize, 2, __wxRadioBoxChoices_1, 1, 0, wxDefaultValidator, _T("ID_RADIOBOX1"));
...
/**
 * Click on Ok : Update the object accordint to the editor.
 */
