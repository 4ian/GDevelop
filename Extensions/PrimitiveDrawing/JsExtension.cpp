...
public:
    ...
    PrimitiveDrawingJsExtension()
    {
        ...
        GetObjectMetadata("PrimitiveDrawing::Drawer")
            .SetIncludeFile("Extensions/PrimitiveDrawing/shapepainterruntimeobject.js")
            .AddIncludeFile("Extensions/PrimitiveDrawing/shapepainterruntimeobject-pixi-renderer.js")
            .AddIncludeFile("Extensions/PrimitiveDrawing/shapepainterruntimeobject-cocos-renderer.js");
