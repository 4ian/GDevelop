...
ShapePainterObjectEditor::ShapePainterObjectEditor(wxWindow* parent,
                                                   gd::Project& game_,
  ...
  Create(parent,
         wxID_ANY,
         _("Edit the Shape Painter object"),
         wxDefaultPosition,
         wxDefaultSize,
  ...
  fillOpacityEdit = new wxSpinCtrl(this,
                                   ID_SPINCTRL3,
                                   _T("255"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
  ...
  outlineColorBt = new wxButton(this,
                                ID_BUTTON3,
                                _("Choose the color"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  outlineOpacityEdit = new wxSpinCtrl(this,
                                      ID_SPINCTRL2,
                                      _T("255"),
                                      wxDefaultPosition,
                                      wxDefaultSize,
  ...
  outlineSizeEdit = new wxSpinCtrl(this,
                                   ID_SPINCTRL1,
                                   _T("1"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
  ...
  wxString __wxRadioBoxChoices_1[2] = {
      _("Absolute"), _("Relative to the position of the Shape Painter object")};
  coordinatesRadio = new wxRadioBox(this,
                                    ID_RADIOBOX1,
                                    _("Drawing coordinates"),
                                    wxDefaultPosition,
                                    wxDefaultSize,
                                    2,
                                    __wxRadioBoxChoices_1,
                                    1,
                                    wxRA_HORIZONTAL,
                                    wxDefaultValidator,
                                    _T("ID_RADIOBOX1"));
  ...
  Connect(ID_BUTTON1,
          ...
          (wxObjectEventFunction)&ShapePainterObjectEditor::OnfillColorBtClick);
  Connect(
      ID_BUTTON3,
      wxEVT_COMMAND_BUTTON_CLICKED,
      (wxObjectEventFunction)&ShapePainterObjectEditor::OnoutlineColorBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ShapePainterObjectEditor::OnokBtClick);
  Connect(ID_BUTTON4,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&ShapePainterObjectEditor::OncancelBtClick);
  //*)

  fillOpacityEdit->SetValue(object.GetFillOpacity());
  fillColorBt->SetBackgroundColour(wxColour(
      object.GetFillColorR(), object.GetFillColorG(), object.GetFillColorB()));

  outlineSizeEdit->SetValue(object.GetOutlineSize());
  outlineOpacityEdit->SetValue(object.GetOutlineOpacity());
  outlineColorBt->SetBackgroundColour(wxColour(object.GetOutlineColorR(),
                                               object.GetOutlineColorG(),
                                               object.GetOutlineColorB()));

  if (!object.AreCoordinatesAbsolute()) coordinatesRadio->SetSelection(1);
}
...
void ShapePainterObjectEditor::OnokBtClick(wxCommandEvent& event) {
  ...
  object.SetFillColor(
      static_cast<int>(fillColorBt->GetBackgroundColour().Red()),
  ...
  object.SetOutlineColor(
      static_cast<int>(outlineColorBt->GetBackgroundColour().Red()),
  ...
  if (coordinatesRadio->GetSelection() == 1) object.SetCoordinatesRelative();
...
void ShapePainterObjectEditor::OnfillColorBtClick(wxCommandEvent& event) {
  wxColour color =
      wxGetColourFromUser(this, fillColorBt->GetBackgroundColour());
  if (color.IsOk()) {
...
void ShapePainterObjectEditor::OnoutlineColorBtClick(wxCommandEvent& event) {
  wxColour color =
      wxGetColourFromUser(this, outlineColorBt->GetBackgroundColour());
  if (color.IsOk()) {
