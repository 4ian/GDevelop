gdjs.ShapePainterRuntimeObjectCocosRenderer = function(
  runtimeObject,
  runtimeScene
) {
...
gdjs.ShapePainterRuntimeObjectRenderer =
  gdjs.ShapePainterRuntimeObjectCocosRenderer; //Register the class to let the engine use it.
...
gdjs.ShapePainterRuntimeObjectCocosRenderer.prototype.drawRectangle = function(
  x1,
  y1,
  x2,
  y2
...
gdjs.ShapePainterRuntimeObjectCocosRenderer.prototype.drawCircle = function(
  x,
  y,
  radius
) {
...
gdjs.ShapePainterRuntimeObjectCocosRenderer.prototype.drawLine = function(
  x1,
  y1,
  x2,
  y2,
