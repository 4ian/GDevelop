gdjs.ShapePainterRuntimeObjectPixiRenderer = function(
  runtimeObject,
  runtimeScene
) {
...
gdjs.ShapePainterRuntimeObjectRenderer =
  gdjs.ShapePainterRuntimeObjectPixiRenderer; //Register the class to let the engine use it.
...
gdjs.ShapePainterRuntimeObjectPixiRenderer.prototype.drawRectangle = function(
  x1,
  y1,
  x2,
  y2
...
gdjs.ShapePainterRuntimeObjectPixiRenderer.prototype.drawCircle = function(
  x,
  y,
  radius
) {
...
gdjs.ShapePainterRuntimeObjectPixiRenderer.prototype.drawLine = function(
  x1,
  y1,
  x2,
  y2,
