...
gdjs.ShapePainterRuntimeObject = function(runtimeScene, objectData) {
  ...
  this._fillColor = parseInt(
    gdjs.rgbToHex(
      objectData.fillColor.r,
      objectData.fillColor.g,
      objectData.fillColor.b
    ),
    16
  );
  this._outlineColor = parseInt(
    gdjs.rgbToHex(
      objectData.outlineColor.r,
      objectData.outlineColor.g,
      objectData.outlineColor.b
    ),
    16
  );
  ...
  if (this._renderer)
    gdjs.ShapePainterRuntimeObjectRenderer.call(
      this._renderer,
      this,
      runtimeScene
    );
...
gdjs.ShapePainterRuntimeObject.prototype = Object.create(
  gdjs.RuntimeObject.prototype
);
gdjs.ShapePainterRuntimeObject.thisIsARuntimeObjectConstructor =
...
gdjs.ShapePainterRuntimeObject.prototype.stepBehaviorsPreEvents = function(
  runtimeScene
) {
...
gdjs.ShapePainterRuntimeObject.prototype.drawRectangle = function(
  x1,
  y1,
  x2,
  y2
...
gdjs.ShapePainterRuntimeObject.prototype.drawLine = function(
  x1,
  y1,
  x2,
  y2,
