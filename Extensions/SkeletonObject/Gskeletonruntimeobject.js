...
gdjs.SkeletonRuntimeObject.prototype = Object.create(
  gdjs.RuntimeObject.prototype
);
gdjs.SkeletonRuntimeObject.thisIsARuntimeObjectConstructor =
  "SkeletonObject::Skeleton";

gdjs.SkeletonRuntimeObject.prototype.extraInitializationFromInitialInstance = function(
  initialInstanceData
) {
...
gdjs.SkeletonRuntimeObject.prototype.getSkeletonData = function(
  runtimeScene,
  objectData
) {
  var skeletonData = this.manager.getSkeleton(
    runtimeScene,
    this.name,
    objectData
  );
...
gdjs.SkeletonRuntimeObject.prototype.stepBehaviorsPreEvents = function(
  runtimeScene
) {
...
gdjs.SkeletonRuntimeObject.prototype.getDrawableX = function() {
  return (
    this.getX() - this.rootArmature.shared.aabb[0][0] * Math.abs(this.scaleX)
  );
};
gdjs.SkeletonRuntimeObject.prototype.getDrawableY = function() {
  return (
    this.getY() - this.rootArmature.shared.aabb[0][1] * Math.abs(this.scaleY)
  );
};
...
gdjs.SkeletonRuntimeObject.prototype.setAnimationIndex = function(
  newAnimation,
  blendTime = 0,
  loops = -1
) {
...
gdjs.SkeletonRuntimeObject.prototype.setAnimationName = function(
  newAnimation,
  blendTime = 0,
  loops = -1
) {
...
gdjs.SkeletonRuntimeObject.prototype.setAnimationTimeScale = function(
  timeScale
) {
...
gdjs.SkeletonRuntimeObject.prototype.setBoneScaleX = function(
  bonePath,
  scaleX
) {
  var bone = this.getBone(bonePath);
...
gdjs.SkeletonRuntimeObject.prototype.setBoneScaleY = function(
  bonePath,
  scaleY
) {
  var bone = this.getBone(bonePath);
...
gdjs.SkeletonRuntimeObject.prototype.setSlotVisible = function(
  slotPath,
  visible
) {
  var slot = this.getSlot(slotPath);
...
gdjs.SkeletonRuntimeObject.prototype.isPointInsideSlot = function(
  slotPath,
  x,
  y
) {
  ...
  for (var i = 0; i < this.hitBoxes.length; ++i) {
    if (gdjs.Polygon.isPointInside(hitBoxes[i], x, y)) return true;
  }
...
gdjs.SkeletonRuntimeObject.prototype.raycastSlot = function(
  slotPath,
  x,
  y,
  angle,
...
gdjs.SkeletonRuntimeObject.slotObjectCollisionTest = function(
  skl,
  obj,
  slotPath
) {
...
gdjs.SkeletonRuntimeObject.slotSlotCollisionTest = function(
  skl1,
  skl2,
  slotPaths
) {
