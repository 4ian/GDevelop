...
SoundObjectEditor::SoundObjectEditor(wxWindow* parent,
                                     gd::Project& game_,
                                     SoundObject& object_)
    : game(game_), object(object_) {
  ...
  MusicRadioBt = new wxRadioButton(Panel1,
                                   ID_RADIOBUTTON2,
                                   _("Music"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
                                   ...
                                   wxDefaultValidator,
                                   _T("ID_RADIOBUTTON2"));
  MusicRadioBt->SetToolTip(
      _("Load the content of the sound file only partially when the sound is "
        "played. Useful for long sounds and musics."));
  StaticBoxSizer4->Add(
      MusicRadioBt,
      1,
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  SoundRadioBt = new wxRadioButton(Panel1,
                                   ID_RADIOBUTTON1,
                                   _("Sound"),
                                   wxDefaultPosition,
                                   wxDefaultSize,
                                   ...
                                   wxDefaultValidator,
                                   _T("ID_RADIOBUTTON1"));
  SoundRadioBt->SetToolTip(
      _("The sound file is entirely loaded into memory so as to be quicly "
        "played. Adapted to small sounds and noises."));
  StaticBoxSizer4->Add(
      SoundRadioBt, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer2->Add(
      StaticBoxSizer4, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer2->Add(
      -1,
      -1,
      1,
  ...
  StaticText6 = new wxStaticText(
      Panel1,
      ID_STATICTEXT6,
      _("\"Music\" mode is more appropriate for long sound file, during more "
        "than 10 seconds:\nThe sound file is only partially loaded in memory "
        "when it is played.\n\"Sound\" mode is to be used with smaller sound "
        "file, as the sound files are in this case\ntotally loaded into the "
        "memory."),
      wxDefaultPosition,
      wxDefaultSize,
      0,
      _T("ID_STATICTEXT6"));
  wxFont StaticText6Font(8,
  ...
  StaticText7 = new wxStaticText(Panel1,
                                 ID_STATICTEXT7,
                                 _("Sound spatialisation is only available for "
                                   "\"mono\" sound ( and not stereo ones )."),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT7"));
  wxFont StaticText7Font(8,
                         wxFONTFAMILY_DEFAULT,
                         wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_NORMAL,
                         false,
  ...
  FlexGridSizer2->Add(
      StaticBoxSizer3,
      1,
      wxALL | wxEXPAND | wxALIGN_BOTTOM | wxALIGN_CENTER_HORIZONTAL,
      5);
  Panel1->SetSizer(FlexGridSizer2);
  FlexGridSizer2->Fit(Panel1);
  FlexGridSizer2->SetSizeHints(Panel1);
  Panel2 = new wxPanel(Notebook1,
                       ID_PANEL2,
                       wxDefaultPosition,
                       wxDefaultSize,
                       wxTAB_TRAVERSAL,
  ...
  StaticText1 = new wxStaticText(Panel2,
                                 ID_STATICTEXT1,
                                 _("Sound level:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  VolumeSpinCtrl = new wxSpinCtrl(Panel2,
                                  ID_SPINCTRL1,
                                  _T("0"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  FlexGridSizer4->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText2 = new wxStaticText(Panel2,
                                 ID_STATICTEXT2,
                                 _("Pitch:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  pitchTextCtrl = new wxTextCtrl(Panel2,
                                 ID_TEXTCTRL3,
                                 _("1"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  FlexGridSizer4->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText3 = new wxStaticText(Panel2,
                                 ID_STATICTEXT3,
                                 _("Minimal distance:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  MinDistanceSpinCtrl = new wxSpinCtrl(Panel2,
                                       ID_SPINCTRL3,
                                       _T("1"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
  ...
  FlexGridSizer4->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  StaticText4 = new wxStaticText(Panel2,
                                 ID_STATICTEXT4,
                                 _("Attenuation:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  AttenuationSpinCtrl = new wxTextCtrl(Panel2,
                                       ID_TEXTCTRL2,
                                       _("1"),
                                       wxDefaultPosition,
                                       wxDefaultSize,
  ...
  FlexGridSizer4->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  LoopCheckBox = new wxCheckBox(Panel2,
                                ID_CHECKBOX1,
                                _("Loop"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  StaticText5 = new wxStaticText(Panel2,
                                 ID_STATICTEXT5,
                                 _("Name of the sound file:"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT5"));
  ...
  FileNameTextCtrl = new wxTextCtrl(Panel2,
                                    ID_TEXTCTRL1,
                                    wxEmptyString,
                                    wxDefaultPosition,
                                    wxSize(99, 21),
                                    ...
                                    wxDefaultValidator,
                                    _T("ID_TEXTCTRL1"));
  FlexGridSizer5->Add(FileNameTextCtrl,
                      1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
                      5);
  Button1 = new wxButton(Panel2,
                         ID_BUTTON2,
                         _("..."),
                         wxDefaultPosition,
                         wxSize(30, 23),
  ...
  ValidateButton = new wxButton(this,
                                ID_BUTTON1,
                                _("Ok"),
                                wxDefaultPosition,
                                wxDefaultSize,
  ...
  Connect(ID_BUTTON2,
          ...
          (wxObjectEventFunction)&SoundObjectEditor::OnButton1Click);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&SoundObjectEditor::OnValidateButtonClick);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&SoundObjectEditor::OnButton2Click);
  //*)

  VolumeSpinCtrl->SetValue(object.GetVolume());
  AttenuationSpinCtrl->SetValue(
      wxString(gd::String::From(object.GetAttenuation()).c_str()));
  pitchTextCtrl->SetValue(
      wxString(gd::String::From(object.GetPitch()).c_str()));
...
void SoundObjectEditor::OnValidateButtonClick(wxCommandEvent& event) {
  ...
  object.SetAttenuation(
      gd::String(AttenuationSpinCtrl->GetValue()).To<float>());
...
void SoundObjectEditor::OnButton2Click(wxCommandEvent& event) { EndModal(0); }
