...
object(object_)
{
	...
	Create(parent, wxID_ANY, _("Editer l\'objet son"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER, _T("wxID_ANY"));
	...
	StaticBoxSizer1 = new wxStaticBoxSizer(wxHORIZONTAL, Panel2, _("Propriétés sonores"));
	FlexGridSizer4 = new wxFlexGridSizer(5, 2, 0, 0);
	FlexGridSizer4->AddGrowableCol(1);
	StaticText1 = new wxStaticText(Panel2, ID_STATICTEXT1, _("Volume :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	StaticText2 = new wxStaticText(Panel2, ID_STATICTEXT2, _("Pitch (1:100) :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	...
	StaticText3 = new wxStaticText(Panel2, ID_STATICTEXT3, _("Distance minimale :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	...
	StaticText4 = new wxStaticText(Panel2, ID_STATICTEXT4, _("Atténuation :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	...
	LoopCheckBox = new wxCheckBox(Panel2, ID_CHECKBOX1, _("Jouer en boucle"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
	...
	StaticBoxSizer2 = new wxStaticBoxSizer(wxHORIZONTAL, Panel2, _("Nom du fichier"));
	FlexGridSizer5 = new wxFlexGridSizer(1, 3, 0, 0);
	FlexGridSizer5->AddGrowableCol(1);
	StaticText5 = new wxStaticText(Panel2, ID_STATICTEXT5, _("Nom du fichier son :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	...
	Button1->SetToolTip(_("Parcourir"));
