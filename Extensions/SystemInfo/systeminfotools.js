...
gdjs.evtTools.systemInfo = {
  ...
  /** @type {?boolean} */
  _cachedHasTouchScreen: null,
};

/** @returns {boolean} */
gdjs.evtTools.systemInfo._checkIsMobile = function () {
  // @ts-ignore
...
gdjs.evtTools.systemInfo.isMobile = function () {
  if (gdjs.evtTools.systemInfo._cachedIsMobile !== null) {
    return gdjs.evtTools.systemInfo._cachedIsMobile;
  }

  return (gdjs.evtTools.systemInfo._cachedIsMobile = gdjs.evtTools.systemInfo._checkIsMobile());
};

/** @returns {boolean} */
gdjs.evtTools.systemInfo._checkHasTouchScreen = function () {
 ...
 */
gdjs.evtTools.systemInfo.hasTouchScreen = function () {
  if (gdjs.evtTools.systemInfo._cachedHasTouchScreen !== null) {
    return gdjs.evtTools.systemInfo._cachedHasTouchScreen;
  }

  return (gdjs.evtTools.systemInfo._cachedHasTouchScreen = gdjs.evtTools.systemInfo._checkHasTouchScreen());
};
