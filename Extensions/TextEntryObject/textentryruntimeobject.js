...
gdjs.TextEntryRuntimeObject = function(runtimeScene, objectData) {
  ...
  if (this._renderer)
    gdjs.TextEntryRuntimeObjectRenderer.call(
      this._renderer,
      this,
      runtimeScene
    );
...
gdjs.TextEntryRuntimeObject.prototype = Object.create(
  gdjs.RuntimeObject.prototype
);
gdjs.TextEntryRuntimeObject.thisIsARuntimeObjectConstructor =
  "TextEntryObject::TextEntry";

gdjs.TextEntryRuntimeObject.prototype.onDeletedFromScene = function(
  runtimeScene
) {
