namespace gdjs {
   ...
   */
   export const extractTileUidFlippedStates = (globalTileUid: integer): TiledGID => {
    ...
    return {id: tileUid, flippedHorizontally: !!flippedHorizontally, flippedVertically: !!flippedVertically, flippedDiagonally: !!flippedDiagonally};
  };
  }
}