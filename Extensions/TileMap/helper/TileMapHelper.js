(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TileMapHelper = {}, global.PIXI));
    ...
    var TileTextureCache = /** @class */ (function () {
        ...
        TileTextureCache.prototype.findTileTexture = function (tileId, flippedHorizontally, flippedVertically, flippedDiagonally) {
            ...
            var flippedTexture = new PIXI__namespace.Texture(unflippedTexture.baseTexture, frame, orig, trim, rotate);
    ...
    var PixiTileMapHelper = /** @class */ (function () {
        ...
        PixiTileMapHelper.parseAtlas = function (tiledData, atlasTexture, getTexture) {
            ...
            for (var frame = 0; frame < tilecount; frame++) {
                ...
                try {
                    var rect = new PIXI__namespace.Rectangle(x, y, tilewidth, tileheight);
                    var texture = new PIXI__namespace.Texture(atlasTexture, rect);
    ...
    exports.EditableTileMap = EditableTileMap;
    exports.EditableTileMapLayer = EditableTileMapLayer;
    exports.PixiTileMapHelper = PixiTileMapHelper;
    exports.TileDefinition = TileDefinition;
    exports.TileMapManager = TileMapManager;
    exports.TileTextureCache = TileTextureCache;
