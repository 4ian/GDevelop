...
export type LDtkTileMap = {
    ...
    imageExportMode: "None" | "OneImagePerLayer" | "OneImagePerLevel" | "LayersAndLevels";
    /** File format version */
    jsonVersion: string;
...
type LDtkFieldDef = {
    ...
    textLanguageMode: "LangC" | "LangHaxe" | "LangJS" | "LangJson" | "LangLog" | "LangLua" | "LangMarkdown" | "LangPython" | "LangRuby" | "LangXml" | null;
...
type LDtkFlag = "DiscardPreCsvIntGrid" | "ExportPreCsvIntGridFormat" | "IgnoreBackupSuggest" | "PrependIndexToLevelFileNames" | "MultiWorlds" | "UseMultilinesType";
