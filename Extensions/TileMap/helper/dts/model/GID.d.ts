...
export declare namespace FlippingHelper {
    ...
    function setFlippedHorizontally(tileId: integer, flippedHorizontally: boolean): integer;
    function setFlippedVertically(tileId: integer, flippedVertically: boolean): integer;
    function setFlippedDiagonally(tileId: integer, flippedDiagonally: boolean): integer;
...
export declare function getTileGID(tileId: integer, flippedHorizontally: boolean, flippedVertically: boolean, flippedDiagonally: boolean): integer;
