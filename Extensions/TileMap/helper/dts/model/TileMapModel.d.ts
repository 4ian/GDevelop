import { PolygonVertices, integer, float, EditableTileMapAsJsObject, EditableTileMapLayerAsJsObject } from "./CommonTypes";
/**
 * A tile map model.
 *
...
export declare class EditableTileMap {
     ...
     */
    static from(editableTileMapAsJsObject: EditableTileMapAsJsObject, { tileSize, tileSetColumnCount, tileSetRowCount, }: {
        tileSize: number;
     ...
     */
    increaseDimensions(columnsToAppend: number, columnsToUnshift: number, rowsToAppend: number, rowsToUnshift: number): void;
    /**
...
export declare class EditableTileMapLayer extends AbstractEditableLayer {
    ...
    static from(editableTileMapLayerAsJsObject: EditableTileMapLayerAsJsObject, tileMap: EditableTileMap, isTileIdValid: (tileId: number) => boolean): EditableTileMapLayer;
    toJSObject(): EditableTileMapLayerAsJsObject;
    /**
    ...
    isEmpty(): boolean;
    reduceDimensions(columnsToPop: number, columnsToShift: number, rowsToPop: number, rowsToShift: number): void;
    increaseDimensions(columnsToAppend: number, columnsToUnshift: number, rowsToAppend: number, rowsToUnshift: number): void;
    /**
...
export declare class TileDefinition {
     ...
     */
    addHitBox(tag: string, polygon: PolygonVertices, hasFullHitBox: boolean): void;
    /**
