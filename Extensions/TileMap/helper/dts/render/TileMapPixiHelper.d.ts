...
export declare namespace PixiTileMapHelper {
     ...
     */
    function parseAtlas(tileMap: TileMapFileContent, levelIndex: number, atlasTexture: PIXI.BaseTexture<PIXI.Resource> | null, getTexture: (textureName: string) => PIXI.BaseTexture<PIXI.Resource>): TileTextureCache | null;
    /**
     * Split an atlas image into Pixi textures.
     *
     * @param atlasTexture The texture containing the whole tile set.
     ...
     * @returns A textures cache.
     */
    function parseSimpleTileMapAtlas(atlasTexture: PIXI.BaseTexture<PIXI.Resource>, columnCount: number, rowCount: number, tileSize: number): TileTextureCache;
    /**
     ...
     */
    function updatePixiTileMap(untypedPixiTileMap: any, tileMap: EditableTileMap, textureCache: TileTextureCache, displayMode: "index" | "visible" | "all", layerIndex: number, leftBound: number, rightBound: number, topBound: number, bottomBound: number): void;
    /**
     * Re-renders the collision mask
     */
    function updatePixiCollisionMask(pixiGraphics: PIXI.Graphics, tileMap: EditableTileMap, typeFilter: string, layerIndex: integer | null, outlineSize: integer, outlineColor: integer, outlineOpacity: float, fillColor: integer, fillOpacity: float): void;
}
