    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText19 = new wxStaticText(m_tileSetPropertiesPanel, wxID_ANY, _("Size of tiles:"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer17->Add(m_staticText19, 0, wxALL, 5);
    
    m_tileWidthSpin = new wxSpinCtrl(m_tileSetPropertiesPanel, wxID_ANY, wxT("24"), wxDefaultPosition, wxSize(-1,-1), wxSP_ARROW_KEYS);
    m_tileWidthSpin->SetRange(1, 10000);
    m_tileWidthSpin->SetValue(24);
    
    flexGridSizer17->Add(m_tileWidthSpin, 0, wxALL, 5);
    
    m_staticText43 = new wxStaticText(m_tileSetPropertiesPanel, wxID_ANY, _("x"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer17->Add(m_staticText43, 0, wxALL, 5);
    
    m_tileHeightSpin = new wxSpinCtrl(m_tileSetPropertiesPanel, wxID_ANY, wxT("24"), wxDefaultPosition, wxSize(-1,-1), wxSP_ARROW_KEYS);
    m_tileHeightSpin->SetRange(1, 10000);
    m_tileHeightSpin->SetValue(24);
    
    flexGridSizer17->Add(m_tileHeightSpin, 0, wxALL, 5);
    
    m_staticText81 = new wxStaticText(m_tileSetPropertiesPanel, wxID_ANY, _("Margins:"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer17->Add(m_staticText81, 0, wxALL, 5);
    
    m_horizontalMarginsSpin = new wxSpinCtrl(m_tileSetPropertiesPanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxSize(-1,-1), wxSP_ARROW_KEYS);
    ...
    m_staticText85 = new wxStaticText(m_tileSetPropertiesPanel, wxID_ANY, _("x"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer17->Add(m_staticText85, 0, wxALL, 5);
    
    m_verticalMarginsSpin = new wxSpinCtrl(m_tileSetPropertiesPanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxSize(-1,-1), wxSP_ARROW_KEYS);
    ...
    m_imageNameTextCtrl = new wxTextCtrl(m_tileSetPropertiesPanel, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer13->Add(m_imageNameTextCtrl, 0, wxALL|wxEXPAND, 5);
    
    m_updateButton = new wxButton(m_tileSetPropertiesPanel, wxID_ANY, _("Update tileset"), wxDefaultPosition, wxSize(-1,-1), 0);
