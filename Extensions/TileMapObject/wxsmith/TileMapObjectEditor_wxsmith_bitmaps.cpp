...
void wxCF6DCInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/TileMapObjectEditor_wxsmith_bitmaps.cpp$E__Developpement_GD_Extensions_TileMapObject_wxsmith_TileMapObjectEditor_wxsmith_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
