...
TiledSpriteObjectEditor::TiledSpriteObjectEditor(
  ...
  Create(parent,
         wxID_ANY,
         _("Settings of the Tiled Sprite Object"),
         wxDefaultPosition,
         wxDefaultSize,
  ...
  FlexGridSizer3->Add(
      ...
      5);
  smoothCheckBox = new wxCheckBox(Core,
                                  ID_CHECKBOX1,
                                  _("Smooth texture"),
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  Connect(
      ...
      (wxObjectEventFunction)&TiledSpriteObjectEditor::OnfrontAddFromBtClick);
  Connect(ID_BUTTON3,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&TiledSpriteObjectEditor::OnimageBankBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&TiledSpriteObjectEditor::OnokBtClick);
  Connect(ID_BUTTON2,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&TiledSpriteObjectEditor::OncancelBtClick);
  //*)
