gdjs.TiledSpriteRuntimeObjectCocosRenderer = function(
  runtimeObject,
  runtimeScene,
  textureName
) {
...
gdjs.TiledSpriteRuntimeObjectRenderer =
  gdjs.TiledSpriteRuntimeObjectCocosRenderer; //Register the class to let the engine use it.
...
gdjs.TiledSpriteRuntimeObjectCocosRenderer.prototype.setTexture = function(
  textureName,
  runtimeScene
) {
...
gdjs.TiledSpriteRuntimeObjectCocosRenderer.prototype.setWidth = function(
  width
) {
...
gdjs.TiledSpriteRuntimeObjectCocosRenderer.prototype.setHeight = function(
  height
) {
