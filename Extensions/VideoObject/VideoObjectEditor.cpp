...
const long VideoObjectEditor::ID_TEXTCTRL2 = wxNewId();
const long VideoObjectEditor::ID_BUTTON4 = wxNewId();
const long VideoObjectEditor::ID_STATICTEXT4 = wxNewId();
...
object(object_)
{
	...
	Connect(ID_BUTTON3,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&VideoObjectEditor::OncolorBtClick);
	Connect(ID_BUTTON4,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&VideoObjectEditor::OnfontBtClick);
	Connect(ID_SPINCTRL1,wxEVT_COMMAND_SPINCTRL_UPDATED,(wxObjectEventFunction)&VideoObjectEditor::OnSizeEditChange);
...
void VideoObjectEditor::OncolorBtClick(wxCommandEvent& event)
{
}

void VideoObjectEditor::OnfontBtClick(wxCommandEvent& event)
{
}

void VideoObjectEditor::OnSizeEditChange(wxSpinEvent& event)
{
}
#endif
