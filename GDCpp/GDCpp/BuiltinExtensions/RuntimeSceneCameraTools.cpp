...
void GD_API SetCameraX(RuntimeScene & scene, float x, const gd::String & layer, unsigned int cameraId)
{
...
void GD_API SetCameraY(RuntimeScene & scene, float y, const gd::String & layer, unsigned int cameraId)
{
    RuntimeCamera & camera = scene.GetRuntimeLayer(layer).GetCamera(cameraId);
 ...
 */
void GD_API ActDeleteCamera(RuntimeScene & scene, const gd::String & layerName, unsigned int camera)
{
