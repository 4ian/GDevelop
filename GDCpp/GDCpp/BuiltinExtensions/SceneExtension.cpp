...
SceneExtension::SceneExtension()
{
    ...
    AddExpression("Random", _("Random value"), _("Random value"), _("Random"), "res/actions/position.png")
        ...
        .codeExtraInformation.SetFunctionName("GDpriv::CommonInstructions::Random").SetIncludeFile("GDCpp/BuiltinExtensions/CommonInstructionsTools.h");
    ...
    AddCondition("DepartScene",
        ...
        .codeExtraInformation.SetFunctionName("SceneJustBegins").SetIncludeFile("GDCpp/BuiltinExtensions/RuntimeSceneTools.h");
    ...
    AddAction("Scene",
        ...
        .codeExtraInformation.SetFunctionName("ChangeScene").SetIncludeFile("GDCpp/BuiltinExtensions/RuntimeSceneTools.h");
    ...
    AddAction("Quit",
        ...
        .AddCodeOnlyParameter("currentScene", "")
        .codeExtraInformation.SetFunctionName("StopGame").SetIncludeFile("GDCpp/BuiltinExtensions/RuntimeSceneTools.h");
    ...
    AddAction("SceneBackground",
        ...
        .codeExtraInformation.SetFunctionName("ChangeSceneBackground").SetIncludeFile("GDCpp/BuiltinExtensions/RuntimeSceneTools.h");
