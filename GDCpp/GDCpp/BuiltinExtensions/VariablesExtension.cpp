...
VariablesExtension::VariablesExtension()
{
    ...
    AddCondition("VarSceneDef",
        ...
        .AddCodeOnlyParameter("currentScene", "")
        .AddParameter("scenevar", _("Name of the variable"))
        .codeExtraInformation.SetFunctionName("SceneVariableDefined").SetIncludeFile("GDCpp/BuiltinExtensions/RuntimeSceneTools.h");
    ...
    AddCondition("VarGlobalDef",
        ...
        .AddCodeOnlyParameter("currentScene", "")
        .AddParameter("globalvar", _("Name of the variable"))
        .codeExtraInformation.SetFunctionName("GlobalVariableDefined").SetIncludeFile("GDCpp/BuiltinExtensions/RuntimeSceneTools.h");
