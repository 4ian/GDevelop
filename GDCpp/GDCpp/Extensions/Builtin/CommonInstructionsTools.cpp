...
std::mt19937 InitializeRandomEngine() {
  ...
  return std::mt19937(randomDevice.entropy() > 0
                          ? randomDevice()
...
gd::String GD_API ToString(double number) { return gd::String::From(number); }
...
double GD_API ToRad(double angle) { return angle * 3.1415926 / 180.0; }

double GD_API ToDeg(double angle) { return angle * 180.0 / 3.1415926; }
