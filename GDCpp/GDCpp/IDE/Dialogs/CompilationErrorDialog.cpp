...
CompilationErrorDialog::CompilationErrorDialog(wxWindow* parent,
                                               gd::String report) {
  ...
  StaticBitmap3 = new wxStaticBitmap(Panel1,
                                     ID_STATICBITMAP3,
                                     wxBitmap(wxImage(_T("res/error24.png"))),
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     wxNO_BORDER,
                                     _T("ID_STATICBITMAP3"));
  ...
  StaticText1 = new wxStaticText(
      Panel1,
      ID_STATICTEXT1,
      _("An error occurred during the compilation, and the game could not be "
        "created.\nSee the report below to see which step caused an error."),
      wxDefaultPosition,
      wxDefaultSize,
      wxALIGN_CENTRE,
      _T("ID_STATICTEXT1"));
  ...
  ReportEdit = new wxTextCtrl(this,
                              ID_TEXTCTRL1,
                              _("No information concerning the error."),
                              wxDefaultPosition,
                              wxSize(253, 97),
  ...
  StaticText2 = new wxStaticText(this,
                                 ID_STATICTEXT2,
                                 _("How solve the problem \?"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 _T("ID_STATICTEXT2"));
  wxFont StaticText2Font(wxDEFAULT,
  ...
  StaticText3 = new wxStaticText(
      this,
      ID_STATICTEXT3,
      _("A problem when copying a known file:\n  -Check that your file (image, "
        "sound ...) exists.\n  -Check you have read/write permission. \n\nA "
        "problem when copying a file unknown:\n  -Check that the file in "
  ...
  FlexGridSizer1->Add(
      ...
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      0);
  StaticLine3 = new wxStaticLine(this,
                                 ID_STATICLINE3,
                                 wxDefaultPosition,
                                 wxSize(10, -1),
                                 wxLI_HORIZONTAL,
  ...
  StaticText4 = new wxStaticText(
      this,
      ID_STATICTEXT4,
      _("If you can not solve the problem, do not hesitate to contact us"),
      wxDefaultPosition,
      wxDefaultSize,
      0,
      _T("ID_STATICTEXT4"));
  wxFont StaticText4Font(wxDEFAULT,
                         wxFONTFAMILY_DEFAULT,
                         wxFONTSTYLE_ITALIC,
                         wxFONTWEIGHT_NORMAL,
                         false,
  ...
  AideBt = new wxButton(this,
                        ...
                        _T("ID_BUTTON1"));
  FlexGridSizer4->Add(
      AideBt, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer1->Add(
      FlexGridSizer4,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  Connect(ID_BUTTON2,
          ...
          (wxObjectEventFunction)&CompilationErrorDialog::OnFermerBtClick);
  Connect(ID_BUTTON1,
          wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&CompilationErrorDialog::OnAideBtClick);
  //*)
