...
ProfileDlg::ProfileDlg(wxWindow* parent,
                       CppLayoutPreviewer& associatedCppLayoutPreviewer)
    : BaseProfiler(), maxData(300), sceneCanvas(associatedCppLayoutPreviewer) {
  ...
  activateCheck = new wxCheckBox(this,
                                 ID_CHECKBOX1,
                                 _("Activate profiling ( Relaunch the scene )"),
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 0,
                                 wxDefaultValidator,
  ...
  FlexGridSizer2->Add(
      activateCheck, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer7 = new wxFlexGridSizer(0, 3, 0, 0);
  FlexGridSizer7->AddGrowableCol(1);
  FlexGridSizer7->AddGrowableRow(0);
  GridSizer1 = new wxGridSizer(3, 1, 0, 0);
  scaleMaxTxt = new wxStaticText(this,
                                 ID_STATICTEXT8,
                                 wxEmptyString,
                                 wxDefaultPosition,
                                 wxDefaultSize,
                                 ...
                                 _T("ID_STATICTEXT8"));
  GridSizer1->Add(
      scaleMaxTxt, 1, wxALL | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL, 5);
  scaleMidTxt = new wxStaticText(this,
                                 ID_STATICTEXT9,
                                 wxEmptyString,
                                 wxDefaultPosition,
                                 wxDefaultSize,
  ...
  FlexGridSizer7->Add(
      ...
      0);
  ratioGraphics = new wxPanel(this,
                              ID_PANEL1,
                              wxDefaultPosition,
                              wxSize(395, 130),
  ...
  FlexGridSizer8->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  eventsTimeTxt = new wxStaticText(this,
                                   ID_STATICTEXT2,
                                   wxEmptyString,
                                   wxDefaultPosition,
                                   wxDefaultSize,
                                   ...
                                   _T("ID_STATICTEXT2"));
  FlexGridSizer8->Add(
      eventsTimeTxt, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer2->Add(
      FlexGridSizer8,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  FlexGridSizer3->Add(
      ...
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
      5);
  totalTimeTxt = new wxStaticText(this,
                                  ID_STATICTEXT1,
                                  wxEmptyString,
                                  wxDefaultPosition,
                                  wxDefaultSize,
                                  ...
                                  _T("ID_STATICTEXT1"));
  FlexGridSizer3->Add(
      totalTimeTxt, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer2->Add(
      FlexGridSizer3,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  FlexGridSizer1->Add(
      Panel3, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  objectsCountTxt = new wxStaticText(this,
                                     ID_STATICTEXT3,
                                     wxEmptyString,
                                     wxDefaultPosition,
                                     wxDefaultSize,
                                     ...
                                     _T("ID_STATICTEXT3"));
  FlexGridSizer1->Add(
      objectsCountTxt, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer2->Add(
      FlexGridSizer1,
      1,
      wxALL | wxEXPAND | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
  ...
  MenuItem1 = new wxMenuItem(MenuItem3,
                             ID_MENUITEM1,
                             _("Change the number of measure"),
                             wxEmptyString,
                             wxITEM_NORMAL);
  MenuItem3->Append(MenuItem1);
  infiniteDataCheck = new wxMenuItem(
      MenuItem3, wxID_ANY, _("Infinity number"), wxEmptyString, wxITEM_CHECK);
  MenuItem3->Append(infiniteDataCheck);
  contextMenu.Append(
      ID_MENUITEM3, _("Number of measures"), MenuItem3, wxEmptyString);
  MenuItem2 = new wxMenuItem((&contextMenu),
                             ID_MENUITEM2,
                             _("Change the interval between each measures."),
                             wxEmptyString,
                             wxITEM_NORMAL);
  contextMenu.Append(MenuItem2);
  contextMenu.AppendSeparator();
  totalTimeCheck = new wxMenuItem((&contextMenu),
                                  wxID_ANY,
                                  _("Display total time"),
                                  wxEmptyString,
                                  wxITEM_CHECK);
  contextMenu.Append(totalTimeCheck);
  eventsTimeCheck = new wxMenuItem((&contextMenu),
                                   wxID_ANY,
                                   _("Display time used by events"),
                                   wxEmptyString,
                                   wxITEM_CHECK);
  contextMenu.Append(eventsTimeCheck);
  objectsCountCheck = new wxMenuItem((&contextMenu),
                                     wxID_ANY,
                                     _("Display the number of objects"),
                                     wxEmptyString,
                                     wxITEM_CHECK);
  ...
  Connect(ID_CHECKBOX1,
          ...
          (wxObjectEventFunction)&ProfileDlg::OnactivateCheckClick);
  ratioGraphics->Connect(
      wxEVT_PAINT,
      (wxObjectEventFunction)&ProfileDlg::OnratioGraphicsPaint,
      0,
      this);
  ratioGraphics->Connect(
      wxEVT_RIGHT_UP,
      (wxObjectEventFunction)&ProfileDlg::OnratioGraphicsRightUp,
      0,
      this);
  ratioGraphics->Connect(
      wxEVT_SIZE,
      (wxObjectEventFunction)&ProfileDlg::OnratioGraphicsResize,
      0,
      this);
  Connect(ID_MENUITEM1,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&ProfileDlg::OnChangeDurationSelected);
  Connect(ID_MENUITEM2,
          wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&ProfileDlg::OnStepTimeSelected);
  //*)
...
void ProfileDlg::UpdateGUI() {
  ...
  eventsTimeTxt->SetLabel(
      _("Events:") +
      gd::String::From(static_cast<double>(lastEventsTime) / 1000.0f) +
      _("ms") + _("/ Percent of time used by events:") +
      gd::String::From(
          static_cast<double>(lastEventsTime) /
          static_cast<double>((lastEventsTime + lastRenderingTime)) * 100.0f) +
      "%");

  totalTimeTxt->SetLabel(
      _("Total rendering time ( Display + Events ):") +
      gd::String::From(
          static_cast<double>((lastRenderingTime + lastEventsTime)) / 1000.0f) +
      _("ms"));

  std::size_t currentObjectCount =
      sceneCanvas.GetRuntimeScene().objectsInstances.GetAllObjects().size();
  objectsCountTxt->SetLabel(_("Number of objects:") +
                            gd::String::From(currentObjectCount));
...
void ProfileDlg::OnratioGraphicsPaint(wxPaintEvent& event) {
  wxBufferedPaintDC dc(
      ratioGraphics);  // Cr�ation obligatoire du wxBufferedPaintDC
  ...
  dc.GradientFillLinear(
      wxRect(0, 0, ratioGraphics->GetSize().x, ratioGraphics->GetSize().y),
      wxColour(81, 81, 81),
      wxColour(119, 126, 137),
      wxSOUTH);

  if (!profilingActivated || totalTimeData.empty()) {
    scaleMaxTxt->SetLabel(gd::String::From(50) + _("ms\n(") +
                          gd::String::From(1.0f / 50 * 1000.0f) + " " +
                          _("fps") + ")");
    scaleMidTxt->SetLabel(gd::String::From(50 / 2.0f) + _("ms\n(") +
                          gd::String::From(1.0f / (50 / 2.0f) * 1000.0f) + " " +
                          _("fps") + ")");
  ...
  scaleMaxTxt->SetLabel(gd::String::From(maximumTime) + _("ms\n(") +
                        gd::String::From(1.0f / maximumTime * 1000.0f) + " " +
                        _("fps") + ")");
  scaleMidTxt->SetLabel(
      gd::String::From(maximumTime / 2.0f) + _("ms\n(") +
  ...
  if (totalTimeCheck->IsChecked()) {
    ...
    std::size_t numberDisplay =
        infiniteDataCheck->IsChecked() ? totalTimeData.size() : maxData - 1;

    points.push_back(
        wxPoint(ratioGraphics->GetSize().x, ratioGraphics->GetSize().y));
    for (std::size_t i = 0; i < totalTimeData.size(); ++i)
      points.push_back(
          wxPoint(static_cast<double>(ratioGraphics->GetSize().x) -
                      (i) / static_cast<double>(numberDisplay) *
                          static_cast<double>(ratioGraphics->GetSize().x),
                  static_cast<double>(ratioGraphics->GetSize().y) -
                      static_cast<double>(totalTimeData[i]) /
                          static_cast<double>(maximumTime) *
                          static_cast<double>(ratioGraphics->GetSize().y)));
  ...
  if (eventsTimeCheck->IsChecked()) {
    vector<wxPoint> points;
    std::size_t numberDisplay =
        infiniteDataCheck->IsChecked() ? eventsData.size() : maxData - 1;
      ...
      points.push_back(
          wxPoint(static_cast<double>(ratioGraphics->GetSize().x) -
                      (i) / static_cast<double>(numberDisplay) *
                          static_cast<double>(ratioGraphics->GetSize().x),
                  static_cast<double>(ratioGraphics->GetSize().y) -
                      static_cast<double>(eventsData[i]) /
                          static_cast<double>(maximumTime) *
                          static_cast<double>(ratioGraphics->GetSize().y)));
    points.push_back(wxPoint(points.back().x, ratioGraphics->GetSize().y));
  ...
  if (objectsCountCheck->IsChecked()) {
    std::deque<std::size_t>::iterator maximumElementIterator =
        std::max_element(objectsCountData.begin(), objectsCountData.end());
    std::size_t maximumElement = *maximumElementIterator;

    vector<wxPoint> points;
    std::size_t numberDisplay =
        infiniteDataCheck->IsChecked() ? objectsCountData.size() : maxData - 1;
      ...
      points.push_back(
          wxPoint(static_cast<double>(ratioGraphics->GetSize().x) -
                      (i) / static_cast<double>(numberDisplay) *
                          static_cast<double>(ratioGraphics->GetSize().x),
                  static_cast<double>(ratioGraphics->GetSize().y) -
                      static_cast<double>(objectsCountData[i]) /
                          static_cast<double>(maximumElement) *
                          static_cast<double>(ratioGraphics->GetSize().y)));
    points.push_back(wxPoint(points.back().x, ratioGraphics->GetSize().y));
...
void ProfileDlg::ParseProfileEvents() {
  ...
  for (std::size_t i = 0; i < sceneCanvas.GetRuntimeScene()
                                  .GetProfiler()
                                  ->profileEventsInformation.size();
       ++i) {
    std::shared_ptr<gd::BaseEvent> event = sceneCanvas.GetRuntimeScene()
                                               .GetProfiler()
                                               ->profileEventsInformation[i]
                                               .originalEvent.lock();
    if (event != std::shared_ptr<gd::BaseEvent>()) {
      event->totalTimeDuringLastSession = sceneCanvas.GetRuntimeScene()
                                              .GetProfiler()
                                              ->profileEventsInformation[i]
                                              .GetTime();
      event->percentDuringLastSession =
          static_cast<double>(event->totalTimeDuringLastSession) /
          static_cast<double>(totalEventsTime) * 100.0;
    } else {
...
void ProfileDlg::OnChangeDurationSelected(wxCommandEvent& event) {
  gd::String newMaxData =
      wxGetTextFromUser(_("Enter the number of measure to memorize"),
                        _("Number of measures"),
                        gd::String::From(maxData));
  maxData = newMaxData.To<int>();
}

void ProfileDlg::OnStepTimeSelected(wxCommandEvent& event) {
  gd::String newStepTime = wxGetTextFromUser(
      _("Enter time between each measure ( milliseconds )"),
      _("Time between each measure"),
      gd::String::From(static_cast<double>(stepTime) * 1000.0f));
...
void ProfileDlg::OnactivateCheckClick(wxCommandEvent& event) {
  ...
  CppPlatform::Get().GetChangesNotifier().OnEventsModified(
      project, sceneCanvas.GetLayout());
}
