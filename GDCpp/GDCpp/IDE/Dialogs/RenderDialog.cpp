...
RenderDialog::RenderDialog(wxWindow* parent,
                           CppLayoutPreviewer* sceneCanvasNotifiedOnClose_)
  ...
  Create(parent,
         ...
         _T("wxID_ANY"));
  renderCanvas = new wxSFMLCanvas(this,
                                  ID_CUSTOM1,
                                  wxDefaultPosition,
                                  wxSize(800, 600),
  ...
  Connect(wxID_ANY,
          wxEVT_CLOSE_WINDOW,
          (wxObjectEventFunction)&RenderDialog::OnClose);
  //*)
}
 ...
 */
void RenderDialog::SetSizeOfRenderingZone(unsigned int width,
                                          unsigned int height) {
