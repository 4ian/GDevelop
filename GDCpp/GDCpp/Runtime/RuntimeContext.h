...
class GD_API RuntimeContext {
 public:
  ...
  /**
   * \brief Shortcut to get a "raw pointers" list to objects with a specific
   * name. Equivalent to : \code
  ...
  RuntimeContext &AddObjectListToMap(const gd::String &objectName,
