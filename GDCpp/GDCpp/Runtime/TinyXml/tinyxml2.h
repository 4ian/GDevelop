...
public:
    ...
    */
    ...
    /**
    	...
    	an errorID.
    */
    XMLError SaveFile( const char* filename, bool compact = false ) const;
    ...
    /**
    	...
    	an errorID.
    */
    XMLError SaveFile( FILE* fp, bool compact = false ) const;
    ...
    */
    ...
    void SetError( XMLError error, const char* str1, const char* str2 ) const;
...
private:
    ...
    mutable XMLError    _errorID;
    Whitespace  _whitespace;
    mutable const char* _errorStr1;
    mutable const char* _errorStr2;
    char*       _charBuffer;
