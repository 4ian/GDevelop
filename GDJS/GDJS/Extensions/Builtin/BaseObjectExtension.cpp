...
BaseObjectExtension::BaseObjectExtension() {
  ...
  objectConditions["PosX"].SetFunctionName("getX");
  objectConditions["PosY"].SetFunctionName("getY");
  ...
  objectActions["Cache"].SetFunctionName("hide");
  objectActions["Montre"].SetFunctionName("hide");
