...
CordovaPackageDialog::CordovaPackageDialog(wxWindow* parent,
                                           wxString packageLocation)
    : BaseCordovaPackageDialog(parent) {
  ID_HYPERLINKCTRL117->SetURL(
      _("http://wiki.compilgames.net/doku.php/en/game_develop/tutorials/"
        "howtouseintelxdk"));
