import type { IDebuggerClient } from '.';
import { HotReloader, HotReloaderLog } from './hot-reloader';
import type { FrameMeasure, ProfilerStats } from '..';
import type { RuntimeGame } from '..';
...
export class WebsocketDebuggerClient implements IDebuggerClient {
  ...
  constructor(runtimeGame: RuntimeGame) {
    ...
    this._hotReloader = new HotReloader(runtimeGame);
    this._ws = null;
...
// Note that we use the global namespace instead of importing to avoid bundling all of gdjs again with the debugger bundle.
gdjs.registerDebuggerClient(WebsocketDebuggerClient);
