import { getEffect, setUniformLocationWith1f } from './cocos-tools';
...
export class LayerCocosRenderer {
  ...
  _makeShaders() {
    ...
    const effect = getEffect(effects[0].effectType);
    if (!effect) {
...
export const LayerRenderer = LayerCocosRenderer;
export type LayerRenderer = LayerCocosRenderer;
