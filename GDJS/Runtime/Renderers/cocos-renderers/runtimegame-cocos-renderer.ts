import { CocosDirectorManager } from './cocos-director-manager';
import type { RuntimeGame } from '../../runtimegame';
...
export class RuntimeGameCocosRenderer {
  ...
  constructor(game: RuntimeGame, forceFullscreen: boolean) {
    this._directorManager = new CocosDirectorManager();
    this._game = game;
  }
...
export const RuntimeGameRenderer = RuntimeGameCocosRenderer;
export type RuntimeGameRenderer = RuntimeGameCocosRenderer;
