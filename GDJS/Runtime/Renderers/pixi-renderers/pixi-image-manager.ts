...
export class PixiImageManager {
  ...
  constructor(resources: ResourceData[]) {
    ...
    this._invalidTexture = Texture.from(
   ...
   */
  getPIXITexture(resourceName: string): Texture {
...
export const ImageManager = PixiImageManager;
export type ImageManager = PixiImageManager;
