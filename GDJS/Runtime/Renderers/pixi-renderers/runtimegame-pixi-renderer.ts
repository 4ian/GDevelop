...
/**
 * The renderer for a RuntimeGame using Pixi.js.
 */
export class RuntimeGamePixiRenderer {
  ...
  _pixiRenderer: Renderer | null = null;
  ...
  createStandardCanvas(parentElement) {
    ...
    this._pixiRenderer = autoDetectRenderer({
  ...
  isWebGLSupported(): boolean {
    return (
      !!this._pixiRenderer && this._pixiRenderer.type === RENDERER_TYPE.WEBGL
    );
  }
