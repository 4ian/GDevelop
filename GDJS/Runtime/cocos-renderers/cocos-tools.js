...
gdjs.CocosTools.makeNightShader = function() {
  ...
  shader.initWithString(
    gdjs.CocosTools.getDefaultVertexShader(),
    '#ifdef GL_ES\n' +
 ...
 * @memberof gdjs.CocosTools
 */
gdjs.CocosTools.setUniformLocationWith1f = function(
  node,
  shader,
  uniform,
  uniformName,
 ...
 * @memberof gdjs.CocosTools
 */
gdjs.CocosTools.setUniformLocationWith2f = function(
  node,
  shader,
  uniform,
  uniformName,
 ...
 * @memberof gdjs.CocosTools
 */
gdjs.CocosTools.setUniformLocationWith4f = function(
  node,
  shader,
  uniform,
  uniformName,
