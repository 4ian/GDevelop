...
gdjs.RuntimeSceneCocosRenderer.prototype.onSceneUnloaded = function() {
  var layerNames = gdjs.staticArray(
    gdjs.RuntimeSceneCocosRenderer.prototype.onSceneUnloaded
  );
    ...
    cc.EventListener.create({
      ...
      onMouseDown: function(event) {
        that._runtimeScene
          .getGame()
          .getInputManager()
          .onMouseButtonPressed(event.getButton() === 0 ? 0 : 1);
      },
      onMouseUp: function(event) {
        that._runtimeScene
          .getGame()
          .getInputManager()
          .onMouseButtonReleased(event.getButton() === 0 ? 0 : 1);
      },
