...
gdjs.CocosEffect.prototype.setRate = function(rate) {
  //Unsupported
};
...
gdjs.CocosSoundManager.prototype.playSound = function(
  soundName,
  loop,
  volume,
  pitch
...
gdjs.CocosSoundManager.prototype.playSoundOnChannel = function(
  soundName,
  channel,
  loop,
  volume,
...
gdjs.CocosSoundManager.prototype.playMusic = function(
  soundName,
  loop,
  volume,
  pitch
...
gdjs.CocosSoundManager.prototype.playMusicOnChannel = function(
  soundName,
  channel,
  loop,
  volume,
...
gdjs.CocosSoundManager.prototype.preloadAudio = function(
  onProgress,
  onComplete,
  resources
) {
