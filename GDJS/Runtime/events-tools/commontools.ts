import { toRad, Variable, RuntimeScene } from '..';
 ...
 */
export const getVariableNumber = function (variable: Variable): number {
 ...
 */
export const getVariableString = function (variable: Variable): string {
 ...
 * @private
 */
export const toggleVariableBoolean = function (variable: Variable) {
 ...
 * @param variable Variable.
 */
export const variableClearChildren = function (variable: Variable) {
 ...
 * @private
 */
export const variablePushCopy = function (array: Variable, variable: Variable) {
 ...
 * @private
 */
export const variableRemoveAt = function (array: Variable, index: number) {
 ...
 */
export const getVariableChildCount = function (variable: Variable): number {
 ...
 */
export const normalize = function (val: float, min: float, max: float): number {
...
export const getXFromAngleAndDistance = function (
  ...
  return distance * Math.cos(toRad(angle));
};
...
export const getYFromAngleAndDistance = function (
  ...
  return distance * Math.sin(toRad(angle));
};
