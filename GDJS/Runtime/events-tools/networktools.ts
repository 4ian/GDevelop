import type { Variable, RuntimeObject, RuntimeScene } from '..';
 ...
 */
export const variableStructureToJSON = function (variable: Variable): string {
 ...
 */
export const _objectToVariable = function (obj: any, variable: Variable) {
