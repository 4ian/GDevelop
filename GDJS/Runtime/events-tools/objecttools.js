 ...
 */
gdjs.evtTools.object.twoListsTest = function(
  predicate,
  objectsLists1,
  objectsLists2,
  inverted,
 ...
 */
gdjs.evtTools.object.pickObjectsIf = function(
  predicate,
  objectsLists,
  negatePredicate,
  extraArg
...
gdjs.evtTools.object.hitBoxesCollisionTest = function(
  objectsLists1,
  objectsLists2,
  inverted,
  runtimeScene
...
gdjs.evtTools.object.distanceTest = function(
  objectsLists1,
  objectsLists2,
  distance,
  inverted
...
gdjs.evtTools.object._movesToward = function(obj1, obj2, tolerance) {
  ...
  var objAngle = Math.atan2(
    obj2.getY() + obj2.getCenterY() - (obj1.getY() + obj1.getCenterY()),
...
gdjs.evtTools.object.movesTowardTest = function(
  objectsLists1,
  objectsLists2,
  tolerance,
  inverted
...
gdjs.evtTools.object._turnedToward = function(obj1, obj2, tolerance) {
  ...
  return (
    Math.abs(gdjs.evtTools.common.angleDifference(obj1.getAngle(), objAngle)) <=
    tolerance / 2
  );
};

gdjs.evtTools.object.turnedTowardTest = function(
  objectsLists1,
  objectsLists2,
  tolerance,
  inverted
...
gdjs.evtTools.object.pickRandomObject = function(runtimeScene, objectsLists) {
  ...
  if (objectsCount === 0) return false;
...
gdjs.evtTools.object.pickNearestObject = function(
  objectsLists,
  x,
  y,
  inverted
...
gdjs.evtTools.object.raycastObject = function(
  objectsLists,
  x,
  y,
  angle,
...
gdjs.evtTools.object.raycastObjectToPosition = function(
  objectsLists,
  x,
  y,
  endX,
 ...
 * @private
 */
gdjs.evtTools.object.doCreateObjectOnScene = function(
  objectsContext,
  objectName,
  objectsLists,
  x,
 ...
 * @private
 */
gdjs.evtTools.object.createObjectOnScene = function(
  objectsContext,
  objectsLists,
  x,
  y,
 ...
 * @private
 */
gdjs.evtTools.object.createObjectFromGroupOnScene = function(
  objectsContext,
  objectsLists,
  objectName,
  x,
