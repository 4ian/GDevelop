...
gdjs.evtTools.runtimeScene.setBackgroundColor = function(
  runtimeScene,
  rgbColor
) {
...
gdjs.evtTools.runtimeScene.timerElapsedTime = function(
  runtimeScene,
  timeInSeconds,
  timerName
) {
...
gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSeconds = function(
  runtimeScene,
  timerName
) {
  var timeManager = runtimeScene.getTimeManager();
...
gdjs.evtTools.runtimeScene.replaceScene = function(
  runtimeScene,
  newSceneName,
  clearOthers
) {
...
gdjs.evtTools.runtimeScene.createObjectsFromExternalLayout = function(
  scene,
  externalLayout,
  xPos,
  yPos
) {
  var externalLayoutData = scene
    .getGame()
