...
gdjs.evtTools.sound.playSound = function(
  runtimeScene,
  soundFile,
  loop,
  volume,
...
gdjs.evtTools.sound.playSoundOnChannel = function(
  runtimeScene,
  soundFile,
  channel,
  loop,
...
gdjs.evtTools.sound.setSoundOnChannelVolume = function(
  runtimeScene,
  channel,
  volume
) {
...
gdjs.evtTools.sound.getSoundOnChannelPlayingOffset = function(
  runtimeScene,
  channel
) {
  var sound = runtimeScene.getSoundManager().getSoundOnChannel(channel);
...
gdjs.evtTools.sound.setSoundOnChannelPlayingOffset = function(
  runtimeScene,
  channel,
  playingOffset
) {
...
gdjs.evtTools.sound.setSoundOnChannelPitch = function(
  runtimeScene,
  channel,
  pitch
) {
...
gdjs.evtTools.sound.playMusic = function(
  runtimeScene,
  soundFile,
  loop,
  volume,
...
gdjs.evtTools.sound.playMusicOnChannel = function(
  runtimeScene,
  soundFile,
  channel,
  loop,
...
gdjs.evtTools.sound.setMusicOnChannelVolume = function(
  runtimeScene,
  channel,
  volume
) {
...
gdjs.evtTools.sound.getMusicOnChannelPlayingOffset = function(
  runtimeScene,
  channel
) {
  var music = runtimeScene.getSoundManager().getMusicOnChannel(channel);
...
gdjs.evtTools.sound.setMusicOnChannelPlayingOffset = function(
  runtimeScene,
  channel,
  playingOffset
) {
...
gdjs.evtTools.sound.setMusicOnChannelPitch = function(
  runtimeScene,
  channel,
  pitch
) {
