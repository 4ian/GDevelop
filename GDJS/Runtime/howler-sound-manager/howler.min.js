  ...
  o.prototype = {
    ...
    play: function(e, o) {
      ...
      if (t._webAudio) {
        ...
        'running' === n.state
          ? f()
          : (t.once('resume', f), t._clearTimer(i._id));
      } else {
        var p = function() {
            (c.currentTime = _),
          ...
          m =
            ...
            (!c.readyState && n._navigator.isCocoonJS);
        if (4 === c.readyState || m) p();
        else {
          var v = function() {
    ...
    _startFadeInterval: function(e, n, o, t, r, a) {
      var u = this,
        ...
        s = _ / 0.01,
        l = s > 0 ? t / s : t;
      l < 4 && ((s = Math.ceil(s / (4 / l))), (l = 4)),
        (e._fadeTo = o),
        (e._interval = setInterval(function() {
          s > 0 && (i += 'in' === d ? 0.01 : -0.01),
            (i = Math.max(0, i)),
            (i = Math.min(1, i)),
    ...
    (Howl.prototype.init = (function(n) {
      return function(e) {
        ...
        return (
          ...
          (t._onorientation = e.onorientation ? [{ fn: e.onorientation }] : []),
          n.call(this, e)
        );
      };
    })(Howl.prototype.init)),
          ...
          (p._stereo = e),
            ...
            p._node &&
              ...
              'spatial' === r
                ...
                : p._panner.pan.setValueAtTime(e, Howler.ctx.currentTime)),
      ...
      for (var i = a._getSoundIds(r), p = 0; p < i.length; p++) {
        ...
        if (s) {
          ...
          (s._orientation = [e, t, o]),
            s._node &&
              (s._panner ||
                (s._pos || (s._pos = a._pos || [0, 0, -0.5]), n(s, 'spatial')),
    ...
    (Howl.prototype.pannerAttr = function() {
      ...
      if (1 === a.length) {
        if ('object' != typeof a[0])
          return (
            (o = r._soundById(parseInt(a[0], 10))),
    ...
    (Sound.prototype.init = (function(n) {
      return function() {
        ...
        (e._orientation = t._orientation),
          ...
          e._stereo
            ? t.stereo(e._stereo)
            : e._pos && t.pos(e._pos[0], e._pos[1], e._pos[2], e._id);
      };
