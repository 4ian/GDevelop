import { RuntimeScene, LayerRenderer } from '.';
...
export class Layer {
   ...
   */
  constructor(layerData: LayerData, runtimeScene: RuntimeScene) {
    ...
    this._renderer = new LayerRenderer(this, runtimeScene.getRenderer());
