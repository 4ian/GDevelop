!(function() {
  (Cocoon = window.Cocoon ? window.Cocoon : {}),
    ...
    (Cocoon.extend = function(subc, superc) {
      var subcp = subc.prototype,
        CocoonJSExtendHierarchyChainClass = function() {};
      (CocoonJSExtendHierarchyChainClass.prototype = superc.prototype),
        ...
        superc.prototype.constructor === Object.prototype.constructor &&
          (superc.prototype.constructor = superc);
      for (var method in subcp)
        subcp.hasOwnProperty(method) &&
    ...
    (Cocoon.clone = function(obj, copy) {
      ...
      var arr = [];
      for (var attr in obj)
        arr.push(copy.hasOwnProperty(attr) ? copy[attr] : obj[attr]);
      return arr;
    }),
    (Cocoon.callNative = function(
      ...
      if (Cocoon.nativeAvailable) {
        ...
        var nativeExtensionObject = ext[nativeExtensionObjectName],
          makeCallFunction = async
            ? nativeExtensionObject.makeCallAsync
            : nativeExtensionObject.makeCall,
          ret = makeCallFunction.apply(nativeExtensionObject, argumentsArray),
          finalRet = ret;
    ...
    (Cocoon.getObjectFromPath = function(baseObject, objectPath) {
      for (
        ...
        (obj[parts[i]] = obj[parts[i]] || void 0), (obj = obj[parts[i]]);
      return obj;
    }),
    (Cocoon.EventHandler = function(
      nativeExtensionObjectName,
      CocoonExtensionObjectName,
      nativeEventName,
      chainFunction
    ) {
      return (
        ...
        (this.addEventListener = function(listener) {
          if (chainFunction) {
            var f = function() {
              chainFunction.call(
                this,
                arguments.callee.sourceListener,
          ...
          var CocoonExtensionObject = Cocoon.getObjectFromPath(
            Cocoon,
            CocoonExtensionObjectName
          );
          if (CocoonExtensionObject && CocoonExtensionObject.nativeAvailable)
            ext[nativeExtensionObjectName].addEventListener(
              nativeEventName,
              listener
            );
          else {
            var indexOfListener = this.listeners.indexOf(listener);
            0 > indexOfListener && this.listeners.push(listener);
          }
        }),
        (this.addEventListenerOnce = function(listener) {
          if (chainFunction) {
            ...
            (f.sourceListener = listener), (listener = f);
          }
          var CocoonExtensionObject = Cocoon.getObjectFromPath(
            Cocoon,
            CocoonExtensionObjectName
          ...
          if (CocoonExtensionObject.nativeAvailable)
            ext[nativeExtensionObjectName].addEventListenerOnce(
              nativeEventName,
              listener
            );
          else {
            var indexOfListener = this.listeners.indexOf(listener);
            0 > indexOfListener && this.listenersOnce.push(listener);
          }
        }),
        (this.removeEventListener = function(listener) {
          ...
          if (CocoonExtensionObject.nativeAvailable)
            ext[nativeExtensionObjectName].removeEventListener(
              nativeEventName,
              listener
            );
          else {
            var indexOfListener = this.listeners.indexOf(listener);
            indexOfListener >= 0 && this.listeners.splice(indexOfListener, 1);
          }
        }),
        (this.removeEventListenerOnce = function(listener) {
          ...
          if (CocoonExtensionObject.nativeAvailable)
            ext[nativeExtensionObjectName].removeEventListenerOnce(
              nativeEventName,
              listener
            );
          else {
        ...
        (this.notifyEventListeners = function() {
          ...
          if (CocoonExtensionObject && CocoonExtensionObject.nativeAvailable)
            ext[nativeExtensionObjectName].notifyEventListeners(
              nativeEventName
            );
          else {
            var argumentsArray = Array.prototype.slice.call(arguments),
              listeners = Array.prototype.slice.call(this.listeners),
              listenersOnce = Array.prototype.slice.call(this.listenersOnce),
              _this = this;
            setTimeout(function() {
    ...
    (Cocoon.define = function(extName, ext) {
      for (
        var namespace =
            'Cocoon.' == extName.substring(0, 7) ? extName.substr(7) : extName,
          base = window.Cocoon,
        ...
        if (
          (console.log(
            object[part]
              ? 'Updated namespace: - ' + extName
              : 'Created namespace: ' + extName
          ),
          (object = object[part] =
            i == parts.length - 1 ? ext(object[part] || {}) : {}),
          !object)
        )
      ...
      (extension.createSignal = function() {
        (this.handle = null),
          ...
          (this.register = function(namespace, handle) {
            if (!namespace && !handle)
              throw new Error("Can't create signal " + (namespace || ''));
            if (handle.addEventListener)
              return (this.signals[namespace] = handle), !0;
            if (!handle.addEventListener) {
              this.signals[namespace] = {};
              for (var prop in handle)
                handle.hasOwnProperty(prop) &&
                  (this.signals[namespace][prop] = handle[prop]);
              return !0;
            }
            throw new Error(
              "Can't create handler for " + namespace + ' signal.'
            );
          }),
          (this.expose = function() {
            return function(signal, callback, params) {
                ...
                return (
                  (fnc.prototype.remove = function(functionListener) {
                    ...
                    handle &&
                      ...
                      (handle.removeEventListener.apply(that, [
                        functionListener,
                      ]),
                      (that.signals[this.signal] = void 0));
                  }),
                  new fnc(signal)
                );
              }
              if ((params && params.once && (once = !0), !this.signals[signal]))
                throw new Error('The signal ' + signal + ' does not exists.');
              ...
              if (
                ...
                !this.signals[signal].addEventListener)
              )
                for (var prop in this.signals[signal])
                  if (this.signals[signal].hasOwnProperty(prop)) {
                    var handle = this.signals[signal][prop];
                    once
                      ? handle.addEventListenerOnce(
                          function() {
                            this.clbk[this.name].apply(
                              this || window,
                              arguments
                            );
  ...
  Cocoon.define('Cocoon.App', function(extension) {
    (extension.nativeAvailable = !!window.ext && !!window.ext.IDTK_APP),
      (extension.isBridgeAvailable = function() {
        if ('boolean' === Cocoon.App.forward.nativeAvailable)
          return Cocoon.App.forward.nativeAvailable;
        var available = Cocoon.callNative(
          'IDTK_APP',
          'forwardAvailable',
          arguments
        );
      ...
      (extension.forward = function(javaScriptCode) {
        return Cocoon.App.nativeAvailable && Cocoon.App.isBridgeAvailable()
          ? Cocoon.callNative('IDTK_APP', 'forward', arguments)
          : navigator.isCocoonJS
            ? void 0
            : 'CocoonJS_App_ForCocoonJS_WebViewIFrame' == window.name
              ? window.parent.eval(javaScriptCode)
              : window.frames.CocoonJS_App_ForCocoonJS_WebViewIFrame.window.eval(
                  javaScriptCode
                );
      }),
      (extension.forwardAsync = function(javaScriptCode, returnCallback) {
        return Cocoon.App.nativeAvailable && Cocoon.App.isBridgeAvailable()
          ? 'undefined' != typeof returnCallback
            ? ext.IDTK_APP.makeCallAsync(
                'forward',
                javaScriptCode,
                returnCallback
              )
            : ext.IDTK_APP.makeCallAsync('forward', javaScriptCode)
          : void setTimeout(function() {
              var res;
              'CocoonJS_App_ForCocoonJS_WebViewIFrame' == window.name
                ? ((res = window.parent.eval(javaScriptCode)),
                  'function' == typeof returnCallback && returnCallback(res))
                : ((res = window.parent.frames.CocoonJS_App_ForCocoonJS_WebViewIFrame.window.eval(
                    javaScriptCode
                  )),
                  'function' == typeof returnCallback && returnCallback(res));
            }, 1);
      }),
      (extension.load = function(path) {
        ...
        if (!navigator.isCocoonJS) {
          ...
          (xhr.onreadystatechange = function() {
            if (4 === xhr.readyState)
              if (200 === xhr.status) {
                var jsCode;
                (jsCode = Cocoon.App.EmulatedWebViewIFrame
                  ? "window.Cocoon && window.Cocoon.App.onLoadInCocoonJSSucceed.notifyEventListeners('" +
                    path +
                    "');"
                  : "window.Cocoon && window.Cocoon.App.onLoadInTheWebViewSucceed.notifyEventListeners('" +
                    path +
                    "');"),
                ...
                var jsCode;
                (jsCode = Cocoon.App.EmulatedWebViewIFrame
                  ? "Cocoon && Cocoon.App.onLoadInCocoonJSFailed.notifyEventListeners('" +
                    path +
                    "');"
                  : "Cocoon && Cocoon.App.onLoadInTheWebViewFailed.notifyEventListeners('" +
                    path +
                    "');"),
                  Cocoon.App.forwardAsync(jsCode);
              }
      ...
      (extension.reload = function() {
        return Cocoon.App.nativeAvailable
          ? Cocoon.callNative('IDTK_APP', 'reload', arguments)
          : navigator.isCocoonJS
            ? void 0
            : 'CocoonJS_App_ForCocoonJS_WebViewIFrame' == window.name
              ? window.parent.location.reload()
              : window.parent.frames.CocoonJS_App_ForCocoonJS_WebViewIFrame.window.location.reload();
      }),
      (extension.openURL = function(url) {
        return Cocoon.App.nativeAvailable
          ? Cocoon.callNative('IDTK_APP', 'openURL', arguments, !0)
          : void (navigator.isCocoonJS || window.open(url, '_blank'));
      }),
      (extension.exit = function() {
        return Cocoon.App.nativeAvailable
          ? Cocoon.callNative('IDTK_APP', 'forceToFinish', arguments)
          : void (navigator.isCocoonJS || window.close());
      }),
      ...
      (extension.onSuspended = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'onsuspended'
      )),
      (extension.onActivated = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'onactivated'
      )),
      (extension.onSuspending = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'onsuspending'
      ));
  ...
  Cocoon.define('Cocoon.App', function(extension) {
    ...
    (extension.pause = function() {
      return Cocoon.App.nativeAvailable
        ? Cocoon.callNative('IDTK_APP', 'pause', arguments)
        : void 0;
    }),
      (extension.resume = function() {
        return Cocoon.App.nativeAvailable
          ? Cocoon.callNative('IDTK_APP', 'resume', arguments)
          : void 0;
      }),
      (extension.loadInTheWebView = function(path) {
            ...
            if (4 === xhr.readyState)
              if (
                ...
                var callback = function() {
                  Cocoon.App.onLoadInTheWebViewSucceed.notifyEventListeners(
                    path
                  ),
                    Cocoon.App.EmulatedWebViewIFrame.removeEventListener(
                      'load',
                      callback
                    );
                };
                ...
                (this.onreadystatechange = null),
                  Cocoon.App.onLoadInTheWebViewFailed.notifyEventListeners(
                    path
                  );
          }),
            xhr.open('GET', path, !0),
      ...
      (extension.reloadWebView = function() {
        Cocoon.App.nativeAvailable && navigator.isCocoonJS
      ...
      (extension.showTheWebView = function(x, y, width, height) {
        Cocoon.App.nativeAvailable && navigator.isCocoonJS
          ...
          : (checkEmulatedWebViewReady(),
            (Cocoon.App.EmulatedWebViewIFrame.style.width =
              (width ? width / window.devicePixelRatio : window.innerWidth) +
              'px'),
            (Cocoon.App.EmulatedWebViewIFrame.style.height =
              (height ? height / window.devicePixelRatio : window.innerHeight) +
              'px'),
            (Cocoon.App.EmulatedWebView.style.left = (x ? x : 0) + 'px'),
            (Cocoon.App.EmulatedWebView.style.top = (y ? y : 0) + 'px'),
            (Cocoon.App.EmulatedWebView.style.width =
              (width ? width / window.devicePixelRatio : window.innerWidth) +
              'px'),
            (Cocoon.App.EmulatedWebView.style.height =
              (height ? height / window.devicePixelRatio : window.innerHeight) +
              'px'),
      ...
      (extension.exitCallback = function(appShouldFinishCallback) {
        navigator.isCocoonJS &&
          Cocoon.App.nativeAvailable &&
          (window.onidtkappfinish = appShouldFinishCallback);
      }),
      (extension.forwardedEventFromTheWebView = function(
        eventName,
        eventDataString
      ) {
        ...
        for (var att in eventData) event[att] = eventData[att];
        (event.target = window), window.dispatchEvent(event);
        for (
          var canvases = document.getElementsByTagName('canvas'), i = 0;
          i < canvases.length;
          i++
        )
          (event.target = canvases[i]), canvases[i].dispatchEvent(event);
      }),
      (extension.onLoadInTheWebViewSucceed = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'forwardpageload'
      )),
      (extension.onLoadInTheWebViewFailed = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'forwardpagefail'
      ));
    ...
    return (
      (extension.logMemoryInfo = function() {
        return Cocoon.nativeAvailable
          ? extension.callNative('IDTK_APP', 'logMemoryInfo', arguments)
          : void 0;
      }),
      (extension.textureReduction = function() {
        Cocoon.nativeAvailable &&
          extension.callNative(
            'IDTK_APP',
            'setDefaultTextureReducerThreshold',
            arguments
          );
      }),
      (extension.markAsMusic = function() {
        return Cocoon.nativeAvailable
          ? extension.callNative('IDTK_APP', 'addForceMusic', arguments)
          : void 0;
      }),
      (extension.captureScreen = function(fileName, storageType, captureType) {
        return Cocoon.nativeAvailable
          ? window.ext.IDTK_APP.makeCall(
              'captureScreen',
              fileName,
              storageType,
              captureType
      ...
      (extension.captureScreenAsync = function(
        fileName,
        storageType,
        captureType,
        callback
        ...
        Cocoon.nativeAvailable &&
          window.ext.IDTK_APP.makeCallAsync(
            'captureScreen',
            fileName,
            storageType,
            captureType,
      ...
      (extension.setAntialias = function() {
        return Cocoon.nativeAvailable
          ? extension.callNative('IDTK_APP', 'setDefaultAntialias', arguments)
          : void 0;
      }),
      ...
      (extension.existsPath = function(path, storageType) {
        return Cocoon.nativeAvailable
          ? window.ext.IDTK_APP.makeCall('existsPath', path, storageType)
          : !1;
      }),
      (extension.setTextCacheSize = function() {
        return Cocoon.nativeAvailable
          ? Cocoon.callNative('IDTK_APP', 'setTextCacheSize', arguments)
          : void 0;
      }),
      extension
    );
    ...
    return (
      ...
      (extension.prompt = function(params, callbacks) {
        ...
        var properties = {
          ...
          args = Cocoon.clone(properties, params),
          succedListener = function() {
            Cocoon.Dialog.onTextDialogCancelled.removeEventListenerOnce(
              errorListener
            ),
              callbacks.success.apply(
                window,
                Array.prototype.slice.call(arguments)
              );
          },
          errorListener = function() {
            Cocoon.Dialog.onTextDialogFinished.removeEventListenerOnce(
              succedListener
            ),
              callbacks.cancel.apply(
                window,
                Array.prototype.slice.call(arguments)
              );
          };
        return (
          Cocoon.Dialog.onTextDialogCancelled.addEventListenerOnce(
            errorListener
          ),
          Cocoon.Dialog.onTextDialogFinished.addEventListenerOnce(
            succedListener
          ),
          Cocoon.App.nativeAvailable
            ? Cocoon.callNative('IDTK_APP', 'showTextDialog', args, !0)
            : void setTimeout(function() {
                var result = prompt(properties.message, properties.text),
                  eventObject = result
                    ? Cocoon.Dialog.onTextDialogFinished
                    : Cocoon.Dialog.onTextDialogCancelled;
      ...
      (extension.confirm = function(params, callback) {
        ...
        var properties = {
          ...
          args = Cocoon.clone(properties, params),
          succedListener = function() {
            Cocoon.Dialog.onMessageBoxDenied.removeEventListenerOnce(
              errorListener
            ),
              callback(!0);
          },
          errorListener = function() {
            Cocoon.Dialog.onMessageBoxConfirmed.removeEventListenerOnce(
              succedListener
            ),
              callback(!1);
          };
        return (
          ...
          Cocoon.Dialog.onMessageBoxConfirmed.addEventListenerOnce(
            succedListener
          ),
          Cocoon.nativeAvailable
            ? Cocoon.callNative('IDTK_APP', 'showMessageBox', args, !0)
            : void setTimeout(function() {
                var result = confirm(properties.message),
                  eventObject = result
                    ? Cocoon.Dialog.onMessageBoxConfirmed
                    : Cocoon.Dialog.onMessageBoxDenied;
                eventObject.notifyEventListeners();
              }, 0)
        );
      }),
      (extension.onTextDialogFinished = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'ontextdialogfinish'
      )),
      (extension.onTextDialogCancelled = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'ontextdialogcancel'
      )),
      (extension.onMessageBoxConfirmed = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'onmessageboxconfirmed'
      )),
      (extension.onMessageBoxDenied = new Cocoon.EventHandler(
        'IDTK_APP',
        'App',
        'onmessageboxdenied'
      )),
  ...
  Cocoon.define('Cocoon.WebView', function(extension) {
    return 'undefined' == typeof Cocoon || null === Cocoon
      ? extension
      : 'undefined' == typeof Cocoon.App || null === Cocoon.App
        ? extension
        : navigator.isCocoonJS
          ? extension
          : ((extension.show = function(x, y, width, height) {
              ...
              var div = window.parent.document.getElementById(
                'CocoonJS_App_ForCocoonJS_WebViewDiv'
              );
              ...
              var iframe = window.parent.document.getElementById(
                'CocoonJS_App_ForCocoonJS_WebViewIFrame'
              );
              (iframe.style.width =
                (width
                  ? width / window.devicePixelRatio
            ...
            (extension.hide = function() {
              return Cocoon.App.nativeAvailable
                ? Cocoon.callNative('IDTK_APP', 'hide', arguments)
                : void (window.parent.document.getElementById(
                    'CocoonJS_App_ForCocoonJS_WebViewDiv'
                  ).style.display = 'none');
            }),
            (extension.loadInCocoon = function(path, callbacks, storageType) {
              if (Cocoon.App.nativeAvailable) {
                var javaScriptCodeToForward =
                  "ext.IDTK_APP.makeCall('loadPath'";
                return (
                  'undefined' != typeof path &&
                    ((javaScriptCodeToForward += ", '" + path + "'"),
                    'undefined' != typeof storageType &&
                      (javaScriptCodeToForward += ", '" + storageType + "'")),
                  (javaScriptCodeToForward += ');'),
                  Cocoon.App.forwardAsync(javaScriptCodeToForward)
                );
              }
            ...
            (extension.reloadCocoonJS = function() {
              return Cocoon.App.nativeAvailable
                ? Cocoon.App.forwardAsync("ext.IDTK_APP.makeCall('reload');")
                : void (
                    navigator.isCocoonJS || window.parent.location.reload()
                  );
            }),
            window.addEventListener('load', function() {
              function forwardEventToCocoonJS(eventName, event) {
                ...
                var jsCode =
                  'Cocoon && Cocoon.App && Cocoon.App.forwardedEventFromTheWebView && Cocoon.App.forwardedEventFromTheWebView(' +
              ...
              if (
                ...
                Cocoon.App.forwardEventsToCocoonJSEnabled = !1;
                  ...
                  window.addEventListener(
                    ...
                    (function(eventName) {
                      return function(event) {
                        Cocoon.App.forwardEventsToCocoonJSEnabled &&
            ...
            (extension.onLoadInCocoonJSSucceed = new Cocoon.EventHandler(
              'IDTK_APP',
              'App',
              'forwardpageload'
            )),
            (extension.onLoadInCocoonJSFailed = new Cocoon.EventHandler(
              'IDTK_APP',
              'App',
              'forwardpagefail'
            )),
  ...
  Cocoon.define('Cocoon.Proxify', function(extension) {
    ...
    return (
      ...
      (extension.setupOriginProxyType = function(
        typeName,
        attributeNames,
        functionNames,
        eventHandlerNames
        ...
        if (Cocoon.nativeAvailable) {
          ...
          if (!attributeNames && !functionNames && !eventHandlerNames)
            throw 'There is no point on setting up a proxy for no attributes, functions nor eventHandlers.';
          ...
          var parentObject = window,
            jsCode =
              'Cocoon.Proxify.setupDestinationProxyType(' +
              JSON.stringify(typeName) +
              ', ' +
              JSON.stringify(eventHandlerNames) +
              ');';
          Cocoon.App.forward(jsCode);
          ...
          (parentObject[typeName] = function() {
            ...
            var jsCode =
              'Cocoon.Proxify.newDestinationProxyObject(' +
              JSON.stringify(typeName) +
              ');';
            (this._cocoonjs_proxy_object_data.id = Cocoon.App.forward(jsCode)),
              ...
              (parentObject[typeName]._cocoonjs_proxy_type_data.proxyObjects[
                this._cocoonjs_proxy_object_data.id
              ] = this);
            for (var i = 0; i < attributeNames.length; i++)
              !(function(attributeName) {
                _this.__defineSetter__(attributeName, function(value) {
                  var jsCode =
                    'Cocoon.Proxify.setDestinationProxyObjectAttribute(' +
                    JSON.stringify(typeName) +
                    ', ' +
                    _this._cocoonjs_proxy_object_data.id +
                    ', ' +
                  ...
                  _this.__defineGetter__(attributeName, function() {
                    var jsCode =
                      'Cocoon.Proxify.getDestinationProxyObjectAttribute(' +
                      JSON.stringify(typeName) +
                      ', ' +
                      _this._cocoonjs_proxy_object_data.id +
                      ', ' +
            ...
            for (var i = 0; i < functionNames.length; i++)
              !(function(functionName) {
                _this[functionName] = function() {
                  ...
                  for (
                    var jsCode =
                        'Cocoon.Proxify.callDestinationProxyObjectFunction(',
                      i = 0;
                    ...
                    jsCode +=
                      (1 !== i
                        ? JSON.stringify(argumentsArray[i])
                        : argumentsArray[i]) +
            ...
            for (var i = 0; i < eventHandlerNames.length; i++)
              !(function(eventHandlerName) {
                _this.__defineSetter__(eventHandlerName, function(value) {
                  _this._cocoonjs_proxy_object_data.eventHandlers[
                    eventHandlerName
                  ] = value;
                }),
                  _this.__defineGetter__(eventHandlerName, function() {
                    return _this
                      ._cocoonjs_proxy_object_data.eventHandlers[eventHandlerName];
                  });
              })(eventHandlerNames[i]);
            return (
              (_this.addEventListener = function(eventTypeName, eventCallback) {
                var addEventCallback = !0,
                  eventListeners =
                    _this._cocoonjs_proxy_object_data.eventListeners[
                      eventTypeName
                    ];
                if (eventListeners)
                  ...
                  var jsCode =
                    'Cocoon.Proxify.addDestinationProxyObjectEventListener(' +
                    JSON.stringify(_this._cocoonjs_proxy_object_data.typeName) +
                    ', ' +
                    _this._cocoonjs_proxy_object_data.id +
                    ', ' +
                    JSON.stringify(eventTypeName) +
                    ');';
                  Cocoon.App.forwardAsync(jsCode);
                }
                addEventCallback && eventListeners.push(eventCallback);
              }),
              (_this.removeEventListener = function(
                ...
                if (eventListeners) {
                  var eventCallbackIndex = eventListeners.indexOf(
                    eventCallback
                  );
            ...
            (parentObject[
              typeName
            ]._cocoonjs_proxy_type_data.deleteProxyObject = function(object) {
              var proxyObjectKey = extension.getKeyForValueInDictionary(
                this.proxyObjects,
                object
              );
              if (proxyObjectKey) {
                var jsCode =
                  'Cocoon.Proxify.deleteDestinationProxyObject(' +
                  JSON.stringify(typeName) +
                  ', ' +
                  object._cocoonjs_proxy_object_data.id +
                  ');';
                Cocoon.App.forwardAsync(jsCode),
            ...
            (parentObject[
              typeName
            ]._cocoonjs_proxy_type_data.callProxyObjectEventHandler = function(
              id,
              eventHandlerName
            ) {
              var object = this.proxyObjects[id],
                eventHandler =
                  object._cocoonjs_proxy_object_data.eventHandlers[
                    eventHandlerName
                  ];
            ...
            (parentObject[
              typeName
            ]._cocoonjs_proxy_type_data.callProxyObjectEventListeners = function(
              id,
              eventTypeName
            ) {
              for (
                var object = this.proxyObjects[id],
                  eventListeners = object._cocoonjs_proxy_object_data.eventListeners[
                    eventTypeName
                  ].slice(),
                  i = 0;
      ...
      (extension.takedownOriginProxyType = function(typeName) {
        if (Cocoon.App.nativeAvailable) {
          ...
          parentObject[typeName] &&
            parentObject[typeName]._cocoonjs_proxy_type_data &&
            (parentObject[typeName] =
              parentObject[typeName]._cocoonjs_proxy_type_data.originalType);
        }
      }),
      (extension.deleteOriginProxyObject = function(object) {
        if (Cocoon.App.nativeAvailable) {
          var parentObject = window;
          object &&
            object._cocoonjs_proxy_object_data &&
            parentObject[
              object._cocoonjs_proxy_object_data.typeName
            ]._cocoonjs_proxy_type_data.deleteProxyObject(object);
        }
      }),
      (extension.callOriginProxyObjectEventHandler = function(
        typeName,
        id,
        eventHandlerName
      ) {
        if (Cocoon.App.nativeAvailable) {
          ...
          parentObject[
            typeName
          ]._cocoonjs_proxy_type_data.callProxyObjectEventHandler(
            id,
            eventHandlerName
          );
        }
      }),
      (extension.callOriginProxyObjectEventListeners = function(
        typeName,
        id,
        eventTypeName
      ) {
        if (Cocoon.App.nativeAvailable) {
          ...
          parentObject[
            typeName
          ]._cocoonjs_proxy_type_data.callProxyObjectEventListeners(
            id,
            eventTypeName
          );
        }
      }),
      (extension.setupDestinationProxyType = function(
        typeName,
        eventHandlerNames
      ) {
        if (Cocoon.App.nativeAvailable) {
      ...
      (extension.newDestinationProxyObject = function(typeName) {
        if (Cocoon.App.nativeAvailable) {
          var parentObject = window,
            proxyObject = new parentObject[typeName]();
          ...
          for (
            var i = 0;
            i <
            parentObject[typeName]._cocoonjs_proxy_type_data.eventHandlerNames
              .length;
            i++
          )
            !(function(eventHandlerName) {
              proxyObject[eventHandlerName] = function() {
                var proxyObject = this,
                  jsCode =
                    'Cocoon.App.callOriginProxyObjectEventHandler(' +
                    JSON.stringify(
                      proxyObject._cocoonjs_proxy_object_data.typeName
                    ) +
                    ', ' +
                    proxyObject._cocoonjs_proxy_object_data.id +
                    ', ' +
                    JSON.stringify(eventHandlerName) +
                    ');';
                Cocoon.App.forwardAsync(jsCode);
              };
            })(
      ...
      (extension.callDestinationProxyObjectFunction = function(
        typeName,
        id,
        functionName
      ) {
        if (Cocoon.App.nativeAvailable) {
          ...
          var proxyObject =
              parentObject[typeName]._cocoonjs_proxy_type_data.proxyObjects[id],
            result = proxyObject[functionName].apply(
              proxyObject,
              argumentsArray
            );
          return result;
      ...
      (extension.setDestinationProxyObjectAttribute = function(
        typeName,
        id,
        attributeName,
        attributeValue
      ...
      (extension.getDestinationProxyObjectAttribute = function(
        typeName,
        id,
        attributeName
      ) {
      ...
      (extension.deleteDestinationProxyObject = function(typeName, id) {
        if (Cocoon.App.nativeAvailable) {
          var parentObject = window;
          delete parentObject[typeName]._cocoonjs_proxy_type_data.proxyObjects[
            id
          ];
        }
      }),
      (extension.addDestinationProxyObjectEventListener = function(
        typeName,
        id,
        eventTypeName
      ) {
        if (Cocoon.App.nativeAvailable) {
          var parentObject = window,
            ...
            callback = function() {
              var proxyObject = this,
                jsCode =
                  'Cocoon.Proxify.callOriginProxyObjectEventListeners(' +
                  JSON.stringify(
                    proxyObject._cocoonjs_proxy_object_data.typeName
                  ) +
                  ', ' +
      ...
      (extension.xhr = function() {
        ...
        Cocoon.Proxify.setupOriginProxyType(
          'XMLHttpRequest',
          ATTRIBUTE_NAMES,
          FUNCTION_NAMES,
          EVENT_HANDLER_NAMES
      ...
      (extension.audio = function() {
        var ATTRIBUTE_NAMES = ['src', 'loop', 'volume', 'preload'],
          FUNCTION_NAMES = ['play', 'pause', 'load', 'canPlayType'],
          EVENT_HANDLER_NAMES = [
            'onended',
            'oncanplay',
            'oncanplaythrough',
      ...
      (extension.console = function() {
        if (Cocoon.nativeAvailable) {
          'undefined' == typeof Cocoon.originalConsole &&
          ...
          for (
            ...
            newConsole[functions[i]] = (function() {
  ...
  Cocoon.define('Cocoon.Device', function(extension) {
    ...
    return (
      ...
      (extension.getDeviceId = function() {
        return Cocoon.nativeAvailable
          ? window.ext.IDTK_APP.makeCall('getDeviceId')
          : void 0;
      }),
      (extension.getDeviceInfo = function() {
        return Cocoon.nativeAvailable
          ? window.ext.IDTK_APP.makeCall('getDeviceInfo')
          : void 0;
      }),
      (extension.getOrientation = function() {
        return Cocoon.nativeAvailable
          ? window.ext.IDTK_APP.makeCall('getPreferredOrientation')
          : 0;
      }),
      ...
      (extension.autoLock = function() {
        return Cocoon.nativeAvailable
          ? Cocoon.callNative('IDTK_APP', 'setAutoLockEnabled', arguments)
          : void 0;
      }),
      extension
    );
  ...
  Cocoon.define('Cocoon.Motion', function(extension) {
    ...
    return (
      ...
      (extension.setAccelerometerInterval = function(updateIntervalInSeconds) {
        return Cocoon.Motion.nativeAvailable
          ? window.ext.IDTK_APP.makeCall(
              'setAccelerometerUpdateIntervalInSeconds',
      ...
      (extension.getAccelerometerInterval = function() {
        return Cocoon.Motion.nativeAvailable
          ? window.ext.IDTK_APP.makeCall(
              'getAccelerometerUpdateIntervalInSeconds'
            )
          : void 0;
      }),
      (extension.setGyroscopeInterval = function(updateIntervalInSeconds) {
        return Cocoon.Motion.nativeAvailable
          ? window.ext.IDTK_APP.makeCall(
              'setGyroscopeUpdateIntervalInSeconds',
              updateIntervalInSeconds
            )
          : void 0;
      }),
      (extension.getGyroscopeInterval = function() {
        Cocoon.Motion.nativeAvailable &&
    ...
    return (
      ...
      (extension.disable = function() {
        Cocoon.nativeAvailable
          ...
          : navigator.isCocoonJS ||
            ...
            ((Cocoon.App.forwardEventsToCocoonJSEnabled = !1),
            Cocoon.App.forwardAsync(
              'Cocoon && Cocoon.Touch && Cocoon.Touch.disable();'
            ));
      }),
      (extension.enable = function() {
        Cocoon.nativeAvailable
          ...
          : navigator.isCocoonJS ||
            Cocoon.App.EmulatedWebViewIFrame ||
            ((Cocoon.App.forwardEventsToCocoonJSEnabled = !0),
            Cocoon.App.forwardAsync(
              'Cocoon && Cocoon.Touch && Cocoon.Touch.enable();'
            ));
      }),
      (extension.disableInWebView = function() {
        Cocoon.nativeAvailable
          ...
          : navigator.isCocoonJS ||
            (Cocoon.App.EmulatedWebViewIFrame
              ? Cocoon.App.forwardAsync(
                  'Cocoon && Cocoon.Touch && Cocoon.Touch.disableInWebView();'
                )
      ...
      (extension.enableInWebView = function() {
        Cocoon.nativeAvailable
          ...
          : navigator.isCocoonJS ||
            (Cocoon.App.EmulatedWebViewIFrame
              ? Cocoon.Touch.forwardAsync(
                  'Cocoon && Cocoon.Touch && Cocoon.Touch.enableInWebView();'
                )
        ...
        if (Cocoon.App.nativeAvailable)
          ...
          (iframe.id = 'CocoonJSWebDialogIFrame'),
            ...
            (iframe.style.cssText =
              'position:fixed;left:0;top:0;bottom:0;right:0; width:100%; height:100%;margin:0;padding:0;');
          var me = this;
          (iframe.onload = function() {
            me.iframeloaded = !0;
            var js =
              'Cocoon = {}; Cocoon.Widget = {}; Cocoon.Widget.WebDialog = {} Cocoon.Widget.WebDialog.close = function(){   window.parent.CocoonJSCloseWebDialog();};';
            me.evalIframe(js);
        ...
        show: function(url, callback) {
          return (
            (this.closeCallback = function() {
              Cocoon.Touch.enable(), callback && callback();
            }),
            Cocoon.App.nativeAvailable
              ...
              : ((this.iframe.src = url),
                void document.body.appendChild(this.iframe))
          );
        },
        close: function() {
          return Cocoon.App.nativeAvailable
            ...
            : (this.iframe.parentNode &&
              ...
              void (this.closeCallback && this.closeCallback()));
        },
  ...
  Cocoon.define('Cocoon.Camera', function(extension) {
    return (
      ...
      (extension.CameraType = { FRONT: 'FRONT', BACK: 'BACK' }),
      ...
      (extension.getAllCamerasInfo = function() {
        return Cocoon.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_CAMERA', 'getAllCamerasInfo', arguments)
          : void 0;
      }),
      (extension.getCameraInfoByIndex = function() {
        return Cocoon.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_CAMERA',
              'getCameraInfoByIndex',
              arguments
            )
          : void 0;
      }),
      (extension.getCameraInfoByType = function() {
        return Cocoon.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_CAMERA',
              'getCameraInfoByType',
      ...
      (extension.start = function(params) {
        if (!Boolean(params.success) || !Boolean(params.error))
          throw new Error('Missing callbacks for Cocoon.Camera.start();');
        if (Cocoon.nativeAvailable) {
          var properties = {
              cameraIndex: 0,
              width: 50,
            ...
            img = (Cocoon.clone(properties, params),
            Cocoon.callNative('IDTK_SRV_CAMERA', 'startCapturing', arguments));
          Boolean(img) ? params.success(img) : params.error(!1);
        } else
          navigator.getMedia(
            { video: !0, audio: !1 },
            function(stream) {
      ...
      (extension.stop = function() {
        return Cocoon.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_CAMERA', 'stopCapturing', arguments)
          : void 0;
      }),
      (extension.isCapturing = function() {
        return Cocoon.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_CAMERA', 'isCapturing', arguments)
          : void 0;
      }),
      extension
    );
  ...
  Cocoon.define('Cocoon.Ad', function(extension) {
    'use strict';
    (extension.nativeAvailable =
      !!Cocoon.nativeAvailable && !!window.ext.IDTK_SRV_AD),
      ...
      (extension.Banner = function(id) {
        if ('number' != typeof id) throw 'The given ad ID is not a number.';
        this.id = id;
        var me = this;
        (this.onBannerShown = new Cocoon.EventHandler(
          'IDTK_SRV_AD',
          'Ad',
          'onbannershow',
          function(sourceListener, args) {
            me.id === args[0] && sourceListener();
          }
        )),
          (this.onBannerHidden = new Cocoon.EventHandler(
            'IDTK_SRV_AD',
            'Ad',
            'onbannerhide',
            function(sourceListener, args) {
          ...
          (this.onBannerReady = new Cocoon.EventHandler(
            'IDTK_SRV_AD',
            'Ad',
            'onbannerready',
            function(sourceListener, args) {
              me.id === args[0] && sourceListener(args[1], args[2]);
            }
          ));
        var signal = new Cocoon.Signal.createSignal();
      ...
      (extension.Banner.prototype = {
        showBanner: function() {
          Cocoon.Ad.nativeAvailable &&
            Cocoon.callNative('IDTK_SRV_AD', 'showBanner', [this.id], !0);
        },
        hideBanner: function() {
          Cocoon.Ad.nativeAvailable &&
            Cocoon.callNative('IDTK_SRV_AD', 'hideBanner', [this.id], !0);
        },
        load: function() {
          Cocoon.Ad.nativeAvailable &&
            Cocoon.callNative('IDTK_SRV_AD', 'refreshBanner', [this.id], !0);
        },
        getRectangle: function() {
          return Cocoon.Ad.nativeAvailable
            ? Cocoon.callNative('IDTK_SRV_AD', 'getRectangle', [this.id])
            : void 0;
        },
        setRectangle: function(rect) {
          return Cocoon.Ad.nativeAvailable
            ? Cocoon.callNative('IDTK_SRV_AD', 'setRectangle', [this.id, rect])
            : void 0;
        },
        setBannerLayout: function(bannerLayout) {
          return Cocoon.Ad.nativeAvailable
            ? Cocoon.callNative('IDTK_SRV_AD', 'setBannerLayout', [
                this.id,
                bannerLayout,
              ])
            : void 0;
      ...
      (extension.Interstitial = function(id) {
        ...
        this.id = id;
        var me = this;
        (this.onFullScreenShown = new Cocoon.EventHandler(
          'IDTK_SRV_AD',
          'Ad',
          'onfullscreenshow',
          function(sourceListener, args) {
          ...
          (this.onFullScreenHidden = new Cocoon.EventHandler(
            'IDTK_SRV_AD',
            'Ad',
            'onfullscreenhide',
            function(sourceListener, args) {
          ...
          (this.onFullScreenReady = new Cocoon.EventHandler(
            'IDTK_SRV_AD',
            'Ad',
            'onfullscreenready',
            function(sourceListener, args) {
      ...
      (extension.Interstitial.prototype = {
        showInterstitial: function() {
          return Cocoon.Ad.nativeAvailable
            ? Cocoon.callNative('IDTK_SRV_AD', 'showFullScreen', [this.id], !0)
            : void 0;
        },
      ...
      (extension.configure = function(parameters) {
        return (
          'undefined' == typeof parameters && (parameters = {}),
          Cocoon.Ad.nativeAvailable
            ? Cocoon.callNative(
                'IDTK_SRV_AD',
      ...
      (extension.createBanner = function(parameters) {
        if (
          ...
          var adId = Cocoon.callNative('IDTK_SRV_AD', 'createBanner', [
              parameters,
            ]),
            banner = new extension.Banner(adId);
          return banner;
        }
      }),
      (extension.releaseBanner = function(banner) {
        if ('undefined' == typeof banner)
      ...
      (extension.createInterstitial = function(parameters) {
        if (
          ...
          var adId = Cocoon.callNative('IDTK_SRV_AD', 'createFullscreen', [
              parameters,
            ]),
            fullscreen = new Cocoon.Ad.Interstitial(adId);
          return fullscreen;
        }
      }),
      (extension.releaseInterstitial = function(fullscreen) {
        ...
        Cocoon.Ad.nativeAvailable &&
          Cocoon.callNative('IDTK_SRV_AD', 'releaseFullscreen', [
            fullscreen.id,
          ]);
      }),
      (extension.showBanner = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_AD', 'showBanner', arguments, !0)
          : void 0;
      }),
      (extension.hideBanner = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_AD', 'hideBanner', arguments, !0)
          : void 0;
      }),
      (extension.refreshBanner = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_AD', 'refreshBanner', arguments, !0)
          : void 0;
      }),
      (extension.showInterstitial = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_AD', 'showFullScreen', arguments, !0)
          : void 0;
      }),
      (extension.refreshInterstitial = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_AD', 'refreshFullScreen', arguments, !0)
          : void 0;
      }),
      (extension.preloadedBanner = !1),
      (extension.loadBanner = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.Ad.preloadedBanner
            ? Cocoon.Ad.refreshBanner()
            : ((Cocoon.Ad.preloadedBanner = !0),
              Cocoon.callNative('IDTK_SRV_AD', 'preloadBanner', arguments, !0))
          : void 0;
      }),
      (extension.preloadedInterstitial = !1),
      (extension.loadInterstitial = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.Ad.preloadedInterstitial
            ? Cocoon.Ad.refreshInterstitial()
            : ((Cocoon.Ad.preloadedInterstitial = !0),
              Cocoon.callNative(
                'IDTK_SRV_AD',
                'preloadFullScreen',
                arguments,
      ...
      (extension.setRectangle = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_AD', 'setRectangle', arguments)
          : void 0;
      }),
      (extension.getRectangle = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_AD', 'getRectangle', arguments)
          : void 0;
      }),
      (extension.setBannerLayout = function() {
        return Cocoon.Ad.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_AD', 'setBannerLayout', arguments)
          : void 0;
      }),
      (extension.onBannerShown = new Cocoon.EventHandler(
        'IDTK_SRV_AD',
        'Ad',
        'onbannershow'
      )),
      (extension.onBannerHidden = new Cocoon.EventHandler(
        'IDTK_SRV_AD',
        'Ad',
        'onbannerhide'
      )),
      (extension.onBannerReady = new Cocoon.EventHandler(
        'IDTK_SRV_AD',
        'Ad',
        'onbannerready'
      )),
      (extension.onFullScreenShown = new Cocoon.EventHandler(
        'IDTK_SRV_AD',
        'Ad',
        'onfullscreenshow'
      )),
      (extension.onFullScreenHidden = new Cocoon.EventHandler(
        'IDTK_SRV_AD',
        'Ad',
        'onfullscreenhide'
      )),
      (extension.onFullScreenReady = new Cocoon.EventHandler(
        'IDTK_SRV_AD',
        'Ad',
        'onfullscreenready'
      ));
  ...
  Cocoon.define('Cocoon.Store', function(extension) {
    'use strict';
    (extension.nativeAvailable =
      !!Cocoon.nativeAvailable && !!window.ext.IDTK_SRV_STORE),
      ...
      (extension.PurchaseInfo = function(
        transactionId,
        purchaseTime,
        purchaseState,
        productId,
      ...
      (extension.getStoreType = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'getStoreType', arguments)
          : !1;
      }),
      (extension.initialize = function(params) {
        params = params || {};
        var properties = { sandbox: !1, managed: !0 },
          args = Cocoon.clone(properties, params);
      ...
      (extension.requestInitialization = function(parameters) {
        return (
          'undefined' == typeof parameters
            ? (parameters = {})
            : (void 0 !== parameters.managed &&
                (parameters.remote = parameters.managed),
              void 0 !== parameters.sandbox &&
                (parameters.debug = parameters.sandbox)),
      ...
      (extension.start = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'start', arguments)
          : void 0;
      }),
      (extension.canPurchase = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'canPurchase', arguments)
          : !1;
      }),
      ...
      (extension.loadProducts = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_STORE',
      ...
      (extension.finish = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'finishPurchase', arguments, !0)
          : void 0;
      }),
      (extension.consume = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_STORE',
              'consumePurchase',
      ...
      (extension.puchaseProductModal = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_STORE',
      ...
      (extension.purchaseProductModalWithPreview = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_STORE',
              'purchaseFeatureModalWithPreview',
              arguments,
              !0
            )
          : void 0;
      }),
      (extension.isProductPurchased = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'isFeaturePurchased', arguments)
          : void 0;
      }),
      ...
      (extension.getProducts = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'getProducts', arguments)
          : void 0;
      }),
      (extension.addProduct = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'addProduct', arguments)
          : void 0;
      }),
      (extension.removeProduct = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'removeProduct', arguments)
          : void 0;
      }),
      (extension.getPurchases = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'getPurchases', arguments)
          : void 0;
      }),
      (extension.addPurchase = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'addPurchase', arguments)
          : void 0;
      }),
      (extension.removePurchase = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'removePurchase', arguments)
          : void 0;
      }),
      (extension.cancelPurchase = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'cancelPurchase', arguments)
          : void 0;
      }),
      (extension.refundPurchase = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'refundPurchase', arguments)
          : void 0;
      }),
      (extension.expirePurchase = function() {
        return Cocoon.Store.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_STORE', 'expirePurchase', arguments)
          : void 0;
      }),
      (extension.onProductsFetchStarted = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onProductsFetchStarted'
      )),
      (extension.onProductsFetchCompleted = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onProductsFetchCompleted'
      )),
      (extension.onProductsFetchFailed = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onProductsFetchFailed'
      )),
      (extension.onProductPurchaseStarted = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onProductPurchaseStarted'
      )),
      (extension.onProductPurchaseVerificationRequestReceived = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onProductPurchaseVerificationRequestReceived'
      )),
      (extension.onProductPurchaseCompleted = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onProductPurchaseCompleted'
      )),
      (extension.onProductPurchaseFailed = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onProductPurchaseFailed'
      )),
      (extension.onRestorePurchasesStarted = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onRestorePurchasesStarted'
      )),
      (extension.onRestorePurchasesCompleted = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onRestorePurchasesCompleted'
      )),
      (extension.onRestorePurchasesFailed = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onRestorePurchasesFailed'
      )),
      (extension.onConsumePurchaseStarted = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onConsumePurchaseStarted'
      )),
      (extension.onConsumePurchaseCompleted = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
        'onConsumePurchaseCompleted'
      )),
      (extension.onConsumePurchaseFailed = new Cocoon.EventHandler(
        'IDTK_SRV_STORE',
        'Store',
  ...
  Cocoon.define('Cocoon.Notification', function(extension) {
    (extension.nativeAvailable =
      !!window.ext && !!window.ext.IDTK_SRV_NOTIFICATION),
      (extension.Local = {}),
      (extension.Push = {}),
      (extension.Local.create = function(params) {
        var properties = {
          ...
          args = Cocoon.clone(properties, params);
        return Cocoon.Notification.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_NOTIFICATION',
      ...
      (extension.start = function() {
        return Cocoon.Notification.nativeAvailable
          ? Cocoon.callNative('IDTK_SRV_NOTIFICATION', 'start', arguments)
          : void 0;
      }),
      ...
      (extension.unsubscribe = function() {
        return Cocoon.Notification.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_NOTIFICATION',
              'unsubscribe',
      ...
      (extension.setBadgeNumber = function() {
        return Cocoon.Notification.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_NOTIFICATION',
              'setBadgeNumber',
      ...
      (extension.Local.getLastNotificationData = function() {
        return Cocoon.Notification.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_NOTIFICATION',
              'getLastReceivedLocalNotificationData',
              arguments
            )
          : void 0;
      }),
      (extension.Push.getLastNotificationData = function() {
        return Cocoon.Notification.nativeAvailable
          ? Cocoon.callNative(
              'IDTK_SRV_NOTIFICATION',
              'getLastReceivedPushNotificationData',
              arguments
            )
          : void 0;
      }),
      (extension.onRegisterForPushNotificationsSucceed = new Cocoon.EventHandler(
        'IDTK_SRV_NOTIFICATION',
        'Notification',
        'pushNotificationServiceRegistered'
      )),
      (extension.onUnregisterForPushNotificationsSucceed = new Cocoon.EventHandler(
        'IDTK_SRV_NOTIFICATION',
        'Notification',
        'pushNotificationServiceUnregistered'
      )),
      (extension.onRegisterForPushNotificationsFailed = new Cocoon.EventHandler(
        'IDTK_SRV_NOTIFICATION',
        'Notification',
        'pushNotificationServiceFailedToRegister'
      )),
      (extension.onPushNotificationReceived = new Cocoon.EventHandler(
        'IDTK_SRV_NOTIFICATION',
        'Notification',
        'pushNotificationReceived'
      )),
      (extension.onLocalNotificationReceived = new Cocoon.EventHandler(
        'IDTK_SRV_NOTIFICATION',
        'Notification',
        'localNotificationReceived'
      )),
      (extension.onPushNotificationDeliverySucceed = new Cocoon.EventHandler(
        'IDTK_SRV_NOTIFICATION',
        'Notification',
        'pushNotificationSuccessfullyDelivered'
      )),
      (extension.onPushNotificationDeliveryFailed = new Cocoon.EventHandler(
        'IDTK_SRV_NOTIFICATION',
        'Notification',
  ...
  Cocoon.define('Cocoon.Social', function(extension) {
    return (
      (extension.Interface = function() {
        this.onLoginStatusChanged = new Cocoon.EventHandler(
          '',
          'dummy',
      ...
      (extension.Interface.prototype = {
        ...
        login: function(callback) {
          callback && callback(!1, { message: 'Not implemented!' });
        },
        logout: function(callback) {
          callback && callback({ message: 'Not implemented!' });
        },
        ...
        requestUserImage: function(callback) {
      ...
      (extension.SocialGamingService.prototype = {
        ...
        requestScore: function(callback) {
          callback(null, { message: 'Not implemented!' });
        },
        ...
        translateAchievementID: function(id) {
          if (this._achievementsMap)
            for (var customID in this._achievementsMap)
              if (customID == id) return this._achievementsMap[customID];
          return id;
        },
        syncAchievementsMap: function(achievements) {
          if (this._achievementsMap)
            for (var i = 0; i < achievements.length; ++i)
              for (var customID in this._achievementsMap)
                this._achievementsMap[customID] ===
                  achievements[i].achievementID &&
      ...
      (extension.ScoreParams = function(
        userID,
        leaderboardID,
        friends,
        timeScope
      ...
      (extension.TimeScope = { ALL_TIME: 0, WEEK: 1, TODAY: 2 }),
      (extension.Achievement = function(
        achievementID,
        title,
        description,
        imageURL,
      ...
      (extension.share = function() {
        return Cocoon.nativeAvailable
          ? Cocoon.callNative('IDTK_APP', 'share', arguments, !0)
          : void 0;
      }),
      extension
    );
      ...
      (extension.ManagerService.prototype = {
        ...
        submitAchievement: function(achievementID) {
          for (var i = 0; i < this.services.length; ++i) {
            ...
            !service.readOnlyHint &&
              service.isLoggedIn() &&
              service.submitAchievement(achievementID, function(error) {
                error &&
                  console.error(
                    'Error submitting achievement: ' + error.message
                  );
              });
          }
        },
        ...
        getLoggedInServices: function() {
          for (var result = [], i = 0; i < this.services.length; ++i) {
            var service = this.services[i];
            !service.fakeSocialService &&
              service.isLoggedIn() &&
              result.push(service);
          }
          return result;
  ...
  Cocoon.define('Cocoon.Social', function(extension) {
    return (
      ...
      (extension.LocalStorageService.prototype = {
        ...
        login: function(callback) {
          this.loggedIn || this.onLoginStatusChanged.notifyEventListeners(!0),
            (this.loggedIn = !0),
            callback &&
              setTimeout(function() {
                callback(!0);
        ...
        submitScore: function(score, callback) {
          var scoreItem = localStorage.getItem(this.keys.score),
            topScore = parseInt(scoreItem) || 0;
          score > topScore && localStorage.setItem(this.keys.score, score),
            callback &&
              setTimeout(function() {
                callback();
              }, 0);
        ...
        getLocalStorageEarnedAchievements: function() {
          var achievementsItem = localStorage.getItem(
              this.keys.earnedAchievements
            ),
            earned = [];
          if (achievementsItem) {
            var array = JSON.stringify(achievementsItem);
            array && array.length && (earned = array);
          }
          return earned;
        },
        requestAchievements: function(callback) {
        ...
        submitAchievement: function(achievementID, callback) {
          if (null === achievementID || 'undefined' == typeof achievementID)
  ...
  Cocoon.define('Cocoon.Social', function(extension) {
    function fromSessionToAuthTokenObject(response, error) {
      return {
        ...
        error: error,
        expires_in: response.expirationDate
          ? response.expirationDate - Date.now()
          : 0,
        player_id: response.playerId,
      };
    }
    function fromGPPlayerToCocoonUser(gpPlayer) {
      return new Cocoon.Social.User(
        gpPlayer.playerId,
        gpPlayer.displayName,
        gpPlayer.avatarImageUrl
      );
    }
    function fromGPPersonToCocoonUser(gpUser) {
      ...
      return (
        ...
        new Cocoon.Social.User(gpUser.id, gpUser.displayName, avatar)
      );
    }
    function fromImageSizeToGPSize(imageSize) {
      return imageSize === Cocoon.Social.ImageSize.THUMB
        ? 100
        : imageSize === Cocoon.Social.ImageSize.MEDIUM
          ? 200
          : imageSize === Cocoon.Social.ImageSize.LARGE
            ? 512
            : void 0;
    }
    function fromGPAchievementToCocoonAchievement(gpItem) {
      ...
      return (result.gpAchievementData = gpItem), result;
    }
    function fromGPScoreToCocoonScore(gpItem, leaderboardID) {
      return new Cocoon.Social.Score(
        gpItem.player.playerId,
        gpItem.scoreValue,
        gpItem.player.displayName,
        gpItem.player.avatarImageUrl,
        leaderboardID
      );
    }
    return (
      (extension.GooglePlayGamesExtension = function() {
        (this.nativeExtensionName = 'IDTK_SRV_GOOGLE_PLAY_GAMES'),
          ...
          (this.nativeAvailable =
            Cocoon.nativeAvailable &&
            'undefined' != typeof window.ext[this.nativeExtensionName]),
          (this.auth = new Cocoon.Social.GooglePlayGamesAuthExtension(this)),
          (this.client = new Cocoon.Social.GooglePlayGamesClientExtension(
            this
          )),
          (this.defaultScopes = [
          ...
          (this.onSessionChanged = new Cocoon.EventHandler(
            this.nativeExtensionName,
            this.extensionName,
            'onSessionChanged'
          )),
      ...
      (extension.GooglePlayGamesExtension.prototype = {
        ...
        getSocialInterface: function() {
          ...
          return (
            this.socialService ||
              (this.socialService = new Cocoon.Social.SocialGamingServiceGooglePlayGames(
                this
              )),
            this.socialService
          );
      ...
      (extension.GooglePlayGamesAuthExtension = function(extension) {
        return (this.extension = extension), this;
      }),
      (extension.GooglePlayGamesAuthExtension.prototype = {
        authorize: function(params, callback) {
          var me = this;
          this.extension.nativeAvailable
            ? Cocoon.callNative(
                this.extension.nativeExtensionName,
                'authorize',
                [
                  params,
                  function(response, error) {
                    (me.extension.token = fromSessionToAuthTokenObject(
                      response,
                      error
                    )),
                      callback && callback(me.extension.token);
                  },
                ],
                !0
              )
            : gapi.auth.authorize(params, function(response) {
                (me.extension.token = response),
                  me.extension.onSessionChanged.notifyEventListeners(
                    response,
        ...
        disconnect: function(callback) {
          this.extension.nativeAvailable
            ...
            : callback && callback({ error: 'Not implemented yet' });
        },
        ...
        getToken: function() {
          return this.extension.nativeAvailable
            ? this.extension.token
            : gapi.auth.getToken();
        },
                ...
                Cocoon.callNative(
                  ...
                  [
                    ...
                    function(response, error) {
                      var result = response;
                      error &&
                        ((result = response || {}), (result.error = error)),
            ...
            var me = this,
              httpRequest = {
                execute: function(callback) {
                  Cocoon.callNative(
                    me.extension.nativeExtensionName,
                    'request',
                    [
                      args,
                      function(response, error) {
      ...
      (extension.SocialGamingServiceGooglePlayGames = function(apiObject) {
        Cocoon.Social.SocialGamingServiceGooglePlayGames.superclass.constructor.call(
          this
        ),
          (this.gapi = apiObject);
        var me = this;
        return (
          this.gapi.onSessionChanged.addEventListener(function(session) {
            var obj = session || {};
            me.onLoginStatusChanged.notifyEventListeners(
              !!obj.access_token,
              obj.error
            );
          }),
      ...
      (extension.SocialGamingServiceGooglePlayGames.prototype = {
        isLoggedIn: function() {
          return this.gapi.token && this.gapi.token.access_token ? !0 : !1;
        },
        login: function(callback) {
          var me = this;
          this.gapi.auth.authorize(
            ...
            function(response) {
              callback && callback(me.isLoggedIn(), response.error);
            }
          );
        },
        logout: function(callback) {
        ...
        getLoggedInUser: function() {
          return this.gapi.currentPlayer
            ? fromGPUserToCocoonUser(this.gapi.currentPlayer)
            : null;
        },
        requestUser: function(callback, userId) {
            ...
            callback: function(response) {
              var user =
                response && !response.error
                  ? fromGPPlayerToCocoonUser(response)
                  : null;
        ...
        requestUserImage: function(callback, userID, imageSize) {
          this.requestUser(function(user, error) {
            if (user && user.userImage) {
              var pixelSize = fromImageSizeToGPSize(
                imageSize || Cocoon.Social.ImageSize.MEDIUM
              );
              -1 === user.userImage.indexOf('sz=')
                ? (user.userImage += '?sz=' + pixelSize)
                : (user.userImage = user.userImage.replace(
                    /sz=\d+/g,
                    'sz=' + pixelSize
                  ));
            }
          ...
          this.gapi.client.request({
            ...
            callback: function(response) {
              if (response && !response.error) {
                for (var friends = [], i = 0; i < response.items.length; ++i)
                  friends.push(fromGPPersonToCocoonUser(response.items[i]));
                callback(friends);
              } else callback([], response ? response.error : null);
            },
          });
        },
        publishMessage: function(message, callback) {
          callback &&
            callback(
              'Not supported... use publishMessageWithDialog method instead'
            );
        },
        publishMessageWithDialog: function(message, callback) {
        ...
        requestScore: function(callback, params) {
          ...
          var playerId = params.userID || 'me',
            leaderboardID =
              params.leaderboardID || this.gapi.settings.defaultLeaderboard;
          if (!leaderboardID)
          ...
          this.gapi.client.request({
            path:
              ...
              '/scores/ALL_TIME',
            callback: function(response) {
              if (response && response.error) callback(null, response.error);
              else if (
                response &&
                response.items &&
        ...
        submitScore: function(score, callback, params) {
          ...
          this.gapi.client.request({
            path:
              this.gapi.gamesAPI + '/leaderboards/' + leaderboardID + '/scores',
            method: 'POST',
            params: { score: score },
            callback: function(response) {
              callback && callback(response ? response.error : null);
            },
          });
        },
        showLeaderboard: function(callback, params) {
          ...
          if (!ios && this.gapi.nativeAvailable) {
            ...
            Cocoon.callNative(
              this.gapi.nativeExtensionName,
              'showLeaderboard',
              [leaderboardID, timeScope, callback],
              !0
            );
          } else {
            ...
            dialog.show(this._leaderboardsTemplate, function(error) {
              (dialog.closed = !0),
                !callbackSent && callback && callback(error);
            });
            var collection = params.friends ? 'SOCIAL' : 'PUBLIC',
              timeSpan = 'ALL_TIME';
            params.timeScope === Cocoon.Social.TimeScope.WEEK
              ? (timeSpan = 'WEEKLY')
              : params.timeScope === Cocoon.Social.TimeScope.TODAY &&
                (timeSpan = 'DAILY'),
              this.gapi.client.request({
                path:
                  this.gapi.gamesAPI +
                ...
                callback: function(response) {
                  if (!dialog.closed) {
                    ...
                    for (var i = 0; i < items.length; ++i) {
                      var item = items[i],
                        score = fromGPScoreToCocoonScore(item, leaderboardID);
        ...
        prepareAchievements: function(reload, callback) {
                ...
                if (response && !response.error) {
                  ...
                  if (response && response.items)
                    for (var i = 0; i < response.items.length; i++)
                      achievements.push(
                        fromGPAchievementToCocoonAchievement(response.items[i])
                      );
          ...
          } else callback(this._cachedAchievements, null);
        },
        requestAllAchievements: function(callback) {
          this.prepareAchievements(!0, callback);
        },
        requestAchievements: function(callback, userID) {
          var me = this;
          this.prepareAchievements(!1, function(allAchievements, error) {
        ...
        submitAchievement: function(achievementID, callback) {
          ...
          if (this.gapi.nativeAvailable) {
            var showNotification = !!this.gapi.settings
              .showAchievementNotifications;
            Cocoon.callNative(
              this.gapi.nativeExtensionName,
              'unlockAchievement',
              [achID, showNotification, callback],
              !0
            );
          } else
            this.gapi.client.request({
        ...
        showAchievements: function(callback) {
          ...
          !ios && this.gapi.nativeAvailable
            ...
            : Cocoon.Social.SocialGamingServiceGooglePlayGames.superclass.showAchievements.call(
                this
              );
        },
      }),
      Cocoon.extend(
        Cocoon.Social.SocialGamingServiceGooglePlayGames,
        Cocoon.Social.SocialGamingService
      ),
      extension
    );
  }),
  Cocoon.define('Cocoon.Social', function(extension) {
    ...
    function fromGCAchievementDescriptionToCocoonAchievement(ach) {
      return new Cocoon.Social.GameCenter.Achievement(
        ach.identifier,
        ach.title,
        ach.achievedDescription,
        '',
        ach.maximumPoints
      );
    }
    return (
      (extension.GameCenterExtension = function() {
        (this.nativeExtensionName = 'IDTK_SRV_GAMECENTER'),
          ...
          (this.nativeAvailable =
            !!window.ext && !!window.ext[this.nativeExtensionName]);
        var me = this;
        return (
          this.nativeAvailable &&
            ((this.onGameCenterLoginStateChanged = new Cocoon.EventHandler(
              this.nativeExtensionName,
              this.extensionName,
              'onGameCenterLoginStateChanged'
            )),
            this.onGameCenterLoginStateChanged.addEventListener(function(
              localPlayer
            ) {
      ...
      (extension.GameCenterExtension.prototype = {
        ...
        getSocialInterface: function() {
          return (
            this._socialService ||
              (this._socialService = new Cocoon.Social.SocialGamingServiceGameCenter(
                this
              )),
            this._socialService
          );
        ...
        login: function(callback) {
          var me = this;
          if (!this.nativeAvailable) throw 'Game Center not available';
          Cocoon.callNative(
            this.nativeExtensionName,
            'login',
            [
        ...
        getLocalPlayer: function() {
          ...
          if (this.nativeAvailable)
            return (
              (this._currentPlayer = Cocoon.callNative(
                this.nativeExtensionName,
                'getLocalPlayer',
                []
              )),
      ...
      (extension.GameCenter.Player = function() {
        (this.playerID = ''), (this.alias = ''), (this.isFriend = !1);
      }),
      (extension.GameCenter.LocalPlayer = function() {
        (this.playerID = ''), (this.alias = ''), (this.isAuthenticated = !1);
      }),
      (extension.GameCenter.Achievement = function(
        identifier,
        percentComplete
      ) {
      ...
      (extension.GameCenter.Leaderboard = function(
        category,
        playerIDs,
        timeScope,
        playerScope,
      ...
      (extension.GameCenter.TimeScope = { TODAY: 0, WEEK: 1, ALL_TIME: 2 }),
      (extension.GameCenter.PlayerScope = { GLOBAL: 0, FRIENDS: 1 }),
      (extension.SocialGamingServiceGameCenter = function(gcExtension) {
        Cocoon.Social.SocialGamingServiceGameCenter.superclass.constructor.call(
          this
        ),
          (this.gc = gcExtension);
        var me = this;
        return (
          this.gc.onGameCenterLoginStateChanged.addEventListener(function(
            localPlayer,
            error
          ) {
            me.onLoginStatusChanged.notifyEventListeners(
      ...
      (extension.SocialGamingServiceGameCenter.prototype = {
        ...
        login: function(callback) {
          this.gc.login(function(localPlayer, error) {
            callback && callback(localPlayer.isAuthenticated, error);
          });
        },
        logout: function(callback) {
          callback &&
        ...
        getLoggedInUser: function() {
          return fromGCPLayerToCocoonUser(
            this.gc._currentPlayer
              ? this.gc._currentPlayer
              : this.gc.getLocalPlayer()
          );
        },
        requestUser: function(callback, userId) {
          if (userId)
            this.gc.loadPlayers([userId], function(response, error) {
              var user =
                response && response.length
                  ? fromGCPLayerToCocoonUser(response[0])
                  : null;
              callback(user, error);
            });
          else {
        ...
        requestScore: function(callback, params) {
          var query = {},
            options = params || {};
          options.leaderboardID && (query.category = options.leaderboardID),
            (query.playerIDs = [
              options.userID || this.getLoggedInUser().userID,
            ]),
            this.gc.loadScores(function(response, error) {
              ...
              response.scores.length
                ...
                : response &&
                  response.localPlayerScore &&
                  (gcScore = response.localPlayerScore);
              var loadedScore = gcScore
                ? new Cocoon.Social.GameCenter.Score(
                    gcScore.playerID,
                    gcScore.value,
                    '',
                    '',
        ...
        submitScore: function(score, callback, params) {
          var options = params || {};
          this.gc.submitScore(
            { value: score, category: options.leaderboardID || '' },
            function(error) {
              ...
              if (error) callback([], error);
                ...
                if (response && response.length)
                  for (var i = 0; i < response.length; i++)
                    achievements.push(
                      fromGCAchievementDescriptionToCocoonAchievement(
                        response[i]
                      )
                    );
                me.setCachedAchievements(achievements),
        ...
        requestAchievements: function(callback) {
          ...
          this.prepareAchievements(!1, function(allAchievements, error) {
            return error
              ? void callback([], error)
              : void me.gc.loadAchievements(function(response, error) {
        ...
        submitAchievement: function(achievementID, callback) {
          ...
          this.gc.submitAchievements(
            [{ identifier: achID, percentComplete: 100 }],
            callback
          );
        },
        resetAchievements: function(callback) {
      ...
      Cocoon.extend(
        extension.SocialGamingServiceGameCenter,
        extension.SocialGamingService
      ),
      extension
    );
  ...
  Cocoon.define('Cocoon.Social', function(extension) {
    ...
    function fromFBScoreToCocoonScore(fbResponse, requestScoreParams) {
      var result = new Cocoon.Social.Score(
        fbResponse.user.id,
        fbResponse.score,
        fbResponse.user.name
      );
      return (
        requestScoreParams &&
          (result.leaderboardID = requestScoreParams.leaderboardID),
        (result.imageURL =
          'https://graph.facebook.com/' + fbResponse.user.id + '/picture'),
        result
      );
    }
    function fromFBAchievementToCocoonAchievement(fbResponse) {
      ...
      return (result.fbAchievementData = fbResponse), result;
    }
    if (
      ((extension.FacebookExtension = function() {
        ...
        return (
          this.nativeAvailable &&
            ((this.onFacebookSessionStateChanged = new Cocoon.EventHandler(
              this.nativeExtensionName,
              this.extensionName,
              'onFacebookSessionStateChanged'
            )),
            (Cocoon.Social.Facebook = this),
            this.onFacebookSessionStateChanged.addEventListener(function(
              session,
              error
            ) {
              var data = fromCocoonFBSessionToFBAPISession(session, error);
              0 == session.state && me.Event.notify('auth.login', data),
      ...
      (extension.FacebookExtension.prototype = {
        ...
        init: function(options) {
          if (!options || !options.appId) throw 'appId must be specified!';
        ...
        getSocialInterface: function() {
          ...
          return (
            this._socialService ||
              (this._socialService = new Cocoon.Social.SocialGamingServiceFacebook(
                this
              )),
            this._socialService
          );
          ...
          this.nativeAvailable
            ? Cocoon.callNative(
                ...
                [
                  options,
                  function(response, error) {
                    (me._currentSession = fromCocoonFBSessionToFBAPISession(
                      response,
                      error
                    )),
                      callback && callback(me._currentSession);
                  },
                ],
                !0
              )
            : FB.login(function(response) {
                (me._currentSession = response), callback && callback(response);
              }, options);
        },
        logout: function(callback) {
          this.nativeAvailable
            ? Cocoon.callNative(
                ...
                [
                  function(response, error) {
                    callback &&
                      callback(
                        fromCocoonFBSessionToFBAPISession(response, error)
                      );
                  },
                ],
                !0
        ...
        getAuthResponse: function() {
          if (this.nativeAvailable) {
            var response = Cocoon.callNative(
              this.nativeExtensionName,
              'getFacebookSession',
              []
            );
        ...
        getLoginStatus: function(callback, force) {
          if (this.nativeAvailable) {
            ...
            setTimeout(function() {
              var response = Cocoon.callNative(
                me.nativeExtensionName,
                'getFacebookSession',
                []
              );
              callback && callback(fromCocoonFBSessionToFBAPISession(response));
            }, 50);
          } else FB.getLoginStatus(callback, force);
        },
        api: function(path, method, params, cb) {
          if (this.nativeAvailable) {
            var openGraph = arguments[0],
              httpMethod = arguments.length > 3 ? arguments[1] : 'GET',
              options = null;
            3 == arguments.length && (options = arguments[1]),
              4 == arguments.length && (options = arguments[2]);
            var callback =
              arguments.length > 1
                ? arguments[arguments.length - 1]
                : function() {};
            return Cocoon.callNative(
              this.nativeExtensionName,
              'api',
              [openGraph, httpMethod, options, callback],
              !0
            );
          }
        ...
        ui: function(params, cb) {
          ...
          navigator.isCocoonJS || FB.ui(params, cb);
        },
        requestAdditionalPermissions: function(
          permissionsType,
          permissions,
          callback
        ) {
          ...
          } else FB.login(callback, { scope: permissions });
        },
        ...
        showShareDialog: function(params, callback) {
          this.nativeAvailable
            ...
            : ((params.method = 'feed'), FB.ui(params, callback));
        },
      ...
      (extension.FacebookEvent = function(nativeAvailable) {
        return (this.nativeAvailable = nativeAvailable), this;
      }),
      (extension.FacebookEvent.prototype = {
        subscribe: function(name, callback) {
          ...
          } else navigator.isCocoonJS || FB.Event.subscribe(name, callback);
        },
        unsubscribe: function(name, callback) {
          ...
          } else navigator.isCocoonJS || FB.Event.unsubscribe(name, callback);
        },
        notify: function(name, param) {
          var eventKey = name + 'listeners',
            array = this[eventKey];
          if (array) for (var i = 0; i < array.length; ++i) array[i](param);
        },
      }),
      (extension.Facebook = new extension.FacebookExtension()),
      (extension.SocialGamingServiceFacebook = function(fbExtension) {
        Cocoon.Social.SocialGamingServiceFacebook.superclass.constructor.call(
          this
        ),
          (this.fb = fbExtension);
        var me = this;
      ...
      (extension.SocialGamingServiceFacebook.prototype = {
        ...
        isLoggedIn: function() {
          return (
            this.fb._currentSession &&
            'connected' === this.fb._currentSession.status
          );
        },
        login: function(callback) {
          var me = this;
        ...
        getLoggedInUser: function() {
          var authResponse = this.fb._currentSession
            ? this.fb._currentSession.authResponse
            : null;
          return authResponse && authResponse.user
            ? fromFBUserToCocoonUser(authResponse.user)
            : authResponse && authResponse.userID
              ? new Cocoon.Social.Facebook.User(
                  authResponse.userID,
                  'Loading...'
                )
              : null;
        ...
        requestPublishPermissions: function(callback) {
          var me = this;
          this.fb.requestAdditionalPermissions(
            'publish',
            'publish_actions',
            function(response) {
              response.error
        ...
        requestUserImage: function(callback, userID, imageSize) {
          ...
          imageSize === Cocoon.Social.ImageSize.THUMB
        ...
        preparePublishAction: function(callback) {
          if (this.currentPermissions)
            this.currentPermissions.publish_actions
              ? callback(!0)
            ...
            this.fb.getPermissions(function(perms) {
              (me.currentPermissions = perms),
                perms && me.preparePublishAction(callback);
            });
          }
        },
        publishMessage: function(message, callback) {
        ...
        publishMessageWithDialog: function(message, callback) {
          this.fb.showShareDialog(
            fromCocoonMessageToFBMessage(message),
            function(response) {
              callback && callback(response.error);
            }
          );
        ...
        requestScore: function(callback, params) {
          var apiCall =
            (params && params.userID ? params.userID : 'me') + '/scores';
          this.fb.api(apiCall, function(response) {
          ...
          this.preparePublishAction(function(granted) {
            granted
              ? me.requestScore(function(currentScore, error) {
                  if (error) return void (callback && callback(error));
                  var topScore = currentScore ? currentScore.score : 0;
                  if (topScore >= score)
                    return void (callback && callback(null));
                  var apiCall =
                    '/' +
                    (params && params.userID ? params.userID : 'me') +
                    '/scores';
                  me.fb.api(apiCall, 'POST', { score: score }, function(
                    response
                  ) {
                    callback && callback(response.error);
                  });
              ...
              if (response.data && response.data.length)
                for (var i = 0; i < response.data.length; ++i) {
                  ...
                  (score.position = i),
                    ...
                    (score.me =
                      score.userID ===
                      me.fb._currentSession.authResponse.userID),
                    scores.push(score);
                }
              var js = 'addScores(' + JSON.stringify(scores) + ')';
              dialog.eval(js);
            ...
            this.fb.api(this.fb._appId + '/achievements', function(response) {
              if (response.error) callback([], response.error);
                ...
                if (response.data)
                  for (var i = 0; i < response.data.length; i++)
                    achievements.push(
                      fromFBAchievementToCocoonAchievement(response.data[i])
                    );
                me.setCachedAchievements(achievements),
                  callback(achievements, null);
              }
          ...
          this.prepareAchievements(!1, function(allAchievements, error) {
            ...
            me.fb.api(apiCall, function(response) {
              if (response.error) callback([], response.error);
                ...
                if (response.data)
                  for (var i = 0; i < response.data.length; i++) {
                    var ach = me.findAchievement(
                      (
                        response.data[i].achievement ||
                        response.data[i].data.achievement
                      ).id
                    );
                    ach && achievements.push(ach);
                  }
              ...
              ? me.requestAchievements(function(achievements, error) {
                  ...
                  for (
                    ...
                    me.fb.api(
                      ...
                      function(response) {
                        response.error && (someError = response.error),
                          remaining--,
                          0 == remaining && callback && callback(someError);
                      }
                    );
                })
              : callback &&
      ...
      Cocoon.extend(
        extension.SocialGamingServiceFacebook,
        extension.SocialGamingService
      ),
      !(
        navigator.isCocoonJS ||
      ...
      var parent = document.getElementsByTagName('script')[0],
        ...
        prot = location.protocol ? location.protocol : 'http:';
  ...
  Cocoon.define('Cocoon.Multiplayer', function(extension) {
    return (
      (extension.MultiplayerService = function(
        nativeExtensionName,
        extensionName
      ) {
        (this.nativeExtensionName = nativeExtensionName),
          ...
          (this.nativeAvailable =
            !!window.ext && !!window.ext[this.nativeExtensionName]);
        var me = this;
        (this.onInvitationReceived = new Cocoon.EventHandler(
          this.nativeExtensionName,
          this.extensionName,
          'onInvitationReceived'
        )),
          (this.onInvitationLoaded = new Cocoon.EventHandler(
            this.nativeExtensionName,
            this.extensionName,
            'onInvitationLoaded',
            function(sourceListener, args) {
              var matchID = args[0],
                error = args[1];
              matchID && !error
                ? ((me.currentMatch = new Cocoon.Multiplayer.Match(
                    me.nativeExtensionName,
                    me.extensionName,
                    matchID
                  )),
        ...
        addPlayersToMatch: function(matchRequest, match, callback) {
          this.nativeAvailable &&
            Cocoon.callNative(
              this.nativeExtensionName,
              'addPlayersToMatch',
              [matchRequest, match.matchID, callback],
              !0
            );
        },
        getMatch: function() {
      ...
      (extension.Match = function(nativeExtensionName, extensionName, matchID) {
        if ('string' != typeof nativeExtensionName)
          throw "The given native extension name '" +
            nativeExtensionName +
            "' is not a string.";
        if ('string' != typeof extensionName)
          throw "The given extension name '" +
            nativeExtensionName +
            "' is not a string.";
        (this.nativeExtensionName = nativeExtensionName),
          (this.extensionName = extensionName),
          (this.nativeAvailable =
            Cocoon.nativeAvailable &&
            'undefined' != typeof window.ext[nativeExtensionName]),
          (this.matchID = matchID);
        var me = this;
        (this.onMatchDataReceived = new Cocoon.EventHandler(
          this.nativeExtensionName,
          this.extensionName,
          'onMatchDataReceived',
          function(sourceListener, args) {
            me.matchID === args[0] && sourceListener(me, args[1], args[2]);
          }
        )),
          (this.onMatchStateChanged = new Cocoon.EventHandler(
            this.nativeExtensionName,
            this.extensionName,
            'onMatchStateChanged',
            function(sourceListener, args) {
          ...
          (this.onMatchConnectionWithPlayerFailed = new Cocoon.EventHandler(
            this.nativeExtensionName,
            this.extensionName,
            'onMatchConnectionWithPlayerFailed',
            function(sourceListener, args) {
              me.matchID === args[0] && sourceListener(me, args[1], args[2]);
            }
          )),
          (this.onMatchFailed = new Cocoon.EventHandler(
            this.nativeExtensionName,
            this.extensionName,
            'onMatchFailed',
            function(sourceListener, args) {
              me.matchID === args[0] && sourceListener(me, args[1]);
            }
          ));
        var signal = new Cocoon.Signal.createSignal();
      ...
      (extension.Match.prototype = {
        ...
        sendDataToAllPlayers: function(data, sendMode) {
          return this.nativeAvailable
            ? Cocoon.callNative(
                ...
                [this.matchID, data, sendMode]
              )
            : void 0;
        },
        sendData: function(data, playerIDs, sendMode) {
          return this.nativeAvailable
            ? Cocoon.callNative(this.nativeExtensionName, 'sendData', [
                this.matchID,
                data,
                playerIDs,
                sendMode,
        ...
        getPlayerIDs: function() {
          return this.nativeAvailable
            ? Cocoon.callNative(this.nativeExtensionName, 'getPlayerIDs', [
                this.matchID,
              ])
            : void 0;
        },
        getLocalPlayerID: function() {
          return this.nativeAvailable
            ? Cocoon.callNative(this.nativeExtensionName, 'getLocalPlayerID', [
                this.matchID,
              ])
            : '';
        },
      }),
      (extension.SendDataMode = { RELIABLE: 0, UNRELIABLE: 1 }),
      ...
      (extension.MatchRequest = function(
        minPlayers,
        maxPlayers,
        playersToInvite,
        playerGroup,
  ...
  Cocoon.define('Cocoon.Multiplayer', function(extension) {
    ...
    (extension.LoopbackService = function() {
      Cocoon.Multiplayer.LoopbackService.superclass.constructor.call(
        this,
        'dummy',
        'dummy'
      ),
      ...
      (extension.LoopbackService.prototype = {
        findMatch: function(request, callback) {
          ...
          for (var exists = !1, i = 0; i < matchServices.length; ++i)
            if (matchServices[i] === this) {
              exists = !0;
              break;
            }
          if (
            (exists || matchServices.push(this),
            matchServices.length >= request.minPlayers)
          ) {
            for (var playerIDs = [], i = 0; i < matchServices.length; ++i)
    ...
    return (
      (LoopbackMatch.prototype = {
        start: function() {
          ...
          setTimeout(function() {
            ...
            for (var i = 0; i < me.pendingData.length; ++i)
              me.onMatchDataReceived.notifyEventListeners(
                me.matchID,
                me.pendingData[i].data,
                me.pendingData[i].player
              );
          }, 0);
        },
        sendDataToAllPlayers: function(data, sendMode) {
        ...
        sendData: function(data, playerIDs) {
          var me = this;
          setTimeout(function() {
            for (var i = 0; i < loopbackServices.length; ++i) {
              for (var destService = null, j = 0; j < playerIDs.length; ++j)
                playerIDs[j] === loopbackServices[i].getPlayerID() &&
                  (destService = loopbackServices[i]);
              destService &&
                destService
                  .getMatch()
                  .notifyDataReceived(data, me.service.getPlayerID());
            }
          }, 0);
        },
        disconnect: function() {
          ...
          for (var i = 0; i < this.playerIDs.length; ++i)
            for (
              var p = this.playerIDs[i], j = 0;
              j < loopbackServices.length;
              ++j
            )
              if (loopbackServices[j].getPlayerID() === p) {
                var match = loopbackServices[i].getMatch();
                match.disconnected ||
                  match.onMatchStateChanged.notifyEventListeners(
                    match,
                    this.service.getPlayerID(),
                    Cocoon.Multiplayer.ConnectionState.DISCONNECTED
                  );
              }
        },
        requestPlayersInfo: function(callback) {
          var me = this;
          setTimeout(function() {
            for (var playersInfo = [], i = 0; i < me.playerIDs.length; ++i)
              playersInfo[i] = {
        ...
        notifyDataReceived: function(data, fromPlayer) {
          this.started
            ? this.onMatchDataReceived.notifyEventListeners(
                this.matchID,
                data,
                fromPlayer
              )
  ...
  Cocoon.define('Cocoon.Multiplayer', function(extension) {
    return (
      (extension.GooglePlayGames = new Cocoon.Multiplayer.MultiplayerService(
        'IDTK_SRV_MULTIPLAYER_GPG',
        'Multiplayer.GooglePlayGames'
      )),
      extension
    );
  }),
  Cocoon.define('Cocoon.Multiplayer', function(extension) {
    return (
      (extension.GameCenter = new Cocoon.Multiplayer.MultiplayerService(
        'IDTK_SRV_MULTIPLAYER_GAMECENTER',
