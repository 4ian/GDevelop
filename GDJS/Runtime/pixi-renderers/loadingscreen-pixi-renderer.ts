namespace gdjs {
  ...
  class LoadingScreenPixiRenderer {
    ...
    constructor(
      ...
      if (true || loadingScreenData.showGDevelopSplash) { // TODO
    ...
    private _updatePositions() {
      ...
      if (this._gdevelopLogoSprite) {
        ...
        const logoWidth = 680;
        const border =
          this._pixiRenderer.width > this._pixiRenderer.height ? 150 : 35;
    ...
    private _render(timeInMs: float) {
      ...
      if (this._state == LoadingScreenState.NOT_STARTED) {
        ...
        if (this._progressBarGraphics) {
          ...
          const progressBarWidth = this._loadingScreenData.progressBarWidth;
          ...
          const progressBarY = Math.floor(this._pixiRenderer.height - 100);
          const lineWidth = 1;
