          ...
          try {
            if (resource.kind === 'video') {
              ...
              if (resource.file.indexOf('.') === -1) {
                ...
                // TODO: When PIXI v8+ is used, loadParser can be forced in
                // PIXI.Assets.load (see https://github.com/pixijs/pixijs/blob/71ed56c569ebc6b53da19e3c49258a0a84892101/packages/assets/src/loader/Loader.ts#L68)
                ...
                loadedTexture = await PIXI.Assets.load(resource.file);
                if (!loadedTexture) {
                  throw new Error(
