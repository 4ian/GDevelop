...
gdjs.RuntimeGamePixiRenderer.prototype.createStandardCanvas = function(
  ...
  this._pixiRenderer = PIXI.autoDetectRenderer(
    this._game.getDefaultWidth(),
    this._game.getDefaultHeight(),
...
gdjs.RuntimeGamePixiRenderer.prototype.resize = function() {
  ...
  if (
    this._pixiRenderer.width !== width ||
    this._pixiRenderer.height !== height
  )
  ...
  function getEventPosition(e) {
    ...
    if (e.pageX) {
      ...
      pos[0] =
        ...
        canvasArea.offsetLeft;
      pos[1] =
        e.clientY +
        document.body.scrollTop +
        document.documentElement.scrollTop -
        canvasArea.offsetTop;
    }
