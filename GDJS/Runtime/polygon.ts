...
export class Polygon {
  ...
  static createRectangle(width: float, height: float): Polygon {
  ...
  static project(axis: FloatPoint, p: Polygon, result: FloatPoint): void {
   ...
   */
  static isPointInside(poly: Polygon, x: float, y: float): boolean {
    let inside = false;
    for (
