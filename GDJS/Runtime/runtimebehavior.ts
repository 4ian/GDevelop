import { RuntimeScene, RuntimeObject, registerBehavior } from '.';
...
export class RuntimeBehavior {
   ...
   *
   * @see RuntimeBehavior#onObjectHotReloaded
   *
   ...
   */
  stepPreEvents(runtimeScene: RuntimeScene): void {
    if (this._activated) {
   ...
   * @param runtimeScene The runtimeScene owning the object
   */
  stepPostEvents(runtimeScene: RuntimeScene): void {
    if (this._activated) {
      const profiler = runtimeScene.getProfiler();
      if (profiler) {
        profiler.begin(this.name);
   ...
   * @param runtimeScene The runtimeScene owning the object
   */
  doStepPreEvents(runtimeScene: RuntimeScene): void {}

  /**
   * This method is called each tick after events are done.
   * @param runtimeScene The runtimeScene owning the object
   */
  doStepPostEvents(runtimeScene: RuntimeScene): void {}
...
registerBehavior('', RuntimeBehavior);
