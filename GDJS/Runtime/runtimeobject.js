...
gdjs.RuntimeObject = function(runtimeScene, objectData) {
  ...
  if (this.aabb === undefined) this.aabb = { min: [0, 0], max: [0, 0] };
  else {
    this.aabb.min[0] = 0;
    this.aabb.min[1] = 0;
    this.aabb.max[0] = 0;
  ...
  if (this._averageForce === undefined)
    this._averageForce = new gdjs.Force(0, 0, false);

  //Behaviors:
  if (this._behaviors === undefined) this._behaviors = []; //Contains the behaviors of the object
  ...
  //Timers:
  if (this._timers === undefined) this._timers = new Hashtable();
  else this._timers.clear();
};
 ...
 */
gdjs.RuntimeObject.prototype.extraInitializationFromInitialInstance = function(
  initialInstanceData
) {
  //Nothing to do.
};
...
gdjs.RuntimeObject.prototype.rotateTowardPosition = function(
  x,
  y,
  speed,
  scene
...
gdjs.RuntimeObject.prototype.rotateTowardAngle = function(
  angle,
  speed,
  runtimeScene
) {
  ...
  var angularDiff = gdjs.evtTools.common.angleDifference(
    this.getAngle(),
    angle
  );
...
gdjs.RuntimeObject.prototype.getVariableNumber =
  gdjs.RuntimeObject.getVariableNumber;
...
gdjs.RuntimeObject.prototype.getVariableString =
  gdjs.RuntimeObject.getVariableString;
...
gdjs.RuntimeObject.prototype.setVariableNumber =
  gdjs.RuntimeObject.setVariableNumber;
...
gdjs.RuntimeObject.prototype.setVariableString =
  gdjs.RuntimeObject.setVariableString;
...
gdjs.RuntimeObject.prototype.variableChildExists =
  gdjs.RuntimeObject.variableChildExists;
...
gdjs.RuntimeObject.prototype.variableRemoveChild =
...
gdjs.RuntimeObject.prototype.variableClearChildren =
  gdjs.RuntimeObject.variableClearChildren;
 ...
 * @param {number} multiplier Set the force multiplier
 */
gdjs.RuntimeObject.prototype.addForceTowardPosition = function(
  x,
  y,
  len,
  multiplier
 ...
 * @param {number} multiplier Set the force multiplier
 */
gdjs.RuntimeObject.prototype.addForceTowardObject = function(
  obj,
  len,
  multiplier
) {
...
gdjs.RuntimeObject.prototype.clearForces = function() {
  gdjs.RuntimeObject.forcesGarbage.push.apply(
...
gdjs.RuntimeObject.prototype.updateForces = function(elapsedTime) {
  for (var i = 0; i < this._forces.length; ) {
    ...
    if (multiplier === 1) {
      // Permanent force
      ++i;
    } else if (multiplier === 0 || force.getLength() <= 0.001) {
      ...
      force.setLength(
        force.getLength() - force.getLength() * (1 - multiplier) * elapsedTime
      );
      ++i;
    }
  }
 ...
 */
gdjs.RuntimeObject.prototype.averageForceAngleIs = function(
  angle,
  toleranceInDegrees
) {
 ...
 */
gdjs.RuntimeObject.prototype.timerElapsedTime = function(
  timerName,
  timeInSeconds
) {
 ...
 */
gdjs.RuntimeObject.prototype.getTimerElapsedTimeInSeconds = function(
  timerName
) {
  if (!this._timers.containsKey(timerName)) {
    return 0;
 ...
 */
gdjs.RuntimeObject.prototype.putAround = function(
  x,
  y,
  distance,
  angleInDegrees
 ...
 * @param {number} angleInDegrees The angle between the object and the target, in degrees.
 */
gdjs.RuntimeObject.prototype.putAroundObject = function(
  obj,
  distance,
  angleInDegrees
) {
 ...
 * @param objectsLists Tables of objects
 */
gdjs.RuntimeObject.prototype.separateObjectsWithoutForces = function(
  objectsLists
) {
  //Prepare the list of objects to iterate over.
  var objects = gdjs.staticArray(
    gdjs.RuntimeObject.prototype.separateObjectsWithoutForces
  );
  objects.length = 0;

  var lists = gdjs.staticArray2(
    gdjs.RuntimeObject.prototype.separateObjectsWithoutForces
  );
 ...
 * @param objectsLists Tables of objects
 */
gdjs.RuntimeObject.prototype.separateObjectsWithForces = function(
  objectsLists,
  len
) {
...
gdjs.RuntimeObject.prototype.cursorOnObject = function(runtimeScene) {
  ...
  var mousePos = layer.convertCoords(
  ...
  for (var i = 0; i < touchIds.length; ++i) {
    var touchPos = layer.convertCoords(
...
gdjs.RuntimeObject.prototype.isCollidingWithPoint = function(pointX, pointY) {
  var hitBoxes = this.getHitBoxes();
  for (var i = 0; i < this.hitBoxes.length; ++i) {
    if (gdjs.Polygon.isPointInside(hitBoxes[i], pointX, pointY)) return true;
  }
...
gdjs.RuntimeObject.getNameIdentifier = function(name) {
  gdjs.RuntimeObject.getNameIdentifier.identifiers =
    gdjs.RuntimeObject.getNameIdentifier.identifiers || new Hashtable();
