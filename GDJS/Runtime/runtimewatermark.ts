namespace gdjs {
  ...
  export class RuntimeWatermark {
    ...
    constructor(gameRenderer: RuntimeGameRenderer) {
    ...
    display() {
      logger.info('display');
      const container = this._gameRenderer.getDomElementContainer();
      if (container) {
        this.addWatermarkLogoToContainer(container);
      }
    }

    private addWatermarkLogoToContainer(container: HTMLElement) {
    ...
    private createDivContainer() {
      ...
      SVGContainer.setAttribute('id', 'watermark');

      SVGContainer.style.opacity = '0';
      switch (this._position) {
        case 'top-left':
          SVGContainer.style.top = this._margin;
          SVGContainer.style.left = this._margin;
          break;
        case 'top-right':
          SVGContainer.style.top = this._margin;
          SVGContainer.style.right = this._margin;
          break;
        case 'bottom-left':
          SVGContainer.style.bottom = this._margin;
          SVGContainer.style.left = this._margin;
          break;
        case 'bottom-right':
          SVGContainer.style.bottom = this._margin;
        ...
        case 'bottom':
          ...
          SVGContainer.style.transform = 'translate(-50%, 0)';
          break;
        case 'top':
          SVGContainer.style.top = this._margin;
          SVGContainer.style.left = '50%';
        ...
        case 'left':
          ...
          SVGContainer.style.transform = 'translate(0, -50%)';
          break;
        case 'right':
          SVGContainer.style.right = this._margin;
          SVGContainer.style.top = '50%';
    ...
    private addStyle() {
      ...
      #watermark {
        ...
        transition: opacity ${this._fadeInDuration} ease-out;
      }
