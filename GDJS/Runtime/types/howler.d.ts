...
// Adapted by Arthur Pacaud <https://github.com/arthuro555> for the GDevelop project

declare module 'howler' {
  export type HowlBaseCallback = (soundId: number) => void;
  export type HowlErrorCallback = (soundId: number, error?: string) => void;
