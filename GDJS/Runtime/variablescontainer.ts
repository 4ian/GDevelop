...
export class VariablesContainer {
  _variables: Hashtable<Variable>;
  _variablesArray: Variable[] = [];
   ...
   */
  add(name: string, newVariable: Variable) {
   ...
   * should not happen.
   */
  getFromIndex(id: number): Variable {
    if (id >= this._variablesArray.length) {
      ...
      let variable: Variable = this._variablesArray[id];
      //Reuse variables removed before.
  ...
  static badVariable: Variable = {
    ...
    _value: 0,
    fromJSON: () => VariablesContainer.badVariable,
    toJSObject: () => 0,
    fromJSObject: () => VariablesContainer.badVariable,
    reinitialize: () => {},
    addChild: () => VariablesContainer.badVariable,
    castTo: () => {},
    clearChildren: () => {},
    clone: () => VariablesContainer.badVariable,
    getChildrenCount: () => 0,
    replaceChildren: () => {},
    ...
    setValue: () => {},
    getValue: () => 0,
    getChild: () => VariablesContainer.badVariable,
    getChildAt: () => VariablesContainer.badVariable,
    hasChild: function () {
      return false;
    },
