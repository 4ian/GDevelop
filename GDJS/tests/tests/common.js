...
describe('gdjs.evtTools.object.twoListsTest', function() {
  it('should properly pick objects', function() {
    ...
    var obj1A = new gdjs.RuntimeObject(runtimeScene, {
      name: 'obj1',
      type: '',
      behaviors: [],
    });
    var obj1B = new gdjs.RuntimeObject(runtimeScene, {
      name: 'obj1',
      type: '',
      behaviors: [],
    });
    var obj1C = new gdjs.RuntimeObject(runtimeScene, {
      name: 'obj1',
      type: '',
      behaviors: [],
    });
    var obj2A = new gdjs.RuntimeObject(runtimeScene, {
      name: 'obj2',
      type: '',
      behaviors: [],
    });
    var obj2B = new gdjs.RuntimeObject(runtimeScene, {
      name: 'obj2',
      type: '',
      behaviors: [],
    });
    var obj2C = new gdjs.RuntimeObject(runtimeScene, {
      name: 'obj2',
      type: '',
      behaviors: [],
    });
...
describe('gdjs.evtTools.object.pickObjectsIf', function() {
  it('should properly pick objects', function() {
    ...
    expect(
      gdjs.evtTools.object.pickObjectsIf(
        function() {
          return true;
        },
        map1,
...
describe('gdjs.evtTools.object.pickRandomObject', function() {
  it('should pick only one object', function() {
    ...
    expect(
      gdjs.evtTools.object.pickRandomObject(runtimeScene, map1)
    ).to.be.ok();
    expect(list1).to.have.length(1);
    expect(
      gdjs.evtTools.object.pickRandomObject(runtimeScene, map1)
    ...
    expect(
      gdjs.evtTools.object.pickRandomObject(runtimeScene, map2)
    ).to.be.ok();
...
describe('gdjs.evtTools.object.pickNearestObject', function() {
  ...
  it('should pick nearest object', function() {
    ...
    expect(gdjs.evtTools.object.pickNearestObject(map1, 100, 90, false)).to.be(
      true
    );
    expect(list1).to.have.length(1);
    expect(list1[0]).to.be(obj1A);
  ...
  it('should pick furthest object when inverted', function() {
    ...
    expect(gdjs.evtTools.object.pickNearestObject(map1, 100, 90, true)).to.be(
      true
    );
    expect(list1).to.have.length(1);
