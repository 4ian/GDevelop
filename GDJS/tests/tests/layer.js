...
describe('gdjs.Layer', function() {
  ...
  it('can convert coordinates', function() {
    ...
    expect(layer.convertCoords(350, 450, 0)[0]).to.be.within(
      -50.001,
      -49.99999
    );
  ...
  it('can convert inverse coordinates', function() {
    ...
    expect(layer.convertInverseCoords(350, 450, 0)[0]).to.be.within(
      649.999,
      650.001
    );
    expect(layer.convertInverseCoords(350, 450, 0)[1]).to.be.within(
      49.9999,
      50.001
    );
  });
