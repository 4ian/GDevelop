...
AjoutPlusImage::AjoutPlusImage(wxWindow* parent)
{
	...
	Create(parent, wxID_ANY, _T("Ajouter plusieurs images"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	...
	AddImageBt = new wxButton(this, ID_BUTTON1, _T("Ajouter"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
