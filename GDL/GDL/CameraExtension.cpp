...
CameraExtension::CameraExtension()
{
    ...
    DECLARE_EXPRESSION("cameraViewportRight", _("Position X du coté bad-droit de la zone de rendu d'une caméra"), _("Position X du coté bas-droit de la zone de rendu d'une caméra"), _("Caméra"), "res/actions/camera.png", &ExpCameraViewportRight)
        DECLARE_PARAMETER("text", _("Calque"), false, "")
        DECLARE_PARAMETER("expression", _("Numéro de la caméra ( 0 par défaut )"), false, "")
    DECLARE_END_EXPRESSION()

    DECLARE_EXPRESSION("cameraViewportBottom", _("Position Y du coté bad-droit de la zone de rendu d'une caméra"), _("Position Y du coté bas-droit de la zone de rendu d'une caméra"), _("Caméra"), "res/actions/camera.png", &ExpCameraViewportBottom)
        DECLARE_PARAMETER("text", _("Calque"), false, "")
        DECLARE_PARAMETER("expression", _("Numéro de la caméra ( 0 par défaut )"), false, "")
    DECLARE_END_EXPRESSION()
