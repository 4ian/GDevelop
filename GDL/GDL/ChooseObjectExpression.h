...
//(*Headers(ChooseObjectExpression)
...
class GD_API ChooseObjectExpression: public wxDialog
{
	public:

		ChooseObjectExpression(wxWindow* parent, wxString title, Game & game_, Scene & scene_, bool pCanSelectGroup, const vector < string > & mainObjectsName);
		virtual ~ChooseObjectExpression();

		//(*Declarations(ChooseObjectExpression)
	...
	protected:
		...
		//(*Identifiers(ChooseObjectExpression)
	...
	private:
		...
		//(*Handlers(ChooseObjectExpression)
