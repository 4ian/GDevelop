    ...
    game(game_)
{
	...
	Create(parent, wxID_ANY, _T("Appel d\'un évènement C++"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	...
	StaticText3 = new wxStaticText(Panel1, ID_STATICTEXT3, _T("Cet évènement va appeler un évènement codé en C++. N\'oubliez pas de déclarer vos évènements à l\'aide d\'un fichier de déclaration."), wxDefaultPosition, wxSize(253,42), wxALIGN_CENTRE, _T("ID_STATICTEXT3"));
	...
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _T("Nom de l\'évènement :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	eventName->SetToolTip(_T("Nom de la scène liée"));
	...
	helpBt = new wxButton(this, ID_BUTTON3, _T("Aide"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
