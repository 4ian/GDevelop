...
scene(scene_)
{
	...
	Create(parent, wxID_ANY, _T("Edition de l\'évènement \"Pour chaque objet\""), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	...
	StaticText3 = new wxStaticText(Panel1, ID_STATICTEXT3, _T("Les conditions et actions seront répétées pour chacun des objets ayant le nom indiqué."), wxDefaultPosition, wxSize(253,60), wxALIGN_CENTRE, _T("ID_STATICTEXT3"));
	...
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _T("Répeter l\'évènement pour chaque objet :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
