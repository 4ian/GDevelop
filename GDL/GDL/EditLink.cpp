...
eventToEdit(pEvent)
{
	...
	Create(parent, wxID_ANY, _T("Créer un lien vers une autre scène"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	...
	StaticText3 = new wxStaticText(Panel1, ID_STATICTEXT3, _T("Un lien permet d\'insérer les évènements d\'une autre \nscène à celle ci."), wxDefaultPosition, wxSize(253,30), wxALIGN_CENTRE, _T("ID_STATICTEXT3"));
	...
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _T("Lien vers la scène :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	NomSceneEdit->SetToolTip(_T("Nom de la scène liée"));
	FlexGridSizer3->Add(NomSceneEdit, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer1->Add(FlexGridSizer3, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
	StaticBoxSizer1 = new wxStaticBoxSizer(wxHORIZONTAL, this, _T("Inclure"));
	FlexGridSizer2 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer2->AddGrowableCol(0);
	AllEventsCheck = new wxRadioButton(this, ID_RADIOBUTTON1, _T("Tous les évènements de la scène"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
	...
	OnlyEventsCheck = new wxRadioButton(this, ID_RADIOBUTTON2, _T("Seulement les évènements"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON2"));
	...
	StartEdit->SetToolTip(_T("Numéro de l\'évènement de départ"));
	FlexGridSizer4->Add(StartEdit, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText2 = new wxStaticText(this, ID_STATICTEXT2, _T("à"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	...
	EndEdit->SetToolTip(_T("Numéro de l\'évènement de fin"));
	FlexGridSizer4->Add(EndEdit, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText4 = new wxStaticText(this, ID_STATICTEXT4, _T("(inclus)"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	...
	AideBt = new wxButton(this, ID_BUTTON3, _T("Aide"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
