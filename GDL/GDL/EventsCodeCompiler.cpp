...
bool EventsCodeCompiler::CompileEventsFileToBitCode(std::string eventsFile, std::string bitCodeFile)
{
    ...
    Args.push_back("RuntimeScene.h.pch");
    Args.push_back(eventsFile.c_str());
    Args.push_back("-fsyntax-only");
    Args.push_back("-w");
    Args.push_back("-IC:/TDM-GCC-4.5.2/lib/gcc/mingw32/4.5.2/include");
    Args.push_back("-Ic:/TDM-GCC-4.5.2/lib/gcc/mingw32/4.5.2/include/c++");
    Args.push_back("-Ic:/TDM-GCC-4.5.2/lib/gcc/mingw32/4.5.2/include/c++/mingw32");
    Args.push_back("-IC:/Libs/llvm/tools/clang/lib/Headers");
    Args.push_back("-ID:/Florian/Programmation/GameDevelop2/ExtLibs/llvm/include");
    Args.push_back("-ID:/Florian/Programmation/GameDevelop2/ExtLibs/llvm/build-tdmgcc45-release/include");
    Args.push_back("-ID:/Florian/Programmation/GameDevelop2/GDL");
    Args.push_back("-ID:/Florian/Programmation/GameDevelop2/ExtLibs/boost");
    Args.push_back("-ID:/Florian/Programmation/GameDevelop2/ExtLibs/SFML/include");
