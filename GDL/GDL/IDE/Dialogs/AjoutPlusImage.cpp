...
AjoutPlusImage::AjoutPlusImage(wxWindow* parent)
{
	...
	Create(parent, wxID_ANY, _("Add several images"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	...
	StaticText1 = new wxStaticText(Panel1, ID_STATICTEXT1, _("Type the name of the images to add.\n( One name by line )"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT1"));
	...
	AddImageBt = new wxButton(this, ID_BUTTON1, _("Add"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
