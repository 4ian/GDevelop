...
game(game_)
{
	...
	AllEventsCheck = new wxRadioButton(this, ID_RADIOBUTTON1, _("Tous les évènements de la scène"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
