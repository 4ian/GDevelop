...
SpriteInitialPositionPanel::SpriteInitialPositionPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticBoxSizer4 = new wxStaticBoxSizer(wxHORIZONTAL, this, _T("Animation"));
	FlexGridSizer10 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer10->AddGrowableCol(0);
	StaticText5 = new wxStaticText(this, ID_STATICTEXT6, _T("Numéro de l\'animation\ninitiale :"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT6"));
	...
	AnimationCombo->SetToolTip(_T("Numéro de l\'animation initiale de l\'objet"));
	...
	StaticBoxSizer2 = new wxStaticBoxSizer(wxHORIZONTAL, this, _T("Direction"));
	FlexGridSizer5 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer5->AddGrowableCol(0);
	StaticText4 = new wxStaticText(this, ID_STATICTEXT5, _T("Angle \ninitial :"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT5"));
	FlexGridSizer5->Add(StaticText4, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer11 = new wxFlexGridSizer(0, 3, 0, 0);
	DirectionEdit = new wxTextCtrl(this, ID_TEXTCTRL3, _T("0"), wxDefaultPosition, wxSize(52,21), 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
	DirectionEdit->SetToolTip(_T("Angle initial"));
