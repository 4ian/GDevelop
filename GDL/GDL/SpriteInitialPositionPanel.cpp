...
SpriteInitialPositionPanel::SpriteInitialPositionPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText5 = new wxStaticText(this, ID_STATICTEXT6, _("Initial animation :"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT6"));
	...
	AnimationCombo->SetToolTip(_("Initial animation of the object"));
	...
	StaticText4 = new wxStaticText(this, ID_STATICTEXT5, _("Initial\nangle :"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT5"));
	...
	DirectionEdit->SetToolTip(_("Initial angle"));
