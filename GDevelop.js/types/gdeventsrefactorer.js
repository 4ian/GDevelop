...
declare class gdEventsRefactorer {
  ...
  static searchInEvents(platform: gdPlatform, events: gdEventsList, search: string, matchCase: boolean, inConditions: boolean, inActions: boolean, inEventStrings: boolean, inEventSentences: boolean, inInstructionNames: boolean): gdVectorEventsSearchResult;
  delete(): void;
  ptr: number;
};