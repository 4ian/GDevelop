...
declare class gdExpressionVariableTypeFinder {
  ...
  static getArrayVariableType(platform: gdPlatform, projectScopedContainers: gdProjectScopedContainers, node: gdExpressionNode, objectName: string): Variable_Type;
  delete(): void;
  ptr: number;
};