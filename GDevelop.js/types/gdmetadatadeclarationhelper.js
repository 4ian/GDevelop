...
declare class gdMetadataDeclarationHelper {
  ...
  static getObjectEventsFunctionFullyQualifiedContextName(eventsBasedObject: gdEventsBasedObject, eventsFunction: gdEventsFunction, codeNamespacePrefix: string): string;
