#include "ChoixObjetExpression.h"

//(*InternalHeaders(ChoixObjetExpression)
#include <wx/bitmap.h>
...
//(*IdInit(ChoixObjetExpression)
const long ChoixObjetExpression::ID_STATICBITMAP3 = wxNewId();
const long ChoixObjetExpression::ID_STATICTEXT1 = wxNewId();
const long ChoixObjetExpression::ID_PANEL1 = wxNewId();
const long ChoixObjetExpression::ID_STATICLINE2 = wxNewId();
const long ChoixObjetExpression::ID_RADIOBUTTON1 = wxNewId();
const long ChoixObjetExpression::ID_RADIOBUTTON2 = wxNewId();
const long ChoixObjetExpression::ID_RADIOBUTTON3 = wxNewId();
const long ChoixObjetExpression::ID_TREECTRL1 = wxNewId();
const long ChoixObjetExpression::ID_TREECTRL2 = wxNewId();
const long ChoixObjetExpression::ID_TREECTRL3 = wxNewId();
const long ChoixObjetExpression::ID_NOTEBOOK1 = wxNewId();
const long ChoixObjetExpression::ID_STATICLINE1 = wxNewId();
const long ChoixObjetExpression::ID_BUTTON1 = wxNewId();
const long ChoixObjetExpression::ID_BUTTON2 = wxNewId();
//*)

BEGIN_EVENT_TABLE(ChoixObjetExpression,wxDialog)
	//(*EventTable(ChoixObjetExpression)
	//*)
END_EVENT_TABLE()

ChoixObjetExpression::ChoixObjetExpression(wxWindow* parent, wxString title, Game & game_, Scene & scene_, bool canSelectGroup_, const vector < string > & mainObjectsName_) :
game(game_),
scene(scene_),
canSelectGroup(canSelectGroup_),
mainObjectsName(mainObjectsName_)
{
	//(*Initialize(ChoixObjetExpression)
	...
	Connect(ID_TREECTRL1,wxEVT_COMMAND_TREE_ITEM_ACTIVATED,(wxObjectEventFunction)&ChoixObjetExpression::OnObjetsListItemActivated);
	Connect(ID_TREECTRL1,wxEVT_COMMAND_TREE_SEL_CHANGED,(wxObjectEventFunction)&ChoixObjetExpression::OnObjetsListSelectionChanged);
	Connect(ID_TREECTRL2,wxEVT_COMMAND_TREE_ITEM_ACTIVATED,(wxObjectEventFunction)&ChoixObjetExpression::OnGroupesListItemActivated);
	Connect(ID_TREECTRL2,wxEVT_COMMAND_TREE_SEL_CHANGED,(wxObjectEventFunction)&ChoixObjetExpression::OnGroupesListSelectionChanged);
	Connect(ID_TREECTRL3,wxEVT_COMMAND_TREE_ITEM_ACTIVATED,(wxObjectEventFunction)&ChoixObjetExpression::OnglobalObjectsListItemActivated);
	Connect(ID_TREECTRL3,wxEVT_COMMAND_TREE_SEL_CHANGED,(wxObjectEventFunction)&ChoixObjetExpression::OnglobalObjectsListSelectionChanged);
	Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ChoixObjetExpression::OnChoisirBtClick);
	Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ChoixObjetExpression::OnAnnulerBtClick);
	//*)
...
ChoixObjetExpression::~ChoixObjetExpression()
{
	//(*Destroy(ChoixObjetExpression)
	//*)
}
 ...
 */
void ChoixObjetExpression::Refresh()
{
...
void ChoixObjetExpression::OnChoisirBtClick(wxCommandEvent& event)
{
	string nomObjet1 = !mainObjectsName.empty() ? mainObjectsName[0] : "";
	string nomObjet2 = mainObjectsName.size() > 1 ? mainObjectsName[1] : "";
...
void ChoixObjetExpression::OnAnnulerBtClick(wxCommandEvent& event)
{
    EndModal(0);
}

void ChoixObjetExpression::OnObjetsListSelectionChanged(wxTreeEvent& event)
{
    item = event.GetItem();
    AutreCheck->SetValue(true);
}
void ChoixObjetExpression::OnGroupesListSelectionChanged(wxTreeEvent& event)
{
    itemGroups = event.GetItem();
    AutreCheck->SetValue(true);
}

void ChoixObjetExpression::OnglobalObjectsListSelectionChanged(wxTreeEvent& event)
{
    itemGlobal = event.GetItem();
    AutreCheck->SetValue(true);
}

void ChoixObjetExpression::OnObjetsListItemActivated(wxTreeEvent& event)
{
    item = event.GetItem();
...
void ChoixObjetExpression::OnGroupesListItemActivated(wxTreeEvent& event)
{
    itemGroups = event.GetItem();
    wxCommandEvent uselessEvent;
    OnChoisirBtClick(uselessEvent);
...
void ChoixObjetExpression::OnglobalObjectsListItemActivated(wxTreeEvent& event)
{
    itemGlobal = event.GetItem();
    wxCommandEvent uselessEvent;
    OnChoisirBtClick(uselessEvent);
