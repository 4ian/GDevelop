...
class ChoixVariableDialog: public wxDialog
{
	public:

		ChoixVariableDialog(wxWindow* parent, ListVariable & variables_);
		virtual ~ChoixVariableDialog();

        std::string selectedVariable;

		ListVariable variables;

		//(*Declarations(ChoixVariableDialog)
		wxButton* helpBt;
	...
	protected:
		...
		//(*Identifiers(ChoixVariableDialog)
