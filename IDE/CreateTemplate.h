...
public:
	...
	CreateTemplate(wxWindow* parent, gd::EventsList & pEvents);
...
private:
	...
	std::string ConvertParam(std::string Parametre, std::string ToReplace, std::string ReplaceBy);
    void ProcessEvents(gd::EventsList & eventsToProcess, std::vector < std::pair<string, int> > parameters);
