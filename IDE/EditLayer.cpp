...
const long EditLayer::ID_STATICBITMAP2 = wxNewId();
const long EditLayer::ID_HYPERLINKCTRL1 = wxNewId();
...
tempLayer(layer_)
{
	...
	Connect(ID_HYPERLINKCTRL1,wxEVT_COMMAND_HYPERLINK,(wxObjectEventFunction)&EditLayer::OnhelpBtClick);
...
void EditLayer::OnhelpBtClick(wxCommandEvent& event)
{
    gd::HelpFileAccess::GetInstance()->OpenURL(_("http://wiki.compilgames.net/doku.php/en/game_develop/documentation/manual/editors/scene_editor/edit_layer"));
}
