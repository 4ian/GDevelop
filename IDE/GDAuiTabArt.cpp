...
wxAuiTabArt* GDAuiTabArt::Clone()
{
    GDAuiTabArt* art = new GDAuiTabArt;
...
void GDAuiTabArt::SetFlags(unsigned int flags)
{
    m_flags = flags;
}

void GDAuiTabArt::SetSizingInfo(const wxSize& tab_ctrl_size,
                                       size_t tab_count)
{
    m_fixed_tab_width = 100;
...
void GDAuiTabArt::DrawBackground(wxDC& dc,
...
void GDAuiTabArt::DrawTab(wxDC& dc,
                                 wxWindow* wnd,
...
int GDAuiTabArt::GetIndentSize()
{
    return 5;
}

wxSize GDAuiTabArt::GetTabSize(wxDC& dc,
                                      wxWindow* WXUNUSED(wnd),
...
void GDAuiTabArt::DrawButton(wxDC& dc,
                                    wxWindow* WXUNUSED(wnd),
                                    const wxRect& in_rect,
                                    int bitmap_id,
                                    int button_state,
...
int GDAuiTabArt::ShowDropDown(wxWindow* wnd,
...
int GDAuiTabArt::GetBestTabCtrlSize(wxWindow* wnd,
                                           const wxAuiNotebookPageArray& pages,
...
void GDAuiTabArt::SetNormalFont(const wxFont& font)
{
    m_normal_font = font;
}

void GDAuiTabArt::SetSelectedFont(const wxFont& font)
{
    m_selected_font = font;
}

void GDAuiTabArt::SetMeasuringFont(const wxFont& font)
{
