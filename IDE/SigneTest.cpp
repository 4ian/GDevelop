...
SigneTest::SigneTest(wxWindow* parent)
{
	...
	SigneRadio = new wxRadioBox(this, ID_RADIOBOX1, _("Signe du test"), wxDefaultPosition, wxSize(167,138), 6, __wxRadioBoxChoices_1, 1, 0, wxDefaultValidator, _T("ID_RADIOBOX1"));
