...
internal external interface QueryOptions { var layers: Array<String>? }
internal external interface GeoJsonSourceOptions { var type: String; var data: dynamic }
internal external interface LayerOptions { var id: String; var source: String; var type: String }
internal external interface LngLat { var lng: Double; var lat: Double }
internal external interface Point { var x: Double; var y: Double }
