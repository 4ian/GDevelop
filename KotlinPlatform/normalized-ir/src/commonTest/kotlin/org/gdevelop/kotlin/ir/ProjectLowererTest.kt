...
private object AliasedExtension : org.gdevelop.kotlin.extensions.ExtensionProvider {
    ...
    override val descriptor = org.gdevelop.kotlin.extensions.ExtensionDescriptor(
        identity,
        listOf(org.gdevelop.kotlin.extensions.ActionDescriptor("Canonical::Move", listOf(org.gdevelop.kotlin.extensions.ParameterDescriptor("distance", org.gdevelop.kotlin.extensions.ValueTypes.Number)), "move")),
        emptyList(),
        aliases = listOf(org.gdevelop.kotlin.extensions.CompatibilityAlias("Legacy::Move", org.gdevelop.kotlin.extensions.QualifiedMemberId(identity, listOf("Canonical", "Move")))),
    )
    override val runtime = object : org.gdevelop.kotlin.extensions.ExtensionRuntime {
        override fun invoke(entry:String, arguments:List<String>, context:org.gdevelop.kotlin.extensions.ExtensionContext)=true
    }
}

class ExtensionIdentityLoweringTest {
    @kotlin.test.Test fun aliasRetainsSerializedSpellingAndLowersTypedArguments() {
        val origin = SourceLocation("fixture", "/events/0/actions/0")
        val project = ProjectDocument("1", "Main", emptyList(), listOf(SceneDeclaration("Main", emptyList(), listOf(EventDeclaration(emptyList(), listOf(OperationDeclaration("Legacy::Move", listOf("01.50"), origin)), emptyList(), origin)))))
        ...
        kotlin.test.assertEquals(org.gdevelop.kotlin.extensions.ResolvedArgument.Number("01.50", 1.5), call.arguments.single())
    }
}
