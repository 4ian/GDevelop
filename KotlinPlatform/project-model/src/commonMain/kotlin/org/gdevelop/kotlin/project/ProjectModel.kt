...
data class InstanceDeclaration(
	...
	val x: Double,
	val y: Double,
	val initialVariables: List<VariableDeclaration>,
	val location: SourceLocation
)
...
data class SceneDeclaration(
	...
	val objects: List<ObjectDeclaration> = emptyList(),
	val groups: List<ObjectGroupDeclaration> = emptyList(),
	val instances: List<InstanceDeclaration> = emptyList(),
...
data class EventDeclaration(
	...
	val location: SourceLocation,
	val localVariables: List<VariableDeclaration> = emptyList()
)
...
data class OperationDeclaration(
	...
	val location: SourceLocation,
	val originalSerializedType: String = type
)
