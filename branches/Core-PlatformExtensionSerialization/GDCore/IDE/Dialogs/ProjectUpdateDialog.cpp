...
ProjectUpdateDialog::ProjectUpdateDialog(wxWindow* parent, wxString updateText)
{
	...
	Create(parent, wxID_ANY, _("Project updated"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	...
	StaticText2 = new wxStaticText(this, ID_STATICTEXT2, _("Remember to always make regular saves of your projects so as to have backup if something\ngoes wrong."), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	...
	Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&ProjectUpdateDialog::OnokBtClick);
	//*)
...
void ProjectUpdateDialog::OnokBtClick(wxCommandEvent& event)
{
    EndModal(0);
}
#endif
