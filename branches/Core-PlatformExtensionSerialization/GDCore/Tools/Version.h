...
namespace AutoVersion{
	...
	static const long GDCore_BUILD = 69;
	static const long GDCore_REVISION = 0;
	
	//Miscellaneous Version Types
	#define GDCore_RC_FILEVERSION 3,2,69,0
	#define GDCore_RC_FILEVERSION_STRING "3, 2, 69, 0\0"
	static const char GDCore_FULLVERSION_STRING[] = "3.2.69.0";
