...
ExternalLayoutsExtension::ExternalLayoutsExtension()
{
    ...
    AddAction("CreateObjectsFromExternalLayout",
        ...
        .cppCallingInformation.SetFunctionName("ExternalLayoutsTools::CreateObjectsFromExternalLayout").SetIncludeFile("GDL/BuiltinExtensions/ExternalLayoutsTools.h");
    #endif
}
