...
public:
    ...
    const std::string & GetAssociatedGDManagedSourceFile(Game & parentGame) const { EnsureAssociatedSourceFileIsUpToDate(parentGame); return associatedGDManagedSourceFile; };
