...
..\bin\dev\CppPlatform\Tools\clang++.exe -cc1  -DGD_API=__declspec(dllimport) -D GD_EXTENSION_API=__declspec(dllimport) -DGD_IDE_ONLY -DDEV -DNDEBUG -DBOOST_DISABLE_ASSERTS -I..\Bin\Dev\CppPlatform\include/TDM-GCC-4.5.2/include  -I..\Bin\Dev\CppPlatform\include/TDM-GCC-4.5.2/lib/gcc/mingw32/4.5.2/include -I..\Bin\Dev\CppPlatform\include\TDM-GCC-4.5.2/lib/gcc/mingw32/4.5.2/include/c++ -I..\Bin\Dev\CppPlatform\include\TDM-GCC-4.5.2/lib/gcc/mingw32/4.5.2/include/c++/mingw32 -I..\Bin\Dev\CppPlatform\include/llvm/tools/clang/lib/Headers -I..\Bin\Dev\CppPlatform\include/llvm/include -I..\Bin\Dev\CppPlatform\include/llvm/build-tdmgcc45-release/include -I..\Bin\Dev\CppPlatform\include/GDL -I..\Bin\Dev\CppPlatform\include/Core -I..\Bin\Dev\CppPlatform\include/boost -I..\Bin\Dev\CppPlatform\include\SFML/include -x c++-header events.h -emit-pch -o events.h.pch
