  ...
  return (
    ...
    >
      <div style={styles.colorPickerHeader} onMouseDown={onMouseDown}>
        <svg width="16" height="16" viewBox="0 0 80 60" style={{ flexShrink: 0 }}>
          <path d="M0,6 Q0,0 6,0 L26,0 L30,6 L74,6 Q80,6 80,12 L80,54 Q80,60 74,60 L6,60 Q0,60 0,54 Z" fill={selectedColor} />
          <path d="M0,14 L80,14 L80,54 Q80,60 74,60 L6,60 Q0,60 0,54 Z" fill="rgba(255,255,255,0.18)" />
        </svg>
        <span style={{ fontSize: 14, fontWeight: 500, color: '#e5e5e5' }}>Folder color</span>
        <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', marginLeft: 'auto' }}>{folderName}</span>
      </div>
      ...
      <div style={styles.colorPickerBody}>
          ...
          {PRESET_COLORS.map(color => (
            <div
              ...
              style={{
                ...
                boxShadow: selectedColor === color ? '0 0 0 1px rgba(255,255,255,0.3)' : 'none',
              }}
        ...
        <div style={styles.colorPickerHexRow}>
          <div style={{ ...styles.colorPickerHexDot, background: selectedColor }} />
          <span style={styles.colorPickerHexText}>{selectedColor}</span>
          <button style={styles.colorPickerCustomBtn} onClick={handleCustomPick}>
            ✎ Custom
          </button>
          <input
            ref={nativeInputRef}
        ...
        <div style={styles.colorPickerActions}>
          ...
          <button style={styles.colorPickerBtnReset} onClick={handleReset} title="Reset color">
            🗑
          </button>
          <button style={styles.colorPickerBtnCancel} onClick={onClose} title="Cancel">
            ✕
          </button>
        </div>
      </div>
