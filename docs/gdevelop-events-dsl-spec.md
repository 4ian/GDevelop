...
extensions/<ExtensionName>/prefabs/<PrefabName>/functions/<optional folders>/<FunctionName>/function.settings
extensions/<ExtensionName>/prefabs/<PrefabName>/functions/<optional folders>/<FunctionName>/<FunctionName>.events
extensions/<ExtensionName>/behaviors/<BehaviorName>/functions/<optional folders>/<FunctionName>/function.settings
extensions/<ExtensionName>/behaviors/<BehaviorName>/functions/<optional folders>/<FunctionName>/<FunctionName>.events
```
...
directories. Prefab and behavior optional subfolders reproduce their editor
function grouping; no owner settings file lists them. The `ifdo-ai` profile
...
events = "game://extensions/Combat/behaviors/Health/functions/Recovery/Heal/Heal.events"
```
...
- Canonical prefab/behavior function paths are
  `functions/<optional folders>/<Function>/<Function>.events`, beside their
  dedicated `function.settings`.
...
behavior methods use their own recursively discovered
`functions/<optional folders>/<Function>/function.settings` files.
...
methods are owned by physical
`functions/<optional folders>/<Function>/` directories containing both
`function.settings` and the sibling `.events` body. Contiguous `order` values
preserve deterministic legacy array order. The physical optional folders are
the source of truth for editor grouping; only a transient legacy folder tree is
