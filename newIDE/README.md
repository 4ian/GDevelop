...
Once you have built the Electron app, you can publish the executables to discord by runnning `yarn publish-discord`.
After publishing the new version, you can test it out by running `./scripts/dispatch/(dispatch.exe|dispatch_mac|dispatch_linux) build update 718194112775454720 718194112775454720 <install_path> --platform <value> --locale en-US`, and running the GDevelop executable present in the specified installation path.
