...
declare module 'react-color' {
  ...
  declare export class ChromePicker extends React$Component<
    ChromePickerProps
  > {}
  declare export class CirclePicker extends React$Component<
    CirclePickerProps
  > {}
  declare export class CompactPicker extends React$Component<
    CompactPickerProps
  > {}
  declare export class GithubPicker extends React$Component<
    GithubPickerProps
  > {}
  declare export class HuePicker extends React$Component<HuePickerProps> {}
  declare export class MaterialPicker extends React$Component<
    MaterialPickerProps
  > {}
  declare export class PhotoshopPicker extends React$Component<
    PhotoshopPickerProps
  > {}
  declare export class SketchPicker extends React$Component<
    SketchPickerProps
  > {}
  declare export class SliderPicker extends React$Component<
    SliderPickerProps
  > {}
  declare export class SwatchesPicker extends React$Component<
    SwatchesPickerProps
  > {}
  declare export class TwitterPicker extends React$Component<
    TwitterPickerProps
  > {}
...
declare module 'react-color/lib/components/common' {
  ...
  declare export class EditableInput extends React$Component<
    EditableInputProps
  > {}
