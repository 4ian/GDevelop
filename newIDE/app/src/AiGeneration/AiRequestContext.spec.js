...
import { AiRequestContext, AiRequestProvider } from './AiRequestContext';
...
type CapturedContext = $Call<typeof React.useContext, typeof AiRequestContext>;

const ContextCapture = ({
  contextRef,
}: {|
  contextRef: { current: CapturedContext | null },
|}) => {
...
const renderProvider = () => {
  const contextRef: { current: CapturedContext | null } = { current: null };
...
describe('AiRequestProvider sub-agent polling', () => {
  beforeEach(() => {
    ...
    mockFn(fetchAiSettings)
      .mockReset()
      .mockResolvedValue(null);
    mockFn(getAiRequests)
      .mockReset()
      .mockResolvedValue({
        aiRequests: [],
        nextPageUri: null,
