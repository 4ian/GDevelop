...
export const AskAiEditor: component(...Props) renders* = React.memo<Props>(
...
export const renderAskAiEditorContainer = (props: RenderEditorContainerPropsWithRef): renders* => (
  <I18n>
    {({ i18n }) => (
      <AskAiEditor
        ref={props.ref}
