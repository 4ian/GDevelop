...
export const useProcessFunctionCalls = (
  ...
  |},
): { isAutoProcessingFunctionCalls: (aiRequestId: string) => boolean, onProcessFunctionCalls: ( functionCalls: Array<AiRequestMessageAssistantFunctionCall>, options: ?{ ignore?: boolean } ) => Promise<void>, setAutoProcessFunctionCalls: ( aiRequestId: string, shouldAutoProcess: boolean ) => void } => {
...
export const useAiRequestState = (
  ...
  |},
): { isFetchingSuggestions: boolean, savingProjectForMessageId: ?string, selectedAiRequest: any, selectedAiRequestId: any, setAiState: any } => {
