...
export const AssetStoreStateProvider = ({
  ...
  const [publicAssetShortHeaders, setPublicAssetShortHeaders] =
  ...
  const [publicAssetPacks, setPublicAssetPacks] =
  ...
  const assetShortHeadersSearchResults: ?Array<AssetShortHeader> =
    useSearchItem(
  ...
  const privateAssetPackListingDatasSearchResults: ?Array<PrivateAssetPackListingData> =
    useSearchItem(
