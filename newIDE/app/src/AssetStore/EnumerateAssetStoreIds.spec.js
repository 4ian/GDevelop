...
describe('enumerateAssetStoreIds', () => {
  ...
  |} => {
    ...
    scene1
      .getObjectsContainer()
      .insertNewObject(project, 'Sprite', 'Scene1Object2', 0);
    ...
    scene2
      .getObjectsContainer()
      .insertNewObject(project, 'Sprite', 'Scene2Object2', 0);
  ...
  test('enumerate asset store ids for a specific scene', () => {
    ...
    const scene1AssetStoreIds = [
      ...enumerateAssetStoreIds(project, scene1.getObjectsContainer()),
    ].sort();
    expect(scene1AssetStoreIds).toEqual(['1234', '56-78', 'abcd'].sort());
    const scene2AssetStoreIds = [
      ...enumerateAssetStoreIds(project, scene2.getObjectsContainer()),
    ].sort();
