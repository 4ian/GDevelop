...
export default function NewObjectFromScratch({
  ...
  const installedEnumeratedObjectMetadatas = React.useMemo(
  ...
  const getDefaultEnumeratedObjectMetadatasByCategory = i18n => {
      ...
      [translateExtensionCategory('User interface', i18n)]: [
        {
          ...
          description: 'Resizable button with text customization.',
          iconFilename:
        ...
        },
        {
          ...
          fullName: 'Slider',
          description:
            'Let users select a numerical value byb dragging a slider.',
          iconFilename:
    ...
    return enumeratedObjectMetadatasByCategory;
  };
  ...
  const enumeratedObjectMetadatasByCategory: {
    ...
    () => {
      const enumeratedObjectMetadatasByCategory = getDefaultEnumeratedObjectMetadatasByCategory(
        i18n
      );
      installedEnumeratedObjectMetadatas.forEach(
        installedEnumeratedObjectMetadata => {
          ...
          enumeratedObjectMetadatasByCategory[category] =
            enumeratedObjectMetadatasByCategory[category] || [];
          const objectIndex = enumeratedObjectMetadatasByCategory[
            category
          ].findIndex(
            enumeratedObjectMetadata =>
          ...
          if (objectIndex !== -1) {
            const currentEnumeratedObjectMetadata =
              enumeratedObjectMetadatasByCategory[category][objectIndex];
            enumeratedObjectMetadatasByCategory[category][objectIndex] = {
    ...
    [installedEnumeratedObjectMetadatas, i18n]
  );
