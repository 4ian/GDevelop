        ...
        >
          <List>
            <FunctionListItem
              ...
              description={
                <Trans>
                  An action that can be used on objects with the behavior. You
                  can define the action parameters: objects, texts, numbers,
                  layers, etc...
                </Trans>
              }
              onChoose={onChoose}
            ...
            <FunctionListItem
              ...
              description={
                <Trans>
                  A condition that can be used on objects with the behavior. You
                  can define the condition parameters: objects, texts, numbers,
                  layers, etc...
                </Trans>
              }
              onChoose={onChoose}
            ...
            <FunctionListItem
              ...
              description={
                <Trans>
                  An expression that can be used on objects with the behavior.
                  Can either return a number or a string, and take some
                  parameters.
                </Trans>
              }
              onChoose={onChoose}
            ...
            {showAdvanced && (
              <>
                ...
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      Events that will be run once when the behavior is
                      deactivated on an object (step events won't be run until
                      the behavior is activated again).
                    </Trans>
                  }
                />
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      Events that will be run once when the behavior is
                      re-activated on an object (after it was previously
                      deactivated).
                    </Trans>
                  }
                />
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      ...
                      per second), for every object that has the behavior
                      attached, after the events from the events sheet.
                    </Trans>
                  }
                />
              </>
