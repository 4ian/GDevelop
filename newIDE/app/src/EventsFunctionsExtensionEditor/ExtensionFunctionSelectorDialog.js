        ...
        >
          <List>
            <FunctionListItem
              ...
              description={
                <Trans>
                  An action that can be used in other events sheet. You can
            ...
            <FunctionListItem
              ...
              description={
                <Trans>
                  A condition that can be used in other events sheet. You can
                  define the condition parameters: objects, texts, numbers,
                  layers, etc...
                </Trans>
              }
              onChoose={onChoose}
            ...
            <FunctionListItem
              ...
              description={
                <Trans>
                  An expression that can be used in formulas. Can either return
                  a number or a string, and take some parameters.
                </Trans>
              }
              onChoose={onChoose}
            />
            {showAdvanced && (
              <React.Fragment>
                ...
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      Events that will be run once when the first scene of the
                      game is loaded, before any other events.
                    </Trans>
                  }
                  onChoose={onChoose}
                />
                ...
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      Events that will be run at every frame (roughly 60 times
                      per second), before the events from the events sheet of
                      the scene.
                    </Trans>
                  }
                  onChoose={onChoose}
                ...
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      Events that will be run at every frame (roughly 60 times
                      per second), after the events from the events sheet of the
                      scene.
                    </Trans>
                  }
                  onChoose={onChoose}
                ...
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      Events that will be run once when a scene is paused
                      (another scene is run on top of it).
                    </Trans>
                  }
                  onChoose={onChoose}
                />
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      Events that will be run once when a scene is resumed
                ...
                <FunctionListItem
                  ...
                  description={
                    <Trans>
                      ...
                      unloaded from memory. The previous scene that was paused
                      will be resumed after this.
                    </Trans>
                  }
                  onChoose={onChoose}
                />
