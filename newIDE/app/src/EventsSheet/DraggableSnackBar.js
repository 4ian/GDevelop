 ...
 */
const DraggableSnackBar: React.ComponentType<{
  ...Props,
  +ref?: React.RefSetter<DraggableSnackBarInterface>,
}> = React.forwardRef<Props, DraggableSnackBarInterface>(
  ({ open, message, action }: Props, ref) => {
    ...
    const onMouseUp: () => void = React.useCallback(
      () => {
