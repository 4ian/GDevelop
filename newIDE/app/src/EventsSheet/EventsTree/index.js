...
const EventsTree: React.AbstractComponent<{ ...EventsTreeProps, +ref?: React.RefSetter<EventsTreeInterface> }, React.RefSetter<EventsTreeInterface>> = React.forwardRef<EventsTreeProps, EventsTreeInterface>(
  (props, ref) => {
    const forceUpdate = useForceUpdate();
