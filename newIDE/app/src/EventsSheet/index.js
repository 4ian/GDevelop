                  ...
                  >
                    <EventsTree
                      ...
                      showObjectThumbnails={
                        this.props.userPreferences.values
                      ...
                      fontSize={
                        this.props.userPreferences.values.eventsSheetZoomLevel
                      }
                    />
                    ...
                    <InlineParameterEditor
                      ...
                      onRequestClose={() => {
                        this.closeParameterEditor(
                          /*shouldCancel=*/ this.props.userPreferences.values
                    ...
                    <ContextMenu
                      ...
                      buildMenuTemplate={(i18n: I18nType) => [
                        ...
                        { type: 'separator' },
                        {
                          ...
                          enabled:
                            this.props.userPreferences.values
                              .eventsSheetZoomLevel < zoomLevel.max,
                        },
                        {
                          ...
                          enabled:
                            this.props.userPreferences.values
                              .eventsSheetZoomLevel > zoomLevel.min,
                        },
                      ]}
                    />
                    <ContextMenu
                    ...
                    {this._renderInstructionEditorDialog(
                      ...
                      this.props.userPreferences.values
                        .useNewInstructionEditorDialog || screenType === 'touch'
                    )}
                    {this.state.analyzedEventsContextResult && (
