...
export const WebProjectLink = ({ build, loading }: WebProjectLinkProps) => {
  ...
  const onShare = async () => {
    ...
    const shareData = {
      ...
      text: 'Try the game I just created!',
      url: buildUrl,
    };
        ...
        {buildUrl && (
          <Column>
            ...
            <Line justifyContent="flex-end">
              <FacebookShareButton
                url={`Try the game I just created! ${buildUrl}`}
                style={styles.icon}
              >
              ...
              <TwitterShareButton
                url={`Try the game I just created! ${buildUrl} #GDevelop`}
                style={styles.icon}
              >
              ...
              <EmailShareButton
                url={`Try the game I just build! ${buildUrl}`}
                style={styles.icon}
              >
