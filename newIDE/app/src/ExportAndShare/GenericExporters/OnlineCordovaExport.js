...
export const SetupExportHeader = ({exportState, updateExportState, isExporting, build}: HeaderProps<ExportState>): null | renders* => {
...
export const onlineCordovaExporter = {
  ...
  name: <Trans>Android</Trans> as renders*,
