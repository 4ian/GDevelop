 ...
 *
 * Contents are stored uncompressed: images, audio and 3D models, which make up
 * nearly all of the bytes, are already compressed formats. This also keeps
 * reading a file a simple `Blob.slice`, which the browser can do without
