              ...
              <Trans>
                {isForEditor ? (
                  <Trans>
                    ...
                    encountered an unhandled exception or error. It's necessary
                    to restart the 3D editor.
                  </Trans>
                ) : (
                  <Trans>
                    Your latest changes could not be applied to the preview(s)
                    being run. You should start a new preview instead to make
                    sure that all your changes are reflected in the game.
                  </Trans>
                )}
              </Trans>
            </Text>
