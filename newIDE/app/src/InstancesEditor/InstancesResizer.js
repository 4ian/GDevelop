  ...
  resizeBy(
    ...
    let scaleY =
      initialSelectionAABB.height() !== 0
        ...
        : flippedTotalDeltaY;
    let scaleZ = Math.max(scaleX, scaleY);
    ...
    for (let i = 0; i < nonLockedInstances.length; i++) {
      ...
      const initialDepth = selectedInstance.hasCustomDepth()
        ? selectedInstance.getCustomDepth()
        : defaultSize[2];
