...
export default class SelectedInstances {
  ...
  pixiContainer = new PIXI.Container() as any;
  rectanglesContainer = new PIXI.Container() as any;
  selectedRectangles = [] as Array<empty>;
  resizeButtons: { [ResizeGrabbingLocation]: PIXI.Graphics } = {};
  rotateButton = new PIXI.Graphics() as any;
  /**
