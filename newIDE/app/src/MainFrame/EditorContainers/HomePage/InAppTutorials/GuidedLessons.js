...
export const allInAppTutorialsCards = [
  {
    ...
    durationInMinutes: 1,
    renderImage: (props: any): renders any => <Platformer {...props} />,
  },
  {
    id: CAMERA_PARALLAX_IN_APP_TUTORIAL_ID,
    title: t`Background and cameras` as any,
    ...
    durationInMinutes: 2,
    renderImage: (props: any): renders any => <Parallax {...props} />,
  },
  {
    id: TOP_DOWN_RPG_MOVEMENT_ID,
    title: t`Top-Down RPG Pixel Perfect` as any,
    ...
    durationInMinutes: 2,
    renderImage: (props: any): renders any => <TopDownRPGMovement {...props} />,
  },
  {
    id: JOYSTICK_IN_APP_TUTORIAL_ID,
    title: t`Joystick controls` as any,
    ...
    durationInMinutes: 1,
    renderImage: (props: any): renders any => <Joystick {...props} />,
  },
  {
    id: OBJECT_3D_IN_APP_TUTORIAL_ID,
    title: t`3D platforms` as any,
    ...
    durationInMinutes: 2,
    renderImage: (props: any): renders any => <Object3D {...props} />,
  },
  {
    id: HEALTH_BAR_IN_APP_TUTORIAL_ID,
    title: t`Health bar` as any,
    ...
    durationInMinutes: 2,
    renderImage: (props: any): renders any => <HealthBar {...props} />,
  },
  {
    id: TILEMAP_PLATFORMER_ID,
    title: t`Paint a Level with Tiles` as any,
    ...
    durationInMinutes: 2,
    renderImage: (props: any): renders any => <TilemapPlatformer {...props} />,
  },
  {
    id: FIRE_A_BULLET_ID,
    title: t`Fire a Bullet` as any,
    ...
    durationInMinutes: 2,
    renderImage: (props: any): renders any => <FireABullet {...props} />,
  },
  {
    id: TIMER_IN_APP_TUTORIAL_ID,
    title: t`Time score` as any,
    ...
    durationInMinutes: 2,
    renderImage: (props: any): renders any => <Timer {...props} />,
  },
  {
    id: COOP_PLATFORMER_ID,
    title: t`Co-op Multiplayer` as any,
    ...
    durationInMinutes: 3,
    renderImage: (props: any): renders any => <CoopPlatformer {...props} />,
  },
  {
    id: PLINKO_MULTIPLIER_IN_APP_TUTORIAL_ID,
    title: t`Score multiplier` as any,
    ...
    durationInMinutes: 3,
    renderImage: (props: any): renders any => <MultiplierScore {...props} />,
  },
];
...
const GuidedLessons = ({selectInAppTutorial, lessonsIds, displayAsCarousel}: Props): renders any => {
