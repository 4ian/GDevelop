...
type GetInitialPreferencesReturn = { aiState: { aiRequestId: null }, autoDisplayChangelog: boolean, autoDownloadUpdates: boolean, autoOpenMostRecentProject: boolean, automaticallyUseCreditsForAiRequests: boolean, autosaveOnPreview: boolean, backdropClickBehavior: string, codeEditorThemeName: string, defaultEditorMosaicNodes: {}, disableNpmScriptConfirmation: boolean, displaySaveReminder: { activated: boolean }, editorStateByProject: {}, eventsSheetCancelInlineParameter: string, eventsSheetIndentScale: number, eventsSheetShowObjectThumbnails: boolean, eventsSheetUseAssignmentOperators: boolean, eventsSheetZoomLevel: number, fetchPlayerTokenForPreviewAutomatically: boolean, gamesDashboardOrderBy: string, hasProjectOpened: boolean, hiddenAlertMessages: {}, hiddenAnnouncements: {}, hiddenAskAiStandAloneForms: {}, hiddenTutorialHints: {}, inAppTutorialsProgress: {}, isAlwaysOnTopInPreview: boolean, isMenuBarHiddenInPreview: boolean, language: string, lastLaunchedVersion: void, newFeaturesAcknowledgements: {}, newObjectDialogDefaultTab: any, newProjectsDefaultFolder: any, newProjectsDefaultStorageProviderName: string, openDiagnosticReportAutomatically: boolean, previewCrashReportUploadLevel: string, projectLastUsedPaths: {}, recentProjectFiles: any, resourcesImporationBehavior: string, shareDialogDefaultTab: string, showAiAskButtonInTitleBar: boolean, showBasicProfilingCounters: boolean, showCreateSectionByDefault: boolean, showDeprecatedInstructionWarning: boolean, showEffectParameterNames: boolean, showExperimentalExtensions: boolean, showInAppTutorialDeveloperMode: boolean, takeScreenshotOnPreview: boolean, themeName: any, use3DEditor: any, useBackgroundSerializerForSaving: boolean, useGDJSDevelopmentWatcher: boolean, useShortcutToClosePreviewWindow: boolean, userShortcutMap: {}, watchProjectFolderFilesForLocalProjects: boolean };

export const getInitialPreferences = (): GetInitialPreferencesReturn => {
