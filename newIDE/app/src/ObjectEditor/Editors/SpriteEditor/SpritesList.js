...
export default class SpritesList extends Component {
  ...
  onEditSprites =() => {
    ...
    for (var i = 0; i < direction.getSpritesCount(); i++) {
      // console.log(i);
      var spriteImagePath = resourcesLoader.getResourceFullUrl(project, direction.getSprite(i).getImageName());
      // piskelWindow.console.log("Path: "+spriteImagePath);
    ...
    piskelWindow.addEventListener('load',() => {
      ...
      if (pskl) {
        piskelWindow.console.log(pskl);
          ...
          // document.querySelector('.editor-frame').contentWindow.pskl.service.ImportService.prototype.createFramesFromImages_()
          //

          //this.document.querySelector('.editor-frame').contentWindow.pskl.service.ImportService.prototype.createPiskelFromImages_()
         // (img,"foo",10,10,true)
          // var importedImage = new Image();
          // importedImage.onload = function (importedImage) {
          //   console.log(importedImage);
            // pskl.piskelController.addFrameAtCurrentIndex();
            // pskl.piskelController.selectNextFrame();
            // var currentFrame = pskl.piskelController.getCurrentFrame();
            // pskl.utils.FrameUtils.addImageToFrame(i, importedImage, 20, 20);
