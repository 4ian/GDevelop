...
const ObjectSelector: React.AbstractComponent<{ ...Props, +ref?: React.RefSetter<ObjectSelectorInterface> }, React.RefSetter<ObjectSelectorInterface>> = React.forwardRef<Props, ObjectSelectorInterface>(
  (props, ref) => {
