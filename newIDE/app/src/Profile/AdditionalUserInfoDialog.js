...
export const shouldAskForAdditionalUserInfo = (profile: Profile) => {
  ...
  if (isEmailAutogenerated) {
    // Accounts that we generated email addresses for should not be asked any questions
    // since it is considered a user has subscribed to a specific subscription to keep
    // users anonymous.
    return false;
  }
