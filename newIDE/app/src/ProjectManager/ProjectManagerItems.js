...
export const ProjectStructureItem = (props: ProjectStructureItemProps) => {
  ...
  return (
    <ListItem
      ...
      onReload={onRefresh}
      style={{
        backgroundColor: theme.listItem.groupBackgroundColor,
        borderBottom: `1px solid ${theme.listItem.separatorColor}`,
      }}
      nestedListStyle={
      ...
      reloadButtonTooltip={`An error has ocurred in functions. Click to reload them.`}
    />
  );
};
