...
export default class ProjectManager extends React.Component<Props, State> {
  ...
  _installExtension = async (
    ...
    const { openedExtensionShortHeader } = this.state;
    if (!openedExtensionShortHeader) return;
    this.setState({ isInstallingExtension: true });
    try {
      this.props.onInstallExtension(openedExtensionShortHeader);
      ...
      this.setState({ isInstallingExtension: false });
    }
  };
                ...
                {({ extensionShortHeadersByName }) => (
                  <div style={styles.container}>
                    <ProjectManagerCommands
                      ...
                      onOpenSearchExtensionDialog={
                        this._openSearchExtensionDialog
                      }
                    />
                          ...
                          filterProjectItemsList(
                                  ...
                                  buildExtraMenuTemplate={(i18n: I18nType) => [
                                    {
                                      ...
                                      enabled: true,
                                      click: () =>
                                        this._onOpenLayoutProperties(layout),
                                    },
                                    {
                                      label: i18n._(t`Edit Scene Variables`),
                                      enabled: true,
                                      click: () =>
                                        this._onOpenLayoutVariables(layout),
                                    },
                                  ]}
                                />
                              );
                            ...
                            .concat(
                              <AddListItem
                                ...
                                primaryText={
                                  <Trans>Click to add a scene</Trans>
                                }
                              />
                            )
                        }
                            ...
                            .map((externalEvents, i) => {
                              ...
                              return (
                                <Item
                                  ...
                                  onEdit={() =>
                                    this.props.onOpenExternalEvents(name)
                                  }
                                  onDelete={() =>
                                    this.props.onDeleteExternalEvents(
                                      externalEvents
                                    )
                                  }
                                  ...
                                  onRename={newName => {
                                    this.props.onRenameExternalEvents(
                                      name,
                                      newName
                                    );
                                    this._onEditName(null, '');
                                  ...
                                  onMoveDown={() =>
                                    this._moveDownExternalEvents(i)
                                  }
                                />
                              );
                            })
                            ...
                            .map((externalLayout, i) => {
                              ...
                              return (
                                <Item
                                  ...
                                  onEdit={() =>
                                    this.props.onOpenExternalLayout(name)
                                  }
                                  onDelete={() =>
                                    this.props.onDeleteExternalLayout(
                                      externalLayout
                                    )
                                  }
                                  ...
                                  onRename={newName => {
                                    this.props.onRenameExternalLayout(
                                      name,
                                      newName
                                    );
                                    this._onEditName(null, '');
                                  ...
                                  onCut={() =>
                                    this._cutExternalLayout(externalLayout)
                                  }
                                  onPaste={() => this._pasteExternalLayout(i)}
                                  onDuplicate={() =>
                                    this._duplicateExternalLayout(
                                      externalLayout,
                                      i
                                    )
                                  }
                                  ...
                                  onMoveDown={() =>
                                    this._moveDownExternalLayout(i)
                                  }
                                />
                              );
                            })
                          ...
                          filterProjectItemsList(
                            ...
                            .map((eventsFunctionsExtension, i) => {
                              ...
                              return (
                                <Item
                                  ...
                                  onPaste={() =>
                                    this._pasteEventsFunctionsExtension(i)
                                  }
                                  onDuplicate={() =>
                            ...
                            .concat(
                              <AddListItem
                                ...
                                primaryText={
                                  <Trans>
                                    Click to add functions and behaviors
                                  </Trans>
                                }
                                onClick={
                                  this.props.onAddEventsFunctionsExtension
                                }
                              />
                            )
                            .concat(
                              <SearchListItem
                                ...
                                primaryText={
                                  <Trans>Search for new extensions</Trans>
                                }
                    ...
                    {this.state.projectVariablesEditorOpen && (
                      <VariablesEditorDialog
                        ...
                        emptyExplanationMessage={
                          <Trans>
                            Global variables are variables that are shared
                            amongst all the scenes of the game.
                          </Trans>
                        }
                        emptyExplanationSecondMessage={
                          <Trans>
                            For example, you can have a variable called
                            UnlockedLevelsCount representing the number of
                            levels unlocked by the player.
                          </Trans>
                        }
                        helpPagePath={
                          '/all-features/variables/global-variables'
                        }
                    ...
                    {this.state.projectPropertiesDialogOpen && (
                      <ProjectPropertiesDialog
                        open
                        initialTab={
                          this.state.projectPropertiesDialogInitialTab
                        }
                        project={project}
                        onClose={() =>
                    ...
                    {openedExtensionShortHeader && (
                      <ExtensionInstallDialog
                        alreadyInstalled
                        isInstalling={this.state.isInstallingExtension}
                        onClose={() =>
