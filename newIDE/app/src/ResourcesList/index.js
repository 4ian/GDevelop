...
import Resource3DPreviewContext from './ResourcePreview/Resource3DPreviewContext';
...
const ResourcesList = React.memo<Props, ResourcesListInterface>(
  React.forwardRef<Props, ResourcesListInterface>(
    (
      ...
      const getResourceThumbnailAsync = React.useCallback(
        async (resource: gdResource) => {
          switch (resource.getKind()) {
            case 'model3D':
                ...
                <I18n>
                  {({ i18n }) => (
                    <SortableVirtualizedItemList
                      ...
                      getItemThumbnailAsync={getResourceThumbnailAsync}
