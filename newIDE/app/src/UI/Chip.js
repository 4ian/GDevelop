...
const Chip: React.AbstractComponent<{ ...Props, +ref?: React.RefSetter<ChipInterface> }, React.RefSetter<ChipInterface>> = React.forwardRef<Props, ChipInterface>((props, ref) => {
