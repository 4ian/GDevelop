...
type UseClickDragAsControlReturn = { onMouseDown: (e: MouseEvent) => void, onMouseMove: (e: MouseEvent) => void, onMouseUp: () => void };

const useClickDragAsControl = ({onChange, onGetInitialValue}: Props): UseClickDragAsControlReturn => {
