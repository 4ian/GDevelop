 ...
 */
export const shouldValidate = (event: SupportedEvent): any | false => {
 ...
 */
export const shouldBrowsePrevious = (event: SupportedEvent): boolean => {
 ...
 */
export const shouldSubmit = (event: SupportedEvent): boolean => {
 ...
 */
export const shouldFocusNextField = (event: SupportedEvent): any | false => {
 ...
 * (or material-ui), and using this should not be needed.
 */
export const shouldFocusPreviousField = (event: SupportedEvent): any | false => {
  return event.key === 'Tab' && event.shiftKey;
};
