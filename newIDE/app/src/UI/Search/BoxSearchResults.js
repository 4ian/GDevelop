...
export const BoxSearchResults: React.ComponentType<any> = React.forwardRef<
  // $FlowFixMe[cannot-resolve-name][incompatible-type] The generic type can't pass through.
  Props<SearchItem>,
