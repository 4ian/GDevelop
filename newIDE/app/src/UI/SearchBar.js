...
const SearchBar: React.AbstractComponent<{ ...Props, +ref?: React.RefSetter<SearchBarInterface> }, React.RefSetter<SearchBarInterface>> = React.forwardRef<Props, SearchBarInterface>(
  (
    {
      id,
      disabled,
