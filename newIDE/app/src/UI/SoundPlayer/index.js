...
const SoundPlayer: React.AbstractComponent<{ ...Props, +ref?: React.RefSetter<SoundPlayerInterface> }, React.RefSetter<SoundPlayerInterface>> = React.forwardRef<Props, SoundPlayerInterface>(
  (
    {
      soundSrc,
      onSoundLoaded,
