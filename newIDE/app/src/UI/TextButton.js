...
const TextButton: React.AbstractComponent<{ ...Props, +ref?: React.RefSetter<ButtonInterface> }, React.RefSetter<ButtonInterface>> = React.forwardRef<Props, ButtonInterface>(
  (
    {
      label,
      primary,
