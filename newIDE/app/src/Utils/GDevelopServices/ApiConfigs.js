...
export const GDevelopBuildApi = {
  baseUrl: ((isDev ? 'https://api-dev.gdevelop.io/build' : 'https://api.gdevelop.io/build'): string),
};

export const GDevelopUsageApi = {
  baseUrl: ((isDev ? 'https://api-dev.gdevelop.io/usage' : 'https://api.gdevelop.io/usage'): string),
};
...
export const GDevelopAssetApi = {
  baseUrl: ((isDev ? 'https://api-dev.gdevelop.io/asset' : 'https://api.gdevelop.io/asset'): string),
};
...
export const GDevelopGameApi = {
  baseUrl: ((isDev ? 'https://api-dev.gdevelop.io/game' : 'https://api.gdevelop.io/game'): string),
};

export const GDevelopUserApi = {
  baseUrl: ((isDev ? 'https://api-dev.gdevelop.io/user' : 'https://api.gdevelop.io/user'): string),
};

export const GDevelopPlayApi = {
  baseUrl: ((isDev ? 'https://api-dev.gdevelop.io/play' : 'https://api.gdevelop.io/play'): string),
};

export const GDevelopShopApi = {
  baseUrl: ((isDev ? 'https://api-dev.gdevelop.io/shop' : 'https://api.gdevelop.io/shop'): string),
};
