 ...
 */
type UseSerializableObjectCancelableEditorReturn = { getOriginalContentSerializedElement: () => gdSerializerElement, hasUnsavedChanges: () => boolean, notifyOfChange: () => void, onCancelChanges: () => Promise<void> };
...
): UseSerializableObjectCancelableEditorReturn => {
 ...
 * returned by the hook.
 */
type UseSerializableObjectsCancelableEditorReturn = { getOriginalContentSerializedElements: () => Map<string, gdSerializerElement>, hasUnsavedChanges: () => boolean, notifyOfChange: () => void, onCancelChanges: () => Promise<void> };
...
): UseSerializableObjectsCancelableEditorReturn => {
