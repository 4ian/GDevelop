...
type GetDefaultRegisterGamePropertiesReturn = { authorName: string, gameId: string, gameName: string, savedStatus: SavedStatus };
...
export const getDefaultRegisterGameProperties = (
  ...
  |},
): GetDefaultRegisterGamePropertiesReturn => ({
  gameId: projectId,
