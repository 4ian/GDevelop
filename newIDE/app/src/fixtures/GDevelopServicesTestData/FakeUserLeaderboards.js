// @flow
import { type UserLeaderboard } from '../../Utils/GDevelopServices/User';

export const fakeUserLeaderboards: UserLeaderboard[] = [
  {
    name: 'weeklyTopUsersWithRatedComments',
    displayNameByLocale: {
    ...
    topUserCommentQualityRatings: [
      {
        ...
        userPublicProfile: {
          ...
          communityLinks: {
            ...
            instagramUsername: '',
            tiktokUsername: '',
            personalWebsite2Link: 'https://gd.games/inusitatus_',
            facebookUsername: '',
            discordServerLink: '',
            snapchatUsername: '',
            personalWebsiteLink:
              'https://forum.gdevelop.io/u/shark_chum/summary',
            youtubeUsername: '',
          },
          iconUrl:
      ...
      },
      {
        ...
        userPublicProfile: {
          ...
          communityLinks: {
            ...
            tiktokUsername: '',
            personalWebsite2Link:
              'https://cuboid.my.canva.site/dreamplayergames',
            facebookUsername: '',
            discordServerLink: '',
            snapchatUsername: '',
            personalWebsiteLink:
              'https://cuboid.my.canva.site/dreamplayergames2',
            youtubeUsername: '',
          },
          iconUrl:
      ...
      },
      {
        ...
        userPublicProfile: {
          ...
          communityLinks: {
            ...
            snapchatUsername: '',
            personalWebsiteLink: '',
            youtubeUsername: 'armanislit',
          },
          iconUrl:
            'https://www.gravatar.com/avatar/f1e58218165345565b0108c396571a23?s=40&d=retro',
        },
      },
    ],
  },
  {
    name: 'monthlyTopUsersWithRatedComments',
    displayNameByLocale: {
      en: 'Top 5 best feedback givers',
    },
    topUserCommentQualityRatings: [
      ...
      },
      {
        ...
        userPublicProfile: {
          ...
          communityLinks: {
            twitterUsername: '05staff1',
            redditUsername: '',
            instagramUsername: '',
            tiktokUsername: '',
            personalWebsite2Link: '',
            facebookUsername: '',
            discordServerLink: 'https://discord.gg/kHTPxtujx5',
            snapchatUsername: '',
            personalWebsiteLink: 'https://gamesandgamesstudio.rf.gd',
            youtubeUsername: '05staff1',
          },
          iconUrl:
