...
type GetFakePopperJsAnchorElementReturn = { clientHeight: number, clientWidth: number, getBoundingClientRect: () => { bottom: number, height: number, left: number, right: number, top: number, width: number, x: number, y: number, } };

export const getFakePopperJsAnchorElement = (): GetFakePopperJsAnchorElementReturn => ({
  clientWidth: 100,
  clientHeight: 100,
