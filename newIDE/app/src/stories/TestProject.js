...
export const shapePainterObject = new gd.ShapePainterObject(
...
export const tiledSpriteObject = new gd.TiledSpriteObject(
  'MyTiledSpriteObject'
);
export const panelSpriteObject = new gd.PanelSpriteObject(
  'MyPanelSpriteObject'
);
export const spriteObject = new gd.SpriteObject('MySpriteObject');
export const spriteObjectWithBehaviors = new gd.SpriteObject(
...
export const testLayoutInstance1 = testLayout
  .getInitialInstances()
